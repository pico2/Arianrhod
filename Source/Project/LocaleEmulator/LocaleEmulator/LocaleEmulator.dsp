...
# ADD LINK32 mylib.lib undoc_ntdll.lib ntdll.lib fms2.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /dll /pdb:"LocaleEmulator.pdb" /debug /machine:I386 /out:"LocaleEmulator.dll" /ltcg /DELAYLOAD:USER32.dll /DELAYLOAD:DBGHELP.dll /DELAYLOAD:GDI32.dll /DELAYLOAD:KERNEL32.dll /OPT:REF /DELAYLOAD:msvcrt.dll
