...
public class HookGravityBox implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(LoadPackageParam pkg) throws Throwable {
        XposedHelpers.findAndHookMethod("com.ceco.lollipop.gravitybox.UnlockActivity", pkg.classLoader, "checkPolicyOk", Context.class, new XC_MethodHook() {
            @Override
...
//                HookLoadPackage.log("hook in");
        ...
        XposedHelpers.findAndHookConstructor("com.ceco.lollipop.gravitybox.GravityBoxSettings$SystemProperties", pkg.classLoader, Bundle.class, new XC_MethodHook() {
            @Override
