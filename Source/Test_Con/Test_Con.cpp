...
VOID SendRequestingSync(CFServiceConnection Connection)
{
    ...
    //       <key>Grappa</key>
    //       <data>
    //       AQG/pB+Rk8ANs4hstE04paiABECDLUYiRHbygT0+EvS+CgjsiPq6
    //       +zGZpu36Q5/94o4JxRNTLlniWmSVxd4igg7SY4bMUGaJ/znJDKDd
    //       qcQ/eWSl
    //       </data>
    //       <key>LibraryID</key>
    //       <string>5B2D82310D4DC29E</string>
...
EXTC_EXPORT VOID CDECL OnDeviceConnected(HANDLE Device)
{
    ...
    for (ULONG_PTR i = 10; i != 0; --i)
    {
        ...
        {
            // if Message.Name == ReadyForSync and Message.Has('Params.DeviceInfo.Grappa'):
            //     EstablishGrappaKey(
            //         GrappaKey,
            //         Base64Decode(Message.Params.DeviceInfo.Grappa),
            //         GrappaLength
            //     )
