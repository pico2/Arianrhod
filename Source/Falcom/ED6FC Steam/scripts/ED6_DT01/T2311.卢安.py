...
def main():
    ...
    def Function_4_45B(): pass

    label("Function_4_45B")

    TalkBegin(0x14)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_4D2")
    OP_A2(0x0)
    ...
    def Function_5_524(): pass

    label("Function_5_524")
    ...
    def Function_6_57D(): pass

    label("Function_6_57D")

    TalkBegin(0x16)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_605")
    OP_A2(0x3)
    ...
    def Function_7_659(): pass

    label("Function_7_659")
    ...
    def Function_8_6A3(): pass

    label("Function_8_6A3")
