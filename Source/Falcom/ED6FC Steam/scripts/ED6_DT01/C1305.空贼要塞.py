...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_58C")
    ClearMapFlags(0x1)
    EventBegin(0x0)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x3), scpexpr(EXPR_EQU), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_4C8")
    ...
    QueueWorkItem(0x104, 1, lambda_474)

    def lambda_482():
        OP_8C(0xFE, 270, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_482)
    OP_8C(0x103, 270, 400)
    ...
    QueueWorkItem(0x0, 3, lambda_4CE)
    Sleep(600)
    OP_8C(0x104, 270, 400)
    ...
    QueueWorkItem(0x103, 1, lambda_528)

    def lambda_536():
        OP_8C(0xFE, 270, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_536)
    OP_8C(0x101, 270, 400)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_68B")
    ClearMapFlags(0x1)
    EventBegin(0x0)
    ...
    QueueWorkItem(0xA, 1, lambda_889)
    ...
    QueueWorkItem(0x8, 1, lambda_8B3)

    def lambda_8C8():
        OP_92(0xFE, 0x102, 0x3E8, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_8C8)
    Sleep(400)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x71, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B0D")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x14E, 1)"), scpexpr(EXPR_END)), "loc_A93")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    ...
    def Function_7_B4E(): pass

    label("Function_7_B4E")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6D, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C38")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x3F, 1)"), scpexpr(EXPR_END)), "loc_BC2")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6D, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D6F")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x3, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FE, 1)"), scpexpr(EXPR_END)), "loc_CF1")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
