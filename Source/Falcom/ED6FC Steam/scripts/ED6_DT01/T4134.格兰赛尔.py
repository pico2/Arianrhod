...
def main():
    ...
    QueueWorkItem(0x101, 2, lambda_289)
    ...
    QueueWorkItem(0x8, 1, lambda_4C2)
    OP_8C(0x8, 90, 400)
    OP_8C(0x8, 0, 400)
    OP_22(0xCB, 0x0, 0x64)
    ...
    QueueWorkItem(0x9, 1, lambda_532)

    def lambda_54D():
        OP_67(0, 5010, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x9, 2, lambda_54D)
    ...
    QueueWorkItem(0x102, 1, lambda_120B)
    ...
    QueueWorkItem(0x102, 1, lambda_12E3)

    def lambda_12F1():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_12F1)
    ...
    QueueWorkItem(0x9, 1, lambda_1442)

    def lambda_145A():
        TurnDirection(0xFE, 0x9, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_145A)
    TurnDirection(0x101, 0x9, 400)
    OP_8C(0x9, 90, 600)
    OP_8C(0x9, 0, 600)
    OP_22(0xCB, 0x0, 0x64)
    ...
    OP_0D()
    OP_21()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x48, 0x1, 0x8000)"), scpexpr(EXPR_END)), "loc_1541")
    Jump("loc_157C")

    label("loc_1541")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x48, 0x1, 0x4000)"), scpexpr(EXPR_EXEC_OP, "OP_29(0x48, 0x1, 0x2000)"), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_155C")
    OP_2B(0x45, 0x1)
    Jump("loc_157C")

    label("loc_155C")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x48, 0x1, 0x1000)"), scpexpr(EXPR_EXEC_OP, "OP_29(0x48, 0x1, 0x800)"), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_1577")
    OP_2B(0x45, 0x3)
    Jump("loc_157C")
