...
def main():
    ...
    ScpFunction(
        ...
        "Function_3_97C",          # 03, 3
        "Function_4_BB2",          # 04, 4
        "Function_5_186E",         # 05, 5
        "Function_6_1CFE",         # 06, 6
        "Function_7_2453",         # 07, 7
        "Function_8_28A2",         # 08, 8
        "Function_9_28CB",         # 09, 9
        "Function_10_28F9",        # 0A, 10
        "Function_11_2927",        # 0B, 11
        "Function_12_2E58",        # 0C, 12
        "Function_13_3086",        # 0D, 13
        "Function_14_3178",        # 0E, 14
        "Function_15_3397",        # 0F, 15
        "Function_16_3841",        # 10, 16
        "Function_17_390A",        # 11, 17
        "Function_18_3911",        # 12, 18
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 6)), scpexpr(EXPR_END)), "loc_BBA")
    Return()
    ...
    QueueWorkItem2(0x101, 2, lambda_C0D)
    ...
    QueueWorkItem2(0x102, 2, lambda_C1E)
    ...
    QueueWorkItem(0x102, 1, lambda_C4A)

    def lambda_C65():
        OP_6C(33000, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_C65)
    ...
    QueueWorkItem(0xA, 2, lambda_F20)
    ...
    QueueWorkItem2(0x8, 1, lambda_F3B)

    def lambda_F4C():
        OP_8E(0xFE, 0xFFFFF9FC, 0x4D26, 0x1A22A, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_F4C)
    ...
    QueueWorkItem2(0x9, 1, lambda_F67)

    def lambda_F78():
        OP_8E(0xFE, 0xFFFFFA24, 0x4B32, 0x19EEC, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 2, lambda_F78)
    ...
    QueueWorkItem2(0x101, 1, lambda_12D6)
    ...
    QueueWorkItem2(0x102, 1, lambda_12E7)
    ...
    QueueWorkItem2(0x101, 1, lambda_1505)
    ...
    QueueWorkItem2(0x102, 1, lambda_1516)
    ...
    QueueWorkItem(0x101, 2, lambda_1542)

    def lambda_155D():
        OP_8E(0xFE, 0x1EA, 0x36B0, 0x13EAC, 0x9C4, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_155D)

    def lambda_1578():
        OP_6D(-90, 14000, 81270, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_1578)
    ...
    def Function_5_186E(): pass

    label("Function_5_186E")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_187B")
    Return()
    ...
    QueueWorkItem(0x8, 1, lambda_1C49)
    ...
    QueueWorkItem(0x9, 1, lambda_1C7B)
    FadeToDark(2000, 0, -1)
    ...
    QueueWorkItem(0x138, 1, lambda_1CA0)
    Sleep(50)
    ...
    QueueWorkItem(0x101, 1, lambda_1CC0)

    def lambda_1CDB():
        OP_90(0xFE, 0x0, 0x0, 0x2710, 0x3E8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1CDB)
    OP_0D()
    OP_A2(0x3FA)
    ...
    QueueWorkItem2(0x8, 2, lambda_1D4B)
    ...
    QueueWorkItem2(0x9, 2, lambda_1D5C)
    SetChrChipByIndex(0x101, 2)
    SetChrChipByIndex(0x102, 3)
    SetChrChipByIndex(0x138, 1)
    ...
    QueueWorkItem(0x138, 1, lambda_1DAF)

    def lambda_1DCA():
        OP_8E(0xFE, 0xFFFFFE20, 0x4D26, 0x1A310, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_1DCA)

    def lambda_1DE5():
        OP_8E(0xFE, 0x35C, 0x4D26, 0x1A310, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1DE5)
    ...
    QueueWorkItem(0x101, 3, lambda_1F39)

    def lambda_1F51():
        OP_90(0xFE, 0x0, 0x0, 0xFFFFF448, 0x5DC, 0x0)
        ExitThread()

    QueueWorkItem(0x138, 1, lambda_1F51)
    Sleep(100)
    ...
    QueueWorkItem(0x102, 1, lambda_1F8C)

    def lambda_1FA7():
        OP_8F(0xFE, 0xFFFFFC9A, 0x4D26, 0x1A2C0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_1FA7)
    Sleep(100)
    ...
    QueueWorkItem(0x9, 1, lambda_1FC7)
    Sleep(1100)
    ...
    QueueWorkItem(0x138, 1, lambda_2040)

    def lambda_204E():
        OP_8C(0xFE, 0, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_204E)
    OP_8C(0x101, 0, 400)
    ...
    def Function_7_2453(): pass

    label("Function_7_2453")
    ...
    QueueWorkItem(0x8, 2, lambda_25E8)

    def lambda_2600():
        OP_8C(0xFE, 0, 400)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_2600)

    def lambda_260E():
        OP_8C(0xFE, 0, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_260E)
    OP_8C(0xB, 0, 400)
    ...
    QueueWorkItem2(0xD, 1, lambda_267D)
    ...
    QueueWorkItem2(0xE, 1, lambda_268E)
    ...
    QueueWorkItem2(0xF, 1, lambda_269F)
    ...
    QueueWorkItem2(0x10, 1, lambda_26B0)
    ...
    QueueWorkItem2(0x11, 1, lambda_26C1)
    ...
    QueueWorkItem2(0x12, 1, lambda_26D2)
    ...
    QueueWorkItem(0xC, 1, lambda_275D)
    ...
    QueueWorkItem(0x8, 1, lambda_27FD)

    def lambda_280B():
        OP_8C(0xFE, 180, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_280B)
    Sleep(1000)
    ...
    def Function_8_28A2(): pass

    label("Function_8_28A2")
    ...
    def Function_10_28F9(): pass

    label("Function_10_28F9")
    ...
    # Function_10_28F9 end

    def Function_11_2927(): pass

    label("Function_11_2927")
    ...
    QueueWorkItem2(0xB, 1, lambda_29C0)
    ...
    QueueWorkItem2(0x8, 1, lambda_29D1)
    ...
    QueueWorkItem2(0x9, 1, lambda_29E2)
    ...
    QueueWorkItem(0x103, 3, lambda_2A3E)
    OP_6F(0x0, 241)
    OP_70(0x0, 0x168)
    OP_73(0x0)
    OP_6F(0x0, 1140)
    ...
    QueueWorkItem2(0x101, 1, lambda_2A78)
    ...
    QueueWorkItem2(0x105, 1, lambda_2A89)
    ...
    QueueWorkItem2(0x103, 1, lambda_2A9A)

    def lambda_2AAB():
        OP_6D(-7590, 12000, 54940, 4000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_2AAB)

    def lambda_2AC3():
        OP_6E(291, 4000)
        ExitThread()

    QueueWorkItem(0x105, 3, lambda_2AC3)

    def lambda_2AD3():
        OP_8E(0xFE, 0xFFFFECB4, 0x31A6, 0xD00C, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_2AD3)
    Sleep(400)
    ...
    QueueWorkItem(0x103, 2, lambda_2AF3)
    Sleep(400)
    ...
    QueueWorkItem(0x105, 2, lambda_2B13)
    WaitChrThread(0x101, 0x2)
    ...
    QueueWorkItem(0x101, 2, lambda_2B33)
    ...
    QueueWorkItem(0x103, 2, lambda_2B56)
    ...
    QueueWorkItem(0x105, 2, lambda_2B76)
    ...
    # Function_11_2927 end

    def Function_12_2E58(): pass

    label("Function_12_2E58")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_2E65")
    Return()
    ...
    QueueWorkItem(0x101, 1, lambda_2F6B)

    def lambda_2F83():
        OP_8E(0xFE, 0xFFFFAFD8, 0x36B0, 0x130EC, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0xE, 1, lambda_2F83)

    def lambda_2F9E():
        OP_8E(0xFE, 0xFFFFAFD8, 0x36B0, 0x130EC, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_2F9E)

    def lambda_2FB9():
        OP_8E(0xFE, 0xFFFFAFD8, 0x36B0, 0x130EC, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_2FB9)
    Sleep(500)
    Battle(0x3A9, 0x0, 0x0, 0x0, 0xFF)
    Switch(
        (scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_END)),
        (1, "loc_2FEC"),
        (SWITCH_DEFAULT, "loc_2FEF"),
    )
    ...
    # Function_12_2E58 end

    def Function_13_3086(): pass

    label("Function_13_3086")

    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_30DE")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3115")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_315C")
    ...
    # Function_13_3086 end

    def Function_14_3178(): pass

    label("Function_14_3178")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_3185")
    Return()
    ...
    QueueWorkItem(0x101, 1, lambda_328D)

    def lambda_32A5():
        OP_8E(0xFE, 0xFFFFFECA, 0x4B32, 0x1F676, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_32A5)

    def lambda_32C0():
        OP_8E(0xFE, 0xFFFFFECA, 0x4B32, 0x1F676, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_32C0)

    def lambda_32DB():
        OP_8E(0xFE, 0xFFFFFECA, 0x4B32, 0x1F676, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_32DB)
    Sleep(500)
    Battle(0x3A9, 0x0, 0x0, 0x0, 0xFF)
    Switch(
        (scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_END)),
        (1, "loc_330E"),
        (SWITCH_DEFAULT, "loc_3311"),
    )
    ...
    # Function_14_3178 end

    def Function_15_3397(): pass

    label("Function_15_3397")
    ...
    QueueWorkItem(0x1D, 1, lambda_3629)

    def lambda_3644():
        OP_8E(0xFE, 0x3FC, 0x2EE0, 0xD1CE, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x1E, 1, lambda_3644)

    def lambda_365F():
        OP_8E(0xFE, 0xA, 0x2EE0, 0xD5D4, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x1F, 1, lambda_365F)

    def lambda_367A():
        OP_8E(0xFE, 0x14, 0x2EE0, 0xC3A0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x20, 1, lambda_367A)

    def lambda_3695():
        OP_8E(0xFE, 0x28A, 0x2EE0, 0xC684, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x13, 1, lambda_3695)
    ...
    QueueWorkItem2(0x101, 1, lambda_36B0)
    ...
    QueueWorkItem2(0x102, 1, lambda_36C1)
    ...
    QueueWorkItem2(0x14, 1, lambda_36D2)
    ...
    QueueWorkItem2(0x15, 1, lambda_36E3)
    ...
    QueueWorkItem2(0x16, 1, lambda_36F4)
    ...
    QueueWorkItem2(0x17, 1, lambda_3705)
    ...
    QueueWorkItem2(0x18, 1, lambda_3716)
    ...
    QueueWorkItem2(0x19, 1, lambda_3727)
    ...
    QueueWorkItem2(0x1A, 1, lambda_3738)
    ...
    QueueWorkItem2(0x1B, 1, lambda_3749)
    ...
    QueueWorkItem2(0x1C, 1, lambda_375A)
    ...
    QueueWorkItem2(0x21, 1, lambda_376B)
    ...
    QueueWorkItem2(0x22, 1, lambda_377C)
    ...
    QueueWorkItem2(0x23, 1, lambda_378D)
    ...
    QueueWorkItem2(0x24, 1, lambda_379E)
    ...
    QueueWorkItem2(0x25, 1, lambda_37AF)
    ...
    QueueWorkItem2(0x26, 1, lambda_37C0)

    def lambda_37D1():
        OP_6D(-1510, 12000, 54280, 9000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_37D1)

    def lambda_37E9():
        OP_6E(342, 9000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_37E9)
    ...
    QueueWorkItem(0x0, 2, lambda_3803)
    ...
    # Function_15_3397 end

    def Function_16_3841(): pass

    label("Function_16_3841")
    ...
    QueueWorkItem(0x101, 1, lambda_3899)

    def lambda_38B1():
        OP_6B(5000, 16000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_38B1)

    def lambda_38C1():
        OP_6D(390, 14500, 76830, 16000)
        ExitThread()

    QueueWorkItem(0x101, 0, lambda_38C1)
    Sleep(2000)
    ...
    QueueWorkItem(0x101, 3, lambda_38DE)
    Sleep(10000)
    FadeToDark(2000, 0, -1)
    OP_0D()
    SetMapFlags(0x2000000)
    ...
    def Function_18_3911(): pass

    label("Function_18_3911")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCE, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_391A")
    Return()
    ...
    QueueWorkItem2(0x2D, 1, lambda_3947)
    Fade(1000)
    ...
    QueueWorkItem(0x101, 2, lambda_399C)
    WaitChrThread(0x101, 0x2)
    OP_20(0x7D0)
    OP_21()
    OP_44(0x2D, 0xFF)
    ...
    QueueWorkItem(0x101, 1, lambda_39F1)
    Sleep(2000)
    ...
    QueueWorkItem(0x2D, 1, lambda_3C52)
    Sleep(1500)
    OP_8C(0x2D, 270, 400)
    ...
    QueueWorkItem(0x2D, 1, lambda_447B)
    Sleep(1000)
    TurnDirection(0x2D, 0x101, 400)
    WaitChrThread(0x2D, 0x1)
    ...
    QueueWorkItem2(0x2D, 1, lambda_471E)

    def lambda_4731():
        OP_8F(0xFE, 0xFFFF5C0E, 0x3E80, 0x13C68, 0x3E8, 0x0)
        ExitThread()

    QueueWorkItem(0x2D, 2, lambda_4731)
    Sleep(500)
    ...
    QueueWorkItem(0x2D, 2, lambda_478C)
    Sleep(1000)
    ClearChrFlags(0x2D, 0x1)
    WaitChrThread(0x2D, 0x2)
    ...
    QueueWorkItem2(0x101, 1, lambda_4913)
    ...
    QueueWorkItem(0x101, 2, lambda_4C8E)
    ...
    QueueWorkItem(0x2D, 2, lambda_4CAF)
    Sleep(500)
    SetChrFlags(0x2D, 0x1)
    WaitChrThread(0x2D, 0x2)
    Fade(500)
    ...
    QueueWorkItem(0x101, 1, lambda_4D43)
    ...
    QueueWorkItem(0x101, 1, lambda_4E14)
    OP_22(0xA4, 0x0, 0x64)
    ...
    QueueWorkItem(0x101, 2, lambda_4E70)

    def lambda_4E80():
        OP_6B(1300, 60000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_4E80)
    Sleep(500)
    ...
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_538A")
    Sleep(10)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x2D), scpexpr(EXPR_END)), "loc_5387")
    FadeToDark(1000, 0, -1)
    OP_0D()
    PlayMovie(0x1, "")
    Sleep(500)
    ...
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_5387")
    Sleep(10)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x2D), scpexpr(EXPR_END)), "loc_5384")
    FadeToDark(1000, 0, -1)
    OP_0D()
    PlayMovie(0x1, "")
    Sleep(1500)
    ...
    # Function_18_3911 end

    def Function_19_538B(): pass

    label("Function_19_538B")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 3)), scpexpr(EXPR_EXEC_OP, "OP_42(0x37)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_NEQ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_540B")
    EventBegin(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_5486")
    EventBegin(0x1)
