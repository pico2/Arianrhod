...
def main():
    ...
    ScpFunction(
        ...
        "Function_7_2558",         # 07, 7
        "Function_8_25EF",         # 08, 8
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 7)), scpexpr(EXPR_END)), "loc_46D")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_316")
    TalkBegin(0xFE)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 2)), scpexpr(EXPR_END)), "loc_627")
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_4D5")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_5C2")
    OP_A2(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_END)), "loc_6CD")
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_66B")
    ...
    QueueWorkItem(0x101, 1, lambda_742)

    def lambda_75A():
        OP_67(0, 5140, -10000, 8000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_75A)

    def lambda_772():
        OP_6B(8860, 8000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_772)

    def lambda_782():
        OP_6C(77000, 9000)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_782)
    Sleep(9000)
    Fade(1000)
    ...
    def Function_5_A4D(): pass

    label("Function_5_A4D")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 3)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2398")
    OP_A2(0x55C)
    OP_28(0x43, 0x1, 0x2)
    OP_28(0x43, 0x1, 0x4)
    EventBegin(0x0)
    ...
    QueueWorkItem(0x8, 1, lambda_10A5)
    Sleep(500)
    ...
    QueueWorkItem(0x9, 1, lambda_10C5)

    def lambda_10E0():
        OP_8E(0xFE, 0x316, 0xAA, 0xFFFFE714, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_10E0)

    def lambda_10FB():
        OP_6D(-150, 190, -6720, 5000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_10FB)

    def lambda_1113():
        OP_6B(850, 5000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1113)
    ...
    QueueWorkItem2(0x9, 1, lambda_1CA0)
    ...
    QueueWorkItem2(0xA, 1, lambda_1CB1)
    OP_8C(0x8, 0, 400)
    ...
    QueueWorkItem(0x8, 1, lambda_1CC9)
    Sleep(1000)
    ...
    QueueWorkItem(0x9, 1, lambda_1CE9)

    def lambda_1D04():
        OP_8E(0xFE, 0x384, 0xA0, 0x1054, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_1D04)
    Sleep(2000)
    ...
    QueueWorkItem(0x101, 1, lambda_1D24)

    def lambda_1D3C():
        OP_6E(489, 4000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1D3C)
    Sleep(4000)
    TurnDirection(0x101, 0x102, 400)
    ...
    QueueWorkItem2(0x102, 3, lambda_201E)

    def lambda_202F():
        OP_6D(-120, 180, -6630, 3000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_202F)

    def lambda_2047():
        OP_6B(4090, 4000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_2047)

    def lambda_2057():
        OP_8E(0xFE, 0xFFFFFF38, 0xAA, 0xFFFFE6BA, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_2057)
    Sleep(500)
    ...
    QueueWorkItem(0x9, 1, lambda_2077)
    Sleep(500)
    ...
    QueueWorkItem(0xA, 1, lambda_2097)
    WaitChrThread(0x8, 0x1)
    ...
    QueueWorkItem(0x9, 2, lambda_2229)
    ...
    QueueWorkItem2(0x9, 1, lambda_2244)
    ...
    QueueWorkItem(0xA, 2, lambda_2261)
    ...
    QueueWorkItem2(0xA, 1, lambda_227C)
    Sleep(1000)
    TurnDirection(0x8, 0x101, 400)
    ...
    QueueWorkItem(0x0, 2, lambda_230E)

    def lambda_2326():
        OP_67(0, 9500, -10000, 5000)
        ExitThread()

    QueueWorkItem(0x1, 2, lambda_2326)

    def lambda_233E():
        OP_6C(45000, 5000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_233E)

    def lambda_234E():
        OP_6B(2800, 5000)
        ExitThread()

    QueueWorkItem(0x1, 3, lambda_234E)

    def lambda_235E():
        OP_8E(0xFE, 0x4EC, 0xFA, 0xD48, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_235E)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2557")
    OP_A2(0x55D)
    OP_28(0x43, 0x1, 0x8)
    OP_28(0x43, 0x1, 0x10)
    EventBegin(0x0)
    ...
    def Function_7_2558(): pass

    label("Function_7_2558")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_25EE")
    EventBegin(0x1)
    OP_4A(0x9, 0)
    OP_4A(0xA, 0)
    ...
    def Function_8_25EF(): pass

    label("Function_8_25EF")
