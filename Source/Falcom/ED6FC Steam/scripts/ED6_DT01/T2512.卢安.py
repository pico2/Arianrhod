...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_BA3",          # 08, 8
        "Function_9_CCF",          # 09, 9
        "Function_10_FB8",         # 0A, 10
        "Function_11_12D6",        # 0B, 11
        "Function_12_2129",        # 0C, 12
        "Function_13_240E",        # 0D, 13
    )
    ...
    TalkBegin(0x9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_601")
    OP_A2(0x0)
    ...
    def Function_4_652(): pass

    label("Function_4_652")

    TalkBegin(0xA)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 0)), scpexpr(EXPR_END)), "loc_7B0")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x27, 0x1, 0x8000)"), scpexpr(EXPR_END)), "loc_707")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_6B8")
    OP_A2(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 7)), scpexpr(EXPR_END)), "loc_803")
    ...
    def Function_5_807(): pass

    label("Function_5_807")
    ...
    TalkBegin(0xC)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 0)), scpexpr(EXPR_END)), "loc_8DB")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_8A5")
    OP_A2(0x3)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 7)), scpexpr(EXPR_END)), "loc_93A")
    ...
    def Function_7_93E(): pass

    label("Function_7_93E")

    TalkBegin(0xD)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_A12")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9F2")
    OP_A2(0x4)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 0)), scpexpr(EXPR_END)), "loc_B5D")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B12")
    OP_A2(0x4)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 7)), scpexpr(EXPR_END)), "loc_B9F")
    ...
    TalkBegin(0xE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_C0A")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 0)), scpexpr(EXPR_END)), "loc_C68")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 7)), scpexpr(EXPR_END)), "loc_CCB")
    ...
    def Function_9_CCF(): pass

    label("Function_9_CCF")

    TalkBegin(0xF)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_D7A")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D40")
    OP_A2(0x6)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 0)), scpexpr(EXPR_END)), "loc_FB4")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_F8D")
    OP_A2(0x6)
    OP_A2(0x7)
    OP_4A(0x10, 255)
    ...
    def Function_10_FB8(): pass

    label("Function_10_FB8")

    TalkBegin(0x10)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_1092")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_106C")
    OP_A2(0x7)
    OP_4A(0xF, 255)
    ...
    QueueWorkItem(0xF, 1, lambda_101A)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 0)), scpexpr(EXPR_END)), "loc_12D2")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_12AB")
    OP_A2(0x6)
    OP_A2(0x7)
    OP_4A(0xF, 255)
    ...
    def Function_11_12D6(): pass

    label("Function_11_12D6")
    ...
    QueueWorkItem(0x101, 1, lambda_1EE0)
    ...
    QueueWorkItem2(0x101, 2, lambda_1F0F)
    ...
    QueueWorkItem2(0x105, 2, lambda_1F20)
    ...
    QueueWorkItem(0x8, 3, lambda_1F5E)
    ...
    # Function_11_12D6 end

    def Function_12_2129(): pass

    label("Function_12_2129")
    ...
    QueueWorkItem(0x101, 1, lambda_221F)
    Sleep(50)
    OP_6F(0xA, 15)
    OP_70(0xA, 0x14)
    Sleep(1000)
    ...
    QueueWorkItem(0x105, 2, lambda_2260)
    ...
    QueueWorkItem(0x105, 2, lambda_236C)
    ...
    # Function_12_2129 end

    def Function_13_240E(): pass

    label("Function_13_240E")
