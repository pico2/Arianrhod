...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_6F3",          # 08, 8
        "Function_9_7B9",          # 09, 9
        "Function_10_9B4",         # 0A, 10
        "Function_11_BA3",         # 0B, 11
        "Function_12_CD4",         # 0C, 12
        "Function_13_E05",         # 0D, 13
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD7, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_973")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x3, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD7, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_899")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0xBB, 1)"), scpexpr(EXPR_END)), "loc_8F3")
    ...
    def Function_10_9B4(): pass

    label("Function_10_9B4")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD7, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B62")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x6, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD7, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A94")
    ...
    QueueWorkItem(0x8, 1, lambda_A03)

    def lambda_A1E():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x4B0)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_A1E)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x119, 1)"), scpexpr(EXPR_END)), "loc_AEA")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    def Function_11_BA3(): pass

    label("Function_11_BA3")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD7, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C93")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x4, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_C19")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_12_CD4(): pass

    label("Function_12_CD4")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD7, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_DC4")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x5, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_D4A")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_13_E05(): pass

    label("Function_13_E05")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD7, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_EF5")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x7, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F7, 1)"), scpexpr(EXPR_END)), "loc_E7B")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
