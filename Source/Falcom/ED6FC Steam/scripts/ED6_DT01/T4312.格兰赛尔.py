...
def main():
    ...
    ScpFunction(
        ...
        "Function_4_C93",          # 04, 4
        "Function_5_E4B",          # 05, 5
        "Function_6_307B",         # 06, 6
        "Function_7_3776",         # 07, 7
    )
    ...
    QueueWorkItem(0x102, 1, lambda_63B)
    ...
    QueueWorkItem(0x102, 2, lambda_657)

    def lambda_66F():
        OP_67(0, 4710, -10000, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_66F)

    def lambda_687():
        OP_6C(68000, 2000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_687)
    ...
    QueueWorkItem(0x101, 1, lambda_71F)
    ...
    QueueWorkItem(0x108, 1, lambda_74B)
    ...
    def Function_3_8DE(): pass

    label("Function_3_8DE")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 4)), scpexpr(EXPR_END)), "loc_8E6")
    Return()
    ...
    QueueWorkItem(0x108, 1, lambda_934)

    def lambda_942():
        OP_8C(0xFE, 0, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_942)

    def lambda_950():
        OP_8C(0xFE, 0, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_950)
    ...
    QueueWorkItem(0x108, 1, lambda_9B1)

    def lambda_9CC():
        OP_8E(0xFE, 0xFFFF34FE, 0x0, 0x30DE, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_9CC)
    ...
    QueueWorkItem(0x108, 1, lambda_AAB)

    def lambda_AC6():
        OP_8E(0xFE, 0xFFFF3878, 0x0, 0x9A92, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_AC6)

    def lambda_AE1():
        OP_8E(0xFE, 0xFFFF3878, 0x0, 0x9A92, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_AE1)
    ...
    QueueWorkItem(0x108, 1, lambda_BF4)
    OP_8C(0x102, 315, 400)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C4C")
    ...
    def Function_4_C93(): pass

    label("Function_4_C93")

    SetMapFlags(0x80)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_DBA")
    OP_A2(0x655)
    EventBegin(0x0)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D87")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 7)), scpexpr(EXPR_END)), "loc_E09")
    OP_8B(0x0, 0xFFFF38FA, 0x5604, 0x190)
    OP_A2(0x658)
    OP_71(0x1, 0x10)
    ...
    def Function_5_E4B(): pass

    label("Function_5_E4B")
    ...
    QueueWorkItem(0x101, 3, lambda_F79)

    def lambda_F91():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_F91)

    def lambda_FA3():
        OP_8E(0xFE, 0xFFFFFFC4, 0x0, 0xDFFC, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_FA3)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 2, lambda_FC3)

    def lambda_FD5():
        OP_8E(0xFE, 0x302, 0x0, 0xDBEC, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_FD5)
    Sleep(500)
    ...
    QueueWorkItem(0x108, 2, lambda_FF5)

    def lambda_1007():
        OP_8E(0xFE, 0xFFFFFC4A, 0x0, 0xDA34, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_1007)
    ...
    QueueWorkItem(0x101, 1, lambda_1042)
    SetChrChipByIndex(0x101, 65535)
    SetChrChipByIndex(0x102, 65535)
    SetChrChipByIndex(0x108, 65535)
    ...
    QueueWorkItem(0x108, 1, lambda_1077)
    ...
    QueueWorkItem(0x102, 1, lambda_112D)

    def lambda_113B():
        TurnDirection(0xFE, 0x10, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_113B)
    ...
    QueueWorkItem(0x101, 2, lambda_1163)

    def lambda_117B():
        OP_67(0, 4420, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_117B)

    def lambda_1193():
        OP_6C(11000, 3000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_1193)
    Sleep(1500)
    ...
    QueueWorkItem(0x102, 1, lambda_11C8)
    Sleep(300)
    ...
    QueueWorkItem(0x108, 2, lambda_11E8)
    Sleep(100)
    ...
    QueueWorkItem(0xF, 2, lambda_1208)
    ...
    QueueWorkItem2(0x108, 1, lambda_1223)
    ...
    QueueWorkItem2(0xF, 1, lambda_1234)
    WaitChrThread(0x101, 0x1)
    ...
    QueueWorkItem(0x101, 2, lambda_15AA)
    OP_6C(45000, 1500)
    ...
    QueueWorkItem(0x102, 1, lambda_1C15)

    def lambda_1C23():
        TurnDirection(0xFE, 0xC, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_1C23)
    ...
    QueueWorkItem(0xF, 1, lambda_1C3F)

    def lambda_1C4D():
        OP_6D(800, 0, 61890, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1C4D)

    def lambda_1C65():
        OP_6E(297, 2000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_1C65)
    Sleep(2000)
    ...
    QueueWorkItem(0x101, 2, lambda_1CA4)

    def lambda_1CBC():
        OP_6E(261, 2000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_1CBC)
    SetChrChipByIndex(0x101, 0)
    ...
    QueueWorkItem(0x101, 1, lambda_1CD1)
    Sleep(200)
    SetChrChipByIndex(0x102, 2)
    ...
    QueueWorkItem(0x102, 1, lambda_1CF6)
    Sleep(100)
    SetChrChipByIndex(0x108, 4)
    ...
    QueueWorkItem(0x108, 1, lambda_1D1B)
    Sleep(200)
    ...
    QueueWorkItem(0x10, 1, lambda_1D3B)
    ...
    QueueWorkItem(0xC, 1, lambda_20CA)

    def lambda_20D8():
        TurnDirection(0xFE, 0x12, 400)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_20D8)

    def lambda_20E6():
        TurnDirection(0xFE, 0x12, 400)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_20E6)

    def lambda_20F4():
        OP_6D(500, 0, 59390, 800)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_20F4)
    OP_6E(280, 800)
    ...
    QueueWorkItem2(0xC, 1, lambda_2115)
    ...
    QueueWorkItem2(0x8, 1, lambda_2126)
    ...
    QueueWorkItem2(0xD, 1, lambda_2137)
    ...
    QueueWorkItem2(0x12, 1, lambda_216C)
    ...
    QueueWorkItem(0x8, 2, lambda_2228)
    Sleep(500)
    ...
    QueueWorkItem(0xD, 1, lambda_223D)
    Sleep(100)
    ...
    QueueWorkItem2(0x101, 1, lambda_22D9)
    ...
    QueueWorkItem2(0x102, 1, lambda_22EA)
    ...
    QueueWorkItem2(0x108, 1, lambda_22FB)
    ...
    QueueWorkItem2(0xF, 1, lambda_230C)
    ...
    QueueWorkItem2(0x10, 1, lambda_231D)
    ...
    QueueWorkItem(0xC, 1, lambda_2434)
    ...
    QueueWorkItem2(0x12, 1, lambda_2469)
    ...
    QueueWorkItem(0x12, 1, lambda_2485)
    Sleep(200)
    ...
    QueueWorkItem(0x101, 1, lambda_24EB)

    def lambda_2503():
        OP_8F(0xFE, 0x2508, 0x1F4, 0xDCE6, 0x2EE0, 0x0)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_2503)
    ...
    QueueWorkItem2(0x12, 1, lambda_2653)
    ...
    QueueWorkItem2(0xD, 1, lambda_2664)
    ...
    QueueWorkItem2(0x101, 1, lambda_2675)
    ...
    QueueWorkItem2(0x102, 1, lambda_2686)
    ...
    QueueWorkItem2(0x108, 1, lambda_2697)
    ...
    QueueWorkItem(0x13, 2, lambda_26DA)

    def lambda_26EC():
        OP_8E(0xFE, 0x1E, 0x0, 0xD7F0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x13, 1, lambda_26EC)
    Sleep(100)
    ...
    QueueWorkItem(0x101, 2, lambda_2746)
    Sleep(100)
    SetChrChipByIndex(0x102, 65535)
    ...
    QueueWorkItem(0x102, 2, lambda_276B)
    Sleep(300)
    ...
    QueueWorkItem(0x10, 2, lambda_278B)
    Sleep(500)
    SetChrChipByIndex(0x108, 65535)
    ...
    QueueWorkItem(0x108, 2, lambda_27B0)
    Sleep(100)
    ...
    QueueWorkItem(0xF, 2, lambda_27D0)
    Sleep(100)
    Sleep(2000)
    OP_44(0x12, 0xFF)
    ...
    QueueWorkItem(0x101, 1, lambda_2CA2)
    ...
    QueueWorkItem(0x102, 1, lambda_2DD7)

    def lambda_2DE5():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_2DE5)

    def lambda_2DF3():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x13, 1, lambda_2DF3)

    def lambda_2E01():
        OP_8F(0xFE, 0x4A6, 0x0, 0xD9EE, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x13, 2, lambda_2E01)

    def lambda_2E1C():
        OP_8F(0xFE, 0xFFFFF948, 0x0, 0xDEF8, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_2E1C)
    Sleep(500)
    ...
    QueueWorkItem2(0x101, 1, lambda_2E3C)
    ...
    QueueWorkItem2(0x102, 1, lambda_2E4D)
    ...
    QueueWorkItem2(0x108, 1, lambda_2E5E)
    ...
    QueueWorkItem2(0x13, 1, lambda_2E6F)
    ...
    QueueWorkItem(0x11, 2, lambda_2E85)

    def lambda_2E97():
        OP_8E(0xFE, 0xFFFFFEA2, 0x0, 0xDF7A, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_2E97)
    Sleep(1000)
    ...
    QueueWorkItem(0xE, 2, lambda_2EC6)

    def lambda_2ED8():
        OP_8E(0xFE, 0xFFFFFCAE, 0x3E8, 0xDF66, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xE, 1, lambda_2ED8)
    Sleep(1000)
    ...
    def Function_6_307B(): pass

    label("Function_6_307B")
    ...
    def Function_7_3776(): pass

    label("Function_7_3776")

    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_37CB")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3827")
