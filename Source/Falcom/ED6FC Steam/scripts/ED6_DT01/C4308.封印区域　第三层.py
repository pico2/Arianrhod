...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_5E9",          # 08, 8
        "Function_9_6AF",          # 09, 9
        "Function_10_89E",         # 0A, 10
        "Function_11_9CF",         # 0B, 11
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD5, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_85D")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x5, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD5, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_78F")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x119, 1)"), scpexpr(EXPR_END)), "loc_7E5")
    ...
    def Function_10_89E(): pass

    label("Function_10_89E")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD5, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_98E")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x3, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_914")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_11_9CF(): pass

    label("Function_11_9CF")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD6, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_ABF")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x4, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_A45")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
