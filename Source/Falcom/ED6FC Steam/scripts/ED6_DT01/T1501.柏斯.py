...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_753",          # 08, 8
        "Function_9_9B6",          # 09, 9
        "Function_10_1BF6",        # 0A, 10
        "Function_11_1C8D",        # 0B, 11
        "Function_12_1D8D",        # 0C, 12
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6D, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 6)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_6CB")
    ClearMapFlags(0x1)
    EventBegin(0x0)
    OP_A2(0x34F)
    ...
    OP_8C(0x1, 0, 400)
    OP_8C(0x2, 0, 400)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3F1")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_417")
    ...
    QueueWorkItem(0x101, 2, lambda_458)
    OP_0D()
    ...
    QueueWorkItem(0x9, 1, lambda_469)
    Sleep(600)
    ...
    QueueWorkItem(0x101, 1, lambda_5B7)
    ...
    def Function_6_701(): pass

    label("Function_6_701")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 7)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_742")
    Call(0, 9)
    Jump("loc_752")

    label("loc_742")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_752")
    Call(0, 11)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6D, 2)), scpexpr(EXPR_END)), "loc_75D")
    Jump("loc_9B5")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 7)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1BF5")
    ClearMapFlags(0x1)
    EventBegin(0x0)
    OP_A2(0x350)
    ...
    QueueWorkItem(0x101, 2, lambda_A04)
    ...
    QueueWorkItem(0x0, 1, lambda_134C)
    ...
    QueueWorkItem(0x8, 1, lambda_1384)
    Sleep(800)
    ...
    QueueWorkItem(0x8, 1, lambda_13A4)
    Sleep(700)
    ...
    QueueWorkItem(0x8, 1, lambda_13C4)
    Sleep(600)
    OP_82(0x1, 0x2)
    ...
    QueueWorkItem(0x8, 1, lambda_13E7)
    Sleep(500)
    ...
    QueueWorkItem(0x8, 1, lambda_1427)
    ...
    QueueWorkItem(0x8, 1, lambda_147C)
    Sleep(300)
    OP_82(0x0, 0x2)
    ...
    QueueWorkItem(0x8, 1, lambda_149F)
    Sleep(300)
    ...
    QueueWorkItem(0x8, 1, lambda_14DF)
    Sleep(300)
    ...
    QueueWorkItem(0x8, 1, lambda_14FF)
    OP_82(0x2, 0x2)
    ...
    def Function_10_1BF6(): pass

    label("Function_10_1BF6")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1C8C")
    EventBegin(0x0)
    OP_20(0x7D0)
    FadeToDark(1000, 0, -1)
    OP_0D()
    ...
    # Function_10_1BF6 end

    def Function_11_1C8D(): pass

    label("Function_11_1C8D")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1D8C")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1CE6")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1D39")
    ...
    # Function_11_1C8D end

    def Function_12_1D8D(): pass

    label("Function_12_1D8D")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 7)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1E83")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1DE4")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1E2F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1F83")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1EA7")
    ...
    QueueWorkItem(0x102, 1, lambda_1EC2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6D, 2)), scpexpr(EXPR_END)), "loc_1F1F")
