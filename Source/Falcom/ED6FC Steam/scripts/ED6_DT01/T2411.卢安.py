...
def main():
    ...
    QueueWorkItem(0x8, 2, lambda_3C2)
    ...
    QueueWorkItem(0xC, 1, lambda_5EB)
    ...
    QueueWorkItem(0x8, 2, lambda_688)
    ...
    QueueWorkItem(0x8, 2, lambda_8A1)
    Sleep(1000)
    ...
    QueueWorkItem(0x8, 1, lambda_8BE)
    Sleep(100)
    ...
    QueueWorkItem(0xC, 1, lambda_8DE)

    def lambda_8F9():
        OP_8E(0xFE, 0x1F4, 0x0, 0x2710, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_8F9)
    Sleep(100)
    ...
    QueueWorkItem(0x9, 1, lambda_919)

    def lambda_934():
        OP_8E(0xFE, 0x1F4, 0x0, 0x2710, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_934)
    ...
    QueueWorkItem2(0x8, 1, lambda_9F2)
    Sleep(400)
    ...
    QueueWorkItem(0x8, 2, lambda_A3B)

    def lambda_A53():
        OP_8E(0xFE, 0xFFFFFB50, 0x0, 0x5D2, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_A53)
    Sleep(100)
    ...
    QueueWorkItem(0xA, 1, lambda_A73)
    Sleep(100)
    ...
    QueueWorkItem(0x9, 1, lambda_A93)
    Sleep(100)
    ...
    QueueWorkItem(0xB, 1, lambda_AB3)
    Sleep(500)
    ...
    QueueWorkItem(0x8, 1, lambda_AD3)
    OP_22(0x88, 0x0, 0x64)
    Sleep(200)
    ...
    QueueWorkItem(0xC, 1, lambda_B40)

    def lambda_B56():
        OP_94(0x1, 0xFE, 0xB4, 0x1F4, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_B56)
    Sleep(200)
    ...
    QueueWorkItem(0x8, 1, lambda_B71)
    ...
    QueueWorkItem(0x0, 1, lambda_C1E)
