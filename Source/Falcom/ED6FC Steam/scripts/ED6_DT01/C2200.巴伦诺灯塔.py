...
def main():
    ...
    QueueWorkItem(0x101, 1, lambda_644)

    def lambda_652():
        TurnDirection(0xFE, 0x106, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_652)
    Sleep(400)
    ...
    def Function_4_7F5(): pass

    label("Function_4_7F5")
    ...
    def Function_5_80E(): pass

    label("Function_5_80E")
    ...
    QueueWorkItem(0x9, 2, lambda_8DA)

    def lambda_8EA():
        OP_6D(-2320, 25000, -1320, 6000)
        ExitThread()

    QueueWorkItem(0x9, 3, lambda_8EA)
    SetChrPos(0x9, 5080, 25000, 6100, 0)
    SetChrPos(0xA, 5080, 25000, 6100, 0)
    ...
    QueueWorkItem(0x101, 1, lambda_BD2)
    Sleep(260)
    OP_44(0x101, 0xFF)
    ...
    def Function_7_FB9(): pass

    label("Function_7_FB9")
