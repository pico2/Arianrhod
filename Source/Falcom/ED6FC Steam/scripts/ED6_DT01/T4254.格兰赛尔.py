...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 6)), scpexpr(EXPR_END)), "loc_4BD")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_END)), "loc_520")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 0)), scpexpr(EXPR_END)), "loc_52A")
    Jump("loc_6C5")

    label("loc_52A")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 6)), scpexpr(EXPR_END)), "loc_5D8")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_5A0")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_6C5")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_620")
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 7)), scpexpr(EXPR_END)), "loc_785")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_728")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_85D")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_7E9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 6)), scpexpr(EXPR_END)), "loc_8EF")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_END)), "loc_8F9")
    Jump("loc_9B2")

    label("loc_8F9")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 0)), scpexpr(EXPR_END)), "loc_903")
    Jump("loc_9B2")

    label("loc_903")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_9B2")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_95B")
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_EBD")
    ...
    def Function_6_FDE(): pass

    label("Function_6_FDE")
    ...
    QueueWorkItem(0x101, 3, lambda_102F)

    def lambda_1047():
        OP_8E(0xFE, 0x10B6C, 0x0, 0x10BE4, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1047)
    ...
    QueueWorkItem(0x101, 1, lambda_1421)

    def lambda_142F():
        TurnDirection(0xFE, 0x9, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_142F)
    Sleep(300)
    ...
    QueueWorkItem2(0x9, 1, lambda_1442)

    def lambda_1453():
        OP_8E(0xFE, 0x10CCA, 0x0, 0x112B0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 2, lambda_1453)
    ...
    QueueWorkItem2(0x8, 1, lambda_146E)
    ...
    QueueWorkItem2(0x101, 1, lambda_147F)
    ...
    QueueWorkItem2(0x8, 1, lambda_1CD1)
    SetChrFlags(0x101, 0x4)
    SetChrFlags(0x102, 0x4)
    SetChrFlags(0x9, 0x4)
    ...
    QueueWorkItem(0x9, 1, lambda_1CFD)
    Sleep(300)
    ...
    QueueWorkItem(0x101, 3, lambda_1D80)

    def lambda_1D98():
        OP_8E(0xFE, 0x10C48, 0x0, 0x12D4A, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_1D98)

    def lambda_1DB3():
        OP_8F(0xFE, 0x10C48, 0x0, 0x12D4A, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1DB3)
    ...
    QueueWorkItem2(0x101, 2, lambda_1EF3)
    ...
    QueueWorkItem(0x9, 1, lambda_1F24)
    ...
    QueueWorkItem(0x9, 1, lambda_1F44)
    WaitChrThread(0x9, 0x1)
    ...
    QueueWorkItem(0x9, 1, lambda_1F64)
    ...
    QueueWorkItem(0x8, 1, lambda_2118)

    def lambda_2126():
        TurnDirection(0xFE, 0x102, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_2126)
    ...
    QueueWorkItem2(0x9, 1, lambda_21D8)
    ...
    QueueWorkItem2(0x8, 1, lambda_21E9)
    ...
    QueueWorkItem2(0x101, 1, lambda_21FA)

    def lambda_220B():
        OP_6C(5000, 3000)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_220B)

    def lambda_221B():
        OP_67(0, 6130, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_221B)
    Sleep(1600)
    ...
    QueueWorkItem(0x102, 1, lambda_2238)
    Sleep(3000)
    ...
    QueueWorkItem(0x102, 3, lambda_2258)

    def lambda_2268():
        OP_67(0, 8000, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_2268)
    ...
    QueueWorkItem(0x101, 1, lambda_23D2)

    def lambda_23E0():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_23E0)
    OP_8C(0x102, 180, 0)
    ...
    def Function_7_2749(): pass

    label("Function_7_2749")
