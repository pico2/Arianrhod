...
def main():
    ...
    ScpFunction(
        ...
        "Function_1_4F4",          # 01, 1
        "Function_2_507",          # 02, 2
        "Function_3_20E0",         # 03, 3
        "Function_4_2A28",         # 04, 4
        "Function_5_2CED",         # 05, 5
        "Function_6_2E1E",         # 06, 6
        "Function_7_2F4F",         # 07, 7
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC2, 5)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC2, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_20DF")
    EventBegin(0x0)
    ...
    QueueWorkItem(0xA, 1, lambda_6C1)
    Sleep(100)
    ...
    QueueWorkItem(0xB, 1, lambda_6E0)
    ...
    QueueWorkItem(0x101, 1, lambda_6FF)

    def lambda_71A():
        OP_8E(0xFE, 0x35DE, 0x0, 0xFFFF414C, 0x2134, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_71A)
    Sleep(600)
    ...
    QueueWorkItem(0x101, 2, lambda_74E)

    def lambda_75E():
        OP_99(0xFE, 0x0, 0xB, 0xBB8)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_75E)
    ...
    QueueWorkItem(0x9, 1, lambda_778)
    ...
    QueueWorkItem(0xB, 1, lambda_79B)
    ...
    QueueWorkItem(0x101, 1, lambda_7C7)

    def lambda_7E2():
        OP_8F(0xFE, 0x35D4, 0x0, 0xFFFF3DF0, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_7E2)
    Sleep(150)
    ...
    QueueWorkItem(0xA, 1, lambda_807)
    ...
    QueueWorkItem(0x9, 1, lambda_87A)

    def lambda_88F():
        OP_92(0xFE, 0x8, 0x0, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_88F)

    def lambda_8A4():
        OP_92(0xFE, 0x8, 0x0, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_8A4)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_9C8)
    ...
    QueueWorkItem(0x101, 3, lambda_CE1)
    Sleep(100)
    ...
    QueueWorkItem(0x102, 3, lambda_D01)
    OP_8C(0x8, 45, 400)
    ...
    QueueWorkItem(0x8, 3, lambda_D46)
    ...
    QueueWorkItem(0x101, 2, lambda_F06)
    Sleep(1500)
    ...
    QueueWorkItem(0x108, 2, lambda_1017)
    ...
    QueueWorkItem(0xF, 2, lambda_1070)

    def lambda_108B():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0x0, 0x3E8)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_108B)

    def lambda_109D():
        OP_99(0xFE, 0x4, 0x7, 0xBB8)
        ExitThread()

    QueueWorkItem(0x108, 2, lambda_109D)
    ...
    QueueWorkItem(0xF, 1, lambda_10E4)

    def lambda_10F2():
        TurnDirection(0xFE, 0x108, 400)
        ExitThread()

    QueueWorkItem(0xE, 1, lambda_10F2)

    def lambda_1100():
        TurnDirection(0xFE, 0x108, 400)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_1100)

    def lambda_110E():
        TurnDirection(0xFE, 0x108, 400)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_110E)

    def lambda_111C():
        TurnDirection(0xFE, 0x108, 400)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_111C)
    ...
    QueueWorkItem2(0x108, 1, lambda_1535)
    ...
    QueueWorkItem2(0x108, 1, lambda_16CD)
    ...
    QueueWorkItem2(0x102, 1, lambda_16DE)
    ...
    QueueWorkItem2(0x108, 2, lambda_17F3)
    ...
    QueueWorkItem2(0x101, 2, lambda_1804)
    ...
    QueueWorkItem2(0x102, 2, lambda_1815)
    ...
    QueueWorkItem2(0x8, 2, lambda_1826)

    def lambda_1837():
        OP_8E(0xFE, 0x48DA, 0x0, 0xFFFF540C, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_1837)

    def lambda_1852():
        OP_8E(0xFE, 0x4434, 0x0, 0xFFFF55EC, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1852)
    ...
    QueueWorkItem(0x101, 1, lambda_196A)
    ...
    QueueWorkItem(0x11, 1, lambda_1D63)
    Sleep(100)
    ...
    QueueWorkItem(0x12, 1, lambda_1D83)
    Sleep(200)
    ...
    QueueWorkItem(0x8, 1, lambda_1DA3)
    Sleep(2000)
    ...
    QueueWorkItem(0x102, 1, lambda_1E86)
    TurnDirection(0x101, 0x108, 400)
    ...
    def Function_3_20E0(): pass

    label("Function_3_20E0")
    ...
    QueueWorkItem(0x101, 3, lambda_21B9)
    OP_6E(309, 5000)
    ...
    QueueWorkItem(0x17, 1, lambda_231E)

    def lambda_2339():
        OP_90(0xFE, 0x7D0, 0x0, 0xFA0, 0x2710, 0x0)
        ExitThread()

    QueueWorkItem(0x18, 1, lambda_2339)

    def lambda_2354():
        OP_90(0xFE, 0x7D0, 0x0, 0xFA0, 0x2710, 0x0)
        ExitThread()

    QueueWorkItem(0x19, 1, lambda_2354)

    def lambda_236F():
        OP_90(0xFE, 0x7D0, 0x0, 0xFA0, 0x2710, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 1, lambda_236F)

    def lambda_238A():
        OP_90(0xFE, 0x7D0, 0x0, 0xFA0, 0x2710, 0x0)
        ExitThread()

    QueueWorkItem(0x1B, 1, lambda_238A)

    def lambda_23A5():
        OP_90(0xFE, 0x7D0, 0x0, 0xFA0, 0x2710, 0x0)
        ExitThread()

    QueueWorkItem(0x1C, 1, lambda_23A5)

    def lambda_23C0():
        OP_90(0xFE, 0x7D0, 0x0, 0xFA0, 0x2710, 0x0)
        ExitThread()

    QueueWorkItem(0x1D, 1, lambda_23C0)

    def lambda_23DB():
        OP_90(0xFE, 0x7D0, 0x0, 0xFA0, 0x2710, 0x0)
        ExitThread()

    QueueWorkItem(0x1E, 1, lambda_23DB)

    def lambda_23F6():
        OP_90(0xFE, 0x7D0, 0x0, 0xFA0, 0x2710, 0x0)
        ExitThread()

    QueueWorkItem(0x1F, 1, lambda_23F6)
    ...
    QueueWorkItem(0x101, 1, lambda_245D)

    def lambda_246B():
        TurnDirection(0xFE, 0x17, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_246B)

    def lambda_2479():
        TurnDirection(0xFE, 0x17, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_2479)

    def lambda_2487():
        TurnDirection(0xFE, 0x17, 400)
        ExitThread()

    QueueWorkItem(0x13, 1, lambda_2487)

    def lambda_2495():
        TurnDirection(0xFE, 0x17, 400)
        ExitThread()

    QueueWorkItem(0x14, 1, lambda_2495)

    def lambda_24A3():
        TurnDirection(0xFE, 0x17, 400)
        ExitThread()

    QueueWorkItem(0x15, 1, lambda_24A3)

    def lambda_24B1():
        TurnDirection(0xFE, 0x17, 400)
        ExitThread()

    QueueWorkItem(0x16, 1, lambda_24B1)

    def lambda_24BF():
        OP_6C(335000, 4000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_24BF)

    def lambda_24CF():
        OP_6E(332, 4000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_24CF)

    def lambda_24DF():
        OP_6D(13880, 0, -49890, 4000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_24DF)

    def lambda_24F7():
        OP_90(0xFE, 0xFFFFF060, 0x0, 0xFFFFE0C0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x17, 1, lambda_24F7)
    Sleep(100)
    ...
    QueueWorkItem(0x18, 1, lambda_2517)

    def lambda_2532():
        OP_90(0xFE, 0xFFFFF060, 0x0, 0xFFFFE0C0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x19, 1, lambda_2532)
    Sleep(100)
    ...
    QueueWorkItem(0x1A, 1, lambda_2552)

    def lambda_256D():
        OP_90(0xFE, 0xFFFFF060, 0x0, 0xFFFFE0C0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x1B, 1, lambda_256D)

    def lambda_2588():
        OP_90(0xFE, 0xFFFFF060, 0x0, 0xFFFFE0C0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x1C, 1, lambda_2588)
    Sleep(100)
    ...
    QueueWorkItem(0x1D, 1, lambda_25A8)

    def lambda_25C3():
        OP_90(0xFE, 0xFFFFF060, 0x0, 0xFFFFE0C0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x1E, 1, lambda_25C3)

    def lambda_25DE():
        OP_90(0xFE, 0xFFFFF060, 0x0, 0xFFFFE0C0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x1F, 1, lambda_25DE)
    ...
    QueueWorkItem(0x102, 1, lambda_26D9)

    def lambda_26E7():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_26E7)

    def lambda_26F5():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x13, 1, lambda_26F5)

    def lambda_2703():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x14, 1, lambda_2703)

    def lambda_2711():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x15, 1, lambda_2711)

    def lambda_271F():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x16, 1, lambda_271F)
    ...
    QueueWorkItem2(0x102, 1, lambda_2912)
    ...
    QueueWorkItem2(0x108, 1, lambda_2923)
    ...
    QueueWorkItem2(0x13, 1, lambda_2934)
    ...
    QueueWorkItem2(0x14, 1, lambda_2945)
    ...
    QueueWorkItem2(0x15, 1, lambda_2956)
    ...
    QueueWorkItem2(0x16, 1, lambda_2967)

    def lambda_2978():
        OP_6C(0, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_2978)
    ...
    def Function_4_2A28(): pass

    label("Function_4_2A28")
    ...
    QueueWorkItem2(0x101, 1, lambda_2BCE)
    ...
    QueueWorkItem2(0x102, 1, lambda_2BDF)
    ...
    QueueWorkItem2(0x108, 1, lambda_2BF0)
    ...
    QueueWorkItem(0x1B, 2, lambda_2C06)

    def lambda_2C14():
        OP_8E(0xFE, 0xFFFF9B60, 0x0, 0x76B6, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x1B, 1, lambda_2C14)
    Sleep(200)
    ...
    QueueWorkItem(0x1A, 2, lambda_2C39)

    def lambda_2C47():
        OP_8E(0xFE, 0xFFFF9B60, 0x0, 0x76B6, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 1, lambda_2C47)
    Sleep(200)
    ...
    QueueWorkItem(0x18, 2, lambda_2C6C)

    def lambda_2C7A():
        OP_8E(0xFE, 0xFFFF9B60, 0x0, 0x76B6, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x18, 1, lambda_2C7A)
    Sleep(200)
    ...
    QueueWorkItem(0x19, 2, lambda_2C9F)

    def lambda_2CAD():
        OP_8E(0xFE, 0xFFFF9B60, 0x0, 0x76B6, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x19, 1, lambda_2CAD)
    Sleep(2000)
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    OP_44(0x108, 0xFF)
    ...
    def Function_5_2CED(): pass

    label("Function_5_2CED")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2E1D")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2D4E")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2D9D")
    TurnDirection(0x102, 0x101, 400)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2E02")
    ...
    def Function_6_2E1E(): pass

    label("Function_6_2E1E")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2F4E")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2E7F")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2ECE")
    TurnDirection(0x102, 0x101, 400)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2F33")
    TurnDirection(0x108, 0x1, 400)
    ...
    def Function_7_2F4F(): pass

    label("Function_7_2F4F")
