...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDB, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_865")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDB, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_79D")
    ...
    QueueWorkItem(0x8, 1, lambda_710)

    def lambda_72B():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x4B0)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_72B)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x5D, 1)"), scpexpr(EXPR_END)), "loc_7F1")
    ...
    def Function_5_8A6(): pass

    label("Function_5_8A6")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDB, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A56")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDB, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_982")
    OP_9F(0x8, 0xFF, 0xFF, 0xFF, 0x0, 0x0)
    ...
    QueueWorkItem(0x8, 2, lambda_910)
    ClearChrFlags(0x8, 0x80)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x146, 1)"), scpexpr(EXPR_END)), "loc_9DA")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDB, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B87")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_B0D")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
