...
def main():
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1E, 0x0, 0x4)"), scpexpr(EXPR_END)), "loc_1AE")
    TalkBegin(0x11)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_F3")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1E, 0x1, 0x8000)"), scpexpr(EXPR_END)), "loc_371")
    OP_2B(0x1E, 0x2)
    OP_2C(0x1E, 0x3E8)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1E, 0x0, 0x2)"), scpexpr(EXPR_END)), "loc_549")
    OP_28(0x1E, 0x4, 0x4)
    OP_28(0x1E, 0x4, 0x8)
    OP_28(0x1E, 0x1, 0x1)
    OP_28(0x1E, 0x1, 0x2)
    ...
    QueueWorkItem(0x101, 1, lambda_8A2)
    ...
    QueueWorkItem(0xFE, 1, lambda_8BE)
    ...
    QueueWorkItem(0x101, 1, lambda_9EF)

    def lambda_9FD():
        TurnDirection(0x102, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_9FD)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1E, 0x1, 0x8000)"), scpexpr(EXPR_END)), "loc_BBD")
    ...
    CloseMessageWindow()
    TurnDirection(0xFE, 0x102, 400)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1E, 0x1, 0x4000)"), scpexpr(EXPR_EXEC_OP, "OP_40(0x335)"), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1AA9")
    OP_28(0x1E, 0x1, 0x20)
    OP_63(0x101)
    ...
    QueueWorkItem(0x102, 1, lambda_14F3)

    def lambda_1501():
        TurnDirection(0x105, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_1501)
    ...
    QueueWorkItem2(0x101, 1, lambda_16A6)
    ...
    QueueWorkItem2(0x102, 1, lambda_16B7)
    ...
    QueueWorkItem2(0x105, 1, lambda_16C8)
    ...
    QueueWorkItem(0x102, 1, lambda_17DB)
    ...
    QueueWorkItem(0x101, 1, lambda_1D46)

    def lambda_1D54():
        TurnDirection(0x102, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1D54)
    ...
    def Function_1_1DD3(): pass

    label("Function_1_1DD3")
    ...
    OP_69(0x12, 0x3E8)
    ClearChrFlags(0x11, 0x10)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 5)), scpexpr(EXPR_END)), "loc_1EDC")
    ...
    CloseMessageWindow()
    TurnDirection(0x102, 0x101, 400)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 5)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x88, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_26FC")
    ...
    QueueWorkItem2(0x101, 1, lambda_2574)
    ...
    QueueWorkItem2(0x102, 1, lambda_2585)
    ...
    QueueWorkItem2(0x105, 1, lambda_2596)
    SetChrFlags(0xFE, 0x40)
    OP_8E(0xFE, 0xD160, 0x0, 0xB5A4, 0x1770, 0x0)
    OP_8C(0xFE, 135, 0)
    OP_96(0xFE, 0xD6D8, 0x0, 0xAFC8, 0x5DC, 0x1B58)
    ...
    QueueWorkItem(0x101, 1, lambda_2686)

    def lambda_2694():
        TurnDirection(0x105, 0x102, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_2694)
    ...
    QueueWorkItem(0x105, 1, lambda_283B)
    ...
    QueueWorkItem2(0x102, 1, lambda_2A3B)
    ...
    QueueWorkItem2(0x105, 1, lambda_2A4C)
    SetChrFlags(0xFE, 0x40)
    OP_8E(0xFE, 0xD160, 0x0, 0xB5A4, 0x1770, 0x0)
    OP_8C(0xFE, 135, 0)
    ...
    QueueWorkItem(0x102, 1, lambda_2B69)
