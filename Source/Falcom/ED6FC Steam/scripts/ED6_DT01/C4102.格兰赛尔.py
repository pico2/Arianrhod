...
def main():
    ...
    def Function_4_670(): pass

    label("Function_4_670")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD0, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_814")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD0, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_74C")
    ...
    QueueWorkItem(0xA, 1, lambda_6BF)

    def lambda_6DA():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x4B0)
        ExitThread()

    QueueWorkItem(0xA, 2, lambda_6DA)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x263, 1)"), scpexpr(EXPR_END)), "loc_7A0")
    ...
    def Function_5_855(): pass

    label("Function_5_855")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD0, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9F9")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD0, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_931")
    OP_9F(0xA, 0xFF, 0xFF, 0xFF, 0x0, 0x0)
    ...
    QueueWorkItem(0xA, 1, lambda_8A4)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x269, 1)"), scpexpr(EXPR_END)), "loc_985")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    def Function_6_A3A(): pass

    label("Function_6_A3A")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD1, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B2A")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_AB0")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_7_B6B(): pass

    label("Function_7_B6B")
    ...
    def Function_8_BAD(): pass

    label("Function_8_BAD")
