...
def main():
    ...
    ScpFunction(
        ...
        "Function_6_6A1",          # 06, 6
        "Function_7_985",          # 07, 7
        "Function_8_29C5",         # 08, 8
        "Function_9_2A09",         # 09, 9
        "Function_10_2A39",        # 0A, 10
        "Function_11_2A91",        # 0B, 11
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_3F7")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 6)), scpexpr(EXPR_END)), "loc_401")
    Jump("loc_49B")

    label("loc_401")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_END)), "loc_40B")
    Jump("loc_49B")

    label("loc_40B")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 0)), scpexpr(EXPR_END)), "loc_440")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_49B")
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 7)), scpexpr(EXPR_END)), "loc_4AC")
    Jump("loc_5E7")

    label("loc_4AC")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_4B6")
    Jump("loc_5E7")

    label("loc_4B6")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 6)), scpexpr(EXPR_END)), "loc_4C0")
    Jump("loc_5E7")

    label("loc_4C0")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_END)), "loc_4CA")
    Jump("loc_5E7")

    label("loc_4CA")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 0)), scpexpr(EXPR_END)), "loc_520")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_5E7")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_579")
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 7)), scpexpr(EXPR_END)), "loc_5F8")
    Jump("loc_69D")

    label("loc_5F8")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_602")
    Jump("loc_69D")

    label("loc_602")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 6)), scpexpr(EXPR_END)), "loc_60C")
    Jump("loc_69D")

    label("loc_60C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_END)), "loc_616")
    Jump("loc_69D")

    label("loc_616")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 0)), scpexpr(EXPR_END)), "loc_657")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_69D")
    ...
    def Function_6_6A1(): pass

    label("Function_6_6A1")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 7)), scpexpr(EXPR_END)), "loc_6AE")
    Jump("loc_981")

    label("loc_6AE")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_77E")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_710")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 6)), scpexpr(EXPR_END)), "loc_788")
    Jump("loc_981")

    label("loc_788")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_END)), "loc_792")
    Jump("loc_981")

    label("loc_792")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 0)), scpexpr(EXPR_END)), "loc_884")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_805")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_981")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_8FE")
    ...
    QueueWorkItem(0x101, 3, lambda_FCB)
    Sleep(1000)
    ...
    QueueWorkItem(0xB, 3, lambda_FE8)

    def lambda_FFA():
        OP_8E(0xFE, 0xA, 0x0, 0x10586, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_FFA)
    ...
    QueueWorkItem(0xB, 1, lambda_101A)
    WaitChrThread(0xB, 0x1)
    OP_8C(0xB, 0, 400)
    ...
    QueueWorkItem(0xA, 3, lambda_1081)

    def lambda_1093():
        OP_8E(0xFE, 0xFFFFFF74, 0x0, 0x10DE2, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_1093)
    Sleep(300)
    ...
    QueueWorkItem(0x8, 3, lambda_10B3)

    def lambda_10C5():
        OP_8E(0xFE, 0x438, 0x0, 0x10C3E, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_10C5)
    Sleep(600)
    ...
    QueueWorkItem(0x9, 3, lambda_10E5)

    def lambda_10F7():
        OP_8E(0xFE, 0x190, 0x0, 0x1070C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_10F7)
    ...
    QueueWorkItem(0x101, 3, lambda_12AB)
    ...
    def Function_8_29C5(): pass

    label("Function_8_29C5")
    ...
    def Function_10_2A39(): pass

    label("Function_10_2A39")
    ...
    # Function_10_2A39 end

    def Function_11_2A91(): pass

    label("Function_11_2A91")
