...
def main():
    ...
    QueueWorkItem(0x102, 1, lambda_3B8)

    def lambda_3C6():
        TurnDirection(0xFE, 0x107, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_3C6)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xB8, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_621")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FF, 1)"), scpexpr(EXPR_END)), "loc_59B")
