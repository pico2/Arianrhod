...
def main():
    ...
    ScpFunction(
        ...
        "Function_9_1F79",         # 09, 9
        "Function_10_1FBB",        # 0A, 10
        "Function_11_1FFD",        # 0B, 11
        "Function_12_2032",        # 0C, 12
        "Function_13_207B",        # 0D, 13
        "Function_14_20C4",        # 0E, 14
        "Function_15_212E",        # 0F, 15
        "Function_16_2650",        # 10, 16
        "Function_17_2A51",        # 11, 17
        "Function_18_2AF1",        # 12, 18
        "Function_19_2BA1",        # 13, 19
        "Function_20_2C51",        # 14, 20
    )
    ...
    QueueWorkItem(0x101, 1, lambda_14AE)

    def lambda_14C6():
        OP_67(0, 8220, -10000, 5000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_14C6)

    def lambda_14DE():
        OP_6B(2300, 5000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_14DE)

    def lambda_14EE():
        OP_6E(405, 5000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_14EE)
    Sleep(5000)
    ...
    QueueWorkItem(0x101, 1, lambda_161B)

    def lambda_1633():
        OP_67(0, 9500, -10000, 5000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1633)

    def lambda_164B():
        OP_6B(3890, 5000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_164B)
    ...
    QueueWorkItem(0x102, 2, lambda_166B)
    ...
    QueueWorkItem(0x8, 1, lambda_1722)
    Sleep(700)
    ...
    QueueWorkItem(0x8, 1, lambda_177F)
    ...
    def Function_9_1F79(): pass

    label("Function_9_1F79")
    ...
    def Function_10_1FBB(): pass

    label("Function_10_1FBB")
    ...
    def Function_13_207B(): pass

    label("Function_13_207B")
    ...
    # Function_13_207B end

    def Function_14_20C4(): pass

    label("Function_14_20C4")
    ...
    # Function_14_20C4 end

    def Function_15_212E(): pass

    label("Function_15_212E")

    Jc((scpexpr(EXPR_GET_RESULT, 0x2), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_264F")
    OP_48()
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x151), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_2161")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x125), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_2187")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xF8), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_21AD")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0x5DC), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xCA), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_21D4")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0x5DC), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x9E), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_21FA")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x5DC), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_227E")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x70), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_2220")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x44), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_2245")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0x5DC), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_227E")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x16), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_226A")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0x5DC), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x5DC), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_227E")
    ...
    FadeToBright(1000, 0)
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA9, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_25D8")
    ...
    Jump("Function_15_212E")

    label("loc_264F")

    Return()

    # Function_15_212E end

    def Function_16_2650(): pass

    label("Function_16_2650")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAD, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA9, 5)), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_265D")
    Return()
    ...
    QueueWorkItem(0x11, 1, lambda_26D9)

    def lambda_26E7():
        TurnDirection(0xFE, 0x0, 800)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_26E7)
    ...
    QueueWorkItem(0x0, 1, lambda_2731)

    def lambda_273F():
        TurnDirection(0xFE, 0x11, 800)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_273F)

    def lambda_274D():
        TurnDirection(0xFE, 0x11, 800)
        ExitThread()

    QueueWorkItem(0x2, 1, lambda_274D)

    def lambda_275B():
        TurnDirection(0xFE, 0x11, 800)
        ExitThread()

    QueueWorkItem(0x3, 1, lambda_275B)

    def lambda_2769():
        TurnDirection(0xFE, 0x11, 800)
        ExitThread()

    QueueWorkItem(0x4, 1, lambda_2769)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_27B1")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_27D5")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x6), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_27FB")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_281A")
    ...
    def Function_18_2AF1(): pass

    label("Function_18_2AF1")
    ...
    # Function_18_2AF1 end

    def Function_19_2BA1(): pass

    label("Function_19_2BA1")
    ...
    # Function_19_2BA1 end

    def Function_20_2C51(): pass

    label("Function_20_2C51")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA9, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_30C9")
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    EventBegin(0x0)
    ClearChrFlags(0x11, 0x80)
    ClearChrFlags(0x12, 0x80)
    ...
    QueueWorkItem(0x0, 1, lambda_2CC2)

    def lambda_2CD0():
        TurnDirection(0xFE, 0x11, 800)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_2CD0)

    def lambda_2CDE():
        TurnDirection(0xFE, 0x11, 800)
        ExitThread()

    QueueWorkItem(0x2, 1, lambda_2CDE)

    def lambda_2CEC():
        TurnDirection(0xFE, 0x11, 800)
        ExitThread()

    QueueWorkItem(0x3, 1, lambda_2CEC)

    def lambda_2CFA():
        TurnDirection(0xFE, 0x11, 800)
        ExitThread()

    QueueWorkItem(0x4, 1, lambda_2CFA)
    Sleep(500)
    Fade(2000)
    ...
    QueueWorkItem(0x11, 1, lambda_2D12)

    def lambda_2D2A():
        OP_6C(80000, 2000)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_2D2A)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2D7D")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2DA1")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x6), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2DC7")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2DE6")
    ...
    QueueWorkItem(0x11, 1, lambda_2E2C)
    ...
    QueueWorkItem(0x11, 2, lambda_2E49)
    Sleep(200)
    ...
    QueueWorkItem(0x12, 2, lambda_2E6E)
    Sleep(1000)
    OP_23(0xAC)
    Battle(0x24E, 0x0, 0x0, 0x0, 0xFF)
    Switch(
    ...
    OP_4A(0x1E, 255)
    EventBegin(0x2)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3157")
