...
def main():
    ...
    ScpFunction(
        ...
        "Function_14_1CB2",        # 0E, 14
        "Function_15_1CE7",        # 0F, 15
        "Function_16_2E75",        # 10, 16
        "Function_17_30E3",        # 11, 17
        "Function_18_314F",        # 12, 18
        "Function_19_32E9",        # 13, 19
        "Function_20_32ED",        # 14, 20
        "Function_21_32F1",        # 15, 21
        "Function_22_32F5",        # 16, 22
    )
    ...
    OP_5F(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1767")
    FadeToBright(300, 0)
    OP_0D()
    OP_A9(0x30)
    OP_56(0x0)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1864")
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x12), scpexpr(EXPR_PUSH_LONG, 0x1F4), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_182C")
    SubMira(500)
    FadeToDark(1000, 0, -1)
    OP_0D()
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x20D)"), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_181E")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_AC(0x9)"), scpexpr(EXPR_END)), "loc_17F8")
    Jump("loc_181E")
    ...
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_18B2")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 4)), scpexpr(EXPR_END)), "loc_19C5")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x8A, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1995")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 2)), scpexpr(EXPR_END)), "loc_1A1A")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 1)), scpexpr(EXPR_END)), "loc_1A72")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 0)), scpexpr(EXPR_END)), "loc_1AE5")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 7)), scpexpr(EXPR_END)), "loc_1B46")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 6)), scpexpr(EXPR_END)), "loc_1B91")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 0)), scpexpr(EXPR_END)), "loc_1BED")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 6)), scpexpr(EXPR_END)), "loc_1C57")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 1)), scpexpr(EXPR_END)), "loc_1CAE")
    ...
    def Function_14_1CB2(): pass

    label("Function_14_1CB2")
    ...
    # Function_14_1CB2 end

    def Function_15_1CE7(): pass

    label("Function_15_1CE7")
    ...
    QueueWorkItem(0x105, 2, lambda_1F44)
    ...
    QueueWorkItem(0x105, 3, lambda_1F61)
    ...
    QueueWorkItem(0x105, 1, lambda_1F87)
    OP_8C(0x9, 270, 0)
    ...
    QueueWorkItem(0x101, 3, lambda_1FAE)
    ...
    QueueWorkItem(0x101, 1, lambda_1FD4)
    ...
    QueueWorkItem(0x102, 3, lambda_1FF4)

    def lambda_2006():
        OP_8E(0xFE, 0x6B30, 0x0, 0xD9C6, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_2006)
    ...
    QueueWorkItem(0x105, 1, lambda_2026)
    ...
    QueueWorkItem(0x101, 1, lambda_2039)
    ...
    QueueWorkItem(0x102, 1, lambda_204C)
    ...
    QueueWorkItem2(0x102, 1, lambda_205A)
    ...
    QueueWorkItem2(0x101, 1, lambda_206B)
    ...
    QueueWorkItem2(0x105, 1, lambda_207C)
    ...
    QueueWorkItem(0x105, 1, lambda_28EF)
    ...
    # Function_15_1CE7 end

    def Function_16_2E75(): pass

    label("Function_16_2E75")
    ...
    QueueWorkItem(0x102, 2, lambda_2F97)

    def lambda_2FAF():
        OP_8E(0xFE, 0x8E8, 0x0, 0xFFFFF8EE, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_2FAF)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_2FCF)
    ...
    QueueWorkItem2(0x8, 1, lambda_2FF4)
    ...
    QueueWorkItem(0x9, 1, lambda_300A)
    WaitChrThread(0x102, 0x1)
    ...
    QueueWorkItem(0x102, 1, lambda_301D)
    Sleep(500)
    ...
    def Function_18_314F(): pass

    label("Function_18_314F")
    ...
    Switch(
        ...
        (0, "loc_31BE"),
        (1, "loc_32C9"),
        (SWITCH_DEFAULT, "loc_32CC"),
    )


    label("loc_31BE")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x33D)"), scpexpr(EXPR_END)), "loc_3216")
    OP_3F(0x33D, 1)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x33E)"), scpexpr(EXPR_END)), "loc_326E")
    OP_3F(0x33E, 1)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x33F)"), scpexpr(EXPR_END)), "loc_32C6")
    OP_3F(0x33F, 1)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x33D)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_EXEC_OP, "OP_40(0x33E)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_EXEC_OP, "OP_40(0x33F)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_32E5")
    OP_64(0x0, 0x1)
    ...
    # Function_18_314F end

    def Function_19_32E9(): pass

    label("Function_19_32E9")

    SetPlaceName(0x71) # 社团大楼　学生会室
    Return()

    # Function_19_32E9 end
    ...
    def Function_21_32F1(): pass

    label("Function_21_32F1")

    SetPlaceName(0x75) # 社团大楼　学生会室
    Return()

    # Function_21_32F1 end

    def Function_22_32F5(): pass

    label("Function_22_32F5")

    SetPlaceName(0x70) # 社团大楼　学生会室
    Return()

    # Function_22_32F5 end
