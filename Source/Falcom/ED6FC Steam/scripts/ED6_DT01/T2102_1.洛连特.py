...
def main():
    ...
    QueueWorkItem(0xE, 1, lambda_226)

    def lambda_236():
        OP_69(0xE, 0xBB8)
        ExitThread()

    QueueWorkItem(0xE, 2, lambda_236)
    ...
    QueueWorkItem(0x101, 1, lambda_250)

    def lambda_26B():
        OP_8E(0x105, 0x1B7D8, 0x0, 0x19320, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_26B)
    ...
    QueueWorkItem(0xE, 1, lambda_5EB)
    OP_8E(0x102, 0x1C1A6, 0x0, 0x196A4, 0x7D0, 0x0)
    OP_8E(0x102, 0x1BB5C, 0x0, 0x196A4, 0x7D0, 0x0)
    EventEnd(0x0)
    Return()
