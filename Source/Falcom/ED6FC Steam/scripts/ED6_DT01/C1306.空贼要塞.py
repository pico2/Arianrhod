...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_9BE",          # 08, 8
        "Function_9_B5B",          # 09, 9
        "Function_10_C4E",         # 0A, 10
        "Function_11_FC4",         # 0B, 11
        "Function_12_1373",        # 0C, 12
        "Function_13_15BD",        # 0D, 13
        "Function_14_16E8",        # 0E, 14
    )
    ...
    def Function_4_8CE(): pass

    label("Function_4_8CE")
    ...
    def Function_5_903(): pass

    label("Function_5_903")
    ...
    def Function_7_98B(): pass

    label("Function_7_98B")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B5A")
    ClearMapFlags(0x1)
    EventBegin(0x0)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x3), scpexpr(EXPR_EQU), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_A96")

    def lambda_9E8():
        OP_6D(-4700, 0, -147260, 1000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_9E8)
    Sleep(600)
    OP_8C(0x102, 90, 400)
    ...
    QueueWorkItem(0x104, 1, lambda_A42)
    ...
    QueueWorkItem(0x0, 3, lambda_A9C)
    Sleep(600)
    OP_8C(0x104, 90, 400)
    ...
    QueueWorkItem(0x102, 1, lambda_B04)
    OP_8C(0x101, 90, 400)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C4D")
    ClearMapFlags(0x1)
    EventBegin(0x0)
    ...
    def Function_10_C4E(): pass

    label("Function_10_C4E")
    ...
    QueueWorkItem(0xA, 1, lambda_E04)

    def lambda_E1F():
        OP_8E(0xFE, 0xE2A4, 0x0, 0xFFFECD7A, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_E1F)

    def lambda_E3A():
        OP_8E(0xFE, 0xE2A4, 0x0, 0xFFFECD7A, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_E3A)

    def lambda_E55():
        OP_8E(0xFE, 0xE2A4, 0x0, 0xFFFECD7A, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0xE, 1, lambda_E55)
    Sleep(400)
    ...
    def Function_11_FC4(): pass

    label("Function_11_FC4")
    ...
    QueueWorkItem(0xC, 1, lambda_11B3)

    def lambda_11CE():
        OP_8E(0xFE, 0x730, 0x0, 0xFFFFC54A, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_11CE)

    def lambda_11E9():
        OP_8E(0xFE, 0x730, 0x0, 0xFFFFC54A, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_11E9)

    def lambda_1204():
        OP_8E(0xFE, 0x730, 0x0, 0xFFFFC54A, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_1204)
    Sleep(500)
    Battle(0x38E, 0x0, 0x0, 0x0, 0xFF)
    Switch(
        (scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_END)),
        (1, "loc_1237"),
        (SWITCH_DEFAULT, "loc_123A"),
    )
    ...
    def Function_12_1373(): pass

    label("Function_12_1373")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x14, 0x1, 0x8000)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_15BC")
    ...
    # Function_12_1373 end

    def Function_13_15BD(): pass

    label("Function_13_15BD")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6E, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_16A7")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x60, 1)"), scpexpr(EXPR_END)), "loc_1631")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    # Function_13_15BD end

    def Function_14_16E8(): pass

    label("Function_14_16E8")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6E, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_17DE")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x3, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x116, 1)"), scpexpr(EXPR_END)), "loc_1760")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
