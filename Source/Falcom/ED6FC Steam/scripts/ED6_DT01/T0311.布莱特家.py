...
def main():
    ...
    ScpFunction(
        ...
        "Function_10_1FB1",        # 0A, 10
        "Function_11_202F",        # 0B, 11
        "Function_12_2066",        # 0C, 12
        "Function_13_2F94",        # 0D, 13
        "Function_14_303E",        # 0E, 14
        "Function_15_447A",        # 0F, 15
        "Function_16_559C",        # 10, 16
        "Function_17_5839",        # 11, 17
    )
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_928")
    OP_A2(0x3)
    ...
    def Function_4_96A(): pass

    label("Function_4_96A")
    ...
    QueueWorkItem(0xA, 1, lambda_A36)
    Sleep(200)
    OP_6F(0x0, 5)
    OP_70(0x0, 0x14)
    Sleep(1500)
    ...
    QueueWorkItem(0xA, 1, lambda_A5E)
    ...
    def Function_5_BBB(): pass

    label("Function_5_BBB")
    ...
    QueueWorkItem(0x101, 2, lambda_14F8)
    ...
    QueueWorkItem(0x101, 2, lambda_15F4)
    ...
    QueueWorkItem(0x9, 1, lambda_1697)
    EventEnd(0x0)
    ...
    def Function_10_1FB1(): pass

    label("Function_10_1FB1")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_1FEC")
    ...
    # Function_10_1FB1 end

    def Function_11_202F(): pass

    label("Function_11_202F")

    OP_A6(0x2)

    label("loc_2032")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_2044")
    TurnDirection(0xFE, 0x101, 0)
    OP_48()
    Jump("loc_2032")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_2059")
    ...
    def Function_13_2F94(): pass

    label("Function_13_2F94")
    ...
    # Function_13_2F94 end

    def Function_14_303E(): pass

    label("Function_14_303E")
    ...
    QueueWorkItem(0x0, 1, lambda_30B4)
    Sleep(2000)
    Fade(5000)
    ...
    QueueWorkItem(0x0, 1, lambda_31B0)
    OP_8C(0xB, 90, 0)
    ...
    QueueWorkItem(0x0, 1, lambda_32F4)
    ...
    QueueWorkItem(0x0, 1, lambda_35D5)
    Fade(1500)
    OP_8C(0x8, 315, 0)
    OP_0D()
    Sleep(500)
    ...
    QueueWorkItem(0xC, 1, lambda_3B7F)
    Sleep(2000)
    ...
    QueueWorkItem(0xC, 1, lambda_3D2E)
    ...
    QueueWorkItem(0xC, 2, lambda_3DD4)

    def lambda_3DE4():
        OP_95(0xC, 0x0, 0x0, 0x0, 0xC8, 0xFA0)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_3DE4)

    def lambda_3E02():
        OP_95(0x16, 0x0, 0x0, 0x0, 0x64, 0x7D0)
        ExitThread()

    QueueWorkItem(0x16, 1, lambda_3E02)
    OP_22(0x7D, 0x0, 0x64)
    ...
    QueueWorkItem(0xC, 2, lambda_3FB1)

    def lambda_3FC1():
        OP_95(0xC, 0x0, 0x0, 0x0, 0xC8, 0xFA0)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_3FC1)

    def lambda_3FDF():
        OP_95(0x16, 0x0, 0x0, 0x0, 0x64, 0x7D0)
        ExitThread()

    QueueWorkItem(0x16, 1, lambda_3FDF)
    OP_95(0xB, 0xC8, 0xFFFFFCE0, 0x4B0, 0xC8, 0x1770)
    ...
    QueueWorkItem(0xC, 2, lambda_4041)

    def lambda_4051():
        OP_95(0xC, 0x0, 0x0, 0x0, 0xFA, 0xFA0)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_4051)

    def lambda_406F():
        OP_95(0x16, 0x0, 0x0, 0x0, 0x64, 0x5DC)
        ExitThread()

    QueueWorkItem(0x16, 1, lambda_406F)
    ...
    CloseMessageWindow()
    Sleep(100)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x40, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_4446")
    Fade(3000)
    ...
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_4446")
    Sleep(10)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x2D), scpexpr(EXPR_END)), "loc_4443")
    FadeToDark(2000, 0, -1)
    OP_0D()
    PlayMovie(0x1, "")
    ...
    # Function_14_303E end

    def Function_15_447A(): pass

    label("Function_15_447A")
    ...
    QueueWorkItem(0x102, 1, lambda_47F8)
    ...
    QueueWorkItem(0x101, 1, lambda_4942)
    ...
    QueueWorkItem(0x102, 1, lambda_4C25)
    SetChrSubChip(0x103, 1)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_4CE3)
    ...
    # Function_15_447A end

    def Function_16_559C(): pass

    label("Function_16_559C")
    ...
    # Function_16_559C end

    def Function_17_5839(): pass

    label("Function_17_5839")
    ...
    OP_4F(0x28, (scpexpr(EXPR_PUSH_LONG, 0xFFFF), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_5F(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_58D0")
    FadeToDark(1000, 0, -1)
    Sleep(700)
    OP_22(0xD, 0x0, 0x64)
    OP_0D()
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_58EA")
    FadeToBright(300, 0)
    TalkEnd(0xFF)
    Return()
