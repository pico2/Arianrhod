...
def main():
    ...
    ScpFunction(
        ...
        "Function_2_4F7",          # 02, 2
        "Function_3_761",          # 03, 3
        "Function_4_10D8",         # 04, 4
        "Function_5_1113",         # 05, 5
        "Function_6_11F4",         # 06, 6
        "Function_7_12EE",         # 07, 7
        "Function_8_198E",         # 08, 8
    )
    ...
    def Function_3_761(): pass

    label("Function_3_761")
    ...
    QueueWorkItem(0x101, 2, lambda_8F0)
    ...
    QueueWorkItem(0x9, 1, lambda_910)

    def lambda_92A():
        OP_9E(0xFE, 0x1E, 0x0, 0x3E8, 0xBB8)
        ExitThread()

    QueueWorkItem(0x18, 1, lambda_92A)
    Sleep(1000)
    ...
    QueueWorkItem(0x9, 1, lambda_9A0)
    ...
    QueueWorkItem(0x9, 1, lambda_9C4)

    def lambda_9DE():
        OP_9E(0xFE, 0x1E, 0x0, 0x3E8, 0xBB8)
        ExitThread()

    QueueWorkItem(0x18, 1, lambda_9DE)
    Sleep(500)
    Fade(1000)
    ...
    QueueWorkItem(0x102, 3, lambda_A1C)

    def lambda_A2C():
        OP_6D(11360, 0, 49140, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_A2C)
    ...
    QueueWorkItem2(0xA, 2, lambda_A44)
    ...
    QueueWorkItem(0xB, 1, lambda_A6E)

    def lambda_A89():
        OP_8E(0xFE, 0x22BA, 0xE6, 0xB50E, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 2, lambda_A89)

    def lambda_AA4():
        OP_8E(0xFE, 0x2724, 0xFA, 0xB8F6, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x19, 1, lambda_AA4)
    ...
    QueueWorkItem(0x19, 1, lambda_AC4)
    WaitChrThread(0x19, 0x1)
    ...
    QueueWorkItem(0xB, 1, lambda_AF0)

    def lambda_B05():
        OP_92(0xFE, 0x19, 0x3E8, 0x320, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 2, lambda_B05)
    Sleep(300)
    ...
    QueueWorkItem(0xB, 2, lambda_B3F)

    def lambda_B4F():
        OP_8E(0xFE, 0x2FD0, 0x0, 0xBD6A, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_B4F)
    Sleep(100)
    ...
    QueueWorkItem(0xA, 2, lambda_B6F)
    Sleep(200)
    ...
    QueueWorkItem(0x19, 1, lambda_B94)
    Sleep(250)
    ...
    QueueWorkItem(0xB, 1, lambda_BB5)
    Sleep(100)
    ...
    QueueWorkItem(0xA, 2, lambda_BD5)
    ...
    QueueWorkItem(0x19, 1, lambda_BF8)
    Sleep(500)
    ...
    QueueWorkItem(0xA, 2, lambda_C18)
    Sleep(500)
    ...
    QueueWorkItem(0xA, 2, lambda_C65)

    def lambda_C7A():
        OP_92(0xFE, 0x19, 0x3E8, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_C7A)
    Sleep(500)
    Fade(1000)
    ...
    QueueWorkItem(0x101, 3, lambda_CAF)
    ...
    QueueWorkItem(0xC, 1, lambda_CD5)
    ...
    QueueWorkItem(0xC, 1, lambda_D04)

    def lambda_D1E():
        OP_9E(0xFE, 0x1E, 0x0, 0x2BC, 0xBB8)
        ExitThread()

    QueueWorkItem(0x1A, 1, lambda_D1E)
    Sleep(700)
    ...
    QueueWorkItem2(0x1A, 1, lambda_D3D)

    def lambda_D4E():
        OP_8F(0xFE, 0xFFFFB3C0, 0x0, 0xD192, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_D4E)
    SetChrFlags(0xC, 0x4)
    ...
    QueueWorkItem(0xD, 1, lambda_DBC)
    Sleep(500)
    ...
    QueueWorkItem(0x1A, 1, lambda_DDC)

    def lambda_DEA():
        OP_6D(-19190, 0, 50360, 2000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_DEA)

    def lambda_E02():
        OP_6E(305, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_E02)
    ...
    QueueWorkItem(0xE, 1, lambda_E17)
    Sleep(1500)
    ...
    QueueWorkItem2(0x1A, 1, lambda_E37)
    ...
    QueueWorkItem(0xE, 1, lambda_E68)
    Sleep(300)
    ...
    QueueWorkItem(0x1B, 1, lambda_E88)
    Sleep(500)
    ...
    QueueWorkItem(0xE, 1, lambda_EA8)

    def lambda_EB6():
        TurnDirection(0xFE, 0x1B, 800)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_EB6)
    Sleep(400)
    ...
    QueueWorkItem(0xE, 1, lambda_EE5)

    def lambda_F00():
        OP_8F(0xFE, 0xFFFFB0E6, 0x0, 0xC1D4, 0x3E8, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_F00)
    ...
    QueueWorkItem(0x101, 2, lambda_FE2)

    def lambda_FFA():
        OP_67(0, 5710, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_FFA)

    def lambda_1012():
        OP_6B(1780, 3000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_1012)

    def lambda_1022():
        OP_6C(44000, 6000)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_1022)

    def lambda_1032():
        OP_6E(545, 3000)
        ExitThread()

    QueueWorkItem(0x108, 2, lambda_1032)

    def lambda_1042():
        OP_8E(0xFE, 0xFFFFFFA6, 0x3E8, 0xE06A, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_1042)
    Sleep(300)
    ...
    QueueWorkItem(0x101, 1, lambda_1062)
    Sleep(100)
    ...
    QueueWorkItem(0x102, 1, lambda_1082)
    ...
    def Function_4_10D8(): pass

    label("Function_4_10D8")
    ...
    QueueWorkItem(0xFE, 3, lambda_10F2)
    OP_8E(0xFE, 0xFFFFFFCE, 0x3E8, 0xE948, 0x1194, 0x0)
    Return()

    # Function_4_10D8 end

    def Function_5_1113(): pass

    label("Function_5_1113")
    ...
    QueueWorkItem(0x102, 1, lambda_1198)

    def lambda_11B0():
        OP_6C(0, 8000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_11B0)
    ...
    def Function_6_11F4(): pass

    label("Function_6_11F4")
    ...
    QueueWorkItem(0x102, 3, lambda_1288)
    Sleep(1000)
    ...
    QueueWorkItem(0x101, 1, lambda_129D)

    def lambda_12B5():
        OP_67(0, 4770, -10000, 9000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_12B5)

    def lambda_12CD():
        OP_6E(480, 9000)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_12CD)
    Sleep(9000)
    ...
    def Function_7_12EE(): pass

    label("Function_7_12EE")
    ...
    QueueWorkItem2(0x1F, 1, lambda_1696)
    ...
    QueueWorkItem(0x101, 1, lambda_17B4)

    def lambda_17CC():
        OP_8E(0xFE, 0x8C, 0x0, 0x5618, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_17CC)
    OP_8C(0x1E, 180, 400)
    ...
    QueueWorkItem(0x1E, 1, lambda_17EE)
    OP_8C(0x102, 180, 400)
    ...
    def Function_8_198E(): pass

    label("Function_8_198E")
