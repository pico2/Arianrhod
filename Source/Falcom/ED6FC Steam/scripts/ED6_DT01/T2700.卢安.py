...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_E64",          # 08, 8
        "Function_9_E9A",          # 09, 9
        "Function_10_1279",        # 0A, 10
        "Function_11_253D",        # 0B, 11
        "Function_12_2565",        # 0C, 12
        "Function_13_25B9",        # 0D, 13
        "Function_14_261D",        # 0E, 14
    )
    ...
    TalkBegin(0x8)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x23, 0x1, 0x4000)"), scpexpr(EXPR_END)), "loc_613")
    ...
    def Function_6_669(): pass

    label("Function_6_669")

    TalkBegin(0xE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 1)), scpexpr(EXPR_END)), "loc_7BD")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_700")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 7)), scpexpr(EXPR_END)), "loc_89F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 1)), scpexpr(EXPR_END)), "loc_9D1")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_END)), "loc_A74")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 1)), scpexpr(EXPR_END)), "loc_B17")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 5)), scpexpr(EXPR_END)), "loc_C72")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x23, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_C14")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x23, 0x0, 0x8)"), scpexpr(EXPR_END)), "loc_C48")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 3)), scpexpr(EXPR_END)), "loc_CD8")
    ...
    def Function_7_CDC(): pass

    label("Function_7_CDC")

    TalkBegin(0xF)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 1)), scpexpr(EXPR_END)), "loc_D3D")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 5)), scpexpr(EXPR_END)), "loc_E18")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x23, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_D96")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x23, 0x0, 0x8)"), scpexpr(EXPR_END)), "loc_DDC")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 3)), scpexpr(EXPR_END)), "loc_E60")
    ...
    def Function_8_E64(): pass

    label("Function_8_E64")
    ...
    def Function_9_E9A(): pass

    label("Function_9_E9A")
    ...
    QueueWorkItem(0x101, 3, lambda_F20)
    ...
    QueueWorkItem(0x101, 2, lambda_F45)
    Sleep(9000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA7, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_FB2")
    ...
    QueueWorkItem(0x102, 1, lambda_104E)
    ...
    def Function_10_1279(): pass

    label("Function_10_1279")
    ...
    QueueWorkItem(0x101, 3, lambda_12E9)

    def lambda_12F9():
        OP_6D(10900, 9200, 14500, 3000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_12F9)

    def lambda_1311():
        OP_6C(24000, 6000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_1311)
    Sleep(5000)
    ...
    QueueWorkItem(0x101, 3, lambda_139E)
    ...
    QueueWorkItem(0x101, 3, lambda_1531)

    def lambda_1549():
        OP_6B(4250, 4000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_1549)

    def lambda_1559():
        OP_67(0, 3980, -10000, 4000)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_1559)

    def lambda_1571():
        OP_6E(345, 4000)
        ExitThread()

    QueueWorkItem(0x105, 3, lambda_1571)

    def lambda_1581():
        OP_8C(0xFE, 90, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1581)

    def lambda_158F():
        OP_8C(0xFE, 90, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_158F)
    OP_8C(0x105, 90, 400)
    ...
    QueueWorkItem(0x101, 2, lambda_15A4)
    Sleep(800)
    ...
    QueueWorkItem(0x102, 2, lambda_15C4)
    Sleep(300)
    ...
    QueueWorkItem(0x105, 2, lambda_15E4)
    ...
    QueueWorkItem2(0x105, 3, lambda_1BEB)
    ...
    QueueWorkItem(0x105, 1, lambda_1F5E)

    def lambda_1F76():
        OP_8C(0xFE, 90, 400)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_1F76)

    def lambda_1F84():
        OP_8F(0xFE, 0x5EEC, 0x1388, 0xFFFFFED4, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1F84)
    Sleep(200)
    ...
    QueueWorkItem(0x101, 1, lambda_1FA4)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 1, lambda_1FD2)
    Sleep(3500)
    OP_72(0x2, 0x800)
    OP_22(0xDF, 0x0, 0x64)
    OP_70(0x2, 0x0)
    ...
    QueueWorkItem(0x105, 1, lambda_20D6)

    def lambda_20E4():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_20E4)

    def lambda_20F2():
        OP_8E(0xFE, 0x19C8, 0x1388, 0x320, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_20F2)
    ...
    QueueWorkItem(0xB, 1, lambda_220F)
    Sleep(300)
    ...
    QueueWorkItem(0xA, 1, lambda_2270)
    ...
    QueueWorkItem2(0xB, 2, lambda_2318)

    def lambda_232B():
        OP_8F(0xFE, 0x16DA, 0x1450, 0x334, 0x3E8, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_232B)
    OP_8C(0xB, 180, 200)
    WaitChrThread(0xB, 0x1)
    OP_44(0xB, 0x2)
    Fade(500)
    ...
    QueueWorkItem(0x105, 1, lambda_24B6)
    ...
    # Function_10_1279 end

    def Function_11_253D(): pass

    label("Function_11_253D")

    OP_A6(0x2)

    label("loc_2540")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2561")
    ...
    # Function_11_253D end

    def Function_12_2565(): pass

    label("Function_12_2565")
    ...
    # Function_12_2565 end

    def Function_13_25B9(): pass

    label("Function_13_25B9")
    ...
    # Function_13_25B9 end

    def Function_14_261D(): pass

    label("Function_14_261D")
