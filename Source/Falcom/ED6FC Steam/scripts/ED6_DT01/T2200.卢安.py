...
def main():
    ...
    TalkBegin(0xC)
    OP_63(0xC)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 0)), scpexpr(EXPR_END)), "loc_3C4")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_42A")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 5)), scpexpr(EXPR_END)), "loc_48A")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 0)), scpexpr(EXPR_END)), "loc_4C6")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 3)), scpexpr(EXPR_END)), "loc_50D")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 4)), scpexpr(EXPR_END)), "loc_576")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_555")
    OP_A2(0x0)
    ...
    def Function_5_57A(): pass

    label("Function_5_57A")
    ...
    def Function_6_594(): pass

    label("Function_6_594")
    ...
    QueueWorkItem(0x0, 2, lambda_622)

    def lambda_63A():
        OP_6C(315000, 10000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_63A)
    Sleep(2000)
    ...
    QueueWorkItem(0x1, 2, lambda_64F)

    def lambda_667():
        OP_6B(2800, 8000)
        ExitThread()

    QueueWorkItem(0x1, 3, lambda_667)
    ...
    def Function_7_7C4(): pass

    label("Function_7_7C4")
    ...
    QueueWorkItem(0x101, 0, lambda_8B0)
    ...
    QueueWorkItem(0x101, 3, lambda_9D1)
    ...
    QueueWorkItem2(0x102, 1, lambda_A1A)

    def lambda_A2B():
        OP_6D(111020, -1800, 41170, 2000)
        ExitThread()

    QueueWorkItem(0x101, 0, lambda_A2B)
    OP_4B(0x101, 1)
    Sleep(600)
    OP_4B(0x105, 1)
    ...
    QueueWorkItem(0x101, 0, lambda_A7B)
    OP_22(0x92, 0x0, 0x64)
    ...
    QueueWorkItem(0xD, 0, lambda_AE0)
    Sleep(300)
    ...
    QueueWorkItem(0xD, 0, lambda_B00)
    OP_73(0x3)
    OP_71(0x3, 0x20)
    OP_6F(0x3, 301)
    OP_70(0x3, 0x168)
    ...
    QueueWorkItem(0xD, 0, lambda_B66)
    Sleep(200)
    ...
    QueueWorkItem(0xD, 0, lambda_B86)
    Sleep(200)
    ...
    QueueWorkItem(0xD, 0, lambda_BA6)
    Sleep(200)
    ...
    QueueWorkItem(0xD, 0, lambda_BC6)
    Sleep(200)
    ...
    QueueWorkItem(0xD, 0, lambda_BE6)
    Sleep(200)
    ...
    QueueWorkItem(0xD, 0, lambda_C06)
    Sleep(200)
    ...
    QueueWorkItem(0xD, 0, lambda_C26)
    Sleep(200)
    ...
    QueueWorkItem(0xD, 0, lambda_C46)
    ...
    def Function_8_C93(): pass

    label("Function_8_C93")
    ...
    QueueWorkItem(0xFE, 3, lambda_CA9)
    ...
    QueueWorkItem(0xE, 0, lambda_DE2)
    Sleep(300)
    ...
    QueueWorkItem(0xE, 0, lambda_E02)
    OP_73(0x2)
    OP_71(0x2, 0x20)
    OP_6F(0x2, 301)
    OP_70(0x2, 0x168)
    ...
    QueueWorkItem(0xE, 0, lambda_F48)
    Return()

    # Function_8_C93 end

    def Function_9_F5E(): pass

    label("Function_9_F5E")
    ...
    QueueWorkItem(0xFE, 3, lambda_F74)
    SetChrPos(0xFE, 115970, 2150, 29130, 0)
    ...
    QueueWorkItem(0xFE, 3, lambda_1078)
    SetChrPos(0xFE, 115970, 2150, 29130, 0)
    OP_8E(0xFE, 0x1C53E, 0x866, 0x7BF2, 0x1770, 0x0)
    SetChrFlags(0xFE, 0x4)
    OP_96(0xFE, 0x1C494, 0x0, 0x80DE, 0x5DC, 0x1388)
    ...
    QueueWorkItem(0xFE, 3, lambda_1159)
    SetChrPos(0xFE, 115970, 2150, 29130, 0)
    ...
    def Function_12_123E(): pass

    label("Function_12_123E")
    ...
    QueueWorkItem(0xFE, 3, lambda_1254)
    SetChrPos(0xFE, 115970, 2150, 29130, 0)
