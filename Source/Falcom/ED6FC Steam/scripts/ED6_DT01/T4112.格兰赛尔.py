...
def main():
    ...
    QueueWorkItem2(0x8, 3, lambda_29B)

    def lambda_2AC():
        OP_6D(2800, 0, 3250, 2000)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_2AC)

    def lambda_2C4():
        OP_6E(318, 2000)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_2C4)
    ...
    QueueWorkItem(0x8, 1, lambda_39D)
    ...
    QueueWorkItem(0x8, 1, lambda_B6C)

    def lambda_B7A():
        OP_6E(290, 1500)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_B7A)
