...
def main():
    ...
    QueueWorkItem2(0x101, 1, lambda_301)
    ...
    QueueWorkItem2(0x102, 1, lambda_312)
    ...
    QueueWorkItem2(0x103, 1, lambda_323)
    ...
    QueueWorkItem2(0xA, 1, lambda_334)
    OP_70(0x1, 0x64)
    OP_73(0x1)
    OP_6F(0x1, 100)
    OP_70(0x1, 0x0)
    ...
    QueueWorkItem2(0x101, 1, lambda_56C)
    ...
    QueueWorkItem2(0x102, 1, lambda_57D)
    ...
    QueueWorkItem2(0x103, 1, lambda_58E)
    OP_A5(0x5)
    OP_A5(0x7)
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    ...
    def Function_1_7B5(): pass

    label("Function_1_7B5")
    ...
    def Function_2_7D0(): pass

    label("Function_2_7D0")
    ...
    def Function_3_7FF(): pass

    label("Function_3_7FF")
    ...
    def Function_6_8B9(): pass

    label("Function_6_8B9")
