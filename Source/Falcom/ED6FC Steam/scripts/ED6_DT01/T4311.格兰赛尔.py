...
def main():
    ...
    ScpFunction(
        ...
        "Function_4_46C",          # 04, 4
        "Function_5_84F",          # 05, 5
        "Function_6_1574",         # 06, 6
        "Function_7_16C3",         # 07, 7
        "Function_8_1793",         # 08, 8
        "Function_9_1867",         # 09, 9
        "Function_10_193B",        # 0A, 10
        "Function_11_1A03",        # 0B, 11
        "Function_12_26E6",        # 0C, 12
    )
    ...
    OP_5F(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_510")
    OP_20(0xBB8)
    FadeToDark(1000, 0, -1)
    Sleep(700)
    OP_22(0xD, 0x0, 0x64)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_52A")
    FadeToBright(300, 0)
    TalkEnd(0x8)
    Return()
    ...
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 7)), scpexpr(EXPR_END)), "loc_586")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 1)), scpexpr(EXPR_END)), "loc_5E8")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 5)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_7E6")
    OP_A2(0x679)
    OP_28(0x4C, 0x1, 0x10)
    EventBegin(0x0)
    OP_69(0x8, 0x3E8)
    ...
    QueueWorkItem(0xC, 1, lambda_A00)
    ...
    QueueWorkItem(0x101, 1, lambda_AC0)
    Sleep(50)
    ...
    QueueWorkItem(0x102, 1, lambda_ADA)
    Sleep(50)
    ...
    QueueWorkItem(0x108, 1, lambda_AF4)
    ...
    QueueWorkItem(0x101, 2, lambda_CD2)
    SetChrChipByIndex(0x101, 65535)
    SetChrChipByIndex(0x102, 65535)
    SetChrChipByIndex(0x108, 65535)
    ...
    QueueWorkItem(0x102, 1, lambda_D0C)
    Sleep(200)
    ...
    QueueWorkItem(0x108, 1, lambda_D1F)
    ...
    QueueWorkItem(0x8, 1, lambda_D44)
    ...
    QueueWorkItem2(0x108, 1, lambda_D5F)
    ...
    QueueWorkItem2(0x101, 1, lambda_D70)
    ...
    QueueWorkItem2(0x102, 1, lambda_D81)
    ...
    CloseMessageWindow()
    OP_28(0x4C, 0x1, 0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_12CB")
    ...
    def Function_6_1574(): pass

    label("Function_6_1574")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_167A")
    EventBegin(0x0)
    OP_A2(0x657)
    OP_28(0x4C, 0x1, 0x20)
    FadeToDark(300, 0, 100)
    ...
    def Function_7_16C3(): pass

    label("Function_7_16C3")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_174C")
    FadeToDark(300, 0, 100)
    SetMessageWindowPos(72, 320, 56, 3)
    SetChrName("")
    ...
    def Function_8_1793(): pass

    label("Function_8_1793")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_181E")
    FadeToDark(300, 0, 100)
    SetMessageWindowPos(72, 320, 56, 3)
    SetChrName("")
    ...
    def Function_9_1867(): pass

    label("Function_9_1867")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_18F2")
    FadeToDark(300, 0, 100)
    SetMessageWindowPos(72, 320, 56, 3)
    SetChrName("")
    ...
    def Function_10_193B(): pass

    label("Function_10_193B")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_19C0")
    FadeToDark(300, 0, 100)
    SetMessageWindowPos(72, 320, 56, 3)
    SetChrName("")
    ...
    # Function_10_193B end

    def Function_11_1A03(): pass

    label("Function_11_1A03")
    ...
    QueueWorkItem(0xE, 1, lambda_1F2B)
    ...
    QueueWorkItem(0x102, 1, lambda_2299)

    def lambda_22A7():
        TurnDirection(0xFE, 0xE, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_22A7)

    def lambda_22B5():
        TurnDirection(0xFE, 0xE, 400)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_22B5)

    def lambda_22C3():
        TurnDirection(0xFE, 0xE, 400)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_22C3)

    def lambda_22D1():
        TurnDirection(0xFE, 0xE, 400)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_22D1)
    ...
    # Function_11_1A03 end

    def Function_12_26E6(): pass

    label("Function_12_26E6")
