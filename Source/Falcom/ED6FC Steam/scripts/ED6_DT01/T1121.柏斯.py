...
def main():
    ...
    ScpFunction(
        ...
        "Function_4_306",          # 04, 4
        "Function_5_4D5",          # 05, 5
        "Function_6_13B9",         # 06, 6
        "Function_7_183E",         # 07, 7
        "Function_8_20F2",         # 08, 8
        "Function_9_2F7A",         # 09, 9
        "Function_10_4296",        # 0A, 10
    )
    ...
    OP_5F(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_4BF")
    OP_0D()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x35, 0x0, 0x10)"), scpexpr(EXPR_EXEC_OP, "OP_29(0x35, 0x0, 0x20)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_3E9")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_A9(0x1C)"), scpexpr(EXPR_END)), "loc_456")
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_4D0")
    TalkEnd(0x8)
    Return()
    ...
    def Function_5_4D5(): pass

    label("Function_5_4D5")

    TalkBegin(0x8)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 6)), scpexpr(EXPR_END)), "loc_655")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_610")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x67, 2)), scpexpr(EXPR_END)), "loc_760")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x65, 3)), scpexpr(EXPR_END)), "loc_A47")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6D, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9C7")
    OP_A2(0x36D)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x63, 0)), scpexpr(EXPR_END)), "loc_B81")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 7)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_C88")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 5)), scpexpr(EXPR_END)), "loc_C33")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 4)), scpexpr(EXPR_END)), "loc_D09")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_11B4")
    EventBegin(0x0)
    OP_A2(0x314)
    ClearMapFlags(0x1)
    Fade(1000)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x61, 3)), scpexpr(EXPR_END)), "loc_1345")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_12E1")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x60, 1)), scpexpr(EXPR_END)), "loc_13B5")
    ...
    def Function_6_13B9(): pass

    label("Function_6_13B9")

    TalkBegin(0x9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 6)), scpexpr(EXPR_END)), "loc_144A")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 7)), scpexpr(EXPR_END)), "loc_140C")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_16D6")
    OP_A2(0x35F)
    OP_A2(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_17E6")
    OP_A2(0x1)
    ...
    def Function_7_183E(): pass

    label("Function_7_183E")

    TalkBegin(0xA)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 6)), scpexpr(EXPR_END)), "loc_19A2")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1964")
    OP_A2(0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6C, 0)), scpexpr(EXPR_END)), "loc_18DF")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6C, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1D01")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2051")
    OP_A2(0x2)
    TurnDirection(0xFE, 0x103, 0)
    ...
    def Function_8_20F2(): pass

    label("Function_8_20F2")
    ...
    QueueWorkItem(0x101, 2, lambda_212D)
    Sleep(2000)
    OP_4A(0x8, 0)
    ...
    QueueWorkItem(0x103, 1, lambda_21BE)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_2C2A)
    Sleep(500)
    ...
    QueueWorkItem(0x1, 2, lambda_2C4A)
    ...
    QueueWorkItem(0x1, 1, lambda_2C8A)
    OP_8C(0x101, 0, 400)
    OP_8C(0x102, 0, 400)
    Sleep(500)
    ...
    QueueWorkItem(0x1, 2, lambda_2E7E)
    ...
    def Function_9_2F7A(): pass

    label("Function_9_2F7A")
    ...
    QueueWorkItem2(0x101, 1, lambda_354B)
    ...
    QueueWorkItem2(0x102, 1, lambda_355C)
    ...
    QueueWorkItem2(0x103, 1, lambda_356D)
    ...
    QueueWorkItem2(0x104, 1, lambda_357E)
    OP_8C(0xB, 180, 400)
    ...
    QueueWorkItem(0xB, 1, lambda_3596)
    Sleep(300)
    OP_8C(0xC, 180, 400)
    ...
    QueueWorkItem(0xC, 1, lambda_35BD)
    ...
    QueueWorkItem(0x104, 1, lambda_371D)
    OP_8C(0x103, 270, 400)
    ...
    QueueWorkItem(0x101, 3, lambda_37E9)
    ...
    QueueWorkItem(0x103, 1, lambda_380F)

    def lambda_381D():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_381D)
    TurnDirection(0x101, 0x8, 400)
    WaitChrThread(0x101, 0x3)
    Sleep(100)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x35, 0x0, 0x20)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_3854")
    OP_AF(0x1C, 0x35)
    Sleep(100)
    OP_28(0x36, 0x4, 0x10)
    OP_28(0x36, 0x4, 0x20)
    ...
    QueueWorkItem(0x101, 3, lambda_3BB2)
    ...
    QueueWorkItem2(0x101, 1, lambda_3BCA)
    ...
    QueueWorkItem2(0x102, 1, lambda_3BDB)
    ...
    QueueWorkItem2(0x103, 1, lambda_3BEC)
    ...
    QueueWorkItem2(0x104, 1, lambda_3BFD)
    ...
    QueueWorkItem2(0x101, 1, lambda_408B)
    ...
    QueueWorkItem2(0x102, 1, lambda_409C)
    ...
    QueueWorkItem2(0x103, 1, lambda_40AD)
    ...
    QueueWorkItem2(0x104, 1, lambda_40BE)
    ...
    QueueWorkItem(0x101, 3, lambda_4183)
    WaitChrThread(0x101, 0x3)
    ...
    QueueWorkItem(0x102, 1, lambda_4201)

    def lambda_420F():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_420F)

    def lambda_421D():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_421D)
    TurnDirection(0x101, 0x8, 400)
    Sleep(200)
    ...
    def Function_10_4296(): pass

    label("Function_10_4296")
