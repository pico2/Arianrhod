...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD6, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_5AE")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD6, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_4E0")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x11A, 1)"), scpexpr(EXPR_END)), "loc_536")
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD6, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_797")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD6, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_6CF")
    ...
    QueueWorkItem(0x9, 1, lambda_63E)

    def lambda_659():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x4B0)
        ExitThread()

    QueueWorkItem(0x9, 2, lambda_659)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x80, 1)"), scpexpr(EXPR_END)), "loc_723")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD6, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_98C")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x3, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD6, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_8B8")
    OP_9F(0x8, 0xFF, 0xFF, 0xFF, 0x0, 0x0)
    ...
    QueueWorkItem(0x8, 1, lambda_827)

    def lambda_842():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x4B0)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_842)
    ClearChrFlags(0x8, 0x80)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0xFE, 1)"), scpexpr(EXPR_END)), "loc_910")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    def Function_8_9CD(): pass

    label("Function_8_9CD")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xD6, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_ABD")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x4, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_A43")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
