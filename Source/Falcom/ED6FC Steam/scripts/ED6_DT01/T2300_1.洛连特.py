...
def main():
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1F, 0x0, 0x2)"), scpexpr(EXPR_END)), "loc_2F1")
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_174")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1B5")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_23A")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_33B")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3DA")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1F, 0x0, 0x2)"), scpexpr(EXPR_END)), "loc_6CE")
    ...
    QueueWorkItem(0x102, 1, lambda_7C6)

    def lambda_7D4():
        OP_8C(0x105, 315, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_7D4)
    ...
    def Function_1_BA5(): pass

    label("Function_1_BA5")
    ...
    QueueWorkItem(0xF, 1, lambda_C23)

    def lambda_C33():
        OP_94(0x1, 0x10, 0x0, 0x1CE8, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_C33)
    Sleep(100)
    ...
    QueueWorkItem(0x101, 1, lambda_C4E)
    Sleep(50)
    ...
    QueueWorkItem(0x102, 1, lambda_C69)
    Sleep(50)
    ...
    QueueWorkItem(0x105, 1, lambda_C84)
    OP_0D()
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x5, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_EDE")
    ...
    QueueWorkItem(0x105, 1, lambda_D9A)
    ...
    QueueWorkItem(0x105, 1, lambda_E29)
    ...
    QueueWorkItem2(0x101, 1, lambda_F62)
    ...
    QueueWorkItem2(0x102, 1, lambda_F73)
    ...
    QueueWorkItem2(0x105, 1, lambda_F84)
