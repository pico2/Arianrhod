...
def main():
    ...
    TalkBegin(0x8)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x81, 5)), scpexpr(EXPR_END)), "loc_35B")
    ...
    TalkBegin(0xB)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 1)), scpexpr(EXPR_END)), "loc_3A1")
    ...
    def Function_5_3A5(): pass

    label("Function_5_3A5")

    TalkBegin(0x9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x81, 5)), scpexpr(EXPR_END)), "loc_3F0")
    ...
    def Function_6_3F4(): pass

    label("Function_6_3F4")

    TalkBegin(0xC)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x81, 5)), scpexpr(EXPR_END)), "loc_427")
    ...
    def Function_7_42B(): pass

    label("Function_7_42B")

    TalkBegin(0xA)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x81, 5)), scpexpr(EXPR_END)), "loc_493")
    ...
    def Function_8_497(): pass

    label("Function_8_497")
    ...
    def Function_9_F46(): pass

    label("Function_9_F46")
    ...
    QueueWorkItem(0x8, 2, lambda_10CC)
