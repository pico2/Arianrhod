...
def main():
    ...
    ScpFunction(
        ...
        "Function_7_2F7C",         # 07, 7
        "Function_8_2FD1",         # 08, 8
        "Function_9_3048",         # 09, 9
        "Function_10_30AE",        # 0A, 10
        "Function_11_3139",        # 0B, 11
    )
    ...
    QueueWorkItem(0xB, 1, lambda_782)

    def lambda_790():
        TurnDirection(0xFE, 0x101, 230)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_790)

    def lambda_79E():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_79E)
    Sleep(400)
    ...
    QueueWorkItem(0x106, 1, lambda_85C)
    Sleep(300)
    OP_63(0x8)
    OP_63(0xB)
    OP_63(0xC)
    ...
    QueueWorkItem(0x8, 1, lambda_89A)

    def lambda_8AA():
        OP_6D(-170, 0, -1480, 700)
        ExitThread()

    QueueWorkItem(0x106, 2, lambda_8AA)
    ...
    QueueWorkItem(0x8, 1, lambda_8E7)
    ...
    QueueWorkItem(0x8, 1, lambda_92D)

    def lambda_947():
        OP_9E(0xFE, 0x14, 0x0, 0x2BC, 0xBB8)
        ExitThread()

    QueueWorkItem(0x106, 1, lambda_947)
    OP_6B(2800, 700)
    Sleep(500)
    ...
    QueueWorkItem(0x8, 2, lambda_994)

    def lambda_9A4():
        OP_99(0x8, 0x4, 0x7, 0xFA0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_9A4)
    SetChrFlags(0x8, 0x20)
    ...
    QueueWorkItem(0xB, 1, lambda_A40)

    def lambda_A5B():
        OP_8E(0xFE, 0xFFFFFC18, 0x0, 0x100, 0x3E8, 0x0)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_A5B)
    ...
    QueueWorkItem(0x101, 1, lambda_B25)
    Sleep(50)
    ...
    QueueWorkItem(0x102, 1, lambda_B4A)
    ...
    QueueWorkItem(0x105, 1, lambda_B6A)
    ...
    QueueWorkItem(0xC, 1, lambda_BAF)
    Sleep(50)
    ...
    QueueWorkItem(0x8, 1, lambda_BD4)
    OP_44(0x106, 0xFF)
    ...
    QueueWorkItem(0x106, 1, lambda_BF8)

    def lambda_C08():
        OP_95(0x106, 0x0, 0x0, 0x5DC, 0x5DC, 0x1B58)
        ExitThread()

    QueueWorkItem(0x106, 2, lambda_C08)
    Sleep(300)
    Battle(0x38F, 0x0, 0x0, 0x0, 0xFF)
    Switch(
        (scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_END)),
        (1, "loc_C3E"),
        (SWITCH_DEFAULT, "loc_C41"),
    )
    ...
    def Function_4_FFE(): pass

    label("Function_4_FFE")
    ...
    QueueWorkItem(0xD, 1, lambda_1190)
    Sleep(50)
    ...
    QueueWorkItem(0xE, 1, lambda_11B5)
    SetChrFlags(0x101, 0x1000)
    SetChrFlags(0x102, 0x1000)
    SetChrFlags(0x105, 0x1000)
    SetChrFlags(0x106, 0x1000)
    ...
    QueueWorkItem(0x101, 1, lambda_11E9)
    Sleep(50)
    SetChrChipByIndex(0x102, 9)
    ...
    QueueWorkItem(0x105, 1, lambda_1258)
    Sleep(200)
    Battle(0x390, 0x0, 0x0, 0x0, 0xFF)
    Switch(
        (scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_END)),
        (1, "loc_128B"),
        (SWITCH_DEFAULT, "loc_128E"),
    )
    ...
    QueueWorkItem(0xF, 1, lambda_154C)
    Sleep(50)
    ...
    QueueWorkItem(0x10, 1, lambda_1571)
    SetChrChipByIndex(0x106, 12)
    ...
    QueueWorkItem(0x106, 1, lambda_1591)
    Sleep(50)
    SetChrChipByIndex(0x105, 37)
    ...
    QueueWorkItem(0x105, 1, lambda_15B6)
    Sleep(50)
    SetChrChipByIndex(0x101, 8)
    ...
    QueueWorkItem(0x101, 1, lambda_15DB)
    Sleep(50)
    SetChrChipByIndex(0x102, 9)
    ...
    QueueWorkItem(0x102, 1, lambda_1600)
    Sleep(300)
    Battle(0x391, 0x0, 0x0, 0x0, 0xFF)
    Switch(
        (scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_END)),
        (1, "loc_1633"),
        (SWITCH_DEFAULT, "loc_1636"),
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_1762")
    Return()
    ...
    QueueWorkItem(0x0, 1, lambda_1772)

    def lambda_1780():
        OP_8C(0xFE, 90, 400)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_1780)

    def lambda_178E():
        OP_8C(0xFE, 90, 400)
        ExitThread()

    QueueWorkItem(0x2, 1, lambda_178E)

    def lambda_179C():
        OP_8C(0xFE, 90, 400)
        ExitThread()

    QueueWorkItem(0x3, 1, lambda_179C)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_17FE")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1837")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1870")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_18A2")
    ...
    QueueWorkItem(0x11, 1, lambda_1F58)

    def lambda_1F66():
        TurnDirection(0xFE, 0x105, 400)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1F66)

    def lambda_1F74():
        TurnDirection(0xFE, 0x105, 400)
        ExitThread()

    QueueWorkItem(0x13, 1, lambda_1F74)

    def lambda_1F82():
        OP_6D(1330, 0, 201850, 2000)
        ExitThread()

    QueueWorkItem(0x14, 1, lambda_1F82)

    def lambda_1F9A():
        OP_67(0, 6000, -10000, 2000)
        ExitThread()

    QueueWorkItem(0x14, 2, lambda_1F9A)

    def lambda_1FB2():
        OP_6B(3000, 2000)
        ExitThread()

    QueueWorkItem(0x14, 3, lambda_1FB2)
    ...
    QueueWorkItem(0x11, 1, lambda_23BC)
    Sleep(100)
    ...
    QueueWorkItem(0x12, 1, lambda_23E1)
    SetChrChipByIndex(0x106, 12)
    ...
    QueueWorkItem(0x106, 1, lambda_2401)
    Sleep(50)
    SetChrChipByIndex(0x105, 37)
    ...
    QueueWorkItem(0x105, 1, lambda_2426)
    Sleep(50)
    SetChrChipByIndex(0x101, 8)
    ...
    QueueWorkItem(0x101, 1, lambda_244B)
    Sleep(50)
    SetChrChipByIndex(0x102, 9)
    ...
    QueueWorkItem(0x102, 1, lambda_2470)
    Sleep(300)
    Battle(0x392, 0x0, 0x0, 0x0, 0xFF)
    Switch(
        (scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_END)),
        (1, "loc_24A3"),
        (SWITCH_DEFAULT, "loc_24A6"),
    )
    ...
    QueueWorkItem(0x11, 1, lambda_2A3B)

    def lambda_2A4B():
        OP_6D(1400, 0, 201500, 1000)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_2A4B)
    ...
    QueueWorkItem(0x11, 1, lambda_2C6A)
    SetChrChipByIndex(0x105, 65535)
    ...
    QueueWorkItem(0x105, 1, lambda_2C87)
    Sleep(100)
    SetChrChipByIndex(0x102, 65535)
    ...
    QueueWorkItem(0x102, 1, lambda_2CAC)
    Sleep(100)
    SetChrChipByIndex(0x101, 65535)
    ...
    QueueWorkItem(0x101, 1, lambda_2CD1)
    Sleep(100)
    ...
    QueueWorkItem(0x106, 1, lambda_2CF6)
    Sleep(200)
    ...
    QueueWorkItem2(0x101, 2, lambda_2D50)
    ...
    QueueWorkItem2(0x102, 2, lambda_2D61)
    ...
    QueueWorkItem2(0x105, 2, lambda_2D72)
    ...
    QueueWorkItem2(0x106, 2, lambda_2D83)
    ...
    QueueWorkItem(0x11, 3, lambda_2D99)
    ...
    QueueWorkItem2(0x106, 2, lambda_2DE8)
    ...
    QueueWorkItem(0x11, 1, lambda_2E0D)
    Sleep(100)
    SetChrChipByIndex(0x12, 42)
    ...
    QueueWorkItem(0x12, 1, lambda_2E76)
    ...
    QueueWorkItem(0x11, 2, lambda_2EBD)

    def lambda_2ECF():
        OP_8E(0xFE, 0x22F6, 0x3E8, 0x3124A, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 3, lambda_2ECF)
    ...
    QueueWorkItem(0x12, 2, lambda_2EEF)

    def lambda_2F01():
        OP_8E(0xFE, 0x22F6, 0x3E8, 0x3124A, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 3, lambda_2F01)
    ...
    def Function_7_2F7C(): pass

    label("Function_7_2F7C")
    ...
    QueueWorkItem(0x106, 1, lambda_2FB1)
    OP_94(0x1, 0x106, 0xB4, 0x258, 0x1770, 0x0)
    Return()

    # Function_7_2F7C end

    def Function_8_2FD1(): pass

    label("Function_8_2FD1")
    ...
    QueueWorkItem(0xFE, 2, lambda_2FE7)
    SetChrChipByIndex(0x101, 8)
    ...
    def Function_9_3048(): pass

    label("Function_9_3048")
    ...
    QueueWorkItem(0xFE, 2, lambda_305E)
    OP_8E(0xFE, 0xB5E, 0x0, 0x327DA, 0x1388, 0x0)
    OP_8E(0xFE, 0xC6C, 0x0, 0x32546, 0x1388, 0x0)
    ...
    QueueWorkItem(0xFE, 2, lambda_30C4)
    SetChrChipByIndex(0x102, 9)
    OP_8E(0xFE, 0xB5E, 0x0, 0x327DA, 0x1388, 0x0)
    OP_8E(0xFE, 0xC6C, 0x0, 0x32546, 0x1388, 0x0)
    ...
    def Function_11_3139(): pass

    label("Function_11_3139")
    ...
    QueueWorkItem(0xFE, 2, lambda_314F)
    SetChrChipByIndex(0x106, 12)
    OP_8E(0xFE, 0xB5E, 0x0, 0x327DA, 0x1388, 0x0)
    OP_8E(0xFE, 0xC6C, 0x0, 0x32546, 0x1388, 0x0)
