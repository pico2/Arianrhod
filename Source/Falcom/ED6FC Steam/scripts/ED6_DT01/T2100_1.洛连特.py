...
def main():
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_45B")
    ...
    QueueWorkItem(0x102, 1, lambda_3F8)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_553")
    ...
    QueueWorkItem(0x101, 1, lambda_487)
    ...
    QueueWorkItem(0x101, 1, lambda_52C)
    TurnDirection(0x105, 0x12, 400)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_610")
    ...
    QueueWorkItem(0x102, 1, lambda_57D)
    ...
    QueueWorkItem(0x101, 1, lambda_5DC)
    TurnDirection(0x102, 0x12, 400)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_690")

    def lambda_647():
        OP_92(0x1, 0x12, 0x3E8, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_647)

    def lambda_65C():
        OP_92(0x2, 0x12, 0x7D0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x2, 1, lambda_65C)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xB), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_705")

    def lambda_6A2():
        OP_91(0x0, 0xFFFFFCE0, 0x0, 0x0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_6A2)
    ...
    QueueWorkItem(0x2, 1, lambda_6D1)
    OP_8E(0x102, 0x3138, 0x0, 0x11EB8, 0x7D0, 0x0)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xC), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_77D")

    def lambda_717():
        OP_91(0x0, 0xFFFFFCE0, 0x0, 0x0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_717)

    def lambda_732():
        OP_91(0x1, 0xFFFFFF38, 0x0, 0x0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_732)
    ...
    QueueWorkItem(0x12, 1, lambda_7C7)
    OP_8C(0x102, 90, 400)
    Sleep(1000)
    ...
    Sleep(800)
    Fade(1000)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x64), scpexpr(EXPR_PUSH_LONG, 0x2D), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_896")
    ...
    QueueWorkItem(0x105, 1, lambda_BA2)
    TurnDirection(0x101, 0x102, 400)
