...
def main():
    ...
    ScpFunction(
        ...
        "Function_11_156A",        # 0B, 11
        "Function_12_1580",        # 0C, 12
        "Function_13_1631",        # 0D, 13
    ...
    def Function_9_E5B(): pass

    label("Function_9_E5B")
    ...
    def Function_11_156A(): pass

    label("Function_11_156A")
    ...
    # Function_11_156A end

    def Function_12_1580(): pass

    label("Function_12_1580")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_15EC")
    ...
    # Function_12_1580 end

    def Function_13_1631(): pass

    label("Function_13_1631")
