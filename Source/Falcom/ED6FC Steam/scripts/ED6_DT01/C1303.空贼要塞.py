...
def main():
    ...
    ScpFunction(
        ...
        "Function_2_2C5",          # 02, 2
        "Function_3_2DB",          # 03, 3
        "Function_4_20DB",         # 04, 4
        "Function_5_2134",         # 05, 5
        "Function_6_217A",         # 06, 6
        "Function_7_21A5",         # 07, 7
        "Function_8_21CB",         # 08, 8
        "Function_9_22F4",         # 09, 9
    )
    ...
    QueueWorkItem2(0xB, 1, lambda_856)
    SetChrFlags(0xB, 0x4)
    ...
    QueueWorkItem(0xB, 0, lambda_8B4)

    def lambda_8D2():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0x0, 0x1F4)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_8D2)
    ...
    QueueWorkItem(0xA, 2, lambda_BD7)
    ...
    QueueWorkItem(0x8, 1, lambda_C0C)
    ...
    QueueWorkItem(0x101, 1, lambda_C1F)
    Sleep(200)
    ...
    QueueWorkItem(0x103, 1, lambda_C50)
    Sleep(200)
    ...
    QueueWorkItem(0x102, 1, lambda_C86)
    Sleep(200)
    ...
    QueueWorkItem(0x104, 1, lambda_CB7)
    ...
    QueueWorkItem(0x9, 1, lambda_D23)
    ...
    QueueWorkItem(0xA, 1, lambda_1024)
    Sleep(1000)
    ...
    QueueWorkItem(0xA, 2, lambda_11BB)
    Sleep(1000)
    ...
    QueueWorkItem(0xA, 1, lambda_11D8)
    Sleep(200)
    ...
    QueueWorkItem(0xA, 1, lambda_13EA)
    Sleep(100)
    ...
    QueueWorkItem(0x9, 1, lambda_140D)
    Sleep(100)
    ...
    QueueWorkItem(0x103, 1, lambda_200B)
    ...
    OP_20(0x5DC)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x3), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_20AF")
    ...
    def Function_4_20DB(): pass

    label("Function_4_20DB")
    ...
    def Function_5_2134(): pass

    label("Function_5_2134")
    ...
    def Function_6_217A(): pass

    label("Function_6_217A")
    ...
    def Function_7_21A5(): pass

    label("Function_7_21A5")
    ...
    def Function_8_21CB(): pass

    label("Function_8_21CB")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6A, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x6B, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_22F3")
    EventBegin(0x0)
    FadeToDark(300, 0, 100)
    SetMessageWindowPos(72, 320, 56, 3)
    SetChrName("")
    ...
    def Function_9_22F4(): pass

    label("Function_9_22F4")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x70, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_23DE")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1FC, 1)"), scpexpr(EXPR_END)), "loc_2368")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
