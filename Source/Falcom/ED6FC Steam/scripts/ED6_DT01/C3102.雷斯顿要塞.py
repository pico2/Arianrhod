...
def main():
    ...
    ScpFunction(
        ...
        "Function_2_218",          # 02, 2
        "Function_3_22E",          # 03, 3
        "Function_4_1143",         # 04, 4
        "Function_5_1277",         # 05, 5
    )
    ...
    QueueWorkItem(0xD, 1, lambda_81C)
    ...
    QueueWorkItem2(0x8, 1, lambda_845)
    ...
    QueueWorkItem2(0xA, 1, lambda_856)
    ...
    QueueWorkItem2(0xB, 1, lambda_867)
    ...
    QueueWorkItem2(0x9, 1, lambda_878)
    ...
    QueueWorkItem(0x101, 3, lambda_8B1)
    ...
    QueueWorkItem(0xC, 1, lambda_8D5)
    ...
    QueueWorkItem(0x101, 1, lambda_973)
    ...
    QueueWorkItem(0x101, 3, lambda_99B)
    ...
    QueueWorkItem2(0xA, 1, lambda_B56)
    ...
    QueueWorkItem2(0xB, 1, lambda_B67)
    ...
    QueueWorkItem2(0xC, 1, lambda_B78)
    ...
    QueueWorkItem2(0xD, 1, lambda_B89)
    ...
    QueueWorkItem2(0x8, 1, lambda_B9A)
    ...
    QueueWorkItem2(0x9, 1, lambda_BAB)
    ...
    QueueWorkItem(0xC, 2, lambda_BD0)
    ...
    QueueWorkItem(0xB, 2, lambda_C06)

    def lambda_C21():
        OP_8E(0x8, 0xFFFFCD42, 0x0, 0x56EA, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_C21)

    def lambda_C3C():
        OP_8F(0x9, 0xFFFFC270, 0x0, 0x56D6, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 2, lambda_C3C)
    ...
    QueueWorkItem(0xA, 1, lambda_FF0)

    def lambda_FFE():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_FFE)

    def lambda_100C():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_100C)
    ...
    def Function_4_1143(): pass

    label("Function_4_1143")
    ...
    def Function_5_1277(): pass

    label("Function_5_1277")
