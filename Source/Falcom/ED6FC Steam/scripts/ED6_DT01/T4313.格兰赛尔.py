...
def main():
    ...
    ScpFunction(
        ...
        "Function_2_2EC",          # 02, 2
        "Function_3_5AD",          # 03, 3
        "Function_4_107C",         # 04, 4
        "Function_5_11A4",         # 05, 5
    ...
    TalkBegin(0x8)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 5)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_4D4")
    OP_A2(0x679)
    OP_28(0x4C, 0x1, 0x10)
    EventBegin(0x0)
    OP_69(0x8, 0x3E8)
    ...
    QueueWorkItem(0xC, 1, lambda_6C8)
    ...
    QueueWorkItem(0x9, 1, lambda_745)

    def lambda_753():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_753)
    ...
    QueueWorkItem(0x108, 1, lambda_7B1)

    def lambda_7CC():
        OP_8E(0xFE, 0xFFFFC3C4, 0x0, 0x481C, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_7CC)

    def lambda_7E7():
        OP_8E(0xFE, 0x550, 0x0, 0x8642, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_7E7)
    ...
    QueueWorkItem(0x8, 1, lambda_990)
    SetChrChipByIndex(0x101, 65535)
    SetChrChipByIndex(0x102, 65535)
    SetChrChipByIndex(0x108, 65535)
    ...
    QueueWorkItem(0x108, 1, lambda_9BA)

    def lambda_9C8():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_9C8)

    def lambda_9D6():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_9D6)
    ...
    QueueWorkItem2(0x108, 1, lambda_9F5)
    ...
    QueueWorkItem2(0x101, 1, lambda_A06)
    ...
    QueueWorkItem2(0x102, 1, lambda_A17)
    ...
    QueueWorkItem(0x101, 3, lambda_B09)
    ...
    CloseMessageWindow()
    OP_28(0x4C, 0x1, 0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E90")
    ...
    def Function_4_107C(): pass

    label("Function_4_107C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_117D")
    EventBegin(0x0)
    OP_A2(0x657)
    OP_28(0x4C, 0x1, 0x20)
    FadeToDark(300, 0, 100)
    ...
    def Function_5_11A4(): pass

    label("Function_5_11A4")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCA, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 1)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1217")
    FadeToDark(300, 0, 100)
    ...
    QueueWorkItem(0xE, 1, lambda_14AF)
    ...
    QueueWorkItem(0x108, 1, lambda_14D9)

    def lambda_14E7():
        TurnDirection(0xFE, 0x12, 400)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_14E7)

    def lambda_14F5():
        TurnDirection(0xFE, 0x12, 400)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_14F5)
    ...
    QueueWorkItem(0xE, 1, lambda_1583)

    def lambda_1591():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_1591)

    def lambda_159F():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_159F)

    def lambda_15AD():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_15AD)

    def lambda_15BB():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_15BB)

    def lambda_15C9():
        TurnDirection(0xFE, 0x11, 400)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_15C9)
    ...
    QueueWorkItem(0xE, 1, lambda_17CD)
    ...
    QueueWorkItem(0xE, 1, lambda_1840)
    ...
    QueueWorkItem(0x101, 1, lambda_1A73)

    def lambda_1A81():
        TurnDirection(0xFE, 0xE, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1A81)

    def lambda_1A8F():
        TurnDirection(0xFE, 0xE, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_1A8F)

    def lambda_1A9D():
        TurnDirection(0xFE, 0xE, 400)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_1A9D)

    def lambda_1AAB():
        TurnDirection(0xFE, 0xE, 400)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_1AAB)
    OP_8C(0xE, 135, 400)
