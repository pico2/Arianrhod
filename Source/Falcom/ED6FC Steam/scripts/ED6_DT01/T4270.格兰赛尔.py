...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_B53",          # 08, 8
        "Function_9_CF0",          # 09, 9
        "Function_10_E84",         # 0A, 10
        "Function_11_1399",        # 0B, 11
        "Function_12_41C0",        # 0C, 12
        "Function_13_5500",        # 0D, 13
        "Function_14_556C",        # 0E, 14
    )
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 7)), scpexpr(EXPR_END)), "loc_7B4")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_89A")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_813")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 6)), scpexpr(EXPR_END)), "loc_8A4")
    Jump("loc_8BF")

    label("loc_8A4")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_END)), "loc_8AE")
    Jump("loc_8BF")

    label("loc_8AE")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 0)), scpexpr(EXPR_END)), "loc_8B8")
    Jump("loc_8BF")

    label("loc_8B8")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_8BF")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x87), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_8E8")
    SetChrSubChip(0xFE, 1)
    Jump("loc_903")

    label("loc_8E8")

    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xE1), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_8FE")
    ...
    ClearChrFlags(0xFE, 0x10)
    TurnDirection(0xFE, 0x0, 0)
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x5A), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_9C4")
    SetChrSubChip(0xFE, 2)
    Jump("loc_9F5")

    label("loc_9C4")

    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xE1), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_9DA")
    SetChrSubChip(0xFE, 1)
    Jump("loc_9F5")

    label("loc_9DA")

    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x13B), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_9F0")
    SetChrSubChip(0xFE, 0)
    Jump("loc_9F5")
    ...
    OP_8C(0xFE, 270, 0)
    SetChrFlags(0xFE, 0x10)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_A51")
    ...
    def Function_8_B53(): pass

    label("Function_8_B53")

    TalkBegin(0x16)
    ClearChrFlags(0xFE, 0x10)
    TurnDirection(0xFE, 0x0, 0)
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x87), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_B78")
    SetChrSubChip(0xFE, 2)
    Jump("loc_B93")

    label("loc_B78")

    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xE1), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_B8E")
    SetChrSubChip(0xFE, 0)
    Jump("loc_B93")
    ...
    OP_8C(0xFE, 0, 0)
    SetChrFlags(0xFE, 0x10)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_END)), "loc_C32")
    ...
    def Function_9_CF0(): pass

    label("Function_9_CF0")

    TalkBegin(0x17)
    ClearChrFlags(0xFE, 0x10)
    TurnDirection(0xFE, 0x0, 0)
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x5A), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_D15")
    SetChrSubChip(0xFE, 1)
    Jump("loc_D46")

    label("loc_D15")

    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xE1), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_D2B")
    SetChrSubChip(0xFE, 2)
    Jump("loc_D46")

    label("loc_D2B")

    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x13B), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_D41")
    SetChrSubChip(0xFE, 0)
    Jump("loc_D46")
    ...
    OP_8C(0xFE, 90, 0)
    SetChrFlags(0xFE, 0x10)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_END)), "loc_DEA")
    ...
    def Function_10_E84(): pass

    label("Function_10_E84")
    ...
    QueueWorkItem(0x138, 2, lambda_F00)

    def lambda_F12():
        OP_8E(0xFE, 0xFFFFFFA6, 0x0, 0x564, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x138, 1, lambda_F12)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 2, lambda_F32)

    def lambda_F44():
        OP_8E(0xFE, 0xFFFFFBF0, 0x0, 0xFFFFFE5C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_F44)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 2, lambda_F64)

    def lambda_F76():
        OP_8E(0xFE, 0x2EE, 0x0, 0xFFFFFE5C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_F76)
    ...
    def Function_11_1399(): pass

    label("Function_11_1399")
    ...
    QueueWorkItem(0x101, 2, lambda_15E3)

    def lambda_15FB():
        OP_6C(18000, 4000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_15FB)

    def lambda_160B():
        OP_67(0, 4200, -10000, 4000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_160B)

    def lambda_1623():
        OP_6E(317, 4000)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_1623)
    Sleep(4000)
    OP_8C(0x8, 180, 300)
    ...
    QueueWorkItem(0x102, 1, lambda_16E8)
    ...
    QueueWorkItem(0x101, 1, lambda_3FD7)
    TurnDirection(0x101, 0x138, 400)
    ...
    QueueWorkItem(0x138, 2, lambda_400B)

    def lambda_401D():
        OP_8E(0xFE, 0xFFFF34A4, 0x0, 0xF96, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x138, 1, lambda_401D)
    ...
    # Function_11_1399 end

    def Function_12_41C0(): pass

    label("Function_12_41C0")
    ...
    QueueWorkItem(0x101, 1, lambda_489A)

    def lambda_48B5():
        OP_8E(0xFE, 0x122, 0x0, 0x59A6, 0x1F40, 0x0)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_48B5)

    def lambda_48D0():
        OP_8E(0xFE, 0x122, 0x0, 0x59A6, 0x1F40, 0x0)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_48D0)
    ...
    QueueWorkItem(0x101, 1, lambda_4A08)

    def lambda_4A16():
        TurnDirection(0xFE, 0x9, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_4A16)

    def lambda_4A24():
        TurnDirection(0xFE, 0x9, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_4A24)
    ...
    QueueWorkItem(0x101, 3, lambda_4B01)
    ...
    QueueWorkItem(0x9, 1, lambda_4B5F)
    ...
    QueueWorkItem(0x9, 1, lambda_4B98)
    ...
    QueueWorkItem(0x9, 1, lambda_4BBF)
    ...
    QueueWorkItem(0x101, 1, lambda_4CCD)

    def lambda_4CDB():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_4CDB)

    def lambda_4CE9():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_4CE9)
    ...
    QueueWorkItem2(0x101, 1, lambda_4D08)
    ...
    QueueWorkItem2(0x103, 1, lambda_4D19)
    ...
    QueueWorkItem2(0x105, 1, lambda_4D2A)

    def lambda_4D3B():
        OP_6D(-4750, 0, 8080, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_4D3B)
    ...
    QueueWorkItem(0x103, 1, lambda_51CB)

    def lambda_51D9():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_51D9)
    ...
    QueueWorkItem2(0x101, 1, lambda_51F8)
    ...
    QueueWorkItem2(0x103, 1, lambda_5209)
    ...
    QueueWorkItem2(0x105, 1, lambda_521A)

    def lambda_522B():
        OP_6D(370, 0, 8590, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_522B)
    OP_92(0xA, 0x9, 0x258, 0x1388, 0x0)
    ...
    # Function_12_41C0 end

    def Function_13_5500(): pass

    label("Function_13_5500")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_556B")
    EventBegin(0x1)
    ...
    # Function_13_5500 end

    def Function_14_556C(): pass

    label("Function_14_556C")

    OP_1F(0x50, 0xC8)
    Return()

    # Function_14_556C end
