...
def main():
    ...
    def Function_4_4BD(): pass

    label("Function_4_4BD")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_517")
    ...
    def Function_5_57F(): pass

    label("Function_5_57F")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_5B8")
    ...
    QueueWorkItem(0x101, 1, lambda_AD2)
    OP_8C(0x8, 180, 400)
    ...
    QueueWorkItem(0x101, 1, lambda_C62)
    Sleep(500)
    ...
    QueueWorkItem2(0x9, 1, lambda_C7F)
    WaitChrThread(0x101, 0x1)
    ...
    QueueWorkItem(0x101, 2, lambda_D0D)

    def lambda_D25():
        OP_6C(38000, 2000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_D25)
    ...
    def Function_7_DB0(): pass

    label("Function_7_DB0")
    ...
    def Function_8_DCC(): pass

    label("Function_8_DCC")
