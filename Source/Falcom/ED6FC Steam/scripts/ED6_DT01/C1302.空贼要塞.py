...
def main():
    ...
    ScpFunction(
        ...
        "Function_2_382",          # 02, 2
        "Function_3_398",          # 03, 3
        "Function_4_1941",         # 04, 4
        "Function_5_199C",         # 05, 5
    )
    ...
    QueueWorkItem2(0x14, 1, lambda_ACE)
    ...
    QueueWorkItem2(0x13, 1, lambda_ADF)
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    OP_44(0x103, 0xFF)
    OP_44(0x104, 0xFF)
    ...
    QueueWorkItem(0x103, 1, lambda_B00)
    ...
    QueueWorkItem(0x104, 1, lambda_B1C)
    ...
    QueueWorkItem(0x101, 3, lambda_B38)

    def lambda_B50():
        OP_8E(0xFE, 0xFFFFC7AC, 0xFA0, 0xFFFFA060, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_B50)
    Sleep(400)
    ...
    QueueWorkItem(0x11, 1, lambda_B70)
    Sleep(400)
    ...
    QueueWorkItem(0x12, 1, lambda_B90)
    ...
    QueueWorkItem2(0x15, 1, lambda_BAB)
    ...
    QueueWorkItem2(0x16, 1, lambda_BBC)
    ...
    QueueWorkItem2(0x17, 1, lambda_BCD)
    ...
    QueueWorkItem2(0x18, 1, lambda_BDE)
    ...
    QueueWorkItem2(0x19, 1, lambda_BEF)
    ...
    QueueWorkItem2(0x1A, 1, lambda_C00)

    def lambda_C11():
        OP_8E(0xFE, 0xFFFFD058, 0xFA0, 0xFFFFA0A6, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0x15, 2, lambda_C11)
    Sleep(400)
    ...
    QueueWorkItem(0x16, 2, lambda_C31)
    Sleep(400)
    ...
    QueueWorkItem(0x17, 2, lambda_C51)
    Sleep(400)
    ...
    QueueWorkItem(0x18, 2, lambda_C71)
    Sleep(400)
    ...
    QueueWorkItem(0x19, 2, lambda_C91)
    Sleep(400)
    ...
    QueueWorkItem(0x1A, 2, lambda_CB1)
    ...
    QueueWorkItem(0x10, 1, lambda_CD1)
    ...
    QueueWorkItem(0x11, 1, lambda_CE4)
    WaitChrThread(0x10, 0x1)
    ...
    QueueWorkItem(0x12, 1, lambda_CF7)
    ...
    QueueWorkItem2(0x10, 2, lambda_EC8)
    ...
    QueueWorkItem2(0x14, 2, lambda_ED9)
    ...
    QueueWorkItem2(0x13, 2, lambda_EEA)
    ...
    QueueWorkItem2(0x11, 2, lambda_EFB)
    ...
    QueueWorkItem2(0x12, 2, lambda_F0C)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 3, lambda_F5E)
    ...
    QueueWorkItem2(0x101, 2, lambda_F76)
    ...
    QueueWorkItem2(0x102, 2, lambda_F87)
    ...
    QueueWorkItem2(0x103, 2, lambda_F98)
    ...
    QueueWorkItem2(0x104, 2, lambda_FA9)

    def lambda_FBA():
        OP_8E(0xFE, 0xFFFFCAA4, 0xFA0, 0xFFFFB0AA, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_FBA)
    Sleep(100)
    ...
    QueueWorkItem(0x103, 1, lambda_FDA)
    Sleep(100)
    ...
    QueueWorkItem(0x102, 1, lambda_FFF)
    Sleep(100)
    ...
    QueueWorkItem(0x104, 1, lambda_101F)
    WaitChrThread(0x101, 0x3)
    ...
    QueueWorkItem2(0x14, 1, lambda_1442)
    ...
    QueueWorkItem2(0x13, 1, lambda_1453)
    ...
    QueueWorkItem2(0x101, 2, lambda_1464)
    ...
    QueueWorkItem2(0x102, 2, lambda_1475)
    ...
    QueueWorkItem2(0x103, 2, lambda_1486)
    ...
    QueueWorkItem2(0x104, 2, lambda_1497)
    Sleep(500)
    ...
    QueueWorkItem2(0x101, 2, lambda_14F8)
    ...
    QueueWorkItem2(0x102, 2, lambda_1509)
    ...
    QueueWorkItem2(0x103, 2, lambda_151A)
    ...
    QueueWorkItem2(0x104, 2, lambda_152B)
    Sleep(1000)
    ...
    QueueWorkItem(0x101, 3, lambda_1643)
    Sleep(3000)
    OP_63(0x101)
    OP_63(0x102)
    OP_63(0x103)
    ...
    QueueWorkItem(0x103, 1, lambda_17F1)

    def lambda_17FF():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_17FF)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x14E)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1918")
    OP_28(0x13, 0x4, 0x40)
    ...
    def Function_4_1941(): pass

    label("Function_4_1941")
    ...
    def Function_5_199C(): pass

    label("Function_5_199C")
