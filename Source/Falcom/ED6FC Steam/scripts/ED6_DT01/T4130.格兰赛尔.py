...
def main():
    ...
    ScpFunction(
        ...
        "Function_5_C10",          # 05, 5
        "Function_6_C34",          # 06, 6
        "Function_7_19FA",         # 07, 7
        "Function_8_1A1A",         # 08, 8
        "Function_9_2B69",         # 09, 9
        "Function_10_3BAC",        # 0A, 10
        "Function_11_5708",        # 0B, 11
        "Function_12_6CA2",        # 0C, 12
        "Function_13_6EE8",        # 0D, 13
        "Function_14_6F20",        # 0E, 14
        "Function_15_6FC5",        # 0F, 15
    )
    ...
    QueueWorkItem(0x101, 2, lambda_F36)
    ...
    QueueWorkItem(0x102, 1, lambda_F6E)
    ...
    QueueWorkItem(0x101, 1, lambda_F8E)
    WaitChrThread(0x101, 0x1)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC2, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1980")
    ...
    def Function_7_19FA(): pass

    label("Function_7_19FA")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x3, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1A0F")
    OP_99(0xFE, 0x0, 0x7, 0x5DC)
    OP_48()
    Jump("Function_7_19FA")
    ...
    def Function_8_1A1A(): pass

    label("Function_8_1A1A")
    ...
    QueueWorkItem(0x101, 1, lambda_21EC)
    ...
    def Function_10_3BAC(): pass

    label("Function_10_3BAC")
    ...
    QueueWorkItem(0x9, 1, lambda_3C48)
    ...
    QueueWorkItem(0x101, 3, lambda_3CAF)

    def lambda_3CC7():
        OP_6B(2600, 2000)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_3CC7)
    ...
    QueueWorkItem2(0x101, 1, lambda_3CD7)

    def lambda_3CE8():
        OP_8E(0xFE, 0xFFFF18F2, 0x0, 0xFC94, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_3CE8)
    ...
    QueueWorkItem(0x9, 2, lambda_3D17)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_482A")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_4F(0x28, (scpexpr(EXPR_PUSH_LONG, 0x18), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCE, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCE, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCE, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_403D")
    ...
    CloseMessageWindow()
    OP_56(0x0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCE, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_438F")
    OP_A2(0x673)
    ...
    CloseMessageWindow()
    OP_56(0x0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCE, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_459F")
    OP_A2(0x674)
    SetMessageWindowPos(75, 250, -1, -1)
    SetChrName("艾丝蒂尔")
    ...
    CloseMessageWindow()
    OP_56(0x0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCE, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_480A")
    OP_A2(0x675)
    SetMessageWindowPos(75, 250, -1, -1)
    SetChrName("艾丝蒂尔")
    ...
    QueueWorkItem(0x9, 1, lambda_525C)
    ...
    QueueWorkItem(0x9, 1, lambda_53C3)
    ...
    QueueWorkItem2(0x101, 1, lambda_5575)
    ...
    QueueWorkItem2(0x102, 1, lambda_5586)

    def lambda_5597():
        OP_6D(-59840, 0, 65099, 2000)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_5597)
    ...
    QueueWorkItem(0x9, 1, lambda_562A)
    WaitChrThread(0x9, 0x1)
    OP_21()
    OP_1D(0xE)
    ...
    # Function_10_3BAC end

    def Function_11_5708(): pass

    label("Function_11_5708")
    ...
    QueueWorkItem(0xA, 1, lambda_5861)
    ...
    QueueWorkItem2(0xA, 1, lambda_58D3)
    ...
    QueueWorkItem2(0x101, 1, lambda_58E4)
    ...
    QueueWorkItem2(0x102, 1, lambda_58F5)

    def lambda_5906():
        OP_6D(-55080, 0, 62180, 2000)
        ExitThread()

    QueueWorkItem(0x108, 3, lambda_5906)

    def lambda_591E():
        OP_8E(0xFE, 0xFFFF2AF4, 0x0, 0xF532, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_591E)
    Sleep(300)
    ...
    QueueWorkItem(0x102, 2, lambda_593E)
    Sleep(300)
    ...
    QueueWorkItem(0x108, 2, lambda_5972)
    WaitChrThread(0x108, 0x2)
    OP_8C(0x108, 180, 400)
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    OP_44(0x108, 0xFF)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCF, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_5B2A")
    OP_A2(0x67F)
    ...
    QueueWorkItem(0x102, 1, lambda_5C85)
    ...
    QueueWorkItem(0x101, 1, lambda_60C2)

    def lambda_60D0():
        TurnDirection(0xFE, 0xB, 400)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_60D0)
    ...
    QueueWorkItem(0xA, 1, lambda_6186)

    def lambda_6194():
        TurnDirection(0xFE, 0x108, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_6194)
    ...
    QueueWorkItem(0x101, 1, lambda_671F)

    def lambda_672D():
        TurnDirection(0xFE, 0xB, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_672D)
    ...
    QueueWorkItem(0x101, 1, lambda_68E9)

    def lambda_68F7():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_68F7)

    def lambda_6905():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_6905)
    ...
    QueueWorkItem(0x102, 1, lambda_6B64)
    TurnDirection(0x101, 0xB, 400)
    ...
    # Function_11_5708 end

    def Function_12_6CA2(): pass

    label("Function_12_6CA2")
    ...
    QueueWorkItem(0x0, 1, lambda_6D57)
    OP_8C(0x9, 289, 400)
    ...
    # Function_12_6CA2 end

    def Function_13_6EE8(): pass

    label("Function_13_6EE8")
    ...
    # Function_13_6EE8 end

    def Function_14_6F20(): pass

    label("Function_14_6F20")
    ...
    # Function_14_6F20 end

    def Function_15_6FC5(): pass

    label("Function_15_6FC5")
