...
def main():
    ...
    ScpFunction(
        ...
        "Function_3_5F1",          # 03, 3
        "Function_4_8B4",          # 04, 4
        "Function_5_1172",         # 05, 5
        "Function_6_11B8",         # 06, 6
        "Function_7_11FE",         # 07, 7
        "Function_8_1244",         # 08, 8
        "Function_9_128A",         # 09, 9
        "Function_10_12BC",        # 0A, 10
        "Function_11_12EE",        # 0B, 11
        "Function_12_1321",        # 0C, 12
        "Function_13_1354",        # 0D, 13
        "Function_14_1387",        # 0E, 14
        "Function_15_13A6",        # 0F, 15
        "Function_16_13D9",        # 10, 16
        "Function_17_140C",        # 11, 17
        "Function_18_143F",        # 12, 18
        "Function_19_1472",        # 13, 19
        "Function_20_14A5",        # 14, 20
        "Function_21_14D8",        # 15, 21
        "Function_22_1BAC",        # 16, 22
        "Function_23_1CD4",        # 17, 23
        "Function_24_1E35",        # 18, 24
        "Function_25_20E9",        # 19, 25
    )
    ...
    QueueWorkItem(0x8, 1, lambda_814)
    ...
    QueueWorkItem(0x101, 1, lambda_830)
    ...
    def Function_4_8B4(): pass

    label("Function_4_8B4")
    ...
    QueueWorkItem(0xE, 1, lambda_B75)

    def lambda_B83():
        TurnDirection(0xFE, 0x17, 800)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_B83)
    ...
    QueueWorkItem(0x11, 1, lambda_B9F)

    def lambda_BAD():
        TurnDirection(0xFE, 0x17, 800)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_BAD)
    Sleep(100)
    ...
    QueueWorkItem(0x101, 1, lambda_BC0)

    def lambda_BD8():
        OP_6C(315000, 2300)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_BD8)
    Sleep(400)
    ...
    QueueWorkItem(0x101, 3, lambda_C34)
    ...
    QueueWorkItem(0x101, 3, lambda_DCF)
    ...
    QueueWorkItem(0x22, 1, lambda_DF6)

    def lambda_E11():
        OP_8E(0xFE, 0x91AA, 0x0, 0x140, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x23, 1, lambda_E11)

    def lambda_E2C():
        OP_8E(0xFE, 0x91AA, 0x0, 0x140, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x24, 1, lambda_E2C)
    Sleep(100)
    ...
    QueueWorkItem(0x18, 1, lambda_E56)

    def lambda_E71():
        OP_8E(0xFE, 0x91AA, 0x0, 0x140, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x1D, 1, lambda_E71)
    Sleep(100)
    ...
    QueueWorkItem(0x19, 1, lambda_E9B)

    def lambda_EB6():
        OP_8E(0xFE, 0x91AA, 0x0, 0x140, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x1E, 1, lambda_EB6)
    Sleep(100)
    ...
    QueueWorkItem(0x1B, 1, lambda_F55)
    Sleep(100)
    OP_44(0x22, 0xFF)
    OP_44(0x23, 0xFF)
    OP_44(0x24, 0xFF)
    ...
    QueueWorkItem(0x17, 1, lambda_FD5)

    def lambda_FE3():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x18, 1, lambda_FE3)

    def lambda_FF1():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x19, 1, lambda_FF1)

    def lambda_FFF():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1A, 1, lambda_FFF)

    def lambda_100D():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1C, 1, lambda_100D)

    def lambda_101B():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1D, 1, lambda_101B)

    def lambda_1029():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1E, 1, lambda_1029)

    def lambda_1037():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1F, 1, lambda_1037)

    def lambda_1045():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x20, 1, lambda_1045)

    def lambda_1053():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x21, 1, lambda_1053)

    def lambda_1061():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x22, 1, lambda_1061)

    def lambda_106F():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x23, 1, lambda_106F)

    def lambda_107D():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x24, 1, lambda_107D)

    def lambda_108B():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x25, 1, lambda_108B)

    def lambda_1099():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x26, 1, lambda_1099)

    def lambda_10A7():
        OP_67(0, 4650, -10000, 1500)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_10A7)

    def lambda_10BF():
        OP_6C(291000, 1500)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_10BF)
    ...
    def Function_5_1172(): pass

    label("Function_5_1172")
    ...
    QueueWorkItem2(0xFE, 0, lambda_11AA)
    Return()

    # Function_5_1172 end

    def Function_6_11B8(): pass

    label("Function_6_11B8")
    ...
    QueueWorkItem2(0xFE, 0, lambda_11F0)
    Return()
    ...
    QueueWorkItem2(0xFE, 0, lambda_1236)
    Return()

    # Function_7_11FE end

    def Function_8_1244(): pass

    label("Function_8_1244")
    ...
    QueueWorkItem2(0xFE, 0, lambda_127C)
    Return()

    # Function_8_1244 end

    def Function_9_128A(): pass

    label("Function_9_128A")
    ...
    QueueWorkItem2(0xFE, 0, lambda_12AE)
    Return()
    ...
    QueueWorkItem2(0xFE, 0, lambda_12E0)
    Return()

    # Function_10_12BC end

    def Function_11_12EE(): pass

    label("Function_11_12EE")
    ...
    # Function_11_12EE end

    def Function_12_1321(): pass

    label("Function_12_1321")
    ...
    # Function_12_1321 end

    def Function_13_1354(): pass

    label("Function_13_1354")
    ...
    # Function_13_1354 end

    def Function_14_1387(): pass

    label("Function_14_1387")
    ...
    # Function_14_1387 end

    def Function_15_13A6(): pass

    label("Function_15_13A6")
    ...
    # Function_15_13A6 end

    def Function_16_13D9(): pass

    label("Function_16_13D9")
    ...
    # Function_16_13D9 end

    def Function_17_140C(): pass

    label("Function_17_140C")
    ...
    # Function_17_140C end

    def Function_18_143F(): pass

    label("Function_18_143F")
    ...
    # Function_18_143F end

    def Function_19_1472(): pass

    label("Function_19_1472")
    ...
    # Function_19_1472 end

    def Function_20_14A5(): pass

    label("Function_20_14A5")
    ...
    # Function_20_14A5 end

    def Function_21_14D8(): pass

    label("Function_21_14D8")
    ...
    QueueWorkItem(0x101, 1, lambda_17D2)

    def lambda_17EA():
        OP_8E(0xFE, 0xB522, 0xC8, 0x442, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x27, 1, lambda_17EA)
    ...
    QueueWorkItem2(0x101, 1, lambda_1AAC)
    ...
    QueueWorkItem2(0x105, 1, lambda_1ABD)
    ...
    QueueWorkItem2(0x103, 1, lambda_1ACE)
    ...
    # Function_21_14D8 end

    def Function_22_1BAC(): pass

    label("Function_22_1BAC")

    TalkBegin(0x27)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 7)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_1C50")
    ...
    OP_5F(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1C26")
    OP_0D()
    OP_A9(0x6C)
    OP_56(0x0)
    TalkEnd(0x27)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1C3F")
    OP_0D()
    OP_A9(0x6D)
    OP_56(0x0)
    TalkEnd(0x27)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1C50")
    TalkEnd(0x27)
    Return()
    ...
    # Function_22_1BAC end

    def Function_23_1CD4(): pass

    label("Function_23_1CD4")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 7)), scpexpr(EXPR_END)), "loc_1CDC")
    Return()
    ...
    # Function_23_1CD4 end

    def Function_24_1E35(): pass

    label("Function_24_1E35")
    ...
    # Function_24_1E35 end

    def Function_25_20E9(): pass

    label("Function_25_20E9")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_224A")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2178")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_21DD")
