...
def main():
    ...
    ScpFunction(
        ...
        "Function_11_3A90",        # 0B, 11
        "Function_12_3E30",        # 0C, 12
        "Function_13_4641",        # 0D, 13
        "Function_14_4F65",        # 0E, 14
        "Function_15_5269",        # 0F, 15
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x68, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_3A8F")
    ClearMapFlags(0x1)
    EventBegin(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x68, 4)), scpexpr(EXPR_END)), "loc_3A40")
    ...
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_3A23")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x2), scpexpr(EXPR_PUSH_LONG, 0xA), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3968")
    Jump("loc_3A23")
    ...
    OP_56(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3A1B")
    Jump("loc_3A23")
    ...
    def Function_11_3A90(): pass

    label("Function_11_3A90")
    ...
    QueueWorkItem(0x0, 1, lambda_3B05)

    def lambda_3B1D():
        OP_6B(2800, 5000)
        ExitThread()

    QueueWorkItem(0x1, 2, lambda_3B1D)

    def lambda_3B2D():
        OP_6C(315000, 5000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_3B2D)

    def lambda_3B3D():
        OP_67(0, 11000, -10000, 5000)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_3B3D)
    Sleep(5000)
    ...
    QueueWorkItem(0x101, 1, lambda_3BD6)

    def lambda_3BEE():
        OP_67(0, 4400, -10000, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_3BEE)

    def lambda_3C06():
        OP_6B(3600, 2000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_3C06)
    WaitChrThread(0x101, 0x1)
    ...
    QueueWorkItem(0x101, 1, lambda_3C2E)

    def lambda_3C46():
        OP_67(0, 9500, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_3C46)

    def lambda_3C5E():
        OP_6B(2800, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_3C5E)
    ...
    # Function_11_3A90 end

    def Function_12_3E30(): pass

    label("Function_12_3E30")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x68, 5)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_4640")
    EventBegin(0x0)
    AddParty(0x1, 0xFF)
    ...
    QueueWorkItem(0x101, 1, lambda_3E7B)
    ...
    QueueWorkItem(0x101, 1, lambda_3F3B)
    TurnDirection(0x102, 0x101, 400)
    ...
    QueueWorkItem(0x101, 1, lambda_42BC)
    ...
    QueueWorkItem(0x0, 1, lambda_44E9)

    def lambda_44F7():
        OP_6B(2600, 1500)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_44F7)
    ...
    QueueWorkItem2(0x102, 1, lambda_4556)
    Sleep(500)
    OP_1D(0x46)
    Sleep(5000)
    ...
    # Function_12_3E30 end

    def Function_13_4641(): pass

    label("Function_13_4641")
    ...
    QueueWorkItem2(0x102, 1, lambda_4684)
    ...
    QueueWorkItem(0x101, 2, lambda_4997)
    ...
    # Function_13_4641 end

    def Function_14_4F65(): pass

    label("Function_14_4F65")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_5268")
    ClearMapFlags(0x1)
    EventBegin(0x0)
    OP_A2(0x34D)
    OP_62(0x101, 0x0, 2000, 0x26, 0x26, 0xFA, 0x1)
    ...
    QueueWorkItem(0x101, 1, lambda_4FAF)

    def lambda_4FBD():
        OP_6C(45000, 1500)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_4FBD)
    ...
    # Function_14_4F65 end

    def Function_15_5269(): pass

    label("Function_15_5269")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x67, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x68, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_52E8")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_52A3")
    OP_A2(0x3)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x68, 5)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_5350")
    EventBegin(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x69, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_5407")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_53C3")
    TurnDirection(0x102, 0x101, 400)
