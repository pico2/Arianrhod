...
def main():
    ...
    ScpFunction(
        ...
        "Function_4_55A",          # 04, 4
        "Function_5_B88",          # 05, 5
        "Function_6_10C2",         # 06, 6
        "Function_7_2378",         # 07, 7
        "Function_8_2DBE",         # 08, 8
        "Function_9_3239",         # 09, 9
        "Function_10_32F0",        # 0A, 10
        "Function_11_3EDA",        # 0B, 11
    )
    ...
    def Function_3_4FD(): pass

    label("Function_3_4FD")
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_679")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_5D9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 2)), scpexpr(EXPR_END)), "loc_683")
    Jump("loc_B84")

    label("loc_683")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC9, 1)), scpexpr(EXPR_END)), "loc_6B0")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC6, 7)), scpexpr(EXPR_END)), "loc_70E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 7)), scpexpr(EXPR_END)), "loc_778")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 6)), scpexpr(EXPR_END)), "loc_85D")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_7E1")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 1)), scpexpr(EXPR_END)), "loc_8CC")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 6)), scpexpr(EXPR_END)), "loc_9C9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 1)), scpexpr(EXPR_END)), "loc_A73")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC2, 0)), scpexpr(EXPR_END)), "loc_ADE")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC1, 0)), scpexpr(EXPR_END)), "loc_B84")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC1, 3)), scpexpr(EXPR_END)), "loc_B49")
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_C08")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 2)), scpexpr(EXPR_END)), "loc_C12")
    Jump("loc_10BE")

    label("loc_C12")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC9, 1)), scpexpr(EXPR_END)), "loc_C7F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC6, 7)), scpexpr(EXPR_END)), "loc_CA9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 7)), scpexpr(EXPR_END)), "loc_D0D")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 6)), scpexpr(EXPR_END)), "loc_D69")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 6)), scpexpr(EXPR_END)), "loc_E3E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 1)), scpexpr(EXPR_END)), "loc_F4E")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_EB4")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC2, 0)), scpexpr(EXPR_END)), "loc_105A")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_FCB")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC1, 0)), scpexpr(EXPR_END)), "loc_10BE")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC1, 3)), scpexpr(EXPR_END)), "loc_10A6")
    ...
    def Function_6_10C2(): pass

    label("Function_6_10C2")
    ...
    QueueWorkItem(0x101, 1, lambda_10D3)
    ...
    QueueWorkItem(0x102, 1, lambda_1103)

    def lambda_1113():
        OP_6C(0, 15000)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_1113)
    Sleep(12000)
    ...
    QueueWorkItem(0x102, 2, lambda_114A)

    def lambda_1162():
        OP_6B(7180, 5000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1162)

    def lambda_1172():
        OP_6E(262, 5000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_1172)

    def lambda_1182():
        OP_8E(0xFE, 0xFFFFFD62, 0x0, 0x4808, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_1182)

    def lambda_119D():
        OP_8E(0xFE, 0x51E, 0x0, 0x4808, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_119D)
    ...
    QueueWorkItem(0x101, 2, lambda_13D5)
    OP_6B(5100, 4000)
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    ...
    QueueWorkItem2(0x8, 1, lambda_1453)
    ...
    QueueWorkItem2(0x9, 1, lambda_147B)

    def lambda_148C():
        OP_8E(0xFE, 0xFFFFFCAE, 0x0, 0x9290, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_148C)

    def lambda_14A7():
        OP_8E(0xFE, 0x316, 0x0, 0x9290, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_14A7)
    ...
    QueueWorkItem(0x101, 1, lambda_1C58)

    def lambda_1C70():
        OP_6B(3800, 3000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1C70)

    def lambda_1C80():
        OP_6C(0, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_1C80)
    Sleep(100)
    ...
    QueueWorkItem(0x8, 2, lambda_1C95)

    def lambda_1CB0():
        OP_8F(0xFE, 0x802, 0x0, 0xA4A6, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 2, lambda_1CB0)
    ...
    QueueWorkItem2(0x101, 1, lambda_1CDC)
    ...
    QueueWorkItem2(0x102, 1, lambda_1CED)
    ...
    QueueWorkItem2(0x9, 1, lambda_1CFE)
    ...
    QueueWorkItem2(0x8, 1, lambda_1D0F)
    ...
    QueueWorkItem(0xA, 1, lambda_1D5A)
    Sleep(500)
    ...
    QueueWorkItem(0xB, 1, lambda_1D7A)
    ...
    QueueWorkItem(0xA, 1, lambda_1F78)
    Sleep(500)
    ...
    QueueWorkItem(0xB, 1, lambda_1F98)
    ...
    QueueWorkItem(0x8, 1, lambda_1FF2)

    def lambda_200D():
        OP_8F(0xFE, 0x3B6, 0x0, 0xA3FC, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_200D)
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    ...
    QueueWorkItem(0x101, 1, lambda_2189)
    TurnDirection(0x102, 0x9, 400)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 0)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC6, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_2385")
    Return()
    ...
    QueueWorkItem(0x101, 1, lambda_238D)

    def lambda_239B():
        TurnDirection(0xFE, 0x108, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_239B)
    ...
    QueueWorkItem(0x101, 1, lambda_2536)

    def lambda_2544():
        OP_8C(0xFE, 0, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_2544)

    def lambda_2552():
        OP_8C(0xFE, 0, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_2552)

    def lambda_2560():
        OP_67(0, 5220, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_2560)

    def lambda_2578():
        OP_6E(287, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_2578)
    ...
    QueueWorkItem(0x102, 1, lambda_25EC)
    OP_62(0x8, 0x0, 2000, 0x2, 0x7, 0x50, 0x1)
    OP_22(0x27, 0x0, 0x64)
    OP_62(0x9, 0x0, 2000, 0x2, 0x7, 0x50, 0x1)
    OP_22(0x27, 0x0, 0x64)
    ...
    QueueWorkItem(0x101, 2, lambda_2AA4)

    def lambda_2AB4():
        OP_6E(438, 3000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_2AB4)
    ...
    QueueWorkItem(0x101, 3, lambda_2B32)

    def lambda_2B4A():
        OP_8E(0x8, 0xFFFFF8D0, 0x2EE, 0xB004, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_2B4A)
    ...
    def Function_8_2DBE(): pass

    label("Function_8_2DBE")
    ...
    QueueWorkItem(0xC, 1, lambda_2E4D)

    def lambda_2E5B():
        OP_8C(0xFE, 0, 400)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_2E5B)
    ...
    QueueWorkItem(0xC, 1, lambda_2EEB)

    def lambda_2EF9():
        OP_8C(0xFE, 180, 400)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_2EF9)
    ...
    QueueWorkItem(0x12, 1, lambda_309B)

    def lambda_30B6():
        OP_8E(0xFE, 0xFFFFFF06, 0x0, 0x180D8, 0x2328, 0x0)
        ExitThread()

    QueueWorkItem(0x13, 1, lambda_30B6)

    def lambda_30D1():
        OP_8E(0xFE, 0xFFFFFF06, 0x0, 0x180D8, 0x1F40, 0x0)
        ExitThread()

    QueueWorkItem(0x14, 1, lambda_30D1)

    def lambda_30EC():
        OP_8E(0xFE, 0xFFFFFF06, 0x0, 0x180D8, 0x1D4C, 0x0)
        ExitThread()

    QueueWorkItem(0x15, 1, lambda_30EC)

    def lambda_3107():
        OP_8E(0xFE, 0xFFFFFF06, 0x0, 0x180D8, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x16, 1, lambda_3107)

    def lambda_3122():
        OP_8E(0xFE, 0xFFFFFF06, 0x0, 0x180D8, 0x2328, 0x0)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_3122)

    def lambda_313D():
        OP_8E(0xFE, 0xFFFFFF06, 0x0, 0x180D8, 0x2328, 0x0)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_313D)

    def lambda_3158():
        OP_8E(0xFE, 0xFFFFFF06, 0x0, 0x180D8, 0x1F40, 0x0)
        ExitThread()

    QueueWorkItem(0x17, 1, lambda_3158)
    ...
    QueueWorkItem(0x19, 1, lambda_318E)

    def lambda_31A9():
        OP_8E(0xFE, 0xFFFFFF06, 0x0, 0x180D8, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 1, lambda_31A9)

    def lambda_31C4():
        OP_8E(0xFE, 0xFFFFFF06, 0x0, 0x180D8, 0x2328, 0x0)
        ExitThread()

    QueueWorkItem(0xE, 1, lambda_31C4)

    def lambda_31DF():
        OP_8E(0xFE, 0xFFFFFF06, 0x0, 0x180D8, 0x2328, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_31DF)

    def lambda_31FA():
        OP_6D(-390, 0, 29050, 5000)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_31FA)

    def lambda_3212():
        OP_6C(44000, 5000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_3212)
    Sleep(1500)
    FadeToDark(2000, 0, -1)
    OP_0D()
    OP_A2(0x3FA)
    ...
    def Function_9_3239(): pass

    label("Function_9_3239")
    ...
    QueueWorkItem(0x0, 1, lambda_32B1)

    def lambda_32C9():
        OP_6C(0, 4000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_32C9)
    Sleep(2000)
    FadeToDark(2000, 0, -1)
    OP_0D()
    OP_A2(0x3FC)
    ...
    def Function_10_32F0(): pass

    label("Function_10_32F0")
    ...
    QueueWorkItem(0x101, 2, lambda_336B)

    def lambda_337B():
        OP_91(0xFE, 0xFFFFF272, 0x0, 0xA1D6, 0x320, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_337B)

    def lambda_3396():
        OP_90(0xFE, 0xFFFFF272, 0x0, 0xA1D6, 0x320, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_3396)

    def lambda_33B1():
        OP_90(0xFE, 0xFFFFF272, 0x0, 0xA1D6, 0x320, 0x0)
        ExitThread()

    QueueWorkItem(0x1B, 1, lambda_33B1)
    Sleep(1000)
    ...
    QueueWorkItem(0x101, 0, lambda_36D5)
    ...
    QueueWorkItem(0x101, 0, lambda_3839)
    ...
    QueueWorkItem(0x102, 2, lambda_396D)
    ClearMapFlags(0x1)
    OP_69(0x101, 0x3E8)
    ...
    QueueWorkItem2(0x101, 1, lambda_3D64)
    ...
    QueueWorkItem2(0x102, 1, lambda_3D75)
    ...
    # Function_10_32F0 end

    def Function_11_3EDA(): pass

    label("Function_11_3EDA")
