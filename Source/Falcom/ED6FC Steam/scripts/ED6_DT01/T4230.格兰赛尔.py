...
def main():
    ...
    ScpFunction(
        ...
        "Function_6_687",          # 06, 6
        "Function_7_B14",          # 07, 7
        "Function_8_3261",         # 08, 8
        "Function_9_49BE",         # 09, 9
        "Function_10_4AC4",        # 0A, 10
        "Function_11_4ACF",        # 0B, 11
    )
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 7)), scpexpr(EXPR_END)), "loc_578")
    Jump("loc_683")

    label("loc_578")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_65E")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_5D7")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 6)), scpexpr(EXPR_END)), "loc_668")
    Jump("loc_683")

    label("loc_668")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_END)), "loc_672")
    Jump("loc_683")

    label("loc_672")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 0)), scpexpr(EXPR_END)), "loc_67C")
    Jump("loc_683")

    label("loc_67C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_683")
    ...
    def Function_6_687(): pass

    label("Function_6_687")
    ...
    QueueWorkItem(0x138, 2, lambda_703)

    def lambda_715():
        OP_8E(0xFE, 0xFFFFFFA6, 0x0, 0x564, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x138, 1, lambda_715)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 2, lambda_735)

    def lambda_747():
        OP_8E(0xFE, 0xFFFFFBF0, 0x0, 0xFFFFFE5C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_747)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 2, lambda_767)

    def lambda_779():
        OP_8E(0xFE, 0x2EE, 0x0, 0xFFFFFE5C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_779)
    ...
    def Function_7_B14(): pass

    label("Function_7_B14")
    ...
    QueueWorkItem(0x101, 2, lambda_CFB)

    def lambda_D13():
        OP_6C(12000, 8000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_D13)

    def lambda_D23():
        OP_67(0, 4200, -10000, 8000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_D23)

    def lambda_D3B():
        OP_6E(317, 8000)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_D3B)
    Sleep(6000)
    ...
    QueueWorkItem(0x101, 1, lambda_D50)

    def lambda_D6B():
        OP_8E(0xFE, 0xFFFE797E, 0x0, 0x3AC0, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_D6B)
    Sleep(2000)
    ...
    QueueWorkItem(0x101, 1, lambda_30E5)
    TurnDirection(0x101, 0x138, 400)
    ...
    QueueWorkItem(0x138, 2, lambda_310F)

    def lambda_3121():
        OP_8E(0xFE, 0xFFFF34A4, 0x0, 0xF96, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x138, 1, lambda_3121)
    ...
    QueueWorkItem2(0x101, 1, lambda_313C)
    ...
    def Function_8_3261(): pass

    label("Function_8_3261")
    ...
    QueueWorkItem(0x101, 2, lambda_39D7)
    ...
    QueueWorkItem(0x103, 1, lambda_3A0F)
    Sleep(50)
    ...
    QueueWorkItem(0x105, 1, lambda_3A2F)
    Sleep(500)
    OP_44(0x101, 0xFF)
    OP_44(0x103, 0xFF)
    OP_44(0x105, 0xFF)
    ...
    SetChrFlags(0xD, 0x800)
    SetChrFlags(0xE, 0x800)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3B30")
    ...
    QueueWorkItem(0x101, 3, lambda_3BEA)
    ...
    QueueWorkItem(0x103, 1, lambda_3C15)
    Sleep(50)
    ...
    QueueWorkItem(0x105, 1, lambda_3C28)
    ...
    QueueWorkItem(0x9, 1, lambda_3D66)
    ...
    QueueWorkItem(0x9, 1, lambda_3DA2)
    ...
    QueueWorkItem(0x9, 1, lambda_3DC7)
    ...
    QueueWorkItem(0x101, 3, lambda_3E7B)

    def lambda_3E93():
        OP_8E(0xFE, 0xFFFFE94E, 0x0, 0x245E, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_3E93)
    Sleep(200)
    ...
    QueueWorkItem(0x103, 2, lambda_3EB3)
    Sleep(200)
    ...
    QueueWorkItem(0x105, 2, lambda_3ED3)
    ...
    QueueWorkItem2(0x101, 1, lambda_3EEE)
    ...
    QueueWorkItem2(0x103, 1, lambda_3EFF)
    ...
    QueueWorkItem2(0x105, 1, lambda_3F10)
    ...
    QueueWorkItem(0x101, 1, lambda_402D)

    def lambda_403B():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_403B)

    def lambda_4049():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_4049)

    def lambda_4057():
        OP_8E(0xA, 0xFFFFE73C, 0x0, 0x1C7A, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_4057)
    ...
    QueueWorkItem2(0x101, 1, lambda_4088)
    ...
    QueueWorkItem2(0x103, 1, lambda_4099)
    ...
    QueueWorkItem2(0x105, 1, lambda_40AA)

    def lambda_40BB():
        OP_6D(-5850, 0, 8290, 1500)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_40BB)
    ...
    QueueWorkItem2(0x101, 1, lambda_4406)
    ...
    QueueWorkItem2(0x103, 1, lambda_4417)
    ...
    QueueWorkItem2(0x105, 1, lambda_4428)
    FadeToBright(1000, 0)
    OP_0D()
    ...
    QueueWorkItem(0x103, 1, lambda_4591)

    def lambda_459F():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_459F)

    def lambda_45AD():
        OP_8E(0xA, 0xFFFFE73C, 0x0, 0x1C7A, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_45AD)
    OP_6D(-2009, 0, 6520, 1000)
    Sleep(200)
    ...
    QueueWorkItem2(0x101, 1, lambda_45DE)
    ...
    QueueWorkItem2(0x103, 1, lambda_45EF)
    ...
    QueueWorkItem2(0x105, 1, lambda_4600)

    def lambda_4611():
        OP_6D(-5850, 0, 8290, 1500)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_4611)
    WaitChrThread(0xA, 0x1)
    TurnDirection(0xA, 0x9, 800)
    WaitChrThread(0x101, 0x3)
    ...
    def Function_9_49BE(): pass

    label("Function_9_49BE")
    ...
    def Function_10_4AC4(): pass

    label("Function_10_4AC4")

    ClearMapFlags(0x2000000)
    OP_1B(0x5, 0x0, 0xFFFF)
    Return()

    # Function_10_4AC4 end

    def Function_11_4ACF(): pass

    label("Function_11_4ACF")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_4B3A")
    EventBegin(0x1)
