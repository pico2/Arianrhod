...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x62, 2)), scpexpr(EXPR_EXEC_OP, "OP_29(0xF, 0x0, 0x40)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_EXEC_OP, "OP_29(0xF, 0x1, 0x4)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_BE8")
    EventBegin(0x0)
    ...
    QueueWorkItem(0x8, 1, lambda_352)
    OP_0D()
    ...
    QueueWorkItem(0x9, 1, lambda_4C6)

    def lambda_4E1():
        OP_8E(0xA, 0x4F6, 0x0, 0x1266, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_4E1)
    ...
    QueueWorkItem(0x101, 1, lambda_561)

    def lambda_57C():
        OP_90(0x102, 0x0, 0x0, 0xFFFFEC78, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_57C)

    def lambda_597():
        OP_90(0x103, 0x0, 0x0, 0xFFFFEC78, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_597)
    ...
    QueueWorkItem(0x0, 1, lambda_66C)

    def lambda_67C():
        OP_6D(-720, 0, 5910, 3000)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_67C)

    def lambda_694():
        OP_6B(2600, 3000)
        ExitThread()

    QueueWorkItem(0x2, 1, lambda_694)
    OP_0D()
    ...
    QueueWorkItem(0x102, 1, lambda_A65)
    Sleep(400)
    ...
    QueueWorkItem(0x101, 1, lambda_B90)

    def lambda_BA5():
        OP_92(0x102, 0x103, 0x0, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_BA5)

    def lambda_BBA():
        OP_92(0x10E, 0x103, 0x0, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x10E, 1, lambda_BBA)
    OP_69(0x103, 0x578)
    ...
    def Function_6_CBD(): pass

    label("Function_6_CBD")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x70, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_E67")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x70, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D99")
    ...
    QueueWorkItem(0xB, 1, lambda_D0C)

    def lambda_D27():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x4B0)
        ExitThread()

    QueueWorkItem(0xB, 2, lambda_D27)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0xF8, 1)"), scpexpr(EXPR_END)), "loc_DEF")
    ...
    def Function_7_EA8(): pass

    label("Function_7_EA8")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x70, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1058")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x70, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_F84")
    ...
    QueueWorkItem(0xC, 1, lambda_EF7)

    def lambda_F12():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x4B0)
        ExitThread()

    QueueWorkItem(0xC, 2, lambda_F12)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x144, 1)"), scpexpr(EXPR_END)), "loc_FDC")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
