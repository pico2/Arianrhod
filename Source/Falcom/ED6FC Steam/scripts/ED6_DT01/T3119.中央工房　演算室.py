...
def main():
    ...
    ScpFunction(
        ...
        "Function_6_1507",         # 06, 6
        "Function_7_151D",         # 07, 7
        "Function_8_1E3E",         # 08, 8
        "Function_9_368B",         # 09, 9
        "Function_10_3EC4",        # 0A, 10
        "Function_11_3F2D",        # 0B, 11
    )
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 1)), scpexpr(EXPR_END)), "loc_710")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_END)), "loc_640")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_7D3")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAA, 0)), scpexpr(EXPR_END)), "loc_872")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 6)), scpexpr(EXPR_END)), "loc_90F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 3)), scpexpr(EXPR_END)), "loc_964")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 1)), scpexpr(EXPR_END)), "loc_A67")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_END)), "loc_9E4")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA1, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_AD4")
    ...
    def Function_4_AD8(): pass

    label("Function_4_AD8")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 1)), scpexpr(EXPR_END)), "loc_C39")
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_B50")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 5)), scpexpr(EXPR_END)), "loc_D02")
    TalkBegin(0xFE)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_D3B")
    TalkBegin(0xFE)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAA, 0)), scpexpr(EXPR_END)), "loc_DF0")
    TalkBegin(0xFE)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 6)), scpexpr(EXPR_END)), "loc_E64")
    TalkBegin(0xFE)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 2)), scpexpr(EXPR_END)), "loc_F47")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x2C, 0x0, 0x8)"), scpexpr(EXPR_EXEC_OP, "OP_29(0x2C, 0x0, 0x10)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_F13")
    SetMapFlags(0x80)
    ...
    OP_5F(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_EDF")
    Call(1, 2)
    Return()
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 3)), scpexpr(EXPR_END)), "loc_106A")
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_F9A")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 1)), scpexpr(EXPR_END)), "loc_11F9")
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_111F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA1, 6)), scpexpr(EXPR_END)), "loc_13DB")
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_125C")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_END)), "loc_148A")
    TalkBegin(0xFE)
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_END)), "loc_1503")
    ...
    def Function_6_1507(): pass

    label("Function_6_1507")
    ...
    def Function_7_151D(): pass

    label("Function_7_151D")
    ...
    QueueWorkItem(0x8, 2, lambda_1975)

    def lambda_198D():
        OP_8E(0xFE, 0x1D6, 0x0, 0x19E6, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_198D)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_19CD)
    ...
    def Function_8_1E3E(): pass

    label("Function_8_1E3E")

    ClearMapFlags(0x1)
    EventBegin(0x0)
    OP_6D(-200, 0, 7100, 1000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 1)), scpexpr(EXPR_END)), "loc_1F8B")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1F48")
    OP_A2(0x533)
    OP_28(0x41, 0x1, 0x8)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_331A")
    OP_4F(0x28, (scpexpr(EXPR_PUSH_LONG, 0x18), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Switch(
        (scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_END)),
        (0, "loc_20CA"),
        (SWITCH_DEFAULT, "loc_330A"),
    )


    label("loc_20CA")

    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_32FA")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_2FC5")
    RunExpression(0x0, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x28, 0x1, 0x1)"), scpexpr(EXPR_END)), "loc_32C7")
    OP_28(0x29, 0x1, 0x8)
    ...
    OP_56(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_3688")
    OP_A2(0x516)
    OP_4A(0x8, 255)
    ...
    def Function_9_368B(): pass

    label("Function_9_368B")
    ...
    QueueWorkItem(0x101, 2, lambda_3905)

    def lambda_391D():
        OP_8E(0xFE, 0xFFFE3EB4, 0x0, 0xFFFFFB50, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x106, 1, lambda_391D)
    Sleep(400)
    ...
    QueueWorkItem(0x101, 1, lambda_393D)
    Sleep(200)
    ...
    QueueWorkItem(0x102, 1, lambda_395D)
    Sleep(100)
    ...
    QueueWorkItem(0x107, 1, lambda_397D)
    Sleep(800)
    ...
    QueueWorkItem(0x102, 3, lambda_399D)

    def lambda_39B5():
        OP_67(0, 3630, -10000, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_39B5)

    def lambda_39CD():
        OP_6B(3490, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_39CD)

    def lambda_39DD():
        OP_6C(21000, 2000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_39DD)
    ...
    QueueWorkItem(0x106, 1, lambda_39F2)
    WaitChrThread(0x106, 0x1)
    ...
    QueueWorkItem(0x106, 1, lambda_3A12)
    ...
    QueueWorkItem(0x101, 1, lambda_3A32)
    WaitChrThread(0x102, 0x1)
    ...
    QueueWorkItem(0x102, 1, lambda_3A52)
    ...
    QueueWorkItem(0x107, 1, lambda_3A72)
    WaitChrThread(0x107, 0x1)
    ...
    QueueWorkItem(0xE, 1, lambda_3AA9)

    def lambda_3AB7():
        TurnDirection(0x9, 0x106, 800)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_3AB7)

    def lambda_3AC5():
        TurnDirection(0xA, 0x106, 800)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_3AC5)
    ...
    QueueWorkItem(0xB, 2, lambda_3B84)
    Sleep(500)
    ...
    QueueWorkItem(0xA, 2, lambda_3BA4)

    def lambda_3BBF():
        OP_8F(0xFE, 0xFFFE32FC, 0x0, 0x576C, 0x3E8, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 2, lambda_3BBF)
    Sleep(50)
    ...
    QueueWorkItem(0xE, 2, lambda_3BDF)
    ...
    QueueWorkItem2(0xA, 1, lambda_3BFA)
    ...
    QueueWorkItem2(0xB, 1, lambda_3C0B)
    ...
    QueueWorkItem2(0x9, 1, lambda_3C1C)
    ...
    QueueWorkItem(0x9, 2, lambda_3C42)

    def lambda_3C5D():
        OP_6D(-118050, 0, 23420, 1000)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_3C5D)

    def lambda_3C75():
        OP_8E(0xFE, 0xFFFE3284, 0x0, 0x5A1E, 0x1F40, 0x0)
        ExitThread()

    QueueWorkItem(0x106, 1, lambda_3C75)
    ...
    QueueWorkItem(0x101, 1, lambda_3CB5)
    Sleep(200)
    ...
    QueueWorkItem(0x102, 2, lambda_3CD5)
    Sleep(500)
    ...
    QueueWorkItem(0x107, 1, lambda_3CF5)
    Sleep(100)
    OP_70(0x8, 0x0)
    WaitChrThread(0x106, 0x1)
    Fade(500)
    ...
    def Function_10_3EC4(): pass

    label("Function_10_3EC4")
    ...
    # Function_10_3EC4 end

    def Function_11_3F2D(): pass

    label("Function_11_3F2D")

    SetPlaceName(0x9A) # 中央工房　演算室
    Return()

    # Function_11_3F2D end
