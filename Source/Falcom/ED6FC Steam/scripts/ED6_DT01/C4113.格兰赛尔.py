...
def main():
    ...
    ScpFunction(
        ...
        "Function_2_646",          # 02, 2
        "Function_3_A96",          # 03, 3
        "Function_4_1615",         # 04, 4
        "Function_5_1648",         # 05, 5
        "Function_6_168E",         # 06, 6
        "Function_7_16D4",         # 07, 7
        "Function_8_171A",         # 08, 8
        "Function_9_174C",         # 09, 9
        "Function_10_177E",        # 0A, 10
        "Function_11_17B1",        # 0B, 11
        "Function_12_17E4",        # 0C, 12
        "Function_13_1817",        # 0D, 13
        "Function_14_1836",        # 0E, 14
        "Function_15_1869",        # 0F, 15
        "Function_16_189C",        # 10, 16
        "Function_17_18CF",        # 11, 17
        "Function_18_1902",        # 12, 18
        "Function_19_1935",        # 13, 19
        "Function_20_1968",        # 14, 20
        "Function_21_1F2F",        # 15, 21
        "Function_22_204B",        # 16, 22
        "Function_23_22B4",        # 17, 23
    )
    ...
    QueueWorkItem(0x8, 1, lambda_8DE)

    def lambda_8EC():
        TurnDirection(0xFE, 0xE, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_8EC)
    ...
    QueueWorkItem(0x101, 1, lambda_90A)

    def lambda_922():
        OP_6C(315000, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_922)
    Sleep(500)
    OP_1D(0x59)
    ...
    QueueWorkItem(0xE, 1, lambda_9DA)

    def lambda_9F0():
        OP_6D(24930, 0, 1380, 1500)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_9F0)
    Sleep(200)
    ...
    QueueWorkItem(0xF, 1, lambda_A21)
    Sleep(50)
    ...
    QueueWorkItem(0x10, 1, lambda_A3B)
    Sleep(50)
    ...
    QueueWorkItem(0x11, 1, lambda_A55)
    Sleep(50)
    ...
    QueueWorkItem(0x12, 1, lambda_A6F)
    FadeToDark(1000, 0, -1)
    OP_0D()
    OP_A2(0x3FA)
    ...
    def Function_3_A96(): pass

    label("Function_3_A96")
    ...
    QueueWorkItem(0xE, 1, lambda_DAF)

    def lambda_DBD():
        TurnDirection(0xFE, 0x17, 800)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_DBD)
    ...
    QueueWorkItem(0x11, 1, lambda_DD9)

    def lambda_DE7():
        TurnDirection(0xFE, 0x17, 800)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_DE7)
    Sleep(100)
    ...
    QueueWorkItem(0x101, 2, lambda_E12)
    Sleep(400)
    ...
    QueueWorkItem(0x101, 1, lambda_E56)

    def lambda_E6E():
        OP_67(0, 6710, -10000, 4000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_E6E)
    ...
    QueueWorkItem(0x101, 3, lambda_FF4)
    ...
    QueueWorkItem(0x22, 1, lambda_1090)

    def lambda_10AB():
        OP_8E(0xFE, 0x91AA, 0x0, 0x140, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x23, 1, lambda_10AB)

    def lambda_10C6():
        OP_8E(0xFE, 0x91AA, 0x0, 0x140, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x24, 1, lambda_10C6)
    Sleep(100)
    ...
    QueueWorkItem(0x18, 1, lambda_10F0)

    def lambda_110B():
        OP_8E(0xFE, 0x91AA, 0x0, 0x140, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x1D, 1, lambda_110B)
    Sleep(100)
    ...
    QueueWorkItem(0x19, 1, lambda_1135)

    def lambda_1150():
        OP_8E(0xFE, 0x91AA, 0x0, 0x140, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x1E, 1, lambda_1150)
    ...
    QueueWorkItem(0x17, 1, lambda_120A)

    def lambda_1218():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x18, 1, lambda_1218)

    def lambda_1226():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x19, 1, lambda_1226)

    def lambda_1234():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1A, 1, lambda_1234)

    def lambda_1242():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1B, 1, lambda_1242)

    def lambda_1250():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1C, 1, lambda_1250)

    def lambda_125E():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1D, 1, lambda_125E)

    def lambda_126C():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1E, 1, lambda_126C)

    def lambda_127A():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x1F, 1, lambda_127A)

    def lambda_1288():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x20, 1, lambda_1288)

    def lambda_1296():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x21, 1, lambda_1296)

    def lambda_12A4():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x22, 1, lambda_12A4)

    def lambda_12B2():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x23, 1, lambda_12B2)

    def lambda_12C0():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x24, 1, lambda_12C0)

    def lambda_12CE():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x25, 1, lambda_12CE)

    def lambda_12DC():
        TurnDirection(0xFE, 0xA, 800)
        ExitThread()

    QueueWorkItem(0x26, 1, lambda_12DC)
    ...
    QueueWorkItem2(0x22, 0, lambda_12EA)
    ...
    QueueWorkItem2(0x23, 0, lambda_12FD)
    ...
    QueueWorkItem2(0x24, 0, lambda_1310)

    def lambda_1323():
        OP_67(0, 4650, -10000, 1500)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_1323)

    def lambda_133B():
        OP_6C(291000, 1500)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_133B)
    ...
    QueueWorkItem(0x1B, 2, lambda_1413)

    def lambda_142E():
        OP_8F(0x1F, 0x50D2, 0x0, 0x46A, 0x2AF8, 0x0)
        ExitThread()

    QueueWorkItem(0x1F, 2, lambda_142E)

    def lambda_1449():
        OP_8F(0x20, 0x4934, 0x0, 0xA28, 0x2AF8, 0x0)
        ExitThread()

    QueueWorkItem(0x20, 2, lambda_1449)
    ...
    QueueWorkItem(0x1B, 1, lambda_1497)

    def lambda_14A7():
        OP_99(0xFE, 0x0, 0x3, 0x3E8)
        ExitThread()

    QueueWorkItem(0x1F, 1, lambda_14A7)

    def lambda_14B7():
        OP_99(0xFE, 0x0, 0x3, 0x3E8)
        ExitThread()

    QueueWorkItem(0x20, 1, lambda_14B7)
    Sleep(30)
    ...
    QueueWorkItem(0x1B, 2, lambda_14CC)

    def lambda_14E7():
        OP_8F(0x1F, 0x50D2, 0x0, 0x46A, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x1F, 2, lambda_14E7)

    def lambda_1502():
        OP_8F(0x20, 0x4934, 0x0, 0xA28, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x20, 2, lambda_1502)
    Sleep(30)
    ...
    QueueWorkItem(0x1B, 2, lambda_1522)

    def lambda_153D():
        OP_8F(0x1F, 0x50D2, 0x0, 0x46A, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x1F, 2, lambda_153D)

    def lambda_1558():
        OP_8F(0x20, 0x4934, 0x0, 0xA28, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x20, 2, lambda_1558)
    Sleep(30)
    OP_44(0x1B, 0x2)
    OP_44(0x1F, 0x2)
    OP_44(0x20, 0x2)
    ...
    def Function_4_1615(): pass

    label("Function_4_1615")
    ...
    def Function_5_1648(): pass

    label("Function_5_1648")
    ...
    QueueWorkItem2(0xFE, 0, lambda_1680)
    Return()
    ...
    QueueWorkItem2(0xFE, 0, lambda_16C6)
    Return()
    ...
    QueueWorkItem2(0xFE, 0, lambda_170C)
    Return()

    # Function_7_16D4 end

    def Function_8_171A(): pass

    label("Function_8_171A")
    ...
    QueueWorkItem2(0xFE, 0, lambda_173E)
    Return()

    # Function_8_171A end

    def Function_9_174C(): pass

    label("Function_9_174C")
    ...
    QueueWorkItem2(0xFE, 0, lambda_1770)
    Return()
    ...
    def Function_11_17B1(): pass

    label("Function_11_17B1")
    ...
    # Function_11_17B1 end

    def Function_12_17E4(): pass

    label("Function_12_17E4")
    ...
    # Function_12_17E4 end

    def Function_13_1817(): pass

    label("Function_13_1817")
    ...
    # Function_13_1817 end

    def Function_14_1836(): pass

    label("Function_14_1836")
    ...
    # Function_14_1836 end

    def Function_15_1869(): pass

    label("Function_15_1869")
    ...
    # Function_15_1869 end

    def Function_16_189C(): pass

    label("Function_16_189C")
    ...
    # Function_16_189C end

    def Function_17_18CF(): pass

    label("Function_17_18CF")
    ...
    # Function_17_18CF end

    def Function_18_1902(): pass

    label("Function_18_1902")
    ...
    # Function_18_1902 end

    def Function_19_1935(): pass

    label("Function_19_1935")
    ...
    # Function_19_1935 end

    def Function_20_1968(): pass

    label("Function_20_1968")
    ...
    QueueWorkItem(0x101, 2, lambda_1AA6)
    Sleep(7000)
    ...
    QueueWorkItem(0x27, 1, lambda_1BD5)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 1, lambda_1BF5)
    ...
    QueueWorkItem2(0x27, 3, lambda_1EC6)
    ...
    # Function_20_1968 end

    def Function_21_1F2F(): pass

    label("Function_21_1F2F")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 7)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_1F3C")
    Return()
    ...
    # Function_21_1F2F end

    def Function_22_204B(): pass

    label("Function_22_204B")
    ...
    # Function_22_204B end

    def Function_23_22B4(): pass

    label("Function_23_22B4")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2414")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2343")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_23A9")
