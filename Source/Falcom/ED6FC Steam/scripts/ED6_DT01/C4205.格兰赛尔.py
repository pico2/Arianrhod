...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCB, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_44A")
    OP_A2(0x65E)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDC, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_7BF")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDC, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_6FD")
    ...
    QueueWorkItem(0x8, 2, lambda_68B)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x2D3, 1)"), scpexpr(EXPR_END)), "loc_74F")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
