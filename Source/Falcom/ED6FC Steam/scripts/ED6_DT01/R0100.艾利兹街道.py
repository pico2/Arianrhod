...
def main():
    ...
    def Function_3_2B8(): pass

    label("Function_3_2B8")
    ...
    def Function_4_2F7(): pass

    label("Function_4_2F7")
    ...
    def Function_6_7E9(): pass

    label("Function_6_7E9")
    ...
    def Function_7_818(): pass

    label("Function_7_818")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x42, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_98D")
    EventBegin(0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x42, 2)), scpexpr(EXPR_END)), "loc_896")
    TurnDirection(0x102, 0x101, 400)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_92A")
    TurnDirection(0x102, 0x101, 400)
