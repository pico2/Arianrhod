...
def main():
    ...
    ScpFunction(
        ...
        "Function_16_3246",        # 10, 16
        "Function_17_36A0",        # 11, 17
        "Function_18_38F3",        # 12, 18
        "Function_19_3989",        # 13, 19
        "Function_20_39CF",        # 14, 20
        "Function_21_3A15",        # 15, 21
        "Function_22_3A83",        # 16, 22
        "Function_23_3AF1",        # 17, 23
        "Function_24_3B37",        # 18, 24
        "Function_25_3B7D",        # 19, 25
        "Function_26_3BEB",        # 1A, 26
        "Function_27_3C59",        # 1B, 27
        "Function_28_3CC7",        # 1C, 28
        "Function_29_4625",        # 1D, 29
        "Function_30_482B",        # 1E, 30
        "Function_31_5B65",        # 1F, 31
        "Function_32_5DCA",        # 20, 32
        "Function_33_5ECC",        # 21, 33
        "Function_34_5F3A",        # 22, 34
        "Function_35_84AA",        # 23, 35
        "Function_36_8ECE",        # 24, 36
        "Function_37_8ED8",        # 25, 37
        "Function_38_923D",        # 26, 38
        "Function_39_92CE",        # 27, 39
        "Function_40_9322",        # 28, 40
        "Function_41_9376",        # 29, 41
        "Function_42_93D8",        # 2A, 42
        "Function_43_93DC",        # 2B, 43
        "Function_44_93E0",        # 2C, 44
        "Function_45_93E4",        # 2D, 45
        "Function_46_93E8",        # 2E, 46
    )
    ...
    QueueWorkItem2(0x102, 1, lambda_28A6)
    OP_8C(0x108, 270, 400)
    ...
    QueueWorkItem(0x108, 1, lambda_28BE)
    OP_8C(0x104, 270, 400)
    ...
    QueueWorkItem(0x104, 1, lambda_28E0)
    Sleep(3000)
    TurnDirection(0x101, 0x102, 400)
    ...
    QueueWorkItem(0x101, 1, lambda_29F9)

    def lambda_2A07():
        TurnDirection(0xFE, 0xC, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_2A07)
    ...
    QueueWorkItem(0xC, 1, lambda_2A26)
    Sleep(200)
    ...
    QueueWorkItem(0xD, 1, lambda_2A46)
    Sleep(200)
    ...
    QueueWorkItem(0xE, 1, lambda_2A66)
    ...
    QueueWorkItem(0xD, 1, lambda_2E98)
    OP_8C(0xE, 270, 400)
    ...
    QueueWorkItem(0xE, 1, lambda_2EBA)
    OP_8C(0xC, 270, 400)
    ...
    QueueWorkItem(0xC, 1, lambda_2EDC)
    Sleep(3000)
    ...
    QueueWorkItem(0x101, 1, lambda_2EFC)
    ...
    def Function_16_3246(): pass

    label("Function_16_3246")
    ...
    QueueWorkItem(0x101, 1, lambda_3317)

    def lambda_332F():
        OP_6E(333, 5000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_332F)

    def lambda_333F():
        OP_6C(45000, 5000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_333F)
    Sleep(5000)
    ...
    QueueWorkItem2(0x102, 1, lambda_34E7)
    OP_8C(0x108, 270, 400)
    ...
    QueueWorkItem(0x108, 1, lambda_34FF)
    OP_8C(0x104, 270, 400)
    ...
    QueueWorkItem(0x104, 1, lambda_3521)
    Sleep(3000)
    TurnDirection(0x101, 0x102, 400)
    ...
    # Function_16_3246 end

    def Function_17_36A0(): pass

    label("Function_17_36A0")

    Jc((scpexpr(EXPR_GET_RESULT, 0x1), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_38F2")
    OP_48()
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x151), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_36D3")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x125), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_36F9")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xF8), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_371F")
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xCA), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_3746")
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x9E), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_376C")
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x3, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_37F0")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x70), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_3792")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x44), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_37B7")
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x3, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_37F0")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x16), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_37DC")
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x3, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_37F0")
    ...
    OP_69(0xFE, 0x3E8)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_38E0")
    ...
    Jump("Function_17_36A0")

    label("loc_38F2")

    Return()

    # Function_17_36A0 end

    def Function_18_38F3(): pass

    label("Function_18_38F3")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_3988")
    ...
    OP_8E(0xFE, 0xBB8A, 0xFA, 0x10D6, 0xBB8, 0x0)
    OP_8E(0xFE, 0xBB8A, 0xFA, 0xEA4C, 0xBB8, 0x0)
    Jump("Function_18_38F3")

    label("loc_3988")

    Return()

    # Function_18_38F3 end

    def Function_19_3989(): pass

    label("Function_19_3989")
    ...
    Jump("Function_19_3989")

    label("loc_39CE")

    Return()

    # Function_19_3989 end

    def Function_20_39CF(): pass

    label("Function_20_39CF")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_3A14")
    SetChrPos(0xFE, 50960, 0, 16800, 0)
    OP_8E(0xFE, 0xC710, 0x0, 0xE6D2, 0xBB8, 0x0)
    OP_8E(0xFE, 0xC710, 0x0, 0x41A0, 0xBB8, 0x0)
    Jump("Function_20_39CF")

    label("loc_3A14")

    Return()

    # Function_20_39CF end

    def Function_21_3A15(): pass

    label("Function_21_3A15")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_3A82")
    ...
    Jump("Function_21_3A15")

    label("loc_3A82")

    Return()

    # Function_21_3A15 end

    def Function_22_3A83(): pass

    label("Function_22_3A83")
    ...
    Jump("Function_22_3A83")

    label("loc_3AF0")

    Return()

    # Function_22_3A83 end

    def Function_23_3AF1(): pass

    label("Function_23_3AF1")
    ...
    Jump("Function_23_3AF1")

    label("loc_3B36")

    Return()

    # Function_23_3AF1 end

    def Function_24_3B37(): pass

    label("Function_24_3B37")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_3B7C")
    SetChrPos(0xFE, 95540, 250, -5740, 90)
    OP_8E(0xFE, 0xA6D6, 0xFA, 0xFFFFE994, 0xBB8, 0x0)
    OP_8E(0xFE, 0x17534, 0xFA, 0xFFFFE994, 0xBB8, 0x0)
    Jump("Function_24_3B37")

    label("loc_3B7C")

    Return()

    # Function_24_3B37 end

    def Function_25_3B7D(): pass

    label("Function_25_3B7D")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_3BEA")
    ...
    def Function_26_3BEB(): pass

    label("Function_26_3BEB")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_3C58")
    ...
    Jump("Function_26_3BEB")

    label("loc_3C58")

    Return()

    # Function_26_3BEB end

    def Function_27_3C59(): pass

    label("Function_27_3C59")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_3CC6")
    ...
    Jump("Function_27_3C59")

    label("loc_3CC6")

    Return()

    # Function_27_3C59 end

    def Function_28_3CC7(): pass

    label("Function_28_3CC7")
    ...
    QueueWorkItem(0x102, 1, lambda_3D2E)
    Sleep(300)
    ...
    QueueWorkItem(0x101, 1, lambda_3D4E)
    ...
    QueueWorkItem(0x101, 1, lambda_3E56)
    Sleep(400)
    ...
    QueueWorkItem(0x102, 1, lambda_3E76)

    def lambda_3E91():
        OP_67(0, 5940, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_3E91)
    ...
    # Function_28_3CC7 end

    def Function_29_4625(): pass

    label("Function_29_4625")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x36E)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_4684")
    OP_22(0x74, 0x0, 0x64)
    Sleep(300)
    OP_22(0x74, 0x0, 0x64)
    Sleep(300)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_42(0x7)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_47C3")
    OP_22(0x74, 0x0, 0x64)
    Sleep(300)
    OP_22(0x74, 0x0, 0x64)
    Sleep(300)
    ...
    SetMessageWindowPos(72, 320, 56, 3)
    TurnDirection(0x102, 0x101, 400)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC6, 0)), scpexpr(EXPR_END)), "loc_4748")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC6, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_482A")
    FadeToDark(300, 0, 100)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    OP_22(0x73, 0x0, 0x64)
    ...
    # Function_29_4625 end

    def Function_30_482B(): pass

    label("Function_30_482B")
    ...
    QueueWorkItem(0x101, 1, lambda_4905)

    def lambda_491D():
        OP_6E(333, 5000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_491D)

    def lambda_492D():
        OP_6C(45000, 5000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_492D)
    Sleep(5000)
    ...
    QueueWorkItem(0x101, 2, lambda_4C4E)

    def lambda_4C5C():
        TurnDirection(0xFE, 0x9, 400)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_4C5C)

    def lambda_4C6A():
        TurnDirection(0xFE, 0x9, 400)
        ExitThread()

    QueueWorkItem(0x104, 2, lambda_4C6A)

    def lambda_4C78():
        TurnDirection(0xFE, 0x9, 400)
        ExitThread()

    QueueWorkItem(0x108, 2, lambda_4C78)
    ...
    QueueWorkItem2(0x101, 2, lambda_4CCA)
    ...
    QueueWorkItem2(0x102, 2, lambda_4CDB)
    ...
    QueueWorkItem2(0x104, 2, lambda_4CEC)
    ...
    QueueWorkItem2(0x108, 2, lambda_4CFD)

    def lambda_4D0E():
        OP_8E(0xFE, 0x19ADC, 0x4E2, 0x7D00, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_4D0E)
    ...
    QueueWorkItem2(0x104, 2, lambda_56FA)
    ...
    QueueWorkItem2(0x101, 2, lambda_5797)
    ...
    QueueWorkItem2(0x102, 2, lambda_57A8)
    ...
    QueueWorkItem2(0x104, 2, lambda_57B9)
    ...
    QueueWorkItem2(0x108, 2, lambda_57CA)
    OP_44(0x104, 0xFF)
    OP_8C(0x9, 270, 400)
    ...
    QueueWorkItem(0x104, 1, lambda_57E6)
    Sleep(200)
    ...
    QueueWorkItem(0x101, 1, lambda_5808)

    def lambda_5820():
        OP_8F(0xFE, 0x17700, 0xFA, 0x7B0C, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x104, 2, lambda_5820)

    def lambda_583B():
        OP_8E(0xFE, 0x17700, 0xFA, 0x7D3C, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_583B)
    ...
    # Function_30_482B end

    def Function_31_5B65(): pass

    label("Function_31_5B65")
    ...
    QueueWorkItem2(0x101, 1, lambda_5D49)
    ...
    QueueWorkItem2(0x102, 1, lambda_5D5A)
    ...
    QueueWorkItem2(0x108, 1, lambda_5D6B)
    ...
    # Function_31_5B65 end

    def Function_32_5DCA(): pass

    label("Function_32_5DCA")
    ...
    QueueWorkItem(0x0, 0, lambda_5E1D)

    def lambda_5E35():
        OP_67(0, 5170, -10000, 8000)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_5E35)

    def lambda_5E4D():
        OP_6C(270000, 8000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_5E4D)

    def lambda_5E5D():
        OP_6E(149, 8000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_5E5D)
    SetChrFlags(0x24, 0x80)
    ...
    # Function_32_5DCA end

    def Function_33_5ECC(): pass

    label("Function_33_5ECC")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_5F39")
    EventBegin(0x0)
    Fade(1500)
    ...
    # Function_33_5ECC end

    def Function_34_5F3A(): pass

    label("Function_34_5F3A")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 5)), scpexpr(EXPR_END)), "loc_5F43")
    EventBegin(0x0)

    label("loc_5F43")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDD, 4)), scpexpr(EXPR_END)), "loc_5F54")
    RunExpression(0x4, (scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_ADD_SAVE), scpexpr(EXPR_END)))

    label("loc_5F54")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDD, 5)), scpexpr(EXPR_END)), "loc_5F65")
    RunExpression(0x4, (scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_ADD_SAVE), scpexpr(EXPR_END)))

    label("loc_5F65")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDD, 6)), scpexpr(EXPR_END)), "loc_5F76")
    RunExpression(0x4, (scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_ADD_SAVE), scpexpr(EXPR_END)))

    label("loc_5F76")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDD, 7)), scpexpr(EXPR_END)), "loc_5F87")
    RunExpression(0x4, (scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_ADD_SAVE), scpexpr(EXPR_END)))

    label("loc_5F87")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDE, 0)), scpexpr(EXPR_END)), "loc_5F98")
    RunExpression(0x4, (scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_ADD_SAVE), scpexpr(EXPR_END)))

    label("loc_5F98")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDE, 1)), scpexpr(EXPR_END)), "loc_5FA9")
    RunExpression(0x4, (scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_ADD_SAVE), scpexpr(EXPR_END)))

    label("loc_5FA9")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDE, 2)), scpexpr(EXPR_END)), "loc_5FBA")
    RunExpression(0x4, (scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_ADD_SAVE), scpexpr(EXPR_END)))

    label("loc_5FBA")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDE, 3)), scpexpr(EXPR_END)), "loc_5FCB")
    RunExpression(0x4, (scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_ADD_SAVE), scpexpr(EXPR_END)))

    label("loc_5FCB")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDE, 4)), scpexpr(EXPR_END)), "loc_5FDC")
    RunExpression(0x4, (scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_ADD_SAVE), scpexpr(EXPR_END)))

    label("loc_5FDC")

    TurnDirection(0x102, 0x101, 400)
    Jc((scpexpr(EXPR_GET_RESULT, 0x4), scpexpr(EXPR_PUSH_LONG, 0x3), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_602B")
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x4), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_606F")
    ...
    Switch(
        ...
        (0, "loc_6116"),
        (1, "loc_61BA"),
        (SWITCH_DEFAULT, "loc_84A9"),
    )


    label("loc_6116")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_61B0")
    OP_A2(0x66D)
    TurnDirection(0x101, 0x102, 400)
    ...
    QueueWorkItem(0x101, 2, lambda_6222)

    def lambda_623A():
        OP_6C(135000, 3500)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_623A)

    def lambda_624A():
        OP_6D(73240, 250, 45110, 3500)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_624A)

    def lambda_6262():
        OP_6B(2800, 3500)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_6262)

    def lambda_6272():
        OP_8E(0xFE, 0x11E18, 0xFA, 0xAF5A, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_6272)
    Sleep(400)
    ...
    QueueWorkItem(0x102, 1, lambda_6292)
    WaitChrThread(0x101, 0x1)
    OP_8C(0x101, 270, 400)
    ...
    QueueWorkItem(0x102, 1, lambda_62F7)
    WaitChrThread(0x102, 0x1)
    ...
    QueueWorkItem(0x101, 0, lambda_6811)
    Sleep(250)
    ...
    QueueWorkItem(0x101, 2, lambda_6896)

    def lambda_68AE():
        OP_6C(115000, 1500)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_68AE)

    def lambda_68BE():
        OP_6B(3000, 1500)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_68BE)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 1, lambda_68DD)
    WaitChrThread(0x101, 0x1)
    OP_8E(0x101, 0x11B34, 0xFA, 0xAF5A, 0x7D0, 0x0)
    SetChrSubChip(0x102, 0)
    WaitChrThread(0x101, 0x3)
    TurnDirection(0x101, 0x102, 400)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 6)), scpexpr(EXPR_END)), "loc_699E")
    ...
    QueueWorkItem(0x102, 2, lambda_6A27)

    def lambda_6A3F():
        OP_8E(0xFE, 0x1129C, 0xFA, 0xED1C, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_6A3F)
    ...
    QueueWorkItem(0x102, 2, lambda_6B85)

    def lambda_6B95():
        OP_6D(71700, 1250, 39000, 3000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_6B95)

    def lambda_6BAD():
        OP_67(0, 5170, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_6BAD)

    def lambda_6BC5():
        OP_6E(251, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_6BC5)

    def lambda_6BD5():
        OP_6B(3340, 3000)
        ExitThread()

    QueueWorkItem(0x101, 0, lambda_6BD5)
    SetChrSubChip(0x102, 0)
    Sleep(100)
    SetChrSubChip(0x102, 1)
    ...
    QueueWorkItem(0x20, 1, lambda_6BFE)
    Sleep(200)
    ...
    QueueWorkItem(0x101, 1, lambda_6C1E)

    def lambda_6C36():
        OP_67(0, 7230, -10000, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_6C36)

    def lambda_6C4E():
        OP_6E(262, 2000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_6C4E)

    def lambda_6C5E():
        OP_6B(2800, 2000)
        ExitThread()

    QueueWorkItem(0x101, 0, lambda_6C5E)

    def lambda_6C6E():
        OP_6C(135000, 2000)
        ExitThread()

    QueueWorkItem(0x102, 0, lambda_6C6E)
    ...
    QueueWorkItem(0x101, 3, lambda_6DF6)
    ...
    QueueWorkItem(0x102, 3, lambda_7029)
    SetChrSubChip(0x102, 0)
    ...
    QueueWorkItem(0x102, 1, lambda_704B)
    WaitChrThread(0x102, 0x1)
    ...
    QueueWorkItem(0x102, 1, lambda_7172)
    ...
    QueueWorkItem(0x101, 0, lambda_72B4)
    ...
    QueueWorkItem(0x102, 1, lambda_7411)

    def lambda_7421():
        OP_6D(72010, 650, 45100, 1000)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_7421)
    ...
    QueueWorkItem(0x102, 1, lambda_7E03)
    ...
    QueueWorkItem(0x102, 1, lambda_7E93)
    ...
    QueueWorkItem(0x102, 1, lambda_7ED9)
    WaitChrThread(0x102, 0x1)
    ...
    QueueWorkItem(0x102, 1, lambda_7F27)
    WaitChrThread(0x102, 0x1)
    ...
    QueueWorkItem(0x102, 3, lambda_8341)
    ...
    QueueWorkItem(0x102, 1, lambda_836D)

    def lambda_837D():
        OP_8E(0xFE, 0x11260, 0xFA, 0xE13C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x20, 1, lambda_837D)
    Sleep(6000)
    OP_20(0x7D0)
    WaitChrThread(0x102, 0x1)
    WaitChrThread(0x20, 0x1)
    ...
    QueueWorkItem(0x102, 2, lambda_83AC)
    OP_21()
    OP_1D(0x53)
    Sleep(2000)
    ...
    # Function_34_5F3A end

    def Function_35_84AA(): pass

    label("Function_35_84AA")
    ...
    QueueWorkItem(0x101, 2, lambda_86EC)

    def lambda_8704():
        OP_8E(0xFE, 0xCA58, 0x0, 0xB784, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x20, 1, lambda_8704)
    Sleep(2000)
    ...
    QueueWorkItem(0x101, 2, lambda_8987)
    ...
    QueueWorkItem2(0x20, 1, lambda_899F)
    ...
    QueueWorkItem(0x101, 1, lambda_8AD1)
    ...
    # Function_35_84AA end

    def Function_36_8ECE(): pass

    label("Function_36_8ECE")

    OP_77(0x64, 0x64, 0x64, 0x177000, 0x0)
    Return()

    # Function_36_8ECE end

    def Function_37_8ED8(): pass

    label("Function_37_8ED8")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_8EE5")
    Return()
    ...
    QueueWorkItem(0x101, 1, lambda_9017)
    TurnDirection(0x101, 0x102, 400)
    WaitChrThread(0x101, 0x1)
    ...
    # Function_37_8ED8 end

    def Function_38_923D(): pass

    label("Function_38_923D")
    ...
    # Function_38_923D end

    def Function_39_92CE(): pass

    label("Function_39_92CE")
    ...
    # Function_39_92CE end

    def Function_40_9322(): pass

    label("Function_40_9322")
    ...
    # Function_40_9322 end

    def Function_41_9376(): pass

    label("Function_41_9376")
    ...
    # Function_41_9376 end

    def Function_42_93D8(): pass

    label("Function_42_93D8")

    SetPlaceName(0xBA) # 帝国大使馆
    Return()

    # Function_42_93D8 end

    def Function_43_93DC(): pass

    label("Function_43_93DC")

    SetPlaceName(0xB1) # 帝国大使馆
    Return()

    # Function_43_93DC end

    def Function_44_93E0(): pass

    label("Function_44_93E0")

    SetPlaceName(0xBB) # 帝国大使馆
    Return()

    # Function_44_93E0 end

    def Function_45_93E4(): pass

    label("Function_45_93E4")

    SetPlaceName(0xBC) # 帝国大使馆
    Return()

    # Function_45_93E4 end

    def Function_46_93E8(): pass

    label("Function_46_93E8")

    SetPlaceName(0xBD) # 帝国大使馆
    Return()

    # Function_46_93E8 end
