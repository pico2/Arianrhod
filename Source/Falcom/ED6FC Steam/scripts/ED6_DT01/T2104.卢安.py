...
def main():
    ...
    QueueWorkItem(0x101, 0, lambda_463)
    ...
    QueueWorkItem(0x101, 2, lambda_493)

    def lambda_4A3():
        OP_6E(435, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_4A3)

    def lambda_4B3():
        OP_6C(329000, 3000)
        ExitThread()

    QueueWorkItem(0x102, 0, lambda_4B3)
    Sleep(3000)
    ...
    QueueWorkItem(0xE, 1, lambda_6C9)
    Sleep(1700)
    OP_22(0xD4, 0x0, 0x64)
    ...
    QueueWorkItem(0xE, 1, lambda_6EE)
    Sleep(700)
    ...
    QueueWorkItem(0xE, 1, lambda_70E)
    Sleep(600)
    ...
    QueueWorkItem(0xE, 1, lambda_72E)

    def lambda_749():
        OP_6D(-10020, 100, -16530, 3000)
        ExitThread()

    QueueWorkItem(0x101, 0, lambda_749)
    Sleep(400)
    ...
    QueueWorkItem(0xE, 1, lambda_766)
    Sleep(300)
    ...
    QueueWorkItem(0xE, 1, lambda_786)
    Sleep(200)
    ...
    QueueWorkItem(0xE, 1, lambda_7A6)
    Sleep(200)
    ...
    QueueWorkItem(0xE, 1, lambda_7C6)
    Sleep(200)
    ...
    QueueWorkItem(0xE, 1, lambda_7E6)
    Sleep(200)
    ...
    QueueWorkItem(0xE, 1, lambda_806)
