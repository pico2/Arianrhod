...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_55A",          # 08, 8
        "Function_9_5A7",          # 09, 9
        "Function_10_61A",         # 0A, 10
        "Function_11_10EE",        # 0B, 11
        "Function_12_10FD",        # 0C, 12
        "Function_13_110F",        # 0D, 13
        "Function_14_1286",        # 0E, 14
    )
    ...
    def Function_6_465(): pass

    label("Function_6_465")

    TalkBegin(0xA)
    TurnDirection(0xFE, 0x102, 400)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_4FE")
    OP_A2(0x0)
    ...
    def Function_7_51C(): pass

    label("Function_7_51C")
    ...
    def Function_8_55A(): pass

    label("Function_8_55A")
    ...
    def Function_9_5A7(): pass

    label("Function_9_5A7")
    ...
    def Function_10_61A(): pass

    label("Function_10_61A")
    ...
    def Function_11_10EE(): pass

    label("Function_11_10EE")

    OP_8C(0x102, 315, 400)
    OP_8C(0x102, 180, 400)
    Return()

    # Function_11_10EE end

    def Function_12_10FD(): pass

    label("Function_12_10FD")

    OP_6D(-2800, 0, 22400, 8000)
    Return()

    # Function_12_10FD end

    def Function_13_110F(): pass

    label("Function_13_110F")

    EventBegin(0x0)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x0), scpexpr(EXPR_PUSH_LONG, 0x70), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1153")
    ...
    # Function_13_110F end

    def Function_14_1286(): pass

    label("Function_14_1286")
    ...
    QueueWorkItem(0x102, 1, lambda_12DB)

    def lambda_12ED():
        OP_8E(0xFE, 0xFFFED630, 0x0, 0xFFFF8364, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 0, lambda_12ED)
    Sleep(1600)
    ...
    QueueWorkItem(0x101, 1, lambda_1312)
    ...
    QueueWorkItem(0x101, 0, lambda_15D7)
