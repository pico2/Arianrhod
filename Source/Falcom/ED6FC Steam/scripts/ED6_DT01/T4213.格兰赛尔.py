...
def main():
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_366")
    ...
    def Function_4_418(): pass

    label("Function_4_418")
    ...
    QueueWorkItem(0x0, 2, lambda_5AF)

    def lambda_5BF():
        OP_67(0, 5550, -10000, 2000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_5BF)

    def lambda_5D7():
        TurnDirection(0xFE, 0x108, 400)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_5D7)
    Sleep(100)
    ...
    QueueWorkItem(0x9, 1, lambda_5EA)
    Sleep(100)
    ...
    QueueWorkItem(0xB, 1, lambda_5FD)
    Sleep(100)
    ...
    QueueWorkItem(0xC, 1, lambda_610)
    ...
    QueueWorkItem(0x102, 1, lambda_6CC)

    def lambda_6E7():
        OP_8E(0xFE, 0x10252, 0x0, 0xFFFF33AA, 0x2710, 0x0)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_6E7)
    Sleep(50)
    ...
    QueueWorkItem(0x104, 1, lambda_707)

    def lambda_722():
        OP_6D(65930, 0, -40190, 800)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_722)

    def lambda_73A():
        OP_6E(225, 800)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_73A)
    ...
    QueueWorkItem(0x102, 1, lambda_96F)
    ...
    QueueWorkItem2(0x108, 1, lambda_994)
    ...
    QueueWorkItem2(0x104, 1, lambda_9A5)
    ...
    QueueWorkItem(0x104, 1, lambda_A36)
    OP_8C(0x108, 270, 400)
    SetChrChipByIndex(0x108, 8)
    ...
    QueueWorkItem(0x108, 1, lambda_B21)
    OP_8C(0x104, 270, 400)
    SetChrChipByIndex(0x104, 10)
