...
def main():
    ...
    QueueWorkItem(0x101, 1, lambda_1BA)
    ...
    QueueWorkItem2(0x101, 1, lambda_1F5)
    ...
    QueueWorkItem2(0x105, 1, lambda_206)
    ...
    QueueWorkItem2(0x8, 1, lambda_217)
    ...
    QueueWorkItem2(0x105, 1, lambda_3E1)
    ...
    QueueWorkItem2(0x8, 1, lambda_3F2)
    ...
    QueueWorkItem(0x102, 1, lambda_417)
    ...
    QueueWorkItem(0x101, 1, lambda_55C)
    ...
    def Function_1_5E6(): pass

    label("Function_1_5E6")
    ...
    SetMessageWindowPos(72, 320, 56, 3)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 0)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_642")
    OP_28(0x21, 0x1, 0x1000)
    Jump("loc_78E")

    label("loc_642")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x332)"), scpexpr(EXPR_END)), "loc_682")
    Sleep(400)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x21, 0x1, 0x10)"), scpexpr(EXPR_END)), "loc_6BF")
    Sleep(400)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x21, 0x0, 0x40)"), scpexpr(EXPR_END)), "loc_6CC")
    Jump("loc_78E")

    label("loc_6CC")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x21, 0x1, 0x4)"), scpexpr(EXPR_END)), "loc_759")
    Sleep(400)
    OP_28(0x21, 0x1, 0x1000)
