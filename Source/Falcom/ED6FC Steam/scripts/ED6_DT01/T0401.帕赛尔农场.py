...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_62C",          # 08, 8
        "Function_9_643",          # 09, 9
        "Function_10_7B9",         # 0A, 10
        "Function_11_7C3",         # 0B, 11
        "Function_12_890",         # 0C, 12
        "Function_13_AD1",         # 0D, 13
        "Function_14_D57",         # 0E, 14
        "Function_15_F60",         # 0F, 15
        "Function_16_F83",         # 10, 16
        "Function_17_F8B",         # 11, 17
        "Function_18_FA0",         # 12, 18
        "Function_19_FB4",         # 13, 19
        "Function_20_FC8",         # 14, 20
        "Function_21_FDC",         # 15, 21
        "Function_22_1B82",        # 16, 22
        "Function_23_1BC6",        # 17, 23
        "Function_24_1C36",        # 18, 24
        "Function_25_1C4B",        # 19, 25
        "Function_26_1C60",        # 1A, 26
        "Function_27_1C75",        # 1B, 27
        "Function_28_1CB2",        # 1C, 28
        "Function_29_1CBA",        # 1D, 29
        "Function_30_1D4C",        # 1E, 30
        "Function_31_1DCA",        # 1F, 31
        "Function_32_1E5C",        # 20, 32
        "Function_33_21E2",        # 21, 33
        "Function_34_21EA",        # 22, 34
    )
    ...
    def Function_10_7B9(): pass

    label("Function_10_7B9")
    ...
    def Function_11_7C3(): pass

    label("Function_11_7C3")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_88F")
    OP_A2(0x231)
    OP_28(0x2, 0x1, 0x10)
    EventBegin(0x0)
    ...
    def Function_12_890(): pass

    label("Function_12_890")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_AD0")
    OP_A2(0x233)
    OP_28(0x2, 0x1, 0x40)
    EventBegin(0x0)
    ...
    def Function_13_AD1(): pass

    label("Function_13_AD1")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 2)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_D56")
    OP_A2(0x233)
    OP_A2(0x234)
    OP_28(0x2, 0x1, 0x80)
    EventBegin(0x0)
    ...
    QueueWorkItem2(0x101, 1, lambda_B5E)
    ...
    QueueWorkItem2(0x102, 1, lambda_B6F)
    OP_0D()
    ...
    QueueWorkItem(0x101, 2, lambda_B81)

    def lambda_B99():
        OP_6C(45000, 4000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_B99)
    ...
    def Function_14_D57(): pass

    label("Function_14_D57")
    ...
    def Function_15_F60(): pass

    label("Function_15_F60")
    ...
    def Function_16_F83(): pass

    label("Function_16_F83")
    ...
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_F9F")
    TurnDirection(0xFE, 0x9, 0)
    OP_48()
    Jump("Function_17_F8B")
    ...
    def Function_18_FA0(): pass

    label("Function_18_FA0")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_FB3")
    Call(0, 21)
    Call(0, 29)
    ...
    def Function_19_FB4(): pass

    label("Function_19_FB4")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_FC7")
    Call(0, 21)
    Call(0, 30)
    ...
    def Function_20_FC8(): pass

    label("Function_20_FC8")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_FDB")
    Call(0, 21)
    Call(0, 31)
    ...
    def Function_21_FDC(): pass

    label("Function_21_FDC")
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1B46")
    OP_2B(0x2, 0x2)
    Jump("loc_1B53")

    label("loc_1B46")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1B53")
    OP_2B(0x2, 0x1)
    ...
    def Function_22_1B82(): pass

    label("Function_22_1B82")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1BC5")
    OP_95(0xFE, 0x0, 0x0, 0x0, 0x190, 0xBB8)
    Sleep(300)
    OP_95(0xFE, 0x0, 0x0, 0x0, 0x190, 0xBB8)
    Sleep(2500)
    Jump("Function_22_1B82")

    label("loc_1BC5")

    Return()

    # Function_22_1B82 end

    def Function_23_1BC6(): pass

    label("Function_23_1BC6")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1C35")
    Sleep(3000)
    ...
    Jump("Function_23_1BC6")

    label("loc_1C35")

    Return()

    # Function_23_1BC6 end

    def Function_24_1C36(): pass

    label("Function_24_1C36")

    OP_8E(0x9, 0x85AC, 0x32, 0x740E, 0x2EE0, 0x0)
    Return()

    # Function_24_1C36 end

    def Function_25_1C4B(): pass

    label("Function_25_1C4B")

    OP_8E(0xA, 0x85AC, 0x32, 0x740E, 0x2EE0, 0x0)
    Return()

    # Function_25_1C4B end

    def Function_26_1C60(): pass

    label("Function_26_1C60")

    OP_8E(0xB, 0x85AC, 0x32, 0x740E, 0x2EE0, 0x0)
    Return()

    # Function_26_1C60 end

    def Function_27_1C75(): pass

    label("Function_27_1C75")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_END)), "loc_1CB1")
    ...
    OP_48()
    Jump("Function_27_1C75")

    label("loc_1CB1")

    Return()

    # Function_27_1C75 end

    def Function_28_1CB2(): pass

    label("Function_28_1CB2")

    TurnDirection(0xFE, 0x101, 400)
    Return()

    # Function_28_1CB2 end

    def Function_29_1CBA(): pass

    label("Function_29_1CBA")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1D4B")
    EventBegin(0x0)
    ClearMapFlags(0x1)
    OP_A3(0x0)
    OP_A2(0x1)
    ...
    # Function_29_1CBA end

    def Function_30_1D4C(): pass

    label("Function_30_1D4C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1DC9")
    EventBegin(0x0)
    ClearMapFlags(0x1)
    OP_A3(0x0)
    OP_A3(0x1)
    ...
    # Function_30_1D4C end

    def Function_31_1DCA(): pass

    label("Function_31_1DCA")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1E5B")
    EventBegin(0x0)
    ClearMapFlags(0x1)
    OP_A2(0x0)
    OP_A3(0x1)
    ...
    # Function_31_1DCA end

    def Function_32_1E5C(): pass

    label("Function_32_1E5C")

    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_PUSH_LONG, 0x3), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1EEF")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 6)), scpexpr(EXPR_END)), "loc_1F64")
    OP_A2(0x237)
    OP_28(0x2, 0x1, 0x400)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 5)), scpexpr(EXPR_END)), "loc_216D")
    OP_A2(0x236)
    OP_28(0x2, 0x1, 0x200)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 4)), scpexpr(EXPR_END)), "loc_21CC")
    OP_A2(0x235)
    OP_28(0x2, 0x1, 0x100)
    ...
    # Function_32_1E5C end

    def Function_33_21E2(): pass

    label("Function_33_21E2")

    OP_69(0x101, 0x3E8)
    Return()

    # Function_33_21E2 end

    def Function_34_21EA(): pass

    label("Function_34_21EA")

    EventBegin(0x1)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x46, 4)), scpexpr(EXPR_END)), "loc_228E")
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2242")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_22D7")
