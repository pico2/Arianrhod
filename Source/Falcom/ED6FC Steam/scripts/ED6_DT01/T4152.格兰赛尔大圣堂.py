...
def main():
    ...
    ScpFunction(
        ...
        "Function_11_F3A",         # 0B, 11
        "Function_12_FA8",         # 0C, 12
        "Function_13_1146",        # 0D, 13
        "Function_14_13B1",        # 0E, 14
        "Function_15_144C",        # 0F, 15
        "Function_16_14B4",        # 10, 16
        "Function_17_1501",        # 11, 17
        "Function_18_1505",        # 12, 18
        "Function_19_1509",        # 13, 19
    )
    ...
    def Function_4_99C(): pass

    label("Function_4_99C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC3, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9F7")
    EventBegin(0x1)
    OP_22(0x74, 0x0, 0x64)
    Sleep(300)
    OP_22(0x74, 0x0, 0x64)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_42(0x7)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_ADC")
    EventBegin(0x1)
    OP_22(0x74, 0x0, 0x64)
    Sleep(300)
    OP_22(0x74, 0x0, 0x64)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC4, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B4E")
    EventBegin(0x0)
    FadeToDark(300, 0, 100)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_DA1")
    OP_48()
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x151), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_B82")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x125), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_BA8")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xF8), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_BCE")
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xCA), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_BF5")
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x9E), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_C1B")
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_C9F")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x70), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_C41")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x44), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_C66")
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_C9F")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x16), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_C8B")
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_C9F")
    ...
    Sleep(1000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D8F")
    ...
    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_DC8")
    ...
    def Function_7_DC9(): pass

    label("Function_7_DC9")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_DEF")
    ...
    def Function_8_DF0(): pass

    label("Function_8_DF0")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_E5D")
    ...
    def Function_9_E5E(): pass

    label("Function_9_E5E")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_ECB")
    ...
    def Function_11_F3A(): pass

    label("Function_11_F3A")
    ...
    def Function_12_FA8(): pass

    label("Function_12_FA8")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1145")
    OP_A2(0x62E)
    ...
    QueueWorkItem(0x101, 1, lambda_FEC)
    ...
    QueueWorkItem(0x102, 1, lambda_10C9)

    def lambda_10DB():
        OP_8E(0xFE, 0xFFFECBB8, 0x6E0, 0x369C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_10DB)
    Sleep(300)
    FadeToDark(2000, 0, -1)
    ...
    QueueWorkItem(0x101, 1, lambda_1119)
    ...
    QueueWorkItem(0x101, 1, lambda_1272)
    ...
    QueueWorkItem(0x101, 3, lambda_129A)

    def lambda_12AA():
        OP_90(0xFE, 0xFFFFEC78, 0x27B0, 0xFFFFB1E0, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_12AA)
    Sleep(500)
    ...
    QueueWorkItem(0x10, 1, lambda_12CA)

    def lambda_12E5():
        OP_90(0xFE, 0x2710, 0x4EC0, 0xFFFFD8F0, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x13, 1, lambda_12E5)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 1, lambda_1305)
    Sleep(200)
    ...
    QueueWorkItem(0x12, 1, lambda_1325)

    def lambda_1340():
        OP_90(0xFE, 0xFFFFEC78, 0x3B38, 0xFFFFD8F0, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x14, 1, lambda_1340)
    Sleep(500)
    ...
    QueueWorkItem(0x15, 1, lambda_1360)
    Sleep(300)
    ...
    QueueWorkItem(0x16, 1, lambda_1380)
    Sleep(100)
    Sleep(200)
    Sleep(7000)
    OP_A2(0x3FD)
    ...
    def Function_14_13B1(): pass

    label("Function_14_13B1")
    ...
    # Function_14_13B1 end

    def Function_15_144C(): pass

    label("Function_15_144C")
    ...
    # Function_15_144C end

    def Function_16_14B4(): pass

    label("Function_16_14B4")
    ...
    # Function_16_14B4 end

    def Function_17_1501(): pass

    label("Function_17_1501")

    SetPlaceName(0xB8) # 格兰赛尔大圣堂
    Return()

    # Function_17_1501 end

    def Function_18_1505(): pass

    label("Function_18_1505")

    SetPlaceName(0xB7) # 格兰赛尔大圣堂
    Return()

    # Function_18_1505 end

    def Function_19_1509(): pass

    label("Function_19_1509")

    SetPlaceName(0xAF) # 格兰赛尔大圣堂
    Return()

    # Function_19_1509 end
