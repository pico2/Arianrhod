...
def main():
    ...
    ScpFunction(
        ...
        "Function_3_344",          # 03, 3
        "Function_4_52D",          # 04, 4
        "Function_5_29C5",         # 05, 5
        "Function_6_2A67",         # 06, 6
    )
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xDF, 0)), scpexpr(EXPR_END)), "loc_3C7")
    ...
    QueueWorkItem(0x101, 3, lambda_607)

    def lambda_61F():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0x105, 2, lambda_61F)

    def lambda_631():
        OP_8E(0xFE, 0x730, 0x2EE0, 0xD566, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_631)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 2, lambda_651)

    def lambda_663():
        OP_8E(0xFE, 0xBCC, 0x2EE0, 0xD0AC, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_663)
    Sleep(500)
    ...
    QueueWorkItem(0x103, 2, lambda_683)

    def lambda_695():
        OP_8E(0xFE, 0x26C, 0x2EE0, 0xD19C, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_695)
    ...
    QueueWorkItem(0xD, 2, lambda_751)
    ...
    QueueWorkItem2(0xD, 1, lambda_76C)

    def lambda_77D():
        OP_6D(2180, 13000, 59350, 3000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_77D)

    def lambda_795():
        OP_6C(45000, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_795)

    def lambda_7A5():
        OP_6E(321, 3000)
        ExitThread()

    QueueWorkItem(0x105, 2, lambda_7A5)

    def lambda_7B5():
        OP_67(0, 6360, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x105, 3, lambda_7B5)
    Sleep(800)
    ...
    QueueWorkItem(0x8, 2, lambda_7D2)
    Sleep(200)
    ...
    QueueWorkItem(0x105, 1, lambda_7F2)
    Sleep(110)
    ...
    QueueWorkItem(0x101, 1, lambda_812)
    Sleep(100)
    ...
    QueueWorkItem(0x103, 1, lambda_832)
    ...
    QueueWorkItem(0xD, 1, lambda_F26)

    def lambda_F41():
        OP_91(0xFE, 0x0, 0x0, 0x7D0, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_F41)
    ...
    QueueWorkItem(0x105, 2, lambda_F74)
    ...
    QueueWorkItem(0xD, 1, lambda_FA5)
    ...
    QueueWorkItem(0x8, 2, lambda_1216)
    ...
    QueueWorkItem(0x8, 3, lambda_12F1)
    OP_A6(0x0)
    ...
    QueueWorkItem(0x8, 1, lambda_1304)
    OP_A6(0x2)
    ...
    QueueWorkItem(0x105, 2, lambda_136B)
    ...
    QueueWorkItem(0x103, 2, lambda_13A8)

    def lambda_13BE():
        OP_99(0xFE, 0x0, 0x3, 0x7D0)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_13BE)
    ...
    QueueWorkItem(0x8, 1, lambda_157C)
    Sleep(200)
    ...
    QueueWorkItem2(0xD, 1, lambda_15CF)
    ...
    QueueWorkItem2(0x8, 1, lambda_1A53)

    def lambda_1A64():
        OP_6D(1670, 12000, 63950, 2000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_1A64)

    def lambda_1A7C():
        OP_6E(347, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1A7C)

    def lambda_1A8C():
        OP_67(0, 6160, -10000, 2000)
        ExitThread()

    QueueWorkItem(0xD, 3, lambda_1A8C)
    ...
    QueueWorkItem(0x101, 1, lambda_1B92)
    ...
    QueueWorkItem(0x101, 3, lambda_1BC6)

    def lambda_1BDE():
        OP_6C(129000, 2000)
        ExitThread()

    QueueWorkItem(0xD, 2, lambda_1BDE)
    Sleep(200)
    OP_51(0x103, 0x8, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    QueueWorkItem(0x105, 1, lambda_1C33)
    ...
    QueueWorkItem(0x101, 1, lambda_1DE6)

    def lambda_1DF4():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_1DF4)

    def lambda_1E02():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_1E02)

    def lambda_1E10():
        OP_6D(2540, 12000, 61390, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1E10)

    def lambda_1E28():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0xA, 2, lambda_1E28)

    def lambda_1E3A():
        OP_8E(0xFE, 0xD2A, 0x2EE0, 0xE394, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_1E3A)
    Sleep(500)
    ...
    QueueWorkItem(0x9, 2, lambda_1E5A)

    def lambda_1E6C():
        OP_8E(0xFE, 0x7D0, 0x2EE0, 0xE876, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_1E6C)
    Sleep(500)
    ...
    QueueWorkItem2(0xB, 1, lambda_1E8C)

    def lambda_1E9D():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0xB, 2, lambda_1E9D)

    def lambda_1EAF():
        OP_8E(0xFE, 0x816, 0x2EE0, 0xE204, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 3, lambda_1EAF)
    Sleep(500)
    ...
    QueueWorkItem2(0xC, 1, lambda_1ECF)

    def lambda_1EE0():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0xC, 2, lambda_1EE0)

    def lambda_1EF2():
        OP_8E(0xFE, 0x2C6, 0x2EE0, 0xE448, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xC, 3, lambda_1EF2)

    def lambda_1F0D():
        OP_8E(0xFE, 0xDF2, 0x2EE0, 0xE826, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_1F0D)
    Sleep(500)
    ...
    QueueWorkItem(0x103, 1, lambda_1F2D)

    def lambda_1F48():
        OP_6D(2140, 12000, 59300, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1F48)

    def lambda_1F60():
        OP_6E(307, 2000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_1F60)
    ...
    QueueWorkItem(0x103, 1, lambda_1F95)
    WaitChrThread(0x101, 0x1)
    ...
    QueueWorkItem(0x101, 1, lambda_21B1)

    def lambda_21BF():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_21BF)

    def lambda_21CD():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_21CD)

    def lambda_21DB():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_21DB)

    def lambda_21E9():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_21E9)

    def lambda_21F7():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_21F7)
    ...
    def Function_5_29C5(): pass

    label("Function_5_29C5")
    ...
    QueueWorkItem(0xFE, 3, lambda_29FB)
    ...
    QueueWorkItem(0xFE, 3, lambda_2A2D)
    ...
    QueueWorkItem(0xFE, 3, lambda_2A5C)
    Return()

    # Function_5_29C5 end

    def Function_6_2A67(): pass

    label("Function_6_2A67")
