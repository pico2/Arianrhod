...
def main():
    ...
    ScpFunction(
        ...
        "Function_2_77B",          # 02, 2
        "Function_3_8F3",          # 03, 3
        "Function_4_11D6",         # 04, 4
        "Function_5_124D",         # 05, 5
        "Function_6_129C",         # 06, 6
        "Function_7_12F6",         # 07, 7
        "Function_8_1427",         # 08, 8
    )
    ...
    EventBegin(0x2)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_80F")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_877")
    ...
    def Function_3_8F3(): pass

    label("Function_3_8F3")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA7, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAA, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_11D5")
    EventBegin(0x0)
    OP_A2(0x550)
    ...
    QueueWorkItem2(0x101, 3, lambda_9CF)
    ...
    QueueWorkItem2(0x102, 3, lambda_9E0)
    ...
    QueueWorkItem2(0x107, 3, lambda_9F1)
    ...
    QueueWorkItem2(0x106, 3, lambda_A02)

    def lambda_A13():
        OP_8E(0xFE, 0xFFFFC086, 0x0, 0xFFFFEA98, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_A13)
    OP_0D()
    ...
    QueueWorkItem(0x101, 2, lambda_B93)
    OP_44(0x101, 0x3)
    OP_44(0x102, 0x3)
    OP_44(0x107, 0x3)
    OP_44(0x106, 0x3)
    ...
    QueueWorkItem(0x8, 3, lambda_BBB)

    def lambda_BC9():
        TurnDirection(0xFE, 0x106, 400)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_BC9)

    def lambda_BD7():
        TurnDirection(0xFE, 0x106, 400)
        ExitThread()

    QueueWorkItem(0x107, 3, lambda_BD7)
    ...
    QueueWorkItem(0x106, 1, lambda_CD4)
    ...
    QueueWorkItem(0x106, 1, lambda_D16)
    ...
    QueueWorkItem(0x101, 2, lambda_1069)

    def lambda_1077():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_1077)

    def lambda_1085():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x107, 3, lambda_1085)
    ...
    def Function_4_11D6(): pass

    label("Function_4_11D6")
    ...
    def Function_6_129C(): pass

    label("Function_6_129C")
    ...
    def Function_7_12F6(): pass

    label("Function_7_12F6")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xB3, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_13E6")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_136C")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_8_1427(): pass

    label("Function_8_1427")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xB3, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1517")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F6, 1)"), scpexpr(EXPR_END)), "loc_149D")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
