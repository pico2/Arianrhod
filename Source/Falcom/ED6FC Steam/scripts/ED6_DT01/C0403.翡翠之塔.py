...
def main():
    ...
    ScpFunction(
        ...
        "Function_3_4A1",          # 03, 3
        "Function_4_C7F",          # 04, 4
        "Function_5_101A",         # 05, 5
        "Function_6_1029",         # 06, 6
        "Function_7_16E8",         # 07, 7
        "Function_8_1BAE",         # 08, 8
        "Function_9_33A6",         # 09, 9
        "Function_10_33C0",        # 0A, 10
        "Function_11_33E6",        # 0B, 11
        "Function_12_3400",        # 0C, 12
        "Function_13_341A",        # 0D, 13
        "Function_14_3455",        # 0E, 14
        "Function_15_358F",        # 0F, 15
        "Function_16_362B",        # 10, 16
        "Function_17_367F",        # 11, 17
        "Function_18_391D",        # 12, 18
        "Function_19_397D",        # 13, 19
    )
    ...
    TalkBegin(0xB)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4B, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9A0")
    EventBegin(0x0)
    ClearMapFlags(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C17")
    OP_A2(0x3)
    EventBegin(0x0)
    ClearMapFlags(0x1)
    OP_51(0xF, 0x1, (scpexpr(EXPR_GET_CHR_WORK, 0xB, 0x1), scpexpr(EXPR_GET_CHR_WORK, 0x101, 0x1), scpexpr(EXPR_ADD), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_IDIV), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    TalkBegin(0xC)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4A, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4A, 7)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4B, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_F8C")
    EventBegin(0x0)
    OP_44(0x101, 0xFF)
    OP_44(0xC, 0xFF)
    OP_44(0xD, 0xFF)
    ...
    def Function_5_101A(): pass

    label("Function_5_101A")
    ...
    def Function_6_1029(): pass

    label("Function_6_1029")

    TalkBegin(0xD)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4A, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1501")
    EventBegin(0x0)
    OP_A2(0x256)
    ClearMapFlags(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_163D")
    OP_A2(0x4)
    EventBegin(0x0)
    ClearMapFlags(0x1)
    OP_51(0xF, 0x1, (scpexpr(EXPR_GET_CHR_WORK, 0xD, 0x1), scpexpr(EXPR_GET_CHR_WORK, 0x101, 0x1), scpexpr(EXPR_ADD), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_IDIV), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    def Function_7_16E8(): pass

    label("Function_7_16E8")

    TalkBegin(0xE)
    SetChrChipByIndex(0xE, 9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4A, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_19FE")
    EventBegin(0x0)
    ClearMapFlags(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1B8D")
    OP_A2(0x5)
    EventBegin(0x0)
    ClearMapFlags(0x1)
    OP_51(0xF, 0x1, (scpexpr(EXPR_GET_CHR_WORK, 0xE, 0x1), scpexpr(EXPR_GET_CHR_WORK, 0x101, 0x1), scpexpr(EXPR_ADD), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_IDIV), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    def Function_8_1BAE(): pass

    label("Function_8_1BAE")
    ...
    QueueWorkItem(0x101, 1, lambda_1C7B)

    def lambda_1C93():
        OP_8E(0xFE, 0xFFFFFFD8, 0x0, 0x11C6, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 0, lambda_1C93)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 0, lambda_1CB3)
    Sleep(500)
    ...
    QueueWorkItem(0xE, 0, lambda_1CD3)
    Sleep(500)
    ...
    QueueWorkItem(0xC, 0, lambda_1CF3)
    Sleep(3500)
    Fade(1000)
    OP_6D(90, 0, 3680, 0)
    OP_6B(3700, 0)
    ...
    QueueWorkItem(0x101, 1, lambda_1E40)

    def lambda_1E58():
        OP_67(0, 5170, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_1E58)

    def lambda_1E70():
        OP_6B(4840, 3000)
        ExitThread()

    QueueWorkItem(0x1, 2, lambda_1E70)
    Sleep(3000)
    ...
    QueueWorkItem(0x1, 1, lambda_1F7A)

    def lambda_1F92():
        OP_6B(3700, 1500)
        ExitThread()

    QueueWorkItem(0x1, 2, lambda_1F92)
    Sleep(1500)
    ...
    QueueWorkItem(0x101, 1, lambda_23EF)
    ...
    def Function_9_33A6(): pass

    label("Function_9_33A6")
    ...
    def Function_10_33C0(): pass

    label("Function_10_33C0")
    ...
    # Function_10_33C0 end

    def Function_11_33E6(): pass

    label("Function_11_33E6")

    Sleep(1500)
    OP_8E(0xD, 0xFFFFFBC4, 0x3B6, 0x2F52, 0xBB8, 0x0)
    Return()

    # Function_11_33E6 end

    def Function_12_3400(): pass

    label("Function_12_3400")

    Sleep(1500)
    OP_8E(0xE, 0xE1, 0x3B6, 0x2EBE, 0xBB8, 0x0)
    Return()

    # Function_12_3400 end

    def Function_13_341A(): pass

    label("Function_13_341A")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_3454")
    TurnDirection(0x0, 0xFE, 0)
    TurnDirection(0xC, 0xFE, 0)
    TurnDirection(0xD, 0xFE, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_3449")
    ...
    OP_48()
    Jump("Function_13_341A")

    label("loc_3454")

    Return()

    # Function_13_341A end

    def Function_14_3455(): pass

    label("Function_14_3455")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_358E")
    SetChrChipByIndex(0xE, 9)
    ...
    SetChrChipByIndex(0xE, 10)
    Sleep(2000)
    Jump("Function_14_3455")

    label("loc_358E")

    Return()

    # Function_14_3455 end

    def Function_15_358F(): pass

    label("Function_15_358F")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_362A")
    ...
    OP_8B(0xB, 0x8E, 0x3E1C, 0x190)
    Sleep(1000)
    Jump("Function_15_358F")

    label("loc_362A")

    Return()

    # Function_15_358F end

    def Function_16_362B(): pass

    label("Function_16_362B")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4B, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4A, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_367E")
    EventBegin(0x1)
    ClearMapFlags(0x1)
    ...
    # Function_16_362B end

    def Function_17_367F(): pass

    label("Function_17_367F")
    ...
    # Function_17_367F end

    def Function_18_391D(): pass

    label("Function_18_391D")
    ...
    # Function_18_391D end

    def Function_19_397D(): pass

    label("Function_19_397D")
