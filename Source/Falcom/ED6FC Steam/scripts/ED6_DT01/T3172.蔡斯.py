...
def main():
    ...
    ScpFunction(
        ...
        "Function_6_CA9",          # 06, 6
        "Function_7_D73",          # 07, 7
        "Function_8_2351",         # 08, 8
        "Function_9_23BD",         # 09, 9
        "Function_10_23CF",        # 0A, 10
        "Function_11_2EEB",        # 0B, 11
        "Function_12_3BEE",        # 0C, 12
        "Function_13_4156",        # 0D, 13
        "Function_14_42D2",        # 0E, 14
    )
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_END)), "loc_49D")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_430")
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_397")
    ...
    def Function_4_4A1(): pass

    label("Function_4_4A1")
    ...
    QueueWorkItem(0x107, 2, lambda_5D5)
    OP_8C(0x107, 90, 400)
    Sleep(300)
    OP_8C(0x102, 90, 400)
    OP_8C(0x101, 90, 400)
    ...
    QueueWorkItem(0x8, 2, lambda_7F6)

    def lambda_80E():
        OP_8E(0xFE, 0x7468, 0x0, 0x846C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_80E)
    Sleep(800)
    ...
    QueueWorkItem(0x107, 1, lambda_82E)
    Sleep(200)
    ...
    QueueWorkItem(0x102, 1, lambda_84E)
    ...
    QueueWorkItem(0x101, 1, lambda_86E)
    ...
    QueueWorkItem2(0x102, 1, lambda_A2E)
    ...
    QueueWorkItem2(0x107, 1, lambda_A3F)
    ...
    QueueWorkItem(0x8, 2, lambda_A78)

    def lambda_A90():
        OP_8E(0xFE, 0x7486, 0x0, 0x90BA, 0x1F40, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_A90)
    Sleep(200)
    ...
    QueueWorkItem(0x8, 3, lambda_AF7)
    ...
    def Function_6_CA9(): pass

    label("Function_6_CA9")
    ...
    def Function_7_D73(): pass

    label("Function_7_D73")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2350")
    EventBegin(0x0)
    ...
    QueueWorkItem2(0x101, 1, lambda_DDA)
    ...
    QueueWorkItem2(0x102, 1, lambda_DEB)
    ...
    QueueWorkItem2(0x107, 1, lambda_DFC)

    def lambda_E0D():
        OP_8E(0xFE, 0x7A44, 0xFFFFFC18, 0x1DB0, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x107, 2, lambda_E0D)
    Sleep(100)
    ...
    QueueWorkItem(0x101, 2, lambda_E2D)
    Sleep(100)
    ...
    QueueWorkItem(0x102, 2, lambda_E4D)
    ...
    QueueWorkItem(0x8, 2, lambda_102B)

    def lambda_1043():
        OP_8E(0xFE, 0x7EFD, 0xFFFFFC18, 0x2936, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_1043)
    Sleep(300)
    ...
    QueueWorkItem2(0x101, 1, lambda_1256)
    OP_8C(0x102, 180, 600)
    ...
    def Function_8_2351(): pass

    label("Function_8_2351")
    ...
    QueueWorkItem(0xFE, 2, lambda_2397)
    ...
    def Function_9_23BD(): pass

    label("Function_9_23BD")
    ...
    def Function_10_23CF(): pass

    label("Function_10_23CF")
    ...
    QueueWorkItem(0x101, 1, lambda_24CF)
    Sleep(300)
    ...
    QueueWorkItem2(0x107, 2, lambda_24EF)
    ...
    QueueWorkItem2(0x8, 2, lambda_2500)
    WaitChrThread(0x101, 0x1)
    OP_8C(0x101, 90, 400)
    ...
    QueueWorkItem(0x107, 1, lambda_2589)

    def lambda_2597():
        OP_8C(0xFE, 270, 400)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_2597)
    ...
    QueueWorkItem(0x101, 2, lambda_2789)
    OP_20(0x3E8)
    OP_8C(0x107, 0, 400)
    OP_8C(0x8, 90, 400)
    OP_21()
    ...
    QueueWorkItem(0x101, 2, lambda_2C78)

    def lambda_2C90():
        OP_6B(3160, 5000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_2C90)

    def lambda_2CA0():
        OP_67(0, 3400, -10000, 5000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_2CA0)
    Sleep(1000)
    OP_23(0x9E)
    OP_23(0xC9)
    OP_22(0x90, 0x0, 0x64)
    ...
    QueueWorkItem(0x8, 1, lambda_2D48)
    Sleep(100)
    ...
    QueueWorkItem(0x107, 1, lambda_2D63)
    WaitChrThread(0x107, 0x1)
    ...
    # Function_10_23CF end

    def Function_11_2EEB(): pass

    label("Function_11_2EEB")
    ...
    QueueWorkItem(0x101, 2, lambda_31AC)

    def lambda_31C4():
        OP_6B(2750, 5000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_31C4)
    ...
    QueueWorkItem2(0x101, 1, lambda_3463)
    ...
    QueueWorkItem2(0x107, 1, lambda_3474)
    ...
    QueueWorkItem2(0x8, 1, lambda_3485)

    def lambda_3496():
        OP_6D(32900, -1000, 8060, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_3496)
    ...
    QueueWorkItem(0x102, 1, lambda_35E9)

    def lambda_35F7():
        TurnDirection(0x107, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x107, 1, lambda_35F7)
    ...
    QueueWorkItem2(0x107, 1, lambda_37F3)
    ...
    QueueWorkItem2(0x102, 1, lambda_3804)
    ...
    QueueWorkItem2(0x8, 1, lambda_3815)
    ...
    # Function_11_2EEB end

    def Function_12_3BEE(): pass

    label("Function_12_3BEE")
    ...
    QueueWorkItem2(0x101, 1, lambda_3D6A)
    ...
    QueueWorkItem2(0x102, 1, lambda_3D7B)
    ...
    QueueWorkItem(0x106, 1, lambda_41EA)

    def lambda_41F8():
        TurnDirection(0xFE, 0x107, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_41F8)

    def lambda_4206():
        TurnDirection(0xFE, 0x107, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_4206)
    ...
    def Function_14_42D2(): pass

    label("Function_14_42D2")
