...
def main():
    ...
    ScpFunction(
        ...
        "Function_7_C48",          # 07, 7
        "Function_8_C55",          # 08, 8
        "Function_9_126A",         # 09, 9
        "Function_10_1C9E",        # 0A, 10
        "Function_11_1CD9",        # 0B, 11
        "Function_12_2547",        # 0C, 12
        "Function_13_2939",        # 0D, 13
        "Function_14_2A89",        # 0E, 14
    )
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 7)), scpexpr(EXPR_END)), "loc_3E5")
    Jump("loc_52B")

    label("loc_3E5")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_END)), "loc_458")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 6)), scpexpr(EXPR_END)), "loc_462")
    Jump("loc_52B")

    label("loc_462")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_END)), "loc_46C")
    Jump("loc_52B")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_52B")
    ...
    def Function_5_52F(): pass

    label("Function_5_52F")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_53B")
    Call(0, 6)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C47")
    OP_A2(0x63B)
    EventBegin(0x0)
    Fade(1000)
    ...
    def Function_7_C48(): pass

    label("Function_7_C48")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C54")
    Call(0, 8)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1269")
    OP_A2(0x63A)
    EventBegin(0x0)
    EventBegin(0x0)
    Fade(1000)
    ...
    def Function_9_126A(): pass

    label("Function_9_126A")
    ...
    QueueWorkItem(0xC, 1, lambda_12CA)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_12EA)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 1, lambda_130A)
    Sleep(500)
    ...
    QueueWorkItem(0x108, 1, lambda_132A)
    ...
    QueueWorkItem(0xC, 1, lambda_134A)
    ...
    QueueWorkItem(0x102, 1, lambda_136A)
    ...
    QueueWorkItem(0x108, 1, lambda_13AA)
    WaitChrThread(0xC, 0x1)
    Sleep(200)
    ...
    QueueWorkItem(0x102, 1, lambda_15D8)

    def lambda_15E6():
        TurnDirection(0xFE, 0xC, 400)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_15E6)
    ...
    QueueWorkItem(0xC, 1, lambda_19CD)
    ...
    QueueWorkItem(0x102, 1, lambda_1A5B)
    ...
    QueueWorkItem(0x108, 1, lambda_1AB0)
    ...
    QueueWorkItem(0x102, 1, lambda_1BE0)
    ...
    def Function_10_1C9E(): pass

    label("Function_10_1C9E")
    ...
    QueueWorkItem(0xFE, 3, lambda_1CB8)
    OP_8E(0xFE, 0xFFFECB68, 0x0, 0x2602, 0xBB8, 0x0)
    Return()

    # Function_10_1C9E end

    def Function_11_1CD9(): pass

    label("Function_11_1CD9")
    ...
    QueueWorkItem(0x101, 3, lambda_1DD9)

    def lambda_1DF1():
        OP_8E(0xFE, 0xFFFEBD4E, 0x0, 0xCDA0, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1DF1)
    WaitChrThread(0x101, 0x1)
    ...
    QueueWorkItem(0x101, 1, lambda_1E11)
    WaitChrThread(0x102, 0x1)
    ...
    QueueWorkItem(0x102, 1, lambda_1E31)
    WaitChrThread(0x101, 0x1)
    TurnDirection(0x101, 0x108, 400)
    ...
    QueueWorkItem(0x101, 1, lambda_230A)

    def lambda_2318():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_2318)
    Sleep(1000)
    ...
    QueueWorkItem(0x108, 1, lambda_23DA)
    ...
    # Function_11_1CD9 end

    def Function_12_2547(): pass

    label("Function_12_2547")
    ...
    # Function_12_2547 end

    def Function_13_2939(): pass

    label("Function_13_2939")
    ...
    QueueWorkItem(0x101, 1, lambda_2974)
    Sleep(600)
    ...
    QueueWorkItem(0x102, 1, lambda_2994)
    WaitChrThread(0x101, 0x1)
    ...
    QueueWorkItem(0x101, 1, lambda_29B4)
    WaitChrThread(0x102, 0x1)
    ...
    QueueWorkItem(0x102, 1, lambda_29C7)
    ...
    # Function_13_2939 end

    def Function_14_2A89(): pass

    label("Function_14_2A89")
    ...
    QueueWorkItem(0x101, 3, lambda_2AF6)

    def lambda_2B0E():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0x108, 2, lambda_2B0E)

    def lambda_2B20():
        OP_8E(0xFE, 0xFFFEC762, 0x0, 0xDA52, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_2B20)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 2, lambda_2B40)

    def lambda_2B52():
        OP_8E(0xFE, 0xFFFEC640, 0x0, 0xD426, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_2B52)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 2, lambda_2B72)
