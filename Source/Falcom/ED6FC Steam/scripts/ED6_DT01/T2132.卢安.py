...
def main():
    ...
    ScpFunction(
        ...
        "Function_6_10DD",         # 06, 6
        "Function_7_121E",         # 07, 7
        "Function_8_1272",         # 08, 8
        "Function_9_12C2",         # 09, 9
        "Function_10_12E8",        # 0A, 10
        "Function_11_132A",        # 0B, 11
        "Function_12_135E",        # 0C, 12
        "Function_13_13B1",        # 0D, 13
        "Function_14_145D",        # 0E, 14
        "Function_15_16DC",        # 0F, 15
        "Function_16_170A",        # 10, 16
        "Function_17_2FC0",        # 11, 17
        "Function_18_3B88",        # 12, 18
    )
    ...
    OP_5F(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_444")
    OP_0D()
    OP_A9(0x21)
    OP_56(0x0)
    TalkEnd(0x8)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_455")
    TalkEnd(0x8)
    Return()

    label("loc_455")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 0)), scpexpr(EXPR_END)), "loc_4B5")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_528")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 4)), scpexpr(EXPR_END)), "loc_5C5")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 5)), scpexpr(EXPR_END)), "loc_67B")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 4)), scpexpr(EXPR_END)), "loc_773")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_707")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 2)), scpexpr(EXPR_END)), "loc_89F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 3)), scpexpr(EXPR_END)), "loc_987")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_926")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 2)), scpexpr(EXPR_END)), "loc_B08")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x99, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_AB7")
    OP_A2(0x4CD)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 1)), scpexpr(EXPR_END)), "loc_B6E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 0)), scpexpr(EXPR_END)), "loc_FF8")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_F9C")
    EventBegin(0x0)
    Fade(1000)
    OP_69(0x8, 0x0)
    OP_6B(2800, 0)
    ...
    QueueWorkItem(0x136, 2, lambda_E54)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 1)), scpexpr(EXPR_END)), "loc_10D8")
    ...
    def Function_6_10DD(): pass

    label("Function_6_10DD")

    TalkBegin(0xA)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_11AC")
    OP_A2(0x2)
    ...
    def Function_7_121E(): pass

    label("Function_7_121E")
    ...
    def Function_9_12C2(): pass

    label("Function_9_12C2")
    ...
    def Function_12_135E(): pass

    label("Function_12_135E")
    ...
    # Function_12_135E end

    def Function_13_13B1(): pass

    label("Function_13_13B1")

    TalkBegin(0x11)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 4)), scpexpr(EXPR_END)), "loc_142E")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1404")
    OP_A2(0x1)
    ...
    # Function_13_13B1 end

    def Function_14_145D(): pass

    label("Function_14_145D")
    ...
    QueueWorkItem(0x102, 1, lambda_1518)
    ...
    QueueWorkItem(0x101, 2, lambda_158F)

    def lambda_15A7():
        OP_6C(0, 4500)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_15A7)

    def lambda_15B7():
        OP_8E(0xFE, 0xFFFFE660, 0x0, 0x142B2, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_15B7)
    Sleep(500)
    OP_8C(0x102, 315, 400)
    ...
    def Function_16_170A(): pass

    label("Function_16_170A")
    ...
    QueueWorkItem2(0xB, 1, lambda_1948)

    def lambda_1959():
        OP_6D(-7270, 0, 83010, 2000)
        ExitThread()

    QueueWorkItem(0xB, 2, lambda_1959)
    ...
    QueueWorkItem(0xB, 2, lambda_23BF)
    ...
    QueueWorkItem2(0x101, 1, lambda_23D7)
    ...
    QueueWorkItem2(0x102, 1, lambda_23E8)
    ...
    QueueWorkItem(0x101, 2, lambda_23FE)

    def lambda_2419():
        OP_8E(0xFE, 0xFFFFEC14, 0x0, 0x14924, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_2419)
    ...
    QueueWorkItem(0xB, 1, lambda_27C0)
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    ...
    QueueWorkItem(0x9, 2, lambda_2BA3)

    def lambda_2BBB():
        OP_8E(0xFE, 0xFFFFF66E, 0x0, 0x1D42, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_2BBB)
    OP_8C(0x101, 225, 400)
    OP_8C(0x102, 180, 400)
    ...
    # Function_16_170A end

    def Function_17_2FC0(): pass

    label("Function_17_2FC0")
    ...
    QueueWorkItem(0x9, 1, lambda_30AB)

    def lambda_30C3():
        OP_6B(1100, 2000)
        ExitThread()

    QueueWorkItem(0x9, 2, lambda_30C3)

    def lambda_30D3():
        OP_8E(0xFE, 0xFFFF42FA, 0x0, 0xD20A, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_30D3)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 1, lambda_3118)
    WaitChrThread(0x102, 0x1)
    ...
    QueueWorkItem(0x102, 1, lambda_312B)
    ...
    # Function_17_2FC0 end

    def Function_18_3B88(): pass

    label("Function_18_3B88")

    EventBegin(0x1)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_3C38")
    OP_A2(0x3)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3BAB")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3C4E")
    TurnDirection(0x102, 0x1, 400)
    Jump("loc_3C55")
