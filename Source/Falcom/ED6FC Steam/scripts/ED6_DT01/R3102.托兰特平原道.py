...
def main():
    ...
    AddCharChip(
        ...
        'ED6_DT09/CH10080 ._CH',             # 11
        'ED6_DT09/CH10081 ._CH',             # 12
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 2)), scpexpr(EXPR_END)), "loc_B84")
    ...
    def Function_4_B85(): pass

    label("Function_4_B85")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 2)), scpexpr(EXPR_END)), "loc_EB5")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x346)"), scpexpr(EXPR_EXEC_OP, "OP_29(0x28, 0x0, 0x10)"), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_EXEC_OP, "OP_29(0x29, 0x0, 0x10)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_BAA")
    Call(1, 3)
    Jump("loc_EB5")

    label("loc_BAA")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x28, 0x1, 0x1)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_BBD")
    Call(1, 2)
    Jump("loc_EB5")

    label("loc_BBD")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x29, 0x1, 0x4000)"), scpexpr(EXPR_END)), "loc_C26")
    TalkBegin(0xFE)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x29, 0x1, 0x1)"), scpexpr(EXPR_END)), "loc_DDB")
    TalkBegin(0xFE)
    OP_A2(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_E4C")
    SetChrFlags(0xFE, 0x10)
    TalkBegin(0xFE)
    ...
    def Function_6_EC1(): pass

    label("Function_6_EC1")

    EventBegin(0x2)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_F08")
    ...
    def Function_8_FB5(): pass

    label("Function_8_FB5")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xB3, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_117B")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xB4, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_10AD")
    ...
    QueueWorkItem(0x15, 1, lambda_1004)

    def lambda_101F():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x4B0)
        ExitThread()

    QueueWorkItem(0x15, 2, lambda_101F)
    ...
    CloseMessageWindow()
    OP_56(0x0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA7, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1062")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x130, 1)"), scpexpr(EXPR_END)), "loc_1103")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
