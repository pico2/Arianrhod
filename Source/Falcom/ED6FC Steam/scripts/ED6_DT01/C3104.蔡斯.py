...
def main():
    ...
    ScpFunction(
        ...
        "Function_1_C6",           # 01, 1
        "Function_2_E4",           # 02, 2
        "Function_3_15B3",         # 03, 3
        "Function_4_15B4",         # 04, 4
    ...
    QueueWorkItem(0x107, 1, lambda_619)
    ...
    QueueWorkItem(0x106, 1, lambda_83A)

    def lambda_848():
        TurnDirection(0xFE, 0x10B, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_848)

    def lambda_856():
        TurnDirection(0xFE, 0x10B, 400)
        ExitThread()

    QueueWorkItem(0x107, 1, lambda_856)
    ...
    QueueWorkItem(0x107, 1, lambda_D3A)
    Sleep(400)
    ...
    QueueWorkItem(0x106, 1, lambda_D8A)
    ...
    QueueWorkItem(0x107, 3, lambda_ECF)
    ...
    QueueWorkItem2(0x101, 1, lambda_EE7)
    ...
    QueueWorkItem2(0x102, 1, lambda_EF8)
    ...
    QueueWorkItem2(0x106, 1, lambda_F09)
    ...
    QueueWorkItem2(0x10B, 1, lambda_F1A)
    ...
    QueueWorkItem(0x107, 1, lambda_F39)
    OP_48()
    OP_8C(0x107, 0, 0)
    ...
    QueueWorkItem(0x102, 1, lambda_1120)
    TurnDirection(0x101, 0x106, 400)
    ...
    QueueWorkItem(0x106, 1, lambda_13E0)
    OP_8C(0x107, 270, 400)
    ...
    QueueWorkItem(0x107, 1, lambda_1402)
    Sleep(400)
    OP_8C(0x10B, 315, 400)
    ...
    QueueWorkItem(0x10B, 1, lambda_1429)
    OP_8C(0x101, 270, 400)
    Sleep(2000)
    OP_20(0x9C4)
    FadeToDark(2000, 0, -1)
    ...
    MenuEnd(0x0)
    OP_5F(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1530")
    ShowSaveMenu()
    ...
    OP_28(0x54, 0x4, 0x2)
    OP_28(0x54, 0x4, 0x4)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x44, 0x1, 0x8000)"), scpexpr(EXPR_END)), "loc_157B")
    Jump("loc_15A6")

    label("loc_157B")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x44, 0x1, 0x4000)"), scpexpr(EXPR_END)), "loc_158E")
    OP_2B(0x43, 0x1)
    Jump("loc_15A6")

    label("loc_158E")

    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x44, 0x1, 0x2000)"), scpexpr(EXPR_END)), "loc_15A1")
    OP_2B(0x43, 0x2)
    Jump("loc_15A6")
    ...
    def Function_3_15B3(): pass

    label("Function_3_15B3")

    Return()

    # Function_3_15B3 end

    def Function_4_15B4(): pass

    label("Function_4_15B4")
