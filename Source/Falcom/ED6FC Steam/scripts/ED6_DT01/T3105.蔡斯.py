...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_D1C",          # 08, 8
        "Function_9_F7F",          # 09, 9
        "Function_10_FBD",         # 0A, 10
        "Function_11_1E43",        # 0B, 11
        "Function_12_2B57",        # 0C, 12
        "Function_13_2DDC",        # 0D, 13
        "Function_14_2E80",        # 0E, 14
        "Function_15_2E85",        # 0F, 15
        "Function_16_34F7",        # 10, 16
        "Function_17_3963",        # 11, 17
        "Function_18_3C18",        # 12, 18
        "Function_19_48F0",        # 13, 19
        "Function_20_498A",        # 14, 20
    )
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 3)), scpexpr(EXPR_END)), "loc_74D")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 1)), scpexpr(EXPR_END)), "loc_7A7")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 5)), scpexpr(EXPR_END)), "loc_81B")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_873")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAA, 0)), scpexpr(EXPR_END)), "loc_93D")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 7)), scpexpr(EXPR_END)), "loc_9BA")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 2)), scpexpr(EXPR_END)), "loc_B52")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 5)), scpexpr(EXPR_END)), "loc_A75")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 3)), scpexpr(EXPR_END)), "loc_BD5")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B89")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 1)), scpexpr(EXPR_END)), "loc_CCA")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 5)), scpexpr(EXPR_END)), "loc_C40")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA1, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_D18")
    ...
    def Function_8_D1C(): pass

    label("Function_8_D1C")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAA, 0)), scpexpr(EXPR_END)), "loc_DBB")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 7)), scpexpr(EXPR_END)), "loc_E99")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 2)), scpexpr(EXPR_END)), "loc_F7B")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_END)), "loc_ED2")
    ...
    def Function_9_F7F(): pass

    label("Function_9_F7F")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_F9F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_END)), "loc_FB9")
    OP_22(0x192, 0x0, 0x64)
    ...
    def Function_10_FBD(): pass

    label("Function_10_FBD")

    TalkBegin(0x9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1311")
    OP_A2(0x604)
    EventBegin(0x0)
    Fade(1000)
    ...
    QueueWorkItem(0x102, 1, lambda_FFE)

    def lambda_100E():
        OP_6B(2750, 2000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_100E)
    ...
    QueueWorkItem(0x101, 1, lambda_121A)
    ...
    QueueWorkItem(0x102, 1, lambda_1259)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_148C")
    OP_A2(0x602)
    OP_28(0x54, 0x1, 0x2)
    EventBegin(0x0)
    OP_69(0x9, 0x3E8)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1935")
    OP_A2(0x517)
    ClearMapFlags(0x1)
    OP_69(0x9, 0x3E8)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 1)), scpexpr(EXPR_END)), "loc_1993")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 5)), scpexpr(EXPR_END)), "loc_19F3")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_1A67")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 7)), scpexpr(EXPR_END)), "loc_1BB2")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_1B0E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 2)), scpexpr(EXPR_END)), "loc_1C77")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 3)), scpexpr(EXPR_END)), "loc_1C9B")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 1)), scpexpr(EXPR_END)), "loc_1DCC")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_1D1E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA1, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_1E3F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAE, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_202B")
    EventBegin(0x0)
    ...
    QueueWorkItem(0x101, 1, lambda_1F78)

    def lambda_1F86():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1F86)

    def lambda_1F94():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x106, 1, lambda_1F94)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 0)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2A19")
    EventBegin(0x0)
    ...
    QueueWorkItem(0x101, 2, lambda_223A)
    ...
    QueueWorkItem2(0xA, 2, lambda_2301)
    ...
    QueueWorkItem2(0x107, 2, lambda_2312)
    ...
    QueueWorkItem2(0x106, 2, lambda_2323)
    Sleep(1000)
    OP_8C(0x101, 315, 400)
    ...
    QueueWorkItem(0x101, 1, lambda_23F6)
    OP_6D(-49360, -4000, 145960, 2000)
    OP_6F(0x0, 500)
    OP_70(0x0, 0x4B0)
    ...
    QueueWorkItem(0x101, 1, lambda_2446)
    ...
    QueueWorkItem(0x101, 2, lambda_2467)
    ...
    QueueWorkItem(0x101, 2, lambda_24BA)

    def lambda_24CA():
        OP_67(0, 11000, -10000, 5000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_24CA)
    OP_6C(90000, 5000)
    OP_73(0x0)
    Sleep(1000)
    ...
    QueueWorkItem(0x101, 1, lambda_24F3)
    ...
    QueueWorkItem2(0xA, 2, lambda_265A)
    ...
    QueueWorkItem2(0x102, 2, lambda_266B)
    ...
    QueueWorkItem2(0x101, 2, lambda_267C)
    ...
    QueueWorkItem2(0x107, 2, lambda_268D)
    ...
    QueueWorkItem2(0x106, 2, lambda_269E)

    def lambda_26AF():
        OP_6D(-44110, -3800, 143890, 3000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_26AF)

    def lambda_26C7():
        OP_8E(0xFE, 0xFFFF4C0A, 0xFFFFF060, 0x2385C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_26C7)

    def lambda_26E2():
        OP_8E(0xFE, 0xFFFF4A8E, 0xFFFFF060, 0x2341A, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_26E2)
    Sleep(100)
    ...
    QueueWorkItem(0x107, 3, lambda_2702)
    Sleep(100)
    ...
    QueueWorkItem(0x106, 3, lambda_2722)
    ...
    QueueWorkItem(0x102, 1, lambda_2974)

    def lambda_2982():
        TurnDirection(0xFE, 0xA, 400)
        ExitThread()

    QueueWorkItem(0x106, 1, lambda_2982)
    TurnDirection(0x107, 0xA, 400)
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 3)), scpexpr(EXPR_END)), "loc_2C09")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_2BB5")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 1)), scpexpr(EXPR_END)), "loc_2CC2")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_2DD8")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_2D2A")
    ...
    def Function_13_2DDC(): pass

    label("Function_13_2DDC")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_2E7C")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_2E40")
    ...
    # Function_13_2DDC end

    def Function_14_2E80(): pass

    label("Function_14_2E80")

    Call(0, 10)
    Return()

    # Function_14_2E80 end

    def Function_15_2E85(): pass

    label("Function_15_2E85")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 7)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_34F6")
    OP_A2(0x518)
    OP_28(0x3F, 0x1, 0x800)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x3F, 0x1, 0x1000)"), scpexpr(EXPR_END)), "loc_2EAB")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3241")
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 1)), scpexpr(EXPR_END)), "loc_346A")
    ...
    # Function_15_2E85 end

    def Function_16_34F7(): pass

    label("Function_16_34F7")
    ...
    QueueWorkItem(0x101, 2, lambda_3781)

    def lambda_3799():
        OP_6B(3360, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_3799)

    def lambda_37A9():
        OP_6C(32000, 3000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_37A9)
    ...
    QueueWorkItem(0x102, 1, lambda_3801)

    def lambda_381C():
        OP_8E(0xFE, 0xFFFF4BF6, 0xFFFFF060, 0x23532, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x107, 1, lambda_381C)
    ...
    # Function_16_34F7 end

    def Function_17_3963(): pass

    label("Function_17_3963")
    ...
    QueueWorkItem(0xA, 3, lambda_3A46)
    ...
    QueueWorkItem2(0xA, 1, lambda_3A5E)
    ...
    # Function_17_3963 end

    def Function_18_3C18(): pass

    label("Function_18_3C18")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_48EF")
    EventBegin(0x0)
    OP_A2(0x603)
    OP_28(0x54, 0x1, 0x4)
    OP_28(0x54, 0x1, 0x8)
    ...
    QueueWorkItem(0x0, 1, lambda_3C5F)

    def lambda_3C77():
        OP_67(0, 7390, -10000, 4000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_3C77)

    def lambda_3C8F():
        OP_6B(3700, 4000)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_3C8F)

    def lambda_3C9F():
        OP_6C(158000, 4000)
        ExitThread()

    QueueWorkItem(0x1, 2, lambda_3C9F)
    Sleep(3000)
    ...
    QueueWorkItem2(0x101, 3, lambda_3CD6)
    ...
    QueueWorkItem2(0x102, 3, lambda_3CE7)

    def lambda_3CF8():
        OP_8E(0xFE, 0xFFFF4D18, 0xFFFFF060, 0x21D40, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0xC, 2, lambda_3CF8)

    def lambda_3D13():
        OP_6D(-45610, -4000, 139000, 3000)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_3D13)
    Sleep(3000)
    ...
    QueueWorkItem(0x0, 1, lambda_3E7B)
    ...
    QueueWorkItem2(0x101, 3, lambda_3E93)
    ...
    QueueWorkItem2(0x102, 3, lambda_3EA4)

    def lambda_3EB5():
        OP_8E(0xFE, 0xFFFF4ADE, 0xFFFFF060, 0x21AD4, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_3EB5)
    Sleep(1000)
    ...
    QueueWorkItem2(0x101, 3, lambda_3ED5)
    ...
    QueueWorkItem2(0x102, 3, lambda_3EE6)

    def lambda_3EF7():
        OP_8E(0xFE, 0xFFFF4D4A, 0x0, 0x1F521, 0x5DC, 0x0)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_3EF7)
    ...
    QueueWorkItem(0x9, 1, lambda_41B8)

    def lambda_41D3():
        OP_6D(-46700, -2500, 134910, 1500)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_41D3)
    ...
    QueueWorkItem2(0x101, 2, lambda_41EB)
    ...
    QueueWorkItem2(0x102, 2, lambda_41FC)
    ...
    QueueWorkItem2(0x8, 2, lambda_420D)
    Sleep(1500)
    ...
    QueueWorkItem2(0x101, 2, lambda_4223)
    ...
    QueueWorkItem2(0x102, 2, lambda_4234)
    ...
    QueueWorkItem2(0x8, 2, lambda_4245)

    def lambda_4256():
        OP_6D(-46010, -4000, 137720, 2000)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_4256)
    ...
    QueueWorkItem2(0x101, 2, lambda_46BB)
    ...
    QueueWorkItem2(0x102, 2, lambda_46CC)
    ...
    QueueWorkItem2(0x8, 2, lambda_4711)
    ...
    # Function_18_3C18 end

    def Function_19_48F0(): pass

    label("Function_19_48F0")
    ...
    # Function_19_48F0 end

    def Function_20_498A(): pass

    label("Function_20_498A")
