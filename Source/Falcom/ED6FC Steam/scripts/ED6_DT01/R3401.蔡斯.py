...
def main():
    ...
    EventBegin(0x0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_589")
    OP_A2(0x504)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_4F6")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_5B9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1A53")
    OP_71(0x0, 0x4)
    OP_71(0x1, 0x4)
    OP_A2(0x506)
    EventBegin(0x0)
    ...
    QueueWorkItem(0x107, 1, lambda_7C1)
    Sleep(1000)
    OP_22(0xD8, 0x0, 0x64)
    ...
    QueueWorkItem(0x107, 1, lambda_87B)
    SetChrChipByIndex(0x107, 2)
    ...
    QueueWorkItem(0x8, 1, lambda_8F3)

    def lambda_909():
        OP_94(0x1, 0xFE, 0xB4, 0x3E8, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_909)

    def lambda_91F():
        OP_94(0x1, 0xFE, 0xE6, 0x2BC, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_91F)

    def lambda_935():
        OP_94(0x1, 0xFE, 0x5A, 0x1F4, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_935)
    Sleep(1000)
    ...
    QueueWorkItem(0x8, 1, lambda_955)
    ...
    QueueWorkItem(0xA, 1, lambda_97B)
    ...
    QueueWorkItem(0xB, 1, lambda_98E)
    OP_8C(0x107, 270, 0)
    Sleep(400)
    ...
    QueueWorkItem(0x101, 1, lambda_A5F)
    ...
    QueueWorkItem(0xA, 1, lambda_A8B)
    OP_63(0xA)
    Sleep(300)
    ...
    QueueWorkItem(0x9, 1, lambda_AC2)
    OP_63(0x9)
    Sleep(600)
    ...
    QueueWorkItem(0x8, 1, lambda_AE0)
    OP_63(0x8)
    ...
    QueueWorkItem(0xA, 1, lambda_B71)
    Sleep(150)
    ...
    QueueWorkItem(0x9, 1, lambda_BA2)
    Sleep(300)
    ...
    QueueWorkItem(0x8, 1, lambda_BBD)
    Sleep(400)
    ...
    QueueWorkItem(0xA, 1, lambda_C08)
    SetChrFlags(0x101, 0x1000)
    SetChrFlags(0x102, 0x1000)
    ...
    QueueWorkItem(0x101, 0, lambda_C32)

    def lambda_C42():
        OP_6D(203200, 0, -24900, 1500)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_C42)

    def lambda_C5A():
        OP_6C(78000, 1200)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_C5A)
    ...
    QueueWorkItem(0x102, 1, lambda_C97)

    def lambda_CB2():
        OP_8C(0xFE, 135, 400)
        ExitThread()

    QueueWorkItem(0x107, 2, lambda_CB2)
    ...
    QueueWorkItem(0x107, 1, lambda_CCA)
    ...
    QueueWorkItem(0x101, 3, lambda_CF5)
    OP_22(0xA4, 0x0, 0x64)
    ...
    QueueWorkItem(0xA, 1, lambda_D6C)
    ...
    QueueWorkItem(0xB, 1, lambda_DC5)
    ...
    QueueWorkItem(0x101, 0, lambda_F8A)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x6, 0x1, 0x8)"), scpexpr(EXPR_END)), "loc_117A")
    ...
    def Function_5_1A54(): pass

    label("Function_5_1A54")
    ...
    OP_5F(0x0)
    OP_56(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x1), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1C70")
    FadeToBright(100, 0)
    Sleep(500)
    SoundLoad(13)
    OP_82(0x0, 0x2)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x1), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1C8A")
    FadeToBright(300, 0)
    TalkEnd(0xFF)
    Return()
