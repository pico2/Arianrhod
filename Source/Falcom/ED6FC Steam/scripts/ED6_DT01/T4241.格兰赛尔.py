...
def main():
    ...
    QueueWorkItem(0x0, 2, lambda_70B)
    ...
    QueueWorkItem(0x101, 2, lambda_818)
    ...
    QueueWorkItem(0xA, 1, lambda_8A3)
    ...
    QueueWorkItem(0xF, 1, lambda_9EA)
    ...
    QueueWorkItem2(0x105, 1, lambda_AB0)
    ...
    QueueWorkItem2(0x103, 1, lambda_AC1)
    Sleep(50)
    ...
    QueueWorkItem2(0x8, 1, lambda_B05)
    ...
    QueueWorkItem2(0x9, 1, lambda_B16)
    Sleep(50)
    ...
    QueueWorkItem2(0xB, 1, lambda_B5A)
    ...
    QueueWorkItem2(0xC, 1, lambda_B6B)
    WaitChrThread(0x0, 0x2)
    ...
    QueueWorkItem(0xF, 2, lambda_BE4)
    Sleep(200)
    SetChrFlags(0xA, 0x4)
    ...
    QueueWorkItem(0xA, 2, lambda_C09)
    ...
    QueueWorkItem2(0xA, 1, lambda_C24)
    WaitChrThread(0x0, 0x2)
    ...
    QueueWorkItem2(0xA, 1, lambda_D03)
    ...
    QueueWorkItem2(0x101, 1, lambda_DCD)
    Sleep(50)
    ...
    QueueWorkItem2(0x105, 1, lambda_DE3)
    ...
    QueueWorkItem2(0x103, 1, lambda_DF4)
    Sleep(50)
    ...
    QueueWorkItem2(0x8, 1, lambda_E0A)
    ...
    QueueWorkItem2(0x9, 1, lambda_E1B)
    Sleep(50)
    ...
    QueueWorkItem2(0xB, 1, lambda_E31)
    ...
    QueueWorkItem2(0xC, 1, lambda_E42)
    ...
    QueueWorkItem2(0xF, 1, lambda_E53)
    WaitChrThread(0x101, 0x2)
    ...
    QueueWorkItem(0xE, 1, lambda_F36)

    def lambda_F48():
        OP_8E(0xFE, 0xFFFFFBA0, 0x0, 0xFFFEDC16, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0xE, 2, lambda_F48)
    Sleep(600)
    ...
    QueueWorkItem(0xD, 1, lambda_F68)

    def lambda_F7A():
        OP_8E(0xFE, 0xE6, 0x0, 0xFFFEDB30, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 2, lambda_F7A)
    OP_31(0x5, 0x0, 0x22)
    OP_B5(0x5, 0x0)
    OP_B5(0x5, 0x1)
    OP_B5(0x5, 0x2)
    ...
    QueueWorkItem(0xE, 2, lambda_10B3)
    ...
    QueueWorkItem2(0xE, 1, lambda_10CE)

    def lambda_10DF():
        OP_8E(0xFE, 0xFFFFF880, 0x0, 0xFFFEE9AE, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 2, lambda_10DF)
    ...
    QueueWorkItem2(0xD, 1, lambda_10FA)

    def lambda_110B():
        OP_6D(-460, 0, -68660, 2000)
        ExitThread()

    QueueWorkItem(0xA, 2, lambda_110B)

    def lambda_1123():
        OP_8E(0xFE, 0xFFFFF6FA, 0x0, 0xFFFEEEF4, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1123)
    ...
    QueueWorkItem2(0x101, 1, lambda_113E)
    WaitChrThread(0xE, 0x2)
    ...
    QueueWorkItem(0xE, 2, lambda_1163)
    ...
    QueueWorkItem(0x105, 1, lambda_12D5)
    ...
    QueueWorkItem(0x8, 1, lambda_12F1)
    ...
    QueueWorkItem(0xB, 1, lambda_130D)

    def lambda_131B():
        TurnDirection(0xFE, 0xD, 400)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_131B)

    def lambda_1329():
        TurnDirection(0xFE, 0xD, 400)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_1329)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x4B, 0x0, 0x20)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1437")
    Sleep(100)
    OP_AF(0x63, 0x4B)
    ...
    QueueWorkItem(0x101, 1, lambda_156D)

    def lambda_157B():
        TurnDirection(0xFE, 0x105, 400)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_157B)

    def lambda_1589():
        TurnDirection(0xFE, 0xD, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_1589)
    ...
    QueueWorkItem(0xE, 1, lambda_15B5)
    ...
    QueueWorkItem(0xE, 1, lambda_1798)
    ...
    QueueWorkItem(0xB, 1, lambda_1830)
    ...
    QueueWorkItem(0xD, 1, lambda_1B2B)

    def lambda_1B39():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0xE, 1, lambda_1B39)
    ...
    QueueWorkItem2(0xA, 1, lambda_203A)
    ...
    QueueWorkItem2(0x101, 1, lambda_204B)
    ...
    QueueWorkItem2(0x105, 1, lambda_205C)
    ...
    QueueWorkItem2(0x103, 1, lambda_206D)
    ...
    QueueWorkItem2(0x8, 1, lambda_207E)
    ...
    QueueWorkItem2(0x9, 1, lambda_208F)
    ...
    QueueWorkItem2(0xB, 1, lambda_20A0)
    ...
    QueueWorkItem2(0xC, 1, lambda_20B1)
    ...
    QueueWorkItem2(0xF, 1, lambda_20C2)
    ...
    QueueWorkItem2(0xE, 1, lambda_20D3)
    ...
    QueueWorkItem2(0xD, 1, lambda_20E4)

    def lambda_20F5():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_20F5)

    def lambda_2107():
        OP_8E(0xFE, 0x1D6, 0x0, 0xFFFEF688, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x10, 2, lambda_2107)
    ...
    QueueWorkItem(0x103, 1, lambda_22B9)

    def lambda_22C7():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_22C7)

    def lambda_22D5():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_22D5)
    ...
    QueueWorkItem(0xF, 1, lambda_22F1)
    ...
    QueueWorkItem(0x11, 1, lambda_2674)
    Sleep(300)
    ...
    QueueWorkItem(0x11, 1, lambda_2694)
    Sleep(500)
    ...
    QueueWorkItem(0x11, 1, lambda_26B4)
    Sleep(800)
    ...
    QueueWorkItem(0x11, 1, lambda_26D4)
    Sleep(1000)
    ...
    QueueWorkItem(0x11, 1, lambda_26F4)
    FadeToDark(2000, 0, -1)
    OP_0D()
    OP_44(0x11, 0xFF)
    OP_A1(0x11, 0x2)
    ...
    QueueWorkItem(0x101, 0, lambda_27B1)

    def lambda_27C9():
        OP_6B(1310, 20000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_27C9)

    def lambda_27D9():
        OP_6C(55000, 20000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_27D9)

    def lambda_27E9():
        OP_6E(776, 20000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_27E9)
    ...
    QueueWorkItem(0x11, 0, lambda_28CF)
    OP_24(0x68, 0x5A)
    Sleep(400)
    OP_24(0x68, 0x55)
    Sleep(400)
