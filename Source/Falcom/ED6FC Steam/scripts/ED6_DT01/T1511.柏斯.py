...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_3B8",          # 08, 8
        "Function_9_510",          # 09, 9
        "Function_10_542",         # 0A, 10
        "Function_11_AC4",         # 0B, 11
    )
    ...
    def Function_5_278(): pass

    label("Function_5_278")
    ...
    def Function_6_2CF(): pass

    label("Function_6_2CF")
    ...
    def Function_7_340(): pass

    label("Function_7_340")
    ...
    def Function_8_3B8(): pass

    label("Function_8_3B8")

    TalkBegin(0xA)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_4E3")
    OP_A2(0x0)
    ...
    def Function_9_510(): pass

    label("Function_9_510")
    ...
    def Function_10_542(): pass

    label("Function_10_542")
    ...
    def Function_11_AC4(): pass

    label("Function_11_AC4")
