...
def main():
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1D, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_222")
    OP_A2(0xB)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1D, 0x0, 0x8)"), scpexpr(EXPR_EXEC_OP, "OP_29(0x1D, 0x0, 0x10)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_EXEC_OP, "OP_29(0x1D, 0x0, 0x40)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_259")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1D, 0x1, 0x4000)"), scpexpr(EXPR_END)), "loc_2AC")
    ...
    def Function_2_349(): pass

    label("Function_2_349")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1D, 0x0, 0x4)"), scpexpr(EXPR_END)), "loc_50B")
    OP_28(0x1D, 0x4, 0x8)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1C, 0x0, 0x4)"), scpexpr(EXPR_END)), "loc_97B")
    ...
    def Function_4_104D(): pass

    label("Function_4_104D")

    OP_28(0x22, 0x4, 0x10)
    OP_28(0x22, 0x1, 0x4)
    OP_A2(0x1)
    OP_3F(0x67, 1)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1367")
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_42(0x4)"), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_15D0")
