...
def main():
    ...
    QueueWorkItem(0xA, 1, lambda_78C)
    ...
    QueueWorkItem(0xF, 1, lambda_8C5)
    ...
    QueueWorkItem(0x0, 2, lambda_8F3)
    ...
    QueueWorkItem2(0x101, 1, lambda_939)
    Sleep(50)
    ...
    QueueWorkItem2(0x105, 1, lambda_97D)
    ...
    QueueWorkItem2(0x103, 1, lambda_98E)
    Sleep(50)
    ...
    QueueWorkItem2(0x8, 1, lambda_9D2)
    ...
    QueueWorkItem2(0x9, 1, lambda_9E3)
    Sleep(50)
    ...
    QueueWorkItem2(0xB, 1, lambda_A27)
    ...
    QueueWorkItem2(0xC, 1, lambda_A38)
    WaitChrThread(0x0, 0x2)
    ...
    QueueWorkItem(0x0, 2, lambda_A99)

    def lambda_AB1():
        OP_8E(0xFE, 0xFFFFFD4E, 0x0, 0xFFFEE9EA, 0x640, 0x0)
        ExitThread()

    QueueWorkItem(0xF, 2, lambda_AB1)
    Sleep(200)
    SetChrFlags(0xA, 0x4)
    ...
    QueueWorkItem(0xA, 2, lambda_AD6)
    ...
    QueueWorkItem2(0xA, 1, lambda_AF1)
    WaitChrThread(0x0, 0x2)
    ...
    QueueWorkItem2(0xA, 1, lambda_BAA)
    ...
    QueueWorkItem(0x0, 2, lambda_BE5)
    Sleep(100)
    ...
    QueueWorkItem2(0x101, 1, lambda_C02)
    Sleep(50)
    ...
    QueueWorkItem2(0x105, 1, lambda_C18)
    ...
    QueueWorkItem2(0x103, 1, lambda_C29)
    Sleep(50)
    ...
    QueueWorkItem2(0x8, 1, lambda_C3F)
    ...
    QueueWorkItem2(0x9, 1, lambda_C50)
    Sleep(50)
    ...
    QueueWorkItem2(0xB, 1, lambda_C66)
    ...
    QueueWorkItem2(0xC, 1, lambda_C77)
    ...
    QueueWorkItem2(0xF, 1, lambda_C88)
    ...
    QueueWorkItem(0xE, 1, lambda_D3A)

    def lambda_D4C():
        OP_8E(0xFE, 0xFFFFFBA0, 0x0, 0xFFFEDB30, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0xE, 2, lambda_D4C)
    Sleep(600)
    ...
    QueueWorkItem(0xD, 1, lambda_D6C)

    def lambda_D7E():
        OP_8E(0xFE, 0xE6, 0x0, 0xFFFEDC16, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 2, lambda_D7E)
    ...
    QueueWorkItem(0xE, 2, lambda_E00)
    ...
    QueueWorkItem2(0xE, 1, lambda_E1B)

    def lambda_E2C():
        OP_8E(0xFE, 0xFFFFF880, 0x0, 0xFFFEE922, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 2, lambda_E2C)
    ...
    QueueWorkItem2(0xD, 1, lambda_E47)
    ...
    QueueWorkItem(0xA, 1, lambda_F2B)
    ...
    QueueWorkItem(0x101, 1, lambda_F92)

    def lambda_FA0():
        TurnDirection(0xFE, 0xD, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_FA0)

    def lambda_FAE():
        TurnDirection(0xFE, 0xD, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_FAE)
    ...
    QueueWorkItem(0x9, 1, lambda_FCA)

    def lambda_FD8():
        TurnDirection(0xFE, 0xD, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_FD8)

    def lambda_FE6():
        TurnDirection(0xFE, 0xD, 400)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_FE6)

    def lambda_FF4():
        TurnDirection(0xFE, 0xD, 400)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_FF4)
    ...
    QueueWorkItem(0xE, 1, lambda_1109)

    def lambda_1117():
        TurnDirection(0xFE, 0x105, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_1117)
    ...
    QueueWorkItem(0xE, 1, lambda_12CA)
    ...
    QueueWorkItem(0xB, 1, lambda_1343)
    ...
    QueueWorkItem2(0x101, 1, lambda_1A7D)
    ...
    QueueWorkItem2(0x105, 1, lambda_1A8E)
    ...
    QueueWorkItem2(0x103, 1, lambda_1A9F)
    ...
    QueueWorkItem2(0x8, 1, lambda_1AB0)
    ...
    QueueWorkItem2(0x9, 1, lambda_1AC1)
    ...
    QueueWorkItem2(0xB, 1, lambda_1AD2)
    ...
    QueueWorkItem2(0xC, 1, lambda_1AE3)
    ...
    QueueWorkItem2(0xF, 1, lambda_1AF4)
    ...
    QueueWorkItem2(0xE, 1, lambda_1B05)
    ...
    QueueWorkItem2(0xD, 1, lambda_1B16)

    def lambda_1B27():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_1B27)

    def lambda_1B39():
        OP_8E(0xFE, 0x1D6, 0x0, 0xFFFEF688, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x10, 2, lambda_1B39)
    ...
    QueueWorkItem(0x101, 1, lambda_1CAD)

    def lambda_1CBB():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_1CBB)

    def lambda_1CC9():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x103, 1, lambda_1CC9)

    def lambda_1CD7():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_1CD7)

    def lambda_1CE5():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_1CE5)

    def lambda_1CF3():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_1CF3)

    def lambda_1D01():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_1D01)
    ...
    QueueWorkItem(0x101, 1, lambda_1FA0)
