...
def main():
    ...
    ScpFunction(
        ...
        "Function_4_D66",          # 04, 4
        "Function_5_DF8",          # 05, 5
        "Function_6_12E1",         # 06, 6
        "Function_7_13F5",         # 07, 7
        "Function_8_1630",         # 08, 8
        "Function_9_1BBF",         # 09, 9
        "Function_10_1E12",        # 0A, 10
        "Function_11_1E80",        # 0B, 11
        "Function_12_1EEE",        # 0C, 12
        "Function_13_1F34",        # 0D, 13
        "Function_14_1F7A",        # 0E, 14
        "Function_15_1FC0",        # 0F, 15
        "Function_16_202E",        # 10, 16
        "Function_17_22EE",        # 11, 17
        "Function_18_238F",        # 12, 18
        "Function_19_2471",        # 13, 19
        "Function_20_2523",        # 14, 20
        "Function_21_25F7",        # 15, 21
        "Function_22_2734",        # 16, 22
        "Function_23_280A",        # 17, 23
        "Function_24_28D7",        # 18, 24
        "Function_25_2978",        # 19, 25
        "Function_26_2A7B",        # 1A, 26
        "Function_27_2B3E",        # 1B, 27
        "Function_28_2B5A",        # 1C, 28
        "Function_29_2B5E",        # 1D, 29
        "Function_30_2B62",        # 1E, 30
        "Function_31_2B66",        # 1F, 31
        "Function_32_2B6A",        # 20, 32
    )
    ...
    QueueWorkItem(0x102, 1, lambda_915)
    ...
    QueueWorkItem2(0x101, 1, lambda_B9A)
    ...
    QueueWorkItem2(0x102, 1, lambda_BAB)
    ...
    QueueWorkItem(0x10E, 1, lambda_BD0)

    def lambda_BEB():
        OP_6D(-1030, 0, -52400, 2000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_BEB)
    Sleep(2000)
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    ...
    QueueWorkItem(0x101, 1, lambda_E59)
    Sleep(400)
    ...
    QueueWorkItem(0x102, 1, lambda_E79)
    Sleep(500)
    ...
    QueueWorkItem(0x8, 1, lambda_E99)
    ...
    QueueWorkItem(0x8, 1, lambda_10EC)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC2, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_12AF")
    ...
    def Function_6_12E1(): pass

    label("Function_6_12E1")

    EventBegin(0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC2, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1350")
    TurnDirection(0x102, 0x101, 400)
    ...
    QueueWorkItem(0x101, 1, lambda_1443)
    Sleep(400)
    ...
    QueueWorkItem(0x102, 1, lambda_1463)
    OP_6D(16100, 250, 4400, 2000)
    WaitChrThread(0x101, 0x1)
    OP_8C(0x101, 90, 400)
    WaitChrThread(0x102, 0x1)
    ...
    def Function_8_1630(): pass

    label("Function_8_1630")
    ...
    QueueWorkItem(0x101, 1, lambda_17A9)

    def lambda_17B7():
        TurnDirection(0xFE, 0x9, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_17B7)

    def lambda_17C5():
        OP_6D(8710, 250, -11760, 3000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_17C5)

    def lambda_17DD():
        OP_6C(90000, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_17DD)
    ...
    QueueWorkItem(0xA, 1, lambda_180D)
    ...
    def Function_9_1BBF(): pass

    label("Function_9_1BBF")

    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0xFF), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1E11")
    OP_48()
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x151), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_1BF2")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x125), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_1C18")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xF8), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_1C3E")
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0xCA), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_1C65")
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x9E), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_1C8B")
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_NEG), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_1D0F")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x70), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_1CB1")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x44), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_1CD6")
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_1D0F")
    ...
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xFE, 0x4), scpexpr(EXPR_PUSH_LONG, 0x16), scpexpr(EXPR_GTR), scpexpr(EXPR_END)), "loc_1CFB")
    RunExpression(0x1, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    RunExpression(0x2, (scpexpr(EXPR_PUSH_LONG, 0x7D0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    Jump("loc_1D0F")
    ...
    Sleep(1000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1DFF")
    ...
    def Function_11_1E80(): pass

    label("Function_11_1E80")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1EED")
    ...
    Jump("Function_11_1E80")

    label("loc_1EED")

    Return()

    # Function_11_1E80 end

    def Function_12_1EEE(): pass

    label("Function_12_1EEE")
    ...
    Jump("Function_12_1EEE")

    label("loc_1F33")

    Return()

    # Function_12_1EEE end

    def Function_13_1F34(): pass

    label("Function_13_1F34")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1F79")
    SetChrPos(0xFE, 3810, 0, 10100, 180)
    OP_8E(0xFE, 0xEE2, 0x0, 0xFFFF7518, 0xBB8, 0x0)
    OP_8E(0xFE, 0xEE2, 0x0, 0x2774, 0xBB8, 0x0)
    Jump("Function_13_1F34")

    label("loc_1F79")

    Return()

    # Function_13_1F34 end

    def Function_14_1F7A(): pass

    label("Function_14_1F7A")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1FBF")
    SetChrPos(0xFE, -3690, 0, -34890, 180)
    OP_8E(0xFE, 0xFFFFF196, 0x0, 0x25DA, 0xBB8, 0x0)
    OP_8E(0xFE, 0xFFFFF196, 0x0, 0xFFFF77B6, 0xBB8, 0x0)
    Jump("Function_14_1F7A")

    label("loc_1FBF")

    Return()

    # Function_14_1F7A end

    def Function_15_1FC0(): pass

    label("Function_15_1FC0")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_202D")
    ...
    Jump("Function_15_1FC0")

    label("loc_202D")

    Return()

    # Function_15_1FC0 end

    def Function_16_202E(): pass

    label("Function_16_202E")
    ...
    QueueWorkItem(0x104, 1, lambda_20B5)

    def lambda_20D0():
        OP_8E(0xFE, 0x3F2, 0x0, 0xFFFF2702, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_20D0)

    def lambda_20EB():
        OP_8E(0xFE, 0xFFFFFCB8, 0x0, 0xFFFF25F4, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_20EB)
    ...
    QueueWorkItem(0x108, 1, lambda_21EB)
    ...
    QueueWorkItem(0x0, 1, lambda_2350)

    def lambda_2368():
        OP_6C(0, 20000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_2368)
    Sleep(17000)
    FadeToDark(2000, 0, -1)
    OP_0D()
    OP_A2(0x3FB)
    ...
    EventBegin(0x2)
    TurnDirection(0x102, 0x101, 400)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2417")
    OP_A2(0x0)
    ...
    def Function_19_2471(): pass

    label("Function_19_2471")

    EventBegin(0x2)
    TurnDirection(0x102, 0x101, 400)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_24E4")
    OP_A2(0x0)
    ...
    # Function_19_2471 end

    def Function_20_2523(): pass

    label("Function_20_2523")

    EventBegin(0x2)
    TurnDirection(0x102, 0x101, 400)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_25A7")
    OP_A2(0x0)
    ...
    # Function_20_2523 end

    def Function_21_25F7(): pass

    label("Function_21_25F7")

    EventBegin(0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_26E3")
    OP_A2(0x0)
    TurnDirection(0x102, 0x101, 400)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_267B")
    ...
    # Function_21_25F7 end

    def Function_22_2734(): pass

    label("Function_22_2734")
    ...
    # Function_22_2734 end

    def Function_23_280A(): pass

    label("Function_23_280A")

    EventBegin(0x2)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2874")
    ...
    # Function_23_280A end

    def Function_24_28D7(): pass

    label("Function_24_28D7")

    EventBegin(0x2)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_292A")
    ...
    # Function_24_28D7 end

    def Function_25_2978(): pass

    label("Function_25_2978")

    EventBegin(0x2)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2A0A")
    ...
    # Function_25_2978 end

    def Function_26_2A7B(): pass

    label("Function_26_2A7B")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC5, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2B3D")
    EventBegin(0x2)
    ...
    # Function_26_2A7B end

    def Function_27_2B3E(): pass

    label("Function_27_2B3E")
    ...
    # Function_27_2B3E end

    def Function_28_2B5A(): pass

    label("Function_28_2B5A")

    SetPlaceName(0xB9) # 阳光铃铛酒廊
    Return()

    # Function_28_2B5A end

    def Function_29_2B5E(): pass

    label("Function_29_2B5E")

    SetPlaceName(0xB0) # 阳光铃铛酒廊
    Return()

    # Function_29_2B5E end

    def Function_30_2B62(): pass

    label("Function_30_2B62")

    SetPlaceName(0xB2) # 阳光铃铛酒廊
    Return()

    # Function_30_2B62 end

    def Function_31_2B66(): pass

    label("Function_31_2B66")

    SetPlaceName(0xAE) # 阳光铃铛酒廊
    Return()

    # Function_31_2B66 end

    def Function_32_2B6A(): pass

    label("Function_32_2B6A")

    SetPlaceName(0xB3) # 阳光铃铛酒廊
    Return()

    # Function_32_2B6A end
