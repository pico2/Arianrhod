...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x63, 0)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x63, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_E25")
    OP_A2(0x319)
    ClearMapFlags(0x1)
    EventBegin(0x0)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_253")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_275")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_296")
    ...
    QueueWorkItem(0x8, 2, lambda_29C)

    def lambda_2B4():
        OP_6C(45000, 3000)
        ExitThread()

    QueueWorkItem(0x8, 3, lambda_2B4)
    Sleep(500)
    ...
    QueueWorkItem(0x8, 1, lambda_2C9)
    Sleep(2000)
    ...
    QueueWorkItem(0x103, 1, lambda_359)
    Sleep(500)
    ...
    QueueWorkItem(0x101, 1, lambda_379)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_399)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0xE, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_AEC")
    ...
    QueueWorkItem2(0x101, 2, lambda_AF2)
    ...
    QueueWorkItem2(0x102, 2, lambda_B03)
    ...
    QueueWorkItem2(0x103, 2, lambda_B14)
