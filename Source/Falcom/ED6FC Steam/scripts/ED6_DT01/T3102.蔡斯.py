...
def main():
    ...
    ScpFunction(
        ...
        "Function_10_1818",        # 0A, 10
        "Function_11_3A4E",        # 0B, 11
        "Function_12_4878",        # 0C, 12
        "Function_13_4B04",        # 0D, 13
        "Function_14_4BA8",        # 0E, 14
        "Function_15_4BAD",        # 0F, 15
        "Function_16_5405",        # 10, 16
        "Function_17_5D69",        # 11, 17
        "Function_18_6350",        # 12, 18
        "Function_19_63D1",        # 13, 19
        "Function_20_7341",        # 14, 20
        "Function_21_7364",        # 15, 21
        "Function_22_7387",        # 16, 22
        "Function_23_73AA",        # 17, 23
        "Function_24_73CD",        # 18, 24
        "Function_25_7467",        # 19, 25
        "Function_26_74E0",        # 1A, 26
    )
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAE, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_12B5")
    EventBegin(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAA, 0)), scpexpr(EXPR_END)), "loc_1351")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA7, 0)), scpexpr(EXPR_END)), "loc_13E9")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_END)), "loc_1394")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 7)), scpexpr(EXPR_END)), "loc_155A")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_END)), "loc_142C")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 2)), scpexpr(EXPR_END)), "loc_1744")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_END)), "loc_1593")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 0)), scpexpr(EXPR_END)), "loc_17D6")
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_17FA")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_END)), "loc_1814")
    OP_22(0x192, 0x0, 0x64)
    ...
    def Function_10_1818(): pass

    label("Function_10_1818")

    TalkBegin(0x9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2438")
    OP_A2(0x604)
    EventBegin(0x0)
    Fade(1000)
    ...
    QueueWorkItem(0x102, 2, lambda_1869)
    ...
    QueueWorkItem(0x101, 1, lambda_1AE7)
    ...
    QueueWorkItem(0x11, 1, lambda_1C2F)

    def lambda_1C4A():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x29810, 0x1F40, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1C4A)
    OP_22(0x79, 0x1, 0x28)
    Sleep(100)
    OP_24(0x79, 0x3C)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 2, lambda_1CC6)

    def lambda_1CD4():
        OP_8C(0xFE, 180, 5)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_1CD4)

    def lambda_1CE2():
        OP_8F(0xFE, 0xFFFF7B30, 0x4268, 0x26548, 0x1D4C, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_1CE2)

    def lambda_1CFD():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0x1D4C, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1CFD)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 2, lambda_1D1D)

    def lambda_1D2B():
        OP_8C(0xFE, 180, 10)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_1D2B)

    def lambda_1D39():
        OP_8F(0xFE, 0xFFFF7B30, 0x4268, 0x26548, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_1D39)

    def lambda_1D54():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1D54)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 2, lambda_1D74)

    def lambda_1D82():
        OP_8C(0xFE, 180, 30)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_1D82)

    def lambda_1D90():
        OP_8F(0xFE, 0xFFFF7B30, 0x4268, 0x26548, 0x1964, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_1D90)

    def lambda_1DAB():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0x1964, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1DAB)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 2, lambda_1DCB)

    def lambda_1DD9():
        OP_8C(0xFE, 180, 50)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_1DD9)

    def lambda_1DE7():
        OP_8F(0xFE, 0xFFFF7B30, 0x4268, 0x26548, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_1DE7)

    def lambda_1E02():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1E02)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 2, lambda_1E22)

    def lambda_1E30():
        OP_8C(0xFE, 180, 60)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_1E30)

    def lambda_1E3E():
        OP_8F(0xFE, 0xFFFF7B30, 0x4268, 0x26548, 0x157C, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_1E3E)

    def lambda_1E59():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0x157C, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1E59)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 1, lambda_1E79)

    def lambda_1E94():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1E94)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 1, lambda_1EB4)

    def lambda_1ECF():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0x1194, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1ECF)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 1, lambda_1EEF)

    def lambda_1F0A():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1F0A)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 1, lambda_1F2A)

    def lambda_1F45():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0xDAC, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1F45)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 1, lambda_1F65)

    def lambda_1F80():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1F80)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 1, lambda_1FA0)

    def lambda_1FBB():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD8F0, 0x26548, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_1FBB)
    Sleep(800)
    ...
    QueueWorkItem(0x11, 2, lambda_1FDB)

    def lambda_1FE9():
        OP_8C(0xFE, 180, 50)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_1FE9)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 2, lambda_1FFC)

    def lambda_200A():
        OP_8C(0xFE, 180, 40)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_200A)
    Sleep(100)
    ...
    QueueWorkItem(0x12, 2, lambda_202B)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 2, lambda_203E)

    def lambda_204C():
        OP_8C(0xFE, 180, 20)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_204C)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 2, lambda_205F)

    def lambda_206D():
        OP_8C(0xFE, 180, 10)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_206D)
    OP_22(0xCC, 0x0, 0x64)
    OP_6F(0x4, 590)
    OP_70(0x4, 0x2B2)
    WaitChrThread(0x11, 0x1)
    ...
    QueueWorkItem(0x11, 1, lambda_2093)

    def lambda_20AE():
        OP_8F(0xFE, 0xFFFF7CAC, 0xFFFFD8F0, 0x23280, 0x29A, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_20AE)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_20CE)
    ...
    QueueWorkItem(0x101, 1, lambda_2111)
    ...
    QueueWorkItem(0x11, 1, lambda_218C)
    ...
    QueueWorkItem(0x101, 2, lambda_236A)
    OP_6F(0x3, 100)
    OP_70(0x3, 0xC4)
    Sleep(500)
    OP_22(0x78, 0x0, 0x64)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 2)), scpexpr(EXPR_END)), "loc_249E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2654")
    OP_A2(0x602)
    OP_28(0x54, 0x1, 0x2)
    EventBegin(0x0)
    OP_69(0x9, 0x3E8)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_348B")
    EventBegin(0x0)
    OP_A2(0x517)
    EventBegin(0x0)
    Fade(1000)
    ...
    QueueWorkItem(0x102, 1, lambda_2694)

    def lambda_26A4():
        OP_6B(3000, 2000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_26A4)
    OP_69(0x9, 0x7D0)
    ...
    QueueWorkItem(0x101, 2, lambda_2A2E)

    def lambda_2A46():
        OP_6B(900, 5000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_2A46)
    Sleep(2000)
    OP_71(0x4, 0x20)
    OP_6F(0x4, 161)
    OP_70(0x4, 0x104)
    ...
    QueueWorkItem(0x11, 1, lambda_2A6E)
    ...
    QueueWorkItem(0x11, 2, lambda_2B21)

    def lambda_2B2F():
        OP_8C(0xFE, 0, 5)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2B2F)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 2, lambda_2B42)

    def lambda_2B50():
        OP_8C(0xFE, 0, 8)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2B50)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 2, lambda_2B63)
    ...
    QueueWorkItem(0x11, 2, lambda_2B84)

    def lambda_2B92():
        OP_8C(0xFE, 0, 13)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2B92)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 2, lambda_2BA5)

    def lambda_2BB3():
        OP_8C(0xFE, 0, 15)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2BB3)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 2, lambda_2BC6)

    def lambda_2BD4():
        OP_8C(0xFE, 0, 18)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2BD4)

    def lambda_2BE2():
        OP_8F(0xFE, 0xFFFF7B30, 0x2328, 0x26548, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_2BE2)
    Sleep(85)
    ...
    QueueWorkItem(0x11, 2, lambda_2C02)

    def lambda_2C10():
        OP_8C(0xFE, 0, 20)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2C10)
    Sleep(85)
    ...
    QueueWorkItem(0x12, 2, lambda_2C31)
    ...
    QueueWorkItem(0x11, 2, lambda_2C5F)

    def lambda_2C6D():
        OP_8C(0xFE, 0, 25)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2C6D)
    Sleep(85)
    ...
    QueueWorkItem(0x11, 1, lambda_2C80)

    def lambda_2C9B():
        OP_8C(0xFE, 0, 28)
        ExitThread()

    QueueWorkItem(0x11, 2, lambda_2C9B)

    def lambda_2CA9():
        OP_8C(0xFE, 0, 28)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2CA9)
    Sleep(85)
    ...
    QueueWorkItem(0x11, 2, lambda_2CBC)

    def lambda_2CCA():
        OP_8C(0xFE, 0, 30)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2CCA)
    Sleep(85)
    ...
    QueueWorkItem(0x11, 2, lambda_2CDD)

    def lambda_2CEB():
        OP_8C(0xFE, 0, 33)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2CEB)

    def lambda_2CF9():
        OP_8F(0xFE, 0xFFFF7B30, 0x2328, 0x26548, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_2CF9)
    Sleep(85)
    Sleep(85)
    ...
    QueueWorkItem(0x11, 1, lambda_2D1E)
    Sleep(170)
    ...
    QueueWorkItem(0x11, 1, lambda_2D3E)
    Sleep(170)
    ...
    QueueWorkItem(0x11, 1, lambda_2D7E)
    Sleep(170)
    ...
    QueueWorkItem(0x11, 1, lambda_2D9E)
    Sleep(170)
    WaitChrThread(0x11, 0x1)
    Sleep(1900)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 2, lambda_2DCD)

    def lambda_2DDB():
        OP_8C(0xFE, 0, 25)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2DDB)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 2, lambda_2DEE)

    def lambda_2DFC():
        OP_8C(0xFE, 0, 20)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2DFC)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 2, lambda_2E0F)
    ...
    QueueWorkItem(0x11, 2, lambda_2E30)

    def lambda_2E3E():
        OP_8C(0xFE, 0, 10)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2E3E)
    Sleep(200)
    ...
    QueueWorkItem(0x11, 2, lambda_2E51)

    def lambda_2E5F():
        OP_8C(0xFE, 0, 7)
        ExitThread()

    QueueWorkItem(0x12, 2, lambda_2E5F)
    ...
    QueueWorkItem(0x12, 1, lambda_2E85)

    def lambda_2EA0():
        OP_8F(0xFE, 0xFFFF7B30, 0xFFFFD472, 0x24220, 0x64, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_2EA0)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_2EC0)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_2EE0)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_2F00)
    ...
    QueueWorkItem(0x11, 1, lambda_2F38)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_2F58)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_2F78)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_2F98)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_2FB8)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_2FD8)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_2FF8)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_3018)
    Sleep(4500)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_303D)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_305D)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_307D)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_309D)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_30BD)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_30DD)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_30FD)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_311D)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_313D)
    Sleep(100)
    ...
    QueueWorkItem(0x11, 1, lambda_315D)
    OP_44(0x11, 0x1)
    OP_23(0x79)
    OP_22(0xC8, 0x0, 0x64)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 1)), scpexpr(EXPR_END)), "loc_34E9")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 5)), scpexpr(EXPR_END)), "loc_3549")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_35BD")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 7)), scpexpr(EXPR_END)), "loc_3708")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_3664")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 2)), scpexpr(EXPR_END)), "loc_37CD")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 3)), scpexpr(EXPR_END)), "loc_38A6")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_3839")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 7)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_3889")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 1)), scpexpr(EXPR_END)), "loc_39D7")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_3929")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA1, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA0, 2)), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_3A4A")
    ...
    # Function_10_1818 end

    def Function_11_3A4E(): pass

    label("Function_11_3A4E")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAE, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_3ADB")
    TalkBegin(0xA)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 0)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_4732")
    EventBegin(0x0)
    Fade(1000)
    OP_4A(0xA, 255)
    OP_4A(0x8, 255)
    ...
    QueueWorkItem(0x101, 1, lambda_3B47)
    ...
    QueueWorkItem2(0xA, 2, lambda_3D1A)
    ...
    QueueWorkItem2(0x107, 2, lambda_3D2B)
    ...
    QueueWorkItem2(0x106, 2, lambda_3D3C)

    def lambda_3D4D():
        OP_6D(-48810, -4000, 144860, 2000)
        ExitThread()

    QueueWorkItem(0x101, 0, lambda_3D4D)
    ...
    QueueWorkItem(0x101, 2, lambda_3D75)
    Sleep(3000)
    ...
    QueueWorkItem(0x101, 3, lambda_3D8A)
    ...
    QueueWorkItem(0x101, 1, lambda_3F4E)
    ...
    QueueWorkItem(0x101, 2, lambda_3F8A)

    def lambda_3F9A():
        OP_6C(27000, 6100)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_3F9A)
    ...
    QueueWorkItem2(0x102, 0, lambda_3FD6)
    ...
    QueueWorkItem2(0x101, 0, lambda_3FE7)
    ...
    QueueWorkItem(0x102, 3, lambda_4013)

    def lambda_402E():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0xA, 2, lambda_402E)

    def lambda_403C():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x107, 2, lambda_403C)

    def lambda_404A():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x106, 2, lambda_404A)

    def lambda_4058():
        OP_6B(5500, 10000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_4058)
    ...
    QueueWorkItem(0x8, 1, lambda_42F1)
    ...
    QueueWorkItem2(0xA, 2, lambda_430C)
    ...
    QueueWorkItem(0x102, 3, lambda_433A)
    Sleep(100)
    ...
    QueueWorkItem(0x101, 3, lambda_435A)
    Sleep(100)
    ...
    QueueWorkItem(0x107, 3, lambda_437A)
    Sleep(100)
    ...
    QueueWorkItem(0x106, 3, lambda_439A)
    ...
    QueueWorkItem2(0x102, 2, lambda_43BA)
    ...
    QueueWorkItem2(0x101, 2, lambda_43D0)
    ...
    QueueWorkItem2(0x107, 2, lambda_43E6)
    ...
    QueueWorkItem2(0x106, 2, lambda_43FC)
    ...
    QueueWorkItem(0x106, 1, lambda_4687)
    TurnDirection(0x107, 0xA, 400)
    ...
    TalkBegin(0xA)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_END)), "loc_47AB")
    ...
    # Function_11_3A4E end

    def Function_12_4878(): pass

    label("Function_12_4878")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 3)), scpexpr(EXPR_END)), "loc_492A")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_48D6")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 1)), scpexpr(EXPR_END)), "loc_49E3")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_495C")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_4B00")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_4A4B")
    ...
    # Function_12_4878 end

    def Function_13_4B04(): pass

    label("Function_13_4B04")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAB, 1)), scpexpr(EXPR_END)), "loc_4BA4")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_4B68")
    ...
    # Function_13_4B04 end

    def Function_14_4BA8(): pass

    label("Function_14_4BA8")

    Call(0, 10)
    Return()

    # Function_14_4BA8 end

    def Function_15_4BAD(): pass

    label("Function_15_4BAD")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 7)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_5404")
    OP_A2(0x518)
    OP_28(0x3F, 0x1, 0x800)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x3F, 0x1, 0x1000)"), scpexpr(EXPR_END)), "loc_4BD3")
    ...
    QueueWorkItem2(0x101, 0, lambda_4E92)
    ...
    QueueWorkItem2(0x102, 0, lambda_4EA3)

    def lambda_4EB4():
        OP_6D(-37020, -3800, 144870, 3000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_4EB4)
    ...
    QueueWorkItem(0x101, 1, lambda_4F52)
    ...
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_50D1")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA3, 1)), scpexpr(EXPR_END)), "loc_533B")
    ...
    # Function_15_4BAD end

    def Function_16_5405(): pass

    label("Function_16_5405")
    ...
    QueueWorkItem(0x101, 2, lambda_5754)

    def lambda_576C():
        OP_6B(3360, 4000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_576C)

    def lambda_577C():
        OP_6C(32000, 4000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_577C)
    ...
    QueueWorkItem(0x101, 1, lambda_5A32)

    def lambda_5A4A():
        OP_67(0, 1800, -10000, 6000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_5A4A)
    ...
    QueueWorkItem(0x12, 1, lambda_5A8F)
    ...
    QueueWorkItem(0x12, 1, lambda_5AD9)
    ...
    QueueWorkItem(0x12, 1, lambda_5AFE)
    ...
    QueueWorkItem(0x12, 1, lambda_5B23)
    FadeToDark(2000, 0, -1)
    ...
    QueueWorkItem(0x12, 1, lambda_5B52)
    ...
    QueueWorkItem(0x12, 1, lambda_5B77)
    ...
    QueueWorkItem(0x12, 1, lambda_5B9C)

    def lambda_5BB2():
        OP_94(0x1, 0xFE, 0x0, 0xC350, 0x1F40, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_5BB2)
    ...
    # Function_16_5405 end

    def Function_17_5D69(): pass

    label("Function_17_5D69")
    ...
    QueueWorkItem(0x101, 1, lambda_5E75)
    OP_22(0x76, 0x0, 0x64)
    OP_6F(0x4, 1)
    OP_70(0x4, 0x3C)
    OP_73(0x4)
    ...
    QueueWorkItem(0x101, 3, lambda_5EDC)
    ...
    QueueWorkItem(0x12, 1, lambda_5F19)
    ...
    QueueWorkItem(0x12, 1, lambda_5F3E)
    ...
    QueueWorkItem(0x12, 1, lambda_5F63)
    ...
    QueueWorkItem(0x12, 1, lambda_5F88)
    ...
    QueueWorkItem(0x12, 1, lambda_5FAD)
    ...
    QueueWorkItem(0x12, 1, lambda_5FD2)
    ...
    QueueWorkItem(0x12, 1, lambda_5FF7)
    ...
    QueueWorkItem(0x12, 1, lambda_601C)

    def lambda_6032():
        OP_94(0x1, 0xFE, 0x0, 0xC350, 0x1F40, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_6032)
    ...
    QueueWorkItem(0x101, 1, lambda_6095)
    ...
    QueueWorkItem2(0xA, 1, lambda_60BD)
    ...
    # Function_17_5D69 end

    def Function_18_6350(): pass

    label("Function_18_6350")
    ...
    # Function_18_6350 end

    def Function_19_63D1(): pass

    label("Function_19_63D1")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_7340")
    EventBegin(0x0)
    OP_A2(0x603)
    OP_28(0x54, 0x1, 0x4)
    OP_28(0x54, 0x1, 0x8)
    ...
    QueueWorkItem2(0x101, 3, lambda_6446)
    ...
    QueueWorkItem2(0x102, 3, lambda_6457)

    def lambda_6468():
        OP_6D(-46010, -1000, 131740, 2500)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_6468)

    def lambda_6480():
        OP_67(0, 7390, -10000, 4000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_6480)

    def lambda_6498():
        OP_6B(3700, 4000)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_6498)

    def lambda_64A8():
        OP_6C(158000, 4000)
        ExitThread()

    QueueWorkItem(0x1, 2, lambda_64A8)
    Sleep(3000)
    ...
    QueueWorkItem(0xC, 2, lambda_64DF)

    def lambda_64FA():
        OP_6D(-45610, -4000, 139000, 3000)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_64FA)
    Sleep(3000)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x2C, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_665C")
    ...
    QueueWorkItem(0x0, 1, lambda_67F2)
    ...
    QueueWorkItem2(0x101, 3, lambda_680A)
    ...
    QueueWorkItem2(0x102, 3, lambda_681B)

    def lambda_682C():
        OP_8E(0xFE, 0xFFFF4B92, 0xFFFFF060, 0x21E44, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_682C)
    Sleep(1000)
    ...
    QueueWorkItem2(0x101, 3, lambda_684C)
    ...
    QueueWorkItem2(0x102, 3, lambda_685D)
    OP_8C(0xC, 192, 800)
    ...
    QueueWorkItem(0xC, 1, lambda_6875)
    WaitChrThread(0x8, 0x1)
    ...
    QueueWorkItem(0x9, 1, lambda_6B7E)

    def lambda_6B99():
        OP_6D(-46700, -2500, 134910, 1500)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_6B99)
    ...
    QueueWorkItem2(0x101, 2, lambda_6BB1)
    ...
    QueueWorkItem2(0x102, 2, lambda_6BC2)
    ...
    QueueWorkItem2(0x8, 2, lambda_6BD3)
    Sleep(1500)
    ...
    QueueWorkItem2(0x101, 2, lambda_6BE9)
    ...
    QueueWorkItem2(0x102, 2, lambda_6BFA)
    ...
    QueueWorkItem2(0x8, 2, lambda_6C0B)

    def lambda_6C1C():
        OP_6D(-46010, -4000, 137720, 2000)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_6C1C)
    ...
    QueueWorkItem2(0x101, 2, lambda_70D7)
    ...
    QueueWorkItem2(0x102, 2, lambda_70E8)
    ...
    QueueWorkItem(0x101, 1, lambda_71D6)
    TurnDirection(0x101, 0x102, 400)
    WaitChrThread(0x101, 0x1)
    ...
    # Function_19_63D1 end

    def Function_20_7341(): pass

    label("Function_20_7341")
    ...
    # Function_20_7341 end

    def Function_21_7364(): pass

    label("Function_21_7364")
    ...
    # Function_21_7364 end

    def Function_22_7387(): pass

    label("Function_22_7387")
    ...
    # Function_22_7387 end

    def Function_23_73AA(): pass

    label("Function_23_73AA")
    ...
    # Function_23_73AA end

    def Function_24_73CD(): pass

    label("Function_24_73CD")
    ...
    # Function_24_73CD end

    def Function_25_7467(): pass

    label("Function_25_7467")
    ...
    # Function_25_7467 end

    def Function_26_74E0(): pass

    label("Function_26_74E0")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_7557")
    EventBegin(0x2)
    TurnDirection(0x102, 0x101, 400)
