...
def main():
    ...
    ScpFunction(
        ...
        "Function_7_12E8",         # 07, 7
        "Function_8_1522",         # 08, 8
        "Function_9_1752",         # 09, 9
        "Function_10_187D",        # 0A, 10
        "Function_11_19A8",        # 0B, 11
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 4)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_E43")
    OP_A2(0x435)
    OP_28(0x3E, 0x4, 0x2)
    OP_28(0x3E, 0x4, 0x4)
    OP_28(0x3E, 0x1, 0x1)
    ...
    QueueWorkItem2(0x105, 1, lambda_816)
    ...
    QueueWorkItem2(0x101, 1, lambda_827)
    ...
    QueueWorkItem2(0x102, 1, lambda_838)
    ...
    QueueWorkItem(0x101, 2, lambda_AB8)
    ...
    QueueWorkItem2(0x105, 1, lambda_D89)
    ...
    QueueWorkItem2(0x101, 1, lambda_D9A)
    ...
    QueueWorkItem2(0x102, 1, lambda_DAB)
    ...
    def Function_4_E44(): pass

    label("Function_4_E44")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1236")
    OP_A2(0x43E)
    EventBegin(0x0)
    FadeToDark(500, 0, -1)
    OP_0D()
    ...
    QueueWorkItem(0x102, 1, lambda_10C7)
    ...
    QueueWorkItem(0x101, 2, lambda_1188)
    OP_8C(0x105, 270, 400)
    WaitChrThread(0x101, 0x2)
    ...
    def Function_7_12E8(): pass

    label("Function_7_12E8")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 4)), scpexpr(EXPR_END)), "loc_12F4")
    Call(0, 8)
    Return()
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x97, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_183C")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_17C6")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    FadeToBright(300, 0)
    SetMessageWindowPos(-1, -1, -1, -1)
    ...
    def Function_10_187D(): pass

    label("Function_10_187D")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x98, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1967")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x2, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_18F1")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    # Function_10_187D end

    def Function_11_19A8(): pass

    label("Function_11_19A8")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x98, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1B68")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x3, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x98, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1AA0")
    ...
    QueueWorkItem(0xB, 1, lambda_19F7)

    def lambda_1A12():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x4B0)
        ExitThread()

    QueueWorkItem(0xB, 2, lambda_1A12)
    ...
    CloseMessageWindow()
    OP_56(0x0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1A55")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0xF9, 1)"), scpexpr(EXPR_END)), "loc_1AF4")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
