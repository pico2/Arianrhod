...
def main():
    ...
    ScpFunction(
        ...
        "Function_2_477",          # 02, 2
        "Function_3_7AD",          # 03, 3
        "Function_4_101D",         # 04, 4
        "Function_5_1109",         # 05, 5
        "Function_6_11F6",         # 06, 6
        "Function_7_158F",         # 07, 7
        "Function_8_15D2",         # 08, 8
        "Function_9_163A",         # 09, 9
        "Function_10_1765",        # 0A, 10
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x81, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_7AC")
    OP_A2(0x40E)
    EventBegin(0x0)
    ...
    QueueWorkItem(0x0, 2, lambda_5BE)
    OP_8C(0x102, 315, 400)
    WaitChrThread(0x0, 0x2)
    ...
    QueueWorkItem(0x0, 2, lambda_650)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_101C")
    OP_A2(0x411)
    ClearMapFlags(0x1)
    EventBegin(0x0)
    ...
    QueueWorkItem2(0x101, 1, lambda_B27)
    ...
    QueueWorkItem2(0x136, 1, lambda_B38)
    ...
    QueueWorkItem2(0x102, 1, lambda_B49)
    ...
    def Function_4_101D(): pass

    label("Function_4_101D")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1108")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_107F")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_10ED")
    ...
    def Function_5_1109(): pass

    label("Function_5_1109")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x84, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_11F5")
    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_1178")
    TurnDirection(0x102, 0x101, 400)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_11DA")
    ...
    def Function_6_11F6(): pass

    label("Function_6_11F6")
    ...
    def Function_7_158F(): pass

    label("Function_7_158F")
    ...
    def Function_8_15D2(): pass

    label("Function_8_15D2")
    ...
    def Function_9_163A(): pass

    label("Function_9_163A")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x97, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1724")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x0, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_16AE")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
    ...
    def Function_10_1765(): pass

    label("Function_10_1765")

    SetMapFlags(0x8000000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x97, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_184F")
    OP_22(0x2B, 0x0, 0x64)
    OP_70(0x1, 0x3C)
    Sleep(500)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x1F5, 1)"), scpexpr(EXPR_END)), "loc_17D9")
    FadeToDark(300, 0, 100)
    OP_22(0x11, 0x0, 0x64)
    SetMessageWindowPos(-1, -1, -1, -1)
    SetChrName("")
