...
def main():
    ...
    ScpFunction(
        ...
        "Function_11_CD4",         # 0B, 11
        "Function_12_E7C",         # 0C, 12
    )
    ...
    def Function_6_410(): pass

    label("Function_6_410")

    TalkBegin(0x9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x49, 7)), scpexpr(EXPR_END)), "loc_510")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_4AE")
    OP_A2(0x3)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x47, 1)), scpexpr(EXPR_END)), "loc_5A6")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_581")
    OP_A2(0x3)
    ...
    def Function_7_5AA(): pass

    label("Function_7_5AA")

    TalkBegin(0xA)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x49, 7)), scpexpr(EXPR_END)), "loc_5FB")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x47, 1)), scpexpr(EXPR_END)), "loc_642")
    TurnDirection(0xFE, 0x102, 400)
    ...
    def Function_11_CD4(): pass

    label("Function_11_CD4")
    ...
    def Function_12_E7C(): pass

    label("Function_12_E7C")
