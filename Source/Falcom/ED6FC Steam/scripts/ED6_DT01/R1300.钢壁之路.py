...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x61, 4)), scpexpr(EXPR_END)), "loc_2B2")
    Jump("loc_A33")

    label("loc_2B2")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x61, 3)), scpexpr(EXPR_END)), "loc_6A0")
    EventBegin(0x0)
    OP_4A(0x8, 0)
    OP_4A(0x9, 0)
    ...
    OP_A2(0x30C)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x60, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_38E")
    ...
    QueueWorkItem(0x2, 1, lambda_6A8)
    OP_4A(0x8, 0)
    OP_4A(0x9, 0)
    OP_8B(0x0, 0xFFFCD3F8, 0xFFFDAE68, 0x0)
    OP_8B(0x1, 0xFFFCD3F8, 0xFFFDAE68, 0x0)
    OP_8B(0x2, 0xFFFCD3F8, 0xFFFDAE68, 0x0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x60, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9BC")
    OP_62(0x8, 0x0, 2000, 0x2, 0x7, 0x50, 0x1)
    OP_22(0x27, 0x0, 0x64)
    OP_62(0x9, 0x0, 2000, 0x2, 0x7, 0x50, 0x1)
    OP_22(0x27, 0x0, 0x64)
