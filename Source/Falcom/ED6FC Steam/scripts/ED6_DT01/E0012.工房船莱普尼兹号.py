...
def main():
    ...
    ScpFunction(
        ...
        "Function_8_82F",          # 08, 8
        "Function_9_9EF",          # 09, 9
        "Function_10_CA9",         # 0A, 10
        "Function_11_E85",         # 0B, 11
        "Function_12_13AA",        # 0C, 12
        "Function_13_1FD4",        # 0D, 13
    )
    ...
    def Function_4_526(): pass

    label("Function_4_526")
    ...
    def Function_5_5EC(): pass

    label("Function_5_5EC")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_6C8")
    ...
    def Function_6_6D0(): pass

    label("Function_6_6D0")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 2)), scpexpr(EXPR_END)), "loc_709")
    ...
    def Function_8_82F(): pass

    label("Function_8_82F")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 2)), scpexpr(EXPR_END)), "loc_875")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_END)), "loc_8D8")
    ...
    def Function_9_9EF(): pass

    label("Function_9_9EF")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 5)), scpexpr(EXPR_END)), "loc_A43")
    TalkBegin(0xFE)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x31, 0x0, 0x8)"), scpexpr(EXPR_EXEC_OP, "OP_29(0x31, 0x0, 0x10)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_EXEC_OP, "OP_29(0x31, 0x0, 0x40)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_A6D")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x35E)"), scpexpr(EXPR_END)), "loc_A6D")
    Call(1, 2)
    TalkEnd(0xFE)
    Return()
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_END)), "loc_B90")
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 2)), scpexpr(EXPR_END)), "loc_ACC")
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x31, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_B34")
    ...
    TalkBegin(0xFE)
    OP_A2(0x2)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 2)), scpexpr(EXPR_END)), "loc_BEB")
    ...
    def Function_10_CA9(): pass

    label("Function_10_CA9")

    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xAC, 2)), scpexpr(EXPR_END)), "loc_D05")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_D66")
    ...
    QueueWorkItem(0x102, 1, lambda_113E)

    def lambda_114C():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x107, 1, lambda_114C)
    ...
    QueueWorkItem2(0x106, 1, lambda_11F1)
    ...
    QueueWorkItem2(0x101, 1, lambda_1217)
    ...
    QueueWorkItem2(0x102, 1, lambda_1228)
    ...
    QueueWorkItem(0x107, 1, lambda_124D)
    ...
    QueueWorkItem(0x106, 1, lambda_127C)
    Sleep(1000)
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    ...
    QueueWorkItem(0x101, 1, lambda_12A4)

    def lambda_12B2():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_12B2)
    ...
    def Function_12_13AA(): pass

    label("Function_12_13AA")
    ...
    QueueWorkItem2(0x101, 1, lambda_1CE6)
    ...
    QueueWorkItem2(0x102, 1, lambda_1CF7)

    def lambda_1D08():
        OP_6D(114220, 0, 4820, 1500)
        ExitThread()

    QueueWorkItem(0x106, 2, lambda_1D08)

    def lambda_1D20():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1D20)

    def lambda_1D32():
        OP_8E(0xFE, 0x1BB48, 0x0, 0xD8E, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_1D32)

    def lambda_1D4D():
        OP_9F(0xFE, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F4)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_1D4D)
    ...
    QueueWorkItem(0x102, 3, lambda_1D73)
    ...
    QueueWorkItem(0x107, 1, lambda_1D9F)

    def lambda_1DAD():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x106, 1, lambda_1DAD)

    def lambda_1DBB():
        OP_8E(0xFE, 0x1BFEE, 0x0, 0xD2A, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_1DBB)

    def lambda_1DD6():
        OP_8E(0xFE, 0x1BD00, 0x0, 0xF3C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 3, lambda_1DD6)
    ...
    QueueWorkItem2(0x102, 1, lambda_1DF1)
    ...
    # Function_12_13AA end

    def Function_13_1FD4(): pass

    label("Function_13_1FD4")
    ...
    QueueWorkItem2(0x102, 2, lambda_2096)
    ...
    QueueWorkItem2(0x101, 2, lambda_20A7)
    ...
    QueueWorkItem2(0x107, 2, lambda_20B8)
    ...
    QueueWorkItem2(0x106, 2, lambda_20C9)
    OP_4A(0x8, 255)
    OP_0D()
    ...
    QueueWorkItem(0x101, 3, lambda_213C)
    ...
    QueueWorkItem(0x101, 3, lambda_2209)
    ...
    QueueWorkItem(0x101, 3, lambda_2364)
    ...
    QueueWorkItem2(0x101, 2, lambda_237C)
    ...
    QueueWorkItem2(0x107, 2, lambda_238D)
    ...
    QueueWorkItem2(0x106, 2, lambda_239E)
    ...
    QueueWorkItem2(0x8, 2, lambda_23AF)
    ...
    QueueWorkItem2(0x107, 2, lambda_245F)
    ...
    QueueWorkItem2(0x106, 2, lambda_2470)
    ...
    QueueWorkItem2(0x8, 2, lambda_2481)
    ...
    QueueWorkItem(0x101, 2, lambda_24D0)

    def lambda_24E0():
        OP_6D(31110, 0, 9150, 2000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_24E0)
    ...
    QueueWorkItem2(0x106, 2, lambda_26B0)
    ...
    QueueWorkItem2(0x8, 2, lambda_26C1)
    ...
    QueueWorkItem2(0x8, 2, lambda_28BB)
    ...
    QueueWorkItem(0x101, 2, lambda_2A12)
    OP_22(0xA9, 0x0, 0x64)
    OP_6F(0x4, 180)
    OP_70(0x4, 0x0)
    OP_73(0x4)
