...
def main():
    ...
    ScpFunction(
        ...
        "Function_11_D16",         # 0B, 11
        "Function_12_D1A",         # 0C, 12
        "Function_13_D1E",         # 0D, 13
        "Function_14_D22",         # 0E, 14
    )
    ...
    def Function_3_79B(): pass

    label("Function_3_79B")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA5, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B06")
    OP_A2(0x52F)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_820")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_875")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x6), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_8CE")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x5), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_91E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 1)), scpexpr(EXPR_END)), "loc_99C")
    ...
    OP_82(0x1, 0x2)
    Sleep(1000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_A54")
    ...
    SetChrPos(0x101, -115670, 0, 21890, 90)
    SetChrPos(0x107, -114840, 0, 20630, 45)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 1)), scpexpr(EXPR_END)), "loc_B8A")
    SetChrPos(0x106, -116160, 0, 20300, 0)
    ...
    OP_82(0x1, 0x2)
    Sleep(1000)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA6, 1)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA7, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_C10")
    OP_A2(0x53E)
    ...
    def Function_4_C13(): pass

    label("Function_4_C13")
    ...
    def Function_7_CA8(): pass

    label("Function_7_CA8")
    ...
    def Function_11_D16(): pass

    label("Function_11_D16")
    ...
    def Function_12_D1A(): pass

    label("Function_12_D1A")
    ...
    def Function_13_D1E(): pass

    label("Function_13_D1E")
    ...
    def Function_14_D22(): pass

    label("Function_14_D22")
