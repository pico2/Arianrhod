...
def main():
    ...
    ScpFunction(
        ...
        "Function_1_534",          # 01, 1
        "Function_2_547",          # 02, 2
        "Function_3_1147",         # 03, 3
        "Function_4_1AB2",         # 04, 4
        "Function_5_1AE0",         # 05, 5
        "Function_6_1B0E",         # 06, 6
        "Function_7_1B3C",         # 07, 7
    ...
    QueueWorkItem(0x8, 1, lambda_637)
    Sleep(1000)
    OP_8C(0x9, 270, 800)
    ...
    QueueWorkItem(0x9, 1, lambda_668)

    def lambda_683():
        OP_6C(57000, 3000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_683)
    ...
    QueueWorkItem2(0x9, 1, lambda_6CC)
    ...
    QueueWorkItem(0x8, 1, lambda_A71)
    ...
    QueueWorkItem2(0x8, 1, lambda_A84)
    SetChrFlags(0xA, 0x1)
    ...
    QueueWorkItem(0xA, 1, lambda_A9A)
    Sleep(200)
    OP_8C(0x8, 270, 300)
    SetChrChipByIndex(0x8, 7)
    ...
    QueueWorkItem(0x8, 1, lambda_AC6)
    ...
    QueueWorkItem2(0x9, 1, lambda_AE1)
    Sleep(100)
    OP_22(0x8C, 0x0, 0x64)
    ...
    QueueWorkItem(0x0, 1, lambda_AFC)
    ...
    QueueWorkItem(0x0, 2, lambda_C19)

    def lambda_C29():
        OP_6D(100950, -2000, 14190, 2900)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_C29)
    Sleep(2000)
    ...
    QueueWorkItem(0xB, 1, lambda_C46)

    def lambda_C61():
        OP_90(0xFE, 0xFFFFE0C0, 0x0, 0x1F40, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_C61)

    def lambda_C7C():
        OP_90(0xFE, 0xFFFFE0C0, 0x0, 0x1F40, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_C7C)

    def lambda_C97():
        OP_90(0xFE, 0xFFFFE0C0, 0x0, 0x1F40, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xE, 1, lambda_C97)

    def lambda_CB2():
        OP_90(0xFE, 0xFFFFE0C0, 0x0, 0x1F40, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_CB2)

    def lambda_CCD():
        OP_90(0xFE, 0xFFFFE0C0, 0x0, 0x1F40, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x10, 1, lambda_CCD)

    def lambda_CE8():
        OP_90(0xFE, 0xFFFFE0C0, 0x0, 0x1F40, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_CE8)

    def lambda_D03():
        OP_90(0xFE, 0xFFFFE0C0, 0x0, 0x1F40, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x12, 1, lambda_D03)
    Sleep(900)
    ...
    QueueWorkItem(0x0, 0, lambda_D3B)
    ...
    QueueWorkItem(0x0, 1, lambda_D63)
    Sleep(1000)
    ...
    QueueWorkItem(0xE, 1, lambda_D80)

    def lambda_D9B():
        OP_90(0xFE, 0xFFFFD508, 0x0, 0x3E8, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0xF, 1, lambda_D9B)
    Sleep(100)
    ...
    QueueWorkItem(0x10, 1, lambda_DBB)

    def lambda_DD6():
        OP_90(0xFE, 0xFFFFD508, 0x0, 0x3E8, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x11, 1, lambda_DD6)
    Sleep(100)
    ...
    QueueWorkItem(0x12, 1, lambda_DF6)
    Sleep(200)
    ...
    QueueWorkItem(0xB, 1, lambda_E16)
    Sleep(100)
    ...
    QueueWorkItem(0xC, 1, lambda_E36)
    Sleep(100)
    ...
    QueueWorkItem(0xD, 1, lambda_E56)
    ...
    QueueWorkItem2(0xE, 0, lambda_E80)
    ...
    QueueWorkItem2(0xF, 0, lambda_E93)
    ...
    QueueWorkItem2(0x10, 0, lambda_EB5)
    ...
    QueueWorkItem2(0x11, 0, lambda_EC8)
    ...
    QueueWorkItem2(0x12, 0, lambda_EE5)
    ...
    QueueWorkItem(0x9, 1, lambda_F38)
    OP_6B(3200, 1200)
    ...
    QueueWorkItem(0x9, 2, lambda_FFD)

    def lambda_1015():
        OP_8E(0xFE, 0x15E3C, 0xFFFFFC18, 0x3732, 0x1770, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_1015)
    Sleep(200)
    ...
    QueueWorkItem(0xE, 1, lambda_103A)
    Sleep(50)
    ...
    QueueWorkItem(0xF, 1, lambda_1064)
    ...
    QueueWorkItem(0x11, 1, lambda_10A4)
    Sleep(50)
    ...
    QueueWorkItem(0x12, 1, lambda_10C9)

    def lambda_10E4():
        OP_8E(0xFE, 0x1291C, 0x0, 0x3642, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_10E4)
    Sleep(100)
    ...
    QueueWorkItem(0xC, 1, lambda_1104)

    def lambda_111F():
        OP_8E(0xFE, 0x1291C, 0x0, 0x3642, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_111F)
    OP_0D()
    ...
    def Function_3_1147(): pass

    label("Function_3_1147")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC0, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1AB1")
    OP_A2(0x607)
    EventBegin(0x0)
    ...
    QueueWorkItem(0x13, 2, lambda_11F7)

    def lambda_1212():
        OP_8E(0xFE, 0x5EBA, 0x0, 0x7BAC, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x14, 2, lambda_1212)

    def lambda_122D():
        OP_8E(0xFE, 0x5E06, 0x0, 0x82BE, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x16, 2, lambda_122D)

    def lambda_1248():
        OP_8E(0xFE, 0x669E, 0x0, 0x7EFD, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x15, 2, lambda_1248)

    def lambda_1263():
        OP_8E(0xFE, 0x64C8, 0x0, 0x8426, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x17, 2, lambda_1263)

    def lambda_127E():
        OP_6C(315000, 4000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_127E)
    ...
    QueueWorkItem2(0x13, 1, lambda_12D2)
    ...
    QueueWorkItem2(0x14, 1, lambda_12E3)
    ...
    QueueWorkItem2(0x15, 1, lambda_12F4)
    ...
    QueueWorkItem2(0x16, 1, lambda_1305)
    ...
    QueueWorkItem2(0x17, 1, lambda_1316)

    def lambda_1327():
        OP_6D(25030, 0, 29550, 2000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1327)

    def lambda_133F():
        OP_8E(0xFE, 0x6626, 0x0, 0x6D88, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_133F)

    def lambda_135A():
        OP_8E(0xFE, 0x613A, 0x0, 0x6CFC, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_135A)

    def lambda_1375():
        OP_8E(0xFE, 0x631A, 0x0, 0x6838, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x10E, 1, lambda_1375)
    ...
    QueueWorkItem(0x102, 2, lambda_16DE)
    ...
    QueueWorkItem(0x10E, 2, lambda_1714)
    ...
    QueueWorkItem2(0x101, 1, lambda_172F)
    ...
    QueueWorkItem2(0x102, 1, lambda_1740)
    ...
    QueueWorkItem2(0x10E, 1, lambda_1751)
    ...
    def Function_4_1AB2(): pass

    label("Function_4_1AB2")
    ...
    def Function_5_1AE0(): pass

    label("Function_5_1AE0")
    ...
    def Function_6_1B0E(): pass

    label("Function_6_1B0E")
    ...
    def Function_7_1B3C(): pass

    label("Function_7_1B3C")
