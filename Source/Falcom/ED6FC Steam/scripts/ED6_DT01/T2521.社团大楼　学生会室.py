...
def main():
    ...
    ScpFunction(
        ...
        "Function_6_BBF",          # 06, 6
        "Function_7_D41",          # 07, 7
        "Function_8_120F",         # 08, 8
        "Function_9_1643",         # 09, 9
        "Function_10_1AAB",        # 0A, 10
        "Function_11_1FAA",        # 0B, 11
        "Function_12_1FAF",        # 0C, 12
        "Function_13_2553",        # 0D, 13
        "Function_14_26D6",        # 0E, 14
        "Function_15_2726",        # 0F, 15
        "Function_16_2756",        # 10, 16
        "Function_17_278E",        # 11, 17
        "Function_18_2D9B",        # 12, 18
        "Function_19_2DEA",        # 13, 19
        "Function_20_2E24",        # 14, 20
        "Function_21_2E88",        # 15, 21
        "Function_22_2E8C",        # 16, 22
        "Function_23_2E90",        # 17, 23
        "Function_24_2E94",        # 18, 24
    )
    ...
    TalkBegin(0x8)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_869")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 1)), scpexpr(EXPR_END)), "loc_926")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 0)), scpexpr(EXPR_END)), "loc_A04")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9AF")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 7)), scpexpr(EXPR_END)), "loc_A55")
    ...
    def Function_5_A59(): pass

    label("Function_5_A59")

    TalkBegin(0x9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 2)), scpexpr(EXPR_END)), "loc_B81")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B36")
    OP_A2(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 1)), scpexpr(EXPR_END)), "loc_BBB")
    ...
    def Function_6_BBF(): pass

    label("Function_6_BBF")

    TalkBegin(0xA)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 2)), scpexpr(EXPR_END)), "loc_CB3")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_C73")
    OP_A2(0x2)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 1)), scpexpr(EXPR_END)), "loc_D3D")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_D11")
    OP_A2(0x2)
    ...
    def Function_7_D41(): pass

    label("Function_7_D41")

    TalkBegin(0xB)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 2)), scpexpr(EXPR_END)), "loc_E03")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_DB8")
    OP_A2(0x3)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 1)), scpexpr(EXPR_END)), "loc_E4D")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x89, 2)), scpexpr(EXPR_END)), "loc_1200")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x89, 0)), scpexpr(EXPR_END)), "loc_120B")
    Call(0, 9)
    ...
    def Function_8_120F(): pass

    label("Function_8_120F")

    TalkBegin(0xC)
    ClearChrFlags(0xC, 0x10)
    TurnDirection(0xC, 0x0, 0)
    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xC, 0x4), scpexpr(EXPR_PUSH_LONG, 0x5A), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_1234")
    SetChrSubChip(0xC, 2)
    Jump("loc_1265")

    label("loc_1234")

    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xC, 0x4), scpexpr(EXPR_PUSH_LONG, 0xE1), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_124A")
    SetChrSubChip(0xC, 1)
    Jump("loc_1265")

    label("loc_124A")

    Jc((scpexpr(EXPR_GET_CHR_WORK, 0xC, 0x4), scpexpr(EXPR_PUSH_LONG, 0x13B), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_1260")
    SetChrSubChip(0xC, 0)
    Jump("loc_1265")
    ...
    OP_8C(0xC, 270, 0)
    SetChrFlags(0xC, 0x10)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x89, 2)), scpexpr(EXPR_END)), "loc_1634")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x89, 0)), scpexpr(EXPR_END)), "loc_163F")
    Call(0, 9)
    ...
    def Function_9_1643(): pass

    label("Function_9_1643")
    ...
    SetChrSubChip(0xC, 1)
    OP_0D()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x89, 1)), scpexpr(EXPR_END)), "loc_16C0")
    ...
    def Function_10_1AAB(): pass

    label("Function_10_1AAB")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x89, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1F32")
    OP_A2(0x449)
    EventBegin(0x0)
    ...
    # Function_10_1AAB end

    def Function_11_1FAA(): pass

    label("Function_11_1FAA")

    Call(0, 12)
    Return()

    # Function_11_1FAA end
    ...
    OP_4F(0x28, (scpexpr(EXPR_PUSH_LONG, 0xFFFF), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_5F(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_202C")
    FadeToBright(300, 0)
    OP_0D()
    OP_A9(0x30)
    OP_56(0x0)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_2129")
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x12), scpexpr(EXPR_PUSH_LONG, 0x1F4), scpexpr(EXPR_GE), scpexpr(EXPR_END)), "loc_20F1")
    SubMira(500)
    FadeToDark(1000, 0, -1)
    OP_0D()
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_40(0x20D)"), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_20E3")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_AC(0x9)"), scpexpr(EXPR_END)), "loc_20BD")
    Jump("loc_20E3")
    ...
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x87, 5)), scpexpr(EXPR_END)), "loc_2177")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 4)), scpexpr(EXPR_END)), "loc_2265")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2235")
    OP_A2(0x4)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x8A, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2232")
    OP_A2(0x452)
    OP_3E(0x384, 1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 2)), scpexpr(EXPR_END)), "loc_22BA")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 1)), scpexpr(EXPR_END)), "loc_2312")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x86, 0)), scpexpr(EXPR_END)), "loc_2380")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 7)), scpexpr(EXPR_END)), "loc_23E6")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 6)), scpexpr(EXPR_END)), "loc_2432")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x85, 0)), scpexpr(EXPR_END)), "loc_248E")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x83, 6)), scpexpr(EXPR_END)), "loc_24F8")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 1)), scpexpr(EXPR_END)), "loc_254F")
    ...
    def Function_13_2553(): pass

    label("Function_13_2553")

    TalkBegin(0xE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2658")
    OP_A2(0x5)
    ...
    # Function_13_2553 end

    def Function_14_26D6(): pass

    label("Function_14_26D6")
    ...
    def Function_16_2756(): pass

    label("Function_16_2756")
    ...
    # Function_16_2756 end

    def Function_17_278E(): pass

    label("Function_17_278E")

    TalkBegin(0x12)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x8B, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2C94")
    EventBegin(0x0)
    Fade(1000)
    ...
    # Function_17_278E end

    def Function_18_2D9B(): pass

    label("Function_18_2D9B")
    ...
    # Function_18_2D9B end

    def Function_19_2DEA(): pass

    label("Function_19_2DEA")
    ...
    # Function_19_2DEA end

    def Function_20_2E24(): pass

    label("Function_20_2E24")
    ...
    # Function_20_2E24 end

    def Function_21_2E88(): pass

    label("Function_21_2E88")

    SetPlaceName(0x71) # 社团大楼　学生会室
    Return()

    # Function_21_2E88 end

    def Function_22_2E8C(): pass

    label("Function_22_2E8C")

    SetPlaceName(0x72) # 社团大楼　学生会室
    Return()

    # Function_22_2E8C end

    def Function_23_2E90(): pass

    label("Function_23_2E90")

    SetPlaceName(0x75) # 社团大楼　学生会室
    Return()

    # Function_23_2E90 end

    def Function_24_2E94(): pass

    label("Function_24_2E94")

    SetPlaceName(0x70) # 社团大楼　学生会室
    Return()

    # Function_24_2E94 end
