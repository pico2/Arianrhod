...
def main():
    ...
    QueueWorkItem(0x8, 2, lambda_477)
    ...
    QueueWorkItem2(0x101, 2, lambda_48F)
    ...
    QueueWorkItem2(0x102, 2, lambda_4A0)

    def lambda_4B1():
        OP_8E(0xFE, 0x4B0, 0xFA, 0x1E64, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_4B1)
    Sleep(1000)
    ...
    QueueWorkItem(0x101, 1, lambda_4D1)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_4F1)
    ...
    QueueWorkItem(0x8, 2, lambda_703)
    ...
    OP_28(0x28, 0x4, 0x40)
    OP_28(0x29, 0x4, 0x40)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x2A, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_7DA")
    OP_28(0x2A, 0x4, 0x40)

    label("loc_7DA")

    OP_28(0x2C, 0x4, 0x40)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x31, 0x0, 0x8)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_7EF")
    OP_28(0x31, 0x4, 0x40)
    ...
    QueueWorkItem(0x101, 1, lambda_882)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_8A2)
    ...
    QueueWorkItem(0x107, 1, lambda_95D)
