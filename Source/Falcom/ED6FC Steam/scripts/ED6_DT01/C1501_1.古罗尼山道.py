...
def main():
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x1F, 0x1, 0x4000)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1A79")
    OP_28(0x1F, 0x1, 0x4000)
    OP_28(0x1F, 0x4, 0x8)
    ClearMapFlags(0x1)
    EventBegin(0x0)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_E1")
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_16C")
    ...
    QueueWorkItem(0xC, 1, lambda_186)
    ...
    QueueWorkItem(0x101, 1, lambda_230)

    def lambda_24B():
        OP_8E(0x102, 0xFFFE8C84, 0xFA0, 0x123CC, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_24B)

    def lambda_266():
        OP_8E(0x105, 0xFFFE906C, 0xFA0, 0x127B4, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_266)
    OP_8C(0x8, 0, 400)
    OP_62(0x8, 0x0, 2000, 0x28, 0x2B, 0x64, 0x3)
    ...
    QueueWorkItem(0x9, 1, lambda_2BC)
    ...
    QueueWorkItem(0xA, 1, lambda_2DC)
    ...
    QueueWorkItem(0xB, 1, lambda_2FC)
    ...
    QueueWorkItem(0x9, 1, lambda_321)

    def lambda_33C():
        OP_8E(0x101, 0xFFFE72BC, 0x960, 0xF80C, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_33C)
    WaitChrThread(0xA, 0x1)
    ...
    QueueWorkItem(0xA, 1, lambda_35C)

    def lambda_377():
        OP_8E(0x102, 0xFFFE6E70, 0xA28, 0xFC57, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_377)
    WaitChrThread(0xB, 0x1)
    ...
    QueueWorkItem(0xB, 1, lambda_397)

    def lambda_3B2():
        OP_8E(0x105, 0xFFFE74B0, 0xC1C, 0xFFDC, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_3B2)
    WaitChrThread(0xB, 0x1)
    ...
    QueueWorkItem(0xC, 1, lambda_422)
    ...
    QueueWorkItem(0x101, 1, lambda_4C1)

    def lambda_4D7():
        OP_94(0x1, 0x102, 0x0, 0x2BC, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_4D7)

    def lambda_4ED():
        OP_94(0x1, 0x105, 0x0, 0x2BC, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_4ED)
    Sleep(400)
    OP_44(0x101, 0xFF)
    OP_44(0x102, 0xFF)
    OP_44(0x105, 0xFF)
    ...
    QueueWorkItem(0x102, 1, lambda_636)
    ...
    QueueWorkItem(0x101, 1, lambda_690)
    ...
    QueueWorkItem(0xC, 1, lambda_6F6)
    OP_8E(0x137, 0xFFFE6DA8, 0x834, 0xF0A0, 0x7D0, 0x0)
    WaitChrThread(0x137, 0x1)
    TalkBegin(0x137)
    TurnDirection(0x137, 0x101, 400)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x5, 0x0, 0x10)"), scpexpr(EXPR_END)), "loc_EEE")
    OP_28(0x1F, 0x1, 0x8)
    OP_28(0x1F, 0x1, 0x10)
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x5, 0x0, 0x4)"), scpexpr(EXPR_END)), "loc_1545")
    OP_28(0x1F, 0x1, 0x8)
    OP_28(0x1F, 0x1, 0x10)
    ...
    CloseMessageWindow()
    TurnDirection(0x101, 0x137, 400)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x5, 0x1, 0x2)"), scpexpr(EXPR_END)), "loc_FF9")
    ...
    def Function_2_1A7A(): pass

    label("Function_2_1A7A")
    ...
    QueueWorkItem(0xC, 1, lambda_1A84)
