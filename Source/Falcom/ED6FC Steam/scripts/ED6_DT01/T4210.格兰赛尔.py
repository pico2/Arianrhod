...
def main():
    ...
    ScpFunction(
        ...
        "Function_2_32C",          # 02, 2
        "Function_3_3FA",          # 03, 3
        "Function_4_1332",         # 04, 4
        "Function_5_14AF",         # 05, 5
        "Function_6_1517",         # 06, 6
        "Function_7_1CEB",         # 07, 7
        "Function_8_1D14",         # 08, 8
        "Function_9_2AC7",         # 09, 9
        "Function_10_2B40",        # 0A, 10
        "Function_11_2C6B",        # 0B, 11
        "Function_12_2E6E",        # 0C, 12
        "Function_13_2ECB",        # 0D, 13
    )
    ...
    QueueWorkItem(0x8, 1, lambda_644)

    def lambda_65F():
        OP_8E(0xFE, 0xFFFFFCAE, 0x0, 0xFFFFB758, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_65F)
    ...
    QueueWorkItem2(0x108, 1, lambda_C7D)
    ...
    QueueWorkItem2(0x101, 1, lambda_C8E)
    ...
    QueueWorkItem2(0x102, 1, lambda_C9F)
    ...
    QueueWorkItem(0x8, 1, lambda_CC4)
    Sleep(1500)
    ...
    QueueWorkItem(0x108, 1, lambda_E1D)
    ...
    QueueWorkItem(0x9, 1, lambda_E42)
    ...
    QueueWorkItem(0x108, 1, lambda_E87)

    def lambda_E95():
        TurnDirection(0xFE, 0x9, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_E95)
    ...
    QueueWorkItem(0x9, 2, lambda_1037)
    ...
    QueueWorkItem(0x108, 1, lambda_1067)
    ...
    QueueWorkItem(0x102, 1, lambda_1087)
    ...
    QueueWorkItem(0x101, 1, lambda_10A7)
    ...
    QueueWorkItem(0x9, 1, lambda_10F4)
    ...
    QueueWorkItem(0x101, 2, lambda_1139)

    def lambda_1147():
        OP_8C(0xFE, 0, 400)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_1147)

    def lambda_1155():
        OP_8C(0xFE, 0, 400)
        ExitThread()

    QueueWorkItem(0x108, 2, lambda_1155)
    OP_8C(0x9, 0, 400)
    ...
    QueueWorkItem(0x108, 1, lambda_11D7)
    ...
    def Function_4_1332(): pass

    label("Function_4_1332")
    ...
    def Function_5_14AF(): pass

    label("Function_5_14AF")
    ...
    QueueWorkItem(0xFE, 3, lambda_14F6)
    ...
    QueueWorkItem(0x101, 3, lambda_159D)
    Sleep(1000)
    ...
    QueueWorkItem(0xA, 1, lambda_15BA)

    def lambda_15D5():
        OP_8E(0xFE, 0xFFFFF72C, 0x2328, 0x35CA, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_15D5)
    ...
    QueueWorkItem(0xA, 1, lambda_15F5)
    WaitChrThread(0x8, 0x1)
    ...
    QueueWorkItem(0x8, 1, lambda_1608)
    ...
    QueueWorkItem2(0x101, 1, lambda_1616)
    ...
    QueueWorkItem2(0x102, 1, lambda_1627)
    ...
    QueueWorkItem(0x101, 3, lambda_1651)
    ...
    QueueWorkItem2(0xA, 1, lambda_1681)

    def lambda_1692():
        OP_8E(0xFE, 0xFFFFE778, 0x2328, 0x6324, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 2, lambda_1692)
    WaitChrThread(0x8, 0x1)
    ...
    QueueWorkItem2(0x8, 1, lambda_16B2)
    ...
    QueueWorkItem2(0xA, 1, lambda_1AE5)
    ...
    QueueWorkItem2(0x101, 1, lambda_1AF6)
    ...
    QueueWorkItem2(0x102, 1, lambda_1B07)
    ...
    QueueWorkItem2(0x101, 1, lambda_1BE0)
    ...
    QueueWorkItem2(0x102, 1, lambda_1BF1)
    ...
    QueueWorkItem(0xA, 1, lambda_1C30)
    Sleep(300)
    ...
    def Function_7_1CEB(): pass

    label("Function_7_1CEB")
    ...
    def Function_8_1D14(): pass

    label("Function_8_1D14")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 7)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 6)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_1D21")
    Return()
    ...
    QueueWorkItem(0x101, 1, lambda_1DC1)

    def lambda_1DCF():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1DCF)
    ...
    QueueWorkItem(0x8, 1, lambda_1E29)
    ...
    QueueWorkItem(0x101, 1, lambda_23F5)
    ...
    QueueWorkItem(0x8, 1, lambda_2411)

    def lambda_241F():
        TurnDirection(0xFE, 0x108, 400)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_241F)

    def lambda_242D():
        TurnDirection(0xFE, 0x108, 400)
        ExitThread()

    QueueWorkItem(0xC, 1, lambda_242D)
    ...
    QueueWorkItem2(0x101, 1, lambda_244C)
    ...
    QueueWorkItem2(0x102, 1, lambda_245D)
    ...
    QueueWorkItem2(0x8, 1, lambda_246E)
    ...
    QueueWorkItem2(0xB, 1, lambda_247F)
    ...
    QueueWorkItem2(0xC, 1, lambda_2490)
    ...
    QueueWorkItem(0x101, 2, lambda_24B6)

    def lambda_24CE():
        OP_6E(256, 4000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_24CE)

    def lambda_24DE():
        OP_9E(0xFE, 0x3C, 0x0, 0x1388, 0x2BC)
        ExitThread()

    QueueWorkItem(0x108, 1, lambda_24DE)
    ...
    QueueWorkItem(0x108, 1, lambda_27F7)
    ...
    QueueWorkItem2(0x102, 1, lambda_2972)
    ...
    QueueWorkItem2(0x108, 1, lambda_2983)
    ...
    def Function_9_2AC7(): pass

    label("Function_9_2AC7")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2C6A")
    EventBegin(0x1)
    OP_4A(0xD, 255)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_42(0x37)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_2BEF")
    ...
    def Function_11_2C6B(): pass

    label("Function_11_2C6B")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 7)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_2C78")
    Return()

    label("loc_2C78")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 7)), scpexpr(EXPR_END)), "loc_2D06")
    EventBegin(0x1)
    OP_4A(0x10, 255)
    OP_4A(0x11, 255)
    ...
    OP_4A(0xE, 255)
    OP_4A(0xF, 255)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_42(0x37)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_2DBD")
    ...
    # Function_11_2C6B end

    def Function_12_2E6E(): pass

    label("Function_12_2E6E")
    ...
    # Function_12_2E6E end

    def Function_13_2ECB(): pass

    label("Function_13_2ECB")
