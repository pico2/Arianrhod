...
def main():
    ...
    QueueWorkItem(0x101, 1, lambda_317)
    OP_69(0x0, 0x5DC)
    OP_A2(0x321)
    EventEnd(0x0)
    Return()
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_457")
    EventBegin(0x0)
    ...
    def Function_5_496(): pass

    label("Function_5_496")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_51A")
    EventBegin(0x0)
    ...
    def Function_6_575(): pass

    label("Function_6_575")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 5)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_609")
    EventBegin(0x0)
    ...
    def Function_7_64C(): pass

    label("Function_7_64C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_6BE")
    EventBegin(0x0)
    ...
    def Function_8_6FF(): pass

    label("Function_8_6FF")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_745")
    EventBegin(0x0)
