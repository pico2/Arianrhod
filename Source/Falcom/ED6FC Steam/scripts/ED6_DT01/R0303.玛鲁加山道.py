...
def main():
    ...
    ScpFunction(
        ...
        "Function_3_39D",          # 03, 3
        "Function_4_5C1",          # 04, 4
        "Function_5_1068",         # 05, 5
        "Function_6_1072",         # 06, 6
        "Function_7_1084",         # 07, 7
        "Function_8_108E",         # 08, 8
        "Function_9_10AA",         # 09, 9
        "Function_10_10C6",        # 0A, 10
        "Function_11_10E2",        # 0B, 11
        "Function_12_10FE",        # 0C, 12
        "Function_13_1213",        # 0D, 13
        "Function_14_15C2",        # 0E, 14
        "Function_15_15C3",        # 0F, 15
        "Function_16_16B3",        # 10, 16
        "Function_17_194E",        # 11, 17
        "Function_18_196E",        # 12, 18
    )
    ...
    TalkBegin(0x9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x60, 0)), scpexpr(EXPR_END)), "loc_433")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4B, 1)), scpexpr(EXPR_END)), "loc_48D")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4A, 0)), scpexpr(EXPR_END)), "loc_4D6")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x49, 6)), scpexpr(EXPR_END)), "loc_541")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x47, 4)), scpexpr(EXPR_END)), "loc_58E")
    ...
    def Function_4_5C1(): pass

    label("Function_4_5C1")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4A, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4A, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1067")
    ClearMapFlags(0x1)
    EventBegin(0x0)
    OP_A2(0x254)
    ...
    def Function_5_1068(): pass

    label("Function_5_1068")
    ...
    def Function_7_1084(): pass

    label("Function_7_1084")
    ...
    def Function_8_108E(): pass

    label("Function_8_108E")
    ...
    def Function_9_10AA(): pass

    label("Function_9_10AA")
    ...
    def Function_11_10E2(): pass

    label("Function_11_10E2")

    OP_8E(0x110, 0xFFFFFE58, 0x0, 0xFFFF98E9, 0xBB8, 0x0)
    OP_8C(0x110, 0, 400)
    Return()

    # Function_11_10E2 end

    def Function_12_10FE(): pass

    label("Function_12_10FE")
    ...
    PlayEffect(0x0, 0xFF, 0x110, 0, 1200, 500, 0, 0, 0, 500, 500, 500, 0xFF, 0, 0, 0, 0)
    Sleep(300)
    Jump("Function_12_10FE")

    label("loc_1212")

    Return()

    # Function_12_10FE end

    def Function_13_1213(): pass

    label("Function_13_1213")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x47, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_129F")
    EventBegin(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x47, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x47, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_15C1")
    OP_4A(0x9, 255)
    EventBegin(0x0)
    OP_A2(0x23C)
    OP_28(0x3, 0x1, 0x8)
    ...
    # Function_13_1213 end

    def Function_14_15C2(): pass

    label("Function_14_15C2")

    Return()

    # Function_14_15C2 end

    def Function_15_15C3(): pass

    label("Function_15_15C3")
    ...
    # Function_15_15C3 end

    def Function_16_16B3(): pass

    label("Function_16_16B3")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x43, 6)), scpexpr(EXPR_END)), "loc_1769")
    EventBegin(0x0)
    ClearMapFlags(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x41, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1775")
    Return()

    label("loc_1775")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x42, 7)), scpexpr(EXPR_END)), "loc_177D")
    Return()

    label("loc_177D")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x44, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_194D")
    EventBegin(0x0)
    ClearMapFlags(0x1)
    ...
    QueueWorkItem(0x0, 1, lambda_179F)

    def lambda_17AF():
        OP_6C(0, 6000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_17AF)

    def lambda_17BF():
        OP_67(0, 4000, -10000, 9500)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_17BF)
    ...
    # Function_16_16B3 end

    def Function_17_194E(): pass

    label("Function_17_194E")
    ...
    # Function_17_194E end

    def Function_18_196E(): pass

    label("Function_18_196E")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x43, 6)), scpexpr(EXPR_END)), "loc_1980")
    EventBegin(0x0)
