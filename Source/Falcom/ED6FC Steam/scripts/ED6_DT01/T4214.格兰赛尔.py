...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_END)), "loc_444")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 0)), scpexpr(EXPR_END)), "loc_44E")
    Jump("loc_53B")

    label("loc_44E")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_53B")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_496")
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCD, 7)), scpexpr(EXPR_END)), "loc_5FB")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_65F")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 0)), scpexpr(EXPR_END)), "loc_6F1")
    Jump("loc_78B")

    label("loc_6F1")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 1)), scpexpr(EXPR_END)), "loc_78B")
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 4)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_C34")
    ...
    QueueWorkItem(0x101, 3, lambda_D11)
    ...
    QueueWorkItem(0x102, 2, lambda_D44)
    ...
    QueueWorkItem2(0x9, 1, lambda_10AE)

    def lambda_10BF():
        OP_8E(0xFE, 0x10CCA, 0x0, 0x112B0, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 2, lambda_10BF)
    ...
    QueueWorkItem2(0x8, 1, lambda_10DA)
    ...
    QueueWorkItem2(0x101, 1, lambda_10EB)
    ...
    QueueWorkItem2(0x102, 1, lambda_10FC)
    ...
    QueueWorkItem(0x9, 1, lambda_155F)
    ...
    QueueWorkItem(0x9, 1, lambda_16C8)
    TurnDirection(0x8, 0x102, 400)
    ...
    QueueWorkItem2(0x8, 1, lambda_1876)
    ...
    QueueWorkItem(0x9, 1, lambda_189B)
    Sleep(300)
    ...
    QueueWorkItem(0x101, 3, lambda_191E)

    def lambda_1936():
        OP_8E(0xFE, 0x10C48, 0x0, 0x12D4A, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_1936)

    def lambda_1951():
        OP_8F(0xFE, 0x10C48, 0x0, 0x12D4A, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1951)
    ...
    QueueWorkItem(0x101, 1, lambda_1A59)
    Sleep(600)
    ...
    QueueWorkItem(0x9, 1, lambda_1A79)
    ...
    QueueWorkItem(0x9, 1, lambda_1AB9)
    ...
    QueueWorkItem(0x8, 1, lambda_1C37)

    def lambda_1C45():
        TurnDirection(0xFE, 0x102, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_1C45)
    ...
    QueueWorkItem2(0x9, 1, lambda_1CE8)
    ...
    QueueWorkItem2(0x8, 1, lambda_1CF9)
    ...
    QueueWorkItem2(0x101, 1, lambda_1D0A)
    ...
    QueueWorkItem(0x101, 1, lambda_1E3F)

    def lambda_1E4D():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_1E4D)
    ...
    QueueWorkItem(0x8, 1, lambda_20E7)
    EventEnd(0x0)
    AddParty(0x37, 0xFF)
    SetChrChipByIndex(0x0, 0)
    SetChrChipByIndex(0x1, 2)
