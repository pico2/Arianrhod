...
def main():
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_340")
    ...
    QueueWorkItem(0x8, 1, lambda_572)
    Sleep(100)
    ...
    QueueWorkItem(0x9, 1, lambda_585)
    Sleep(100)
    ...
    QueueWorkItem(0xA, 1, lambda_598)
    Sleep(100)
    ...
    QueueWorkItem(0xB, 1, lambda_5AB)
    Sleep(100)
    ...
    QueueWorkItem(0xC, 1, lambda_5BE)
    ...
    QueueWorkItem(0x108, 1, lambda_69F)

    def lambda_6BA():
        OP_8E(0xFE, 0x10252, 0x0, 0xFFFF33AA, 0x2710, 0x0)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_6BA)

    def lambda_6D5():
        OP_6D(65930, 0, -40190, 800)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_6D5)

    def lambda_6ED():
        OP_6E(225, 800)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_6ED)
    Sleep(500)
    OP_44(0x102, 0xFF)
    OP_44(0x108, 0xFF)
    OP_44(0x104, 0xFF)
    ...
    QueueWorkItem2(0x108, 1, lambda_803)
    ...
    QueueWorkItem2(0x104, 1, lambda_82F)
