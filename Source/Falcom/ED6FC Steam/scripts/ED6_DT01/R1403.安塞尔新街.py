...
def main():
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0xF, 0x1, 0x8000)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_462")
    ...
    QueueWorkItem(0x101, 2, lambda_56E)
    ...
    QueueWorkItem2(0x101, 1, lambda_586)
    ...
    QueueWorkItem2(0x102, 1, lambda_597)
    ...
    QueueWorkItem2(0x103, 1, lambda_5A8)
    ...
    QueueWorkItem(0x8, 1, lambda_C1B)
    ...
    QueueWorkItem2(0xA, 1, lambda_C36)
    ...
    QueueWorkItem2(0xB, 1, lambda_C47)
    ...
    QueueWorkItem2(0xC, 1, lambda_C58)
    ...
    QueueWorkItem2(0xD, 1, lambda_C69)
    ...
    QueueWorkItem2(0xE, 1, lambda_C7A)
    ...
    QueueWorkItem2(0xF, 1, lambda_C8B)
    Sleep(800)
    ...
    QueueWorkItem(0x9, 1, lambda_CA1)
    ...
    def Function_4_F74(): pass

    label("Function_4_F74")
    ...
    QueueWorkItem(0x101, 1, lambda_FEB)

    def lambda_1003():
        OP_6B(5500, 15000)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1003)

    def lambda_1013():
        OP_6C(135000, 15000)
        ExitThread()

    QueueWorkItem(0x104, 1, lambda_1013)

    def lambda_1023():
        OP_67(0, 10600, -10000, 15000)
        ExitThread()

    QueueWorkItem(0x104, 2, lambda_1023)
    OP_22(0x79, 0x0, 0x64)
    Sleep(6500)
    OP_22(0xCD, 0x0, 0x64)
    Sleep(8500)
