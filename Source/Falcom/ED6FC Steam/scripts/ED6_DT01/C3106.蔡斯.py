...
def main():
    ...
    ScpFunction(
        ...
        "Function_1_1C6",          # 01, 1
        "Function_2_226",          # 02, 2
        "Function_3_14EB",         # 03, 3
        "Function_4_15A9",         # 04, 4
    )
    ...
    QueueWorkItem(0xA, 1, lambda_4F3)
    Sleep(100)
    OP_8C(0x9, 270, 400)
    ...
    QueueWorkItem2(0x8, 1, lambda_572)
    ...
    QueueWorkItem2(0xB, 1, lambda_627)

    def lambda_638():
        OP_8E(0xFE, 0xFFFFA970, 0x0, 0x5816, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_638)
    Sleep(1000)
    ...
    QueueWorkItem(0x101, 3, lambda_6AD)

    def lambda_6BD():
        OP_6B(2800, 7000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_6BD)
    ...
    def Function_3_14EB(): pass

    label("Function_3_14EB")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1563")
    OP_A2(0x0)
    ...
    def Function_4_15A9(): pass

    label("Function_4_15A9")
    ...
    OP_5F(0x0)
    OP_56(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_17C5")
    FadeToBright(100, 0)
    Sleep(500)
    SoundLoad(13)
    OP_82(0x0, 0x2)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_17DF")
    FadeToBright(300, 0)
    TalkEnd(0xFF)
    Return()
