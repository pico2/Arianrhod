...
def main():
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x7F, 2)), scpexpr(EXPR_END)), "loc_1D7")
    OP_A3(0x3FA)
    Event(0, 9)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x42, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x42, 2)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1F0")
    OP_B1("t0133_y")
    Jump("loc_1F9")
    ...
    def Function_3_1FB(): pass

    label("Function_3_1FB")
    ...
    def Function_4_211(): pass

    label("Function_4_211")

    TalkBegin(0x8)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4B, 1)), scpexpr(EXPR_END)), "loc_337")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_2E4")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x49, 7)), scpexpr(EXPR_END)), "loc_437")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_3EC")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x42, 3)), scpexpr(EXPR_END)), "loc_4FA")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_4B1")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x42, 2)), scpexpr(EXPR_END)), "loc_5E2")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_591")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x40, 5)), scpexpr(EXPR_END)), "loc_6D0")
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_687")
    OP_A2(0x0)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_84E")
    OP_A2(0x0)
    ...
    TalkBegin(0x9)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_9D8")
    OP_A2(0x1)
    ...
    TalkBegin(0xA)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_B2C")
    OP_A2(0x2)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x4D, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x72, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_CDD")
    EventBegin(0x0)
    OP_A2(0x26A)
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_42(0x2)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_CCC")
    ...
    def Function_8_CE7(): pass

    label("Function_8_CE7")
    ...
    QueueWorkItem(0x0, 1, lambda_D6B)

    def lambda_D83():
        OP_6C(302000, 6000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_D83)

    def lambda_D93():
        OP_6E(539, 6000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_D93)

    def lambda_DA3():
        OP_67(0, 7060, -10000, 6000)
        ExitThread()

    QueueWorkItem(0x0, 0, lambda_DA3)
    Sleep(6500)
    Fade(1500)
    ...
    QueueWorkItem(0x0, 1, lambda_F3E)
    OP_20(0x7D0)
    Sleep(1000)
    OP_8C(0x101, 180, 300)
    OP_21()
    ...
    QueueWorkItem(0x0, 1, lambda_1412)
    ...
    QueueWorkItem(0x0, 1, lambda_16A0)
    ...
    QueueWorkItem(0x0, 1, lambda_18D7)

    def lambda_18EF():
        OP_67(0, 6220, -10000, 4000)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_18EF)

    def lambda_1907():
        OP_6C(324000, 4000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_1907)

    def lambda_1917():
        OP_6E(470, 4000)
        ExitThread()

    QueueWorkItem(0x1, 2, lambda_1917)
