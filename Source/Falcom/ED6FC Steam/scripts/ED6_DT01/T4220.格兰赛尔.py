...
def main():
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_59D")
    ...
    TalkBegin(0xFE)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_642")
    ...
    QueueWorkItem(0xC, 1, lambda_B9E)

    def lambda_BB9():
        OP_8E(0xFE, 0xBE, 0x0, 0x1AE8C, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xD, 1, lambda_BB9)
    Sleep(300)
    ...
    QueueWorkItem(0xA, 1, lambda_BD9)

    def lambda_BF4():
        OP_8E(0xFE, 0xBE, 0x0, 0x1AE8C, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_BF4)
    Sleep(1000)
