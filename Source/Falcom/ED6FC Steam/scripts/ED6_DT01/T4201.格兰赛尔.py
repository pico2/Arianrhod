...
def main():
    ...
    ScpFunction(
        ...
        "Function_7_1D81",         # 07, 7
        "Function_8_2427",         # 08, 8
        "Function_9_290F",         # 09, 9
        "Function_10_293D",        # 0A, 10
        "Function_11_2970",        # 0B, 11
        "Function_12_29A3",        # 0C, 12
        "Function_13_324C",        # 0D, 13
        "Function_14_3555",        # 0E, 14
        "Function_15_368C",        # 0F, 15
        "Function_16_396D",        # 10, 16
        "Function_17_3EE7",        # 11, 17
        "Function_18_3F60",        # 12, 18
        "Function_19_5144",        # 13, 19
    )
    ...
    OP_5F(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_BDF")
    OP_0D()
    OP_A9(0x6C)
    OP_56(0x0)
    TalkEnd(0x32)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_BF8")
    OP_0D()
    OP_A9(0x6D)
    OP_56(0x0)
    TalkEnd(0x32)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_C09")
    TalkEnd(0x32)
    Return()
    ...
    QueueWorkItem(0x101, 1, lambda_CF4)

    def lambda_D0F():
        OP_8E(0xFE, 0x722E, 0x2EE0, 0x1730E, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_D0F)

    def lambda_D2A():
        OP_6D(29660, 12000, 100020, 5000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_D2A)

    def lambda_D42():
        OP_67(0, 5000, -10000, 5000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_D42)

    def lambda_D5A():
        OP_6C(12000, 5000)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_D5A)
    ...
    def Function_5_E64(): pass

    label("Function_5_E64")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 6)), scpexpr(EXPR_END)), "loc_E6C")
    Return()
    ...
    QueueWorkItem(0x101, 1, lambda_EBF)

    def lambda_EDA():
        OP_8E(0xFE, 0x438, 0x4650, 0x194BA, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_EDA)
    ...
    QueueWorkItem(0xA, 2, lambda_112E)
    ...
    QueueWorkItem2(0x8, 1, lambda_1149)

    def lambda_115A():
        OP_8E(0xFE, 0xFFFFF9FC, 0x4D26, 0x1A22A, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 2, lambda_115A)
    ...
    QueueWorkItem2(0x9, 1, lambda_1175)

    def lambda_1186():
        OP_8E(0xFE, 0xFFFFFA24, 0x4B32, 0x19EEC, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 2, lambda_1186)
    ...
    QueueWorkItem2(0x101, 1, lambda_162A)
    ...
    QueueWorkItem2(0x102, 1, lambda_163B)

    def lambda_164C():
        OP_8E(0xFE, 0xFFFFFF24, 0x36B0, 0x139A2, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_164C)

    def lambda_1667():
        OP_8E(0xFE, 0xFFFFFC72, 0x36B0, 0x13D4E, 0x9C4, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_1667)

    def lambda_1682():
        OP_8E(0xFE, 0x1EA, 0x36B0, 0x13EAC, 0x9C4, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 2, lambda_1682)

    def lambda_169D():
        OP_6D(-90, 14000, 81270, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_169D)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 3)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 2)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_194B")
    Return()
    ...
    QueueWorkItem(0x8, 1, lambda_1CD3)
    ...
    QueueWorkItem(0x9, 1, lambda_1CFE)
    FadeToDark(2000, 0, -1)
    ...
    QueueWorkItem(0x138, 1, lambda_1D23)
    Sleep(50)
    ...
    QueueWorkItem(0x101, 1, lambda_1D43)

    def lambda_1D5E():
        OP_90(0xFE, 0x0, 0x0, 0x2710, 0x3E8, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1D5E)
    OP_0D()
    OP_A2(0x3FA)
    ...
    def Function_7_1D81(): pass

    label("Function_7_1D81")
    ...
    QueueWorkItem2(0x8, 2, lambda_1DBC)
    ...
    QueueWorkItem2(0x9, 2, lambda_1DCD)
    SetChrChipByIndex(0x101, 2)
    SetChrChipByIndex(0x102, 3)
    SetChrChipByIndex(0x138, 1)
    ...
    QueueWorkItem(0x138, 1, lambda_1E20)

    def lambda_1E3B():
        OP_8E(0xFE, 0xFFFFFE20, 0x4D26, 0x1A310, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_1E3B)

    def lambda_1E56():
        OP_8E(0xFE, 0x35C, 0x4D26, 0x1A310, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1E56)
    ...
    QueueWorkItem(0x101, 3, lambda_1F93)

    def lambda_1FAB():
        OP_90(0xFE, 0x0, 0x0, 0xFFFFF448, 0x5DC, 0x0)
        ExitThread()

    QueueWorkItem(0x138, 1, lambda_1FAB)
    Sleep(100)
    ...
    QueueWorkItem(0x101, 1, lambda_1FCB)

    def lambda_1FE6():
        OP_90(0xFE, 0x0, 0x0, 0xFFFFF448, 0x5DC, 0x0)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1FE6)

    def lambda_2001():
        OP_8F(0xFE, 0xFFFFFC9A, 0x4D26, 0x1A388, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_2001)

    def lambda_201C():
        OP_8F(0xFE, 0x38E, 0x4D26, 0x1A388, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_201C)
    Sleep(1300)
    ...
    QueueWorkItem(0x138, 1, lambda_208B)
    ...
    def Function_8_2427(): pass

    label("Function_8_2427")
    ...
    QueueWorkItem(0xB, 2, lambda_2602)
    OP_8C(0xB, 0, 600)
    ...
    QueueWorkItem2(0xD, 1, lambda_2686)
    ...
    QueueWorkItem2(0xE, 1, lambda_2697)
    ...
    QueueWorkItem2(0xF, 1, lambda_26A8)
    ...
    QueueWorkItem2(0x10, 1, lambda_26B9)
    ...
    QueueWorkItem2(0x11, 1, lambda_26CA)
    ...
    QueueWorkItem2(0x12, 1, lambda_26DB)
    ...
    QueueWorkItem(0xC, 1, lambda_276B)
    ...
    QueueWorkItem(0xB, 1, lambda_28BB)

    def lambda_28D3():
        OP_67(0, 3900, -10000, 1500)
        ExitThread()

    QueueWorkItem(0xB, 2, lambda_28D3)

    def lambda_28EB():
        OP_6B(3220, 1500)
        ExitThread()

    QueueWorkItem(0xB, 3, lambda_28EB)
    Sleep(1000)
    FadeToDark(500, 0, -1)
    OP_0D()
    ...
    def Function_9_290F(): pass

    label("Function_9_290F")
    ...
    def Function_10_293D(): pass

    label("Function_10_293D")
    ...
    # Function_10_293D end

    def Function_11_2970(): pass

    label("Function_11_2970")
    ...
    # Function_11_2970 end

    def Function_12_29A3(): pass

    label("Function_12_29A3")
    ...
    QueueWorkItem2(0x8, 1, lambda_2A5C)
    ...
    QueueWorkItem2(0x9, 1, lambda_2A6D)
    ...
    QueueWorkItem(0x0, 1, lambda_2B52)

    def lambda_2B6A():
        OP_67(0, 5210, -10000, 6000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_2B6A)

    def lambda_2B82():
        OP_6C(29000, 10000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_2B82)
    FadeToBright(2000, 0)
    OP_72(0x0, 0x20)
    OP_6F(0x0, 1110)
    OP_22(0xCC, 0x0, 0x64)
    ...
    QueueWorkItem(0x103, 3, lambda_2CBC)
    OP_22(0x76, 0x0, 0x64)
    OP_B0(0x0, 0x78)
    OP_6F(0x0, 61)
    OP_70(0x0, 0xE6)
    ...
    QueueWorkItem2(0x101, 1, lambda_2D19)
    ...
    QueueWorkItem2(0x105, 1, lambda_2D2A)
    ...
    QueueWorkItem2(0x103, 1, lambda_2D3B)

    def lambda_2D4C():
        OP_6D(-7140, 12000, 55690, 3000)
        ExitThread()

    QueueWorkItem(0x101, 3, lambda_2D4C)

    def lambda_2D64():
        OP_6E(577, 3000)
        ExitThread()

    QueueWorkItem(0x105, 3, lambda_2D64)

    def lambda_2D74():
        OP_67(0, 5360, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x103, 3, lambda_2D74)

    def lambda_2D8C():
        OP_6C(13000, 3000)
        ExitThread()

    QueueWorkItem(0xB, 2, lambda_2D8C)

    def lambda_2D9C():
        OP_6B(1600, 3000)
        ExitThread()

    QueueWorkItem(0xB, 3, lambda_2D9C)
    ...
    QueueWorkItem(0x101, 2, lambda_2DB1)
    Sleep(300)
    ...
    QueueWorkItem(0x103, 2, lambda_2DD6)
    Sleep(300)
    ...
    QueueWorkItem(0x105, 2, lambda_2DFB)
    WaitChrThread(0x101, 0x2)
    ...
    QueueWorkItem(0x101, 2, lambda_2E1B)
    ...
    QueueWorkItem(0x103, 2, lambda_2E3E)
    ...
    QueueWorkItem(0x105, 2, lambda_2E5E)
    ...
    QueueWorkItem(0x101, 1, lambda_2F42)
    Sleep(10)
    ...
    QueueWorkItem(0x103, 1, lambda_2F66)
    Sleep(10)
    ...
    QueueWorkItem(0x105, 1, lambda_2F8A)
    Sleep(20)
    ...
    QueueWorkItem(0x8, 1, lambda_2FA9)
    Sleep(10)
    ...
    QueueWorkItem(0x9, 1, lambda_2FC8)
    Sleep(10)
    ...
    QueueWorkItem(0xB, 1, lambda_2FE7)
    Sleep(200)
    OP_44(0x101, 0xFF)
    OP_44(0x105, 0xFF)
    OP_44(0x103, 0xFF)
    ...
    # Function_12_29A3 end

    def Function_13_324C(): pass

    label("Function_13_324C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 2)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_3259")
    Return()
    ...
    QueueWorkItem(0x101, 2, lambda_337E)

    def lambda_3396():
        OP_92(0xFE, 0xE, 0x3E8, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_3396)
    Sleep(10)
    ...
    QueueWorkItem(0x105, 1, lambda_33B0)
    Sleep(10)
    ...
    QueueWorkItem(0x103, 1, lambda_33CA)
    Sleep(20)
    ...
    QueueWorkItem(0xE, 1, lambda_33E4)
    Sleep(10)
    ...
    QueueWorkItem(0xF, 1, lambda_3404)
    Sleep(10)
    ...
    QueueWorkItem(0x10, 1, lambda_3424)
    Sleep(500)
    ...
    def Function_14_3555(): pass

    label("Function_14_3555")

    EventBegin(0x1)
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_35C2")
    OP_8C(0x101, 180, 0)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x4), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_360E")
    OP_8C(0x105, 180, 0)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_3670")
    OP_8C(0x103, 180, 0)
    ...
    # Function_14_3555 end

    def Function_15_368C(): pass

    label("Function_15_368C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 4)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_OR), scpexpr(EXPR_END)), "loc_3699")
    Return()
    ...
    QueueWorkItem(0x101, 1, lambda_37FA)
    Sleep(50)
    ...
    QueueWorkItem(0x105, 1, lambda_381A)
    Sleep(50)
    ...
    # Function_15_368C end

    def Function_16_396D(): pass

    label("Function_16_396D")
    ...
    QueueWorkItem2(0x2A, 0, lambda_3C83)
    ...
    QueueWorkItem2(0x2B, 0, lambda_3C96)
    ...
    QueueWorkItem2(0x2F, 0, lambda_3CA9)
    ...
    QueueWorkItem2(0x101, 1, lambda_3D56)
    ...
    QueueWorkItem2(0x102, 1, lambda_3D67)
    ...
    QueueWorkItem2(0x14, 1, lambda_3D78)
    ...
    QueueWorkItem2(0x15, 1, lambda_3D89)
    ...
    QueueWorkItem2(0x16, 1, lambda_3D9A)
    ...
    QueueWorkItem2(0x17, 1, lambda_3DAB)
    ...
    QueueWorkItem2(0x18, 1, lambda_3DBC)
    ...
    QueueWorkItem2(0x19, 1, lambda_3DCD)
    ...
    QueueWorkItem2(0x1A, 1, lambda_3DDE)
    ...
    QueueWorkItem2(0x1B, 1, lambda_3DEF)
    ...
    QueueWorkItem2(0x1C, 1, lambda_3E00)
    ...
    QueueWorkItem2(0x21, 1, lambda_3E11)
    ...
    QueueWorkItem2(0x22, 1, lambda_3E22)
    ...
    QueueWorkItem2(0x23, 1, lambda_3E33)
    ...
    QueueWorkItem2(0x24, 1, lambda_3E44)
    ...
    QueueWorkItem2(0x25, 1, lambda_3E55)
    ...
    QueueWorkItem2(0x26, 1, lambda_3E66)

    def lambda_3E77():
        OP_6D(-1510, 12000, 54280, 9000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_3E77)

    def lambda_3E8F():
        OP_6E(342, 9000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_3E8F)
    ...
    QueueWorkItem(0x0, 2, lambda_3EA9)
    ...
    QueueWorkItem(0x101, 1, lambda_3F2C)

    def lambda_3F44():
        OP_6C(35000, 8000)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_3F44)
    Sleep(8000)
    OP_A2(0x3FB)
    ...
    def Function_18_3F60(): pass

    label("Function_18_3F60")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCE, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_3F69")
    Return()
    ...
    QueueWorkItem2(0x31, 1, lambda_3FAD)
    OP_62(0x101, 0x0, 2000, 0x2, 0x7, 0x50, 0x1)
    OP_22(0x27, 0x0, 0x64)
    ...
    QueueWorkItem(0x101, 2, lambda_3FE3)
    ...
    QueueWorkItem2(0x31, 1, lambda_41B5)

    def lambda_41C6():
        OP_8E(0xFE, 0xA8FC, 0x3E80, 0x13F42, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_41C6)
    Sleep(200)
    ...
    QueueWorkItem(0x101, 2, lambda_4C00)

    def lambda_4C18():
        OP_6E(259, 1000)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_4C18)
    ...
    # Function_18_3F60 end

    def Function_19_5144(): pass

    label("Function_19_5144")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC8, 3)), scpexpr(EXPR_EXEC_OP, "OP_42(0x37)"), scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_NEG), scpexpr(EXPR_NEQ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_51C4")
    EventBegin(0x1)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xC7, 6)), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xCC, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_523F")
    EventBegin(0x1)
