...
def main():
    ...
    QueueWorkItem(0x9, 1, lambda_25F)
    OP_8C(0x8, 0, 400)
    ...
    QueueWorkItem(0x101, 1, lambda_2C3)
    Sleep(200)
    ...
    QueueWorkItem(0x102, 1, lambda_2DE)
    Sleep(200)
    ...
    QueueWorkItem(0x105, 1, lambda_2F9)
    ...
    QueueWorkItem(0xC, 1, lambda_3F5)

    def lambda_403():
        OP_94(0x1, 0x8, 0x0, 0x3E8, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_403)

    def lambda_419():
        TurnDirection(0x101, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_419)

    def lambda_427():
        TurnDirection(0x102, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_427)
    TurnDirection(0x105, 0x8, 400)
    WaitChrThread(0x8, 0x1)
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x23, 0x0, 0x2)"), scpexpr(EXPR_END)), "loc_50A")
