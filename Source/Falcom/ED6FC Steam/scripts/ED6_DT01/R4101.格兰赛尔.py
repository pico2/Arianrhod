...
def main():
    ...
    ScpFunction(
        ...
        "Function_2_679",          # 02, 2
        "Function_3_E3D",          # 03, 3
        "Function_4_1169",         # 04, 4
        "Function_5_11CD",         # 05, 5
        "Function_6_1231",         # 06, 6
        "Function_7_1295",         # 07, 7
        "Function_8_12F9",         # 08, 8
        "Function_9_134B",         # 09, 9
        "Function_10_13B4",        # 0A, 10
        "Function_11_140F",        # 0B, 11
        "Function_12_16E4",        # 0C, 12
        "Function_13_172C",        # 0D, 13
        "Function_14_175C",        # 0E, 14
        "Function_15_178C",        # 0F, 15
        "Function_16_17BC",        # 10, 16
        "Function_17_17EC",        # 11, 17
        "Function_18_181C",        # 12, 18
        "Function_19_184C",        # 13, 19
        "Function_20_187C",        # 14, 20
        "Function_21_18AC",        # 15, 21
        "Function_22_18DC",        # 16, 22
        "Function_23_190C",        # 17, 23
        "Function_24_193C",        # 18, 24
        "Function_25_196C",        # 19, 25
        "Function_26_19AF",        # 1A, 26
        "Function_27_1A00",        # 1B, 27
    )
    ...
    QueueWorkItem(0x9, 1, lambda_8F8)
    Sleep(400)
    ...
    QueueWorkItem(0x9, 1, lambda_918)
    Sleep(400)
    SetChrChipByIndex(0x8, 0)
    ...
    QueueWorkItem(0x9, 1, lambda_947)
    ...
    QueueWorkItem2(0x8, 1, lambda_962)
    Sleep(1800)
    OP_44(0x8, 0xFF)
    OP_8C(0x8, 90, 400)
    ...
    QueueWorkItem(0x0, 1, lambda_983)
    ...
    QueueWorkItem2(0x8, 1, lambda_B03)
    ...
    QueueWorkItem(0x0, 3, lambda_B86)

    def lambda_B96():
        OP_6D(-38470, 6000, 118990, 6000)
        ExitThread()

    QueueWorkItem(0x0, 1, lambda_B96)

    def lambda_BAE():
        OP_6C(24000, 6000)
        ExitThread()

    QueueWorkItem(0x1, 1, lambda_BAE)
    Sleep(8000)
    ...
    QueueWorkItem(0x0, 1, lambda_BC3)

    def lambda_BDB():
        OP_67(0, 5740, -10000, 3000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_BDB)
    Sleep(3000)
    ...
    QueueWorkItem(0x8, 1, lambda_C78)
    Sleep(300)
    ...
    QueueWorkItem(0x0, 3, lambda_C98)
    ...
    QueueWorkItem(0x0, 1, lambda_CF0)

    def lambda_D08():
        OP_6C(45000, 3000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_D08)

    def lambda_D18():
        OP_6D(-39940, 2250, 109870, 3000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_D18)
    ...
    QueueWorkItem(0x0, 3, lambda_D38)
    ...
    def Function_3_E3D(): pass

    label("Function_3_E3D")
    ...
    QueueWorkItem(0x19, 2, lambda_EB4)

    def lambda_ECF():
        OP_8F(0xFE, 0xFFFF685C, 0x64, 0x1D8A8, 0x1D4C, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_ECF)
    Sleep(3000)
    ...
    QueueWorkItem(0x19, 2, lambda_EEF)

    def lambda_F0A():
        OP_8F(0xFE, 0xFFFF685C, 0x64, 0x1D8A8, 0x1964, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_F0A)

    def lambda_F25():
        OP_8C(0x19, 0, 5)
        ExitThread()

    QueueWorkItem(0x19, 0, lambda_F25)

    def lambda_F33():
        OP_8C(0x1A, 0, 5)
        ExitThread()

    QueueWorkItem(0x1A, 0, lambda_F33)
    Sleep(1000)
    ...
    QueueWorkItem(0x19, 2, lambda_F7B)

    def lambda_F96():
        OP_8F(0xFE, 0xFFFF685C, 0x64, 0x1D8A8, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_F96)
    Sleep(1000)
    ...
    QueueWorkItem(0x19, 2, lambda_FB6)

    def lambda_FD1():
        OP_8F(0xFE, 0xFFFF685C, 0x64, 0x1D8A8, 0xFA0, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_FD1)
    Sleep(1000)
    ...
    QueueWorkItem(0x19, 2, lambda_FF1)

    def lambda_100C():
        OP_8F(0xFE, 0xFFFF685C, 0x64, 0x1D8A8, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x1A, 2, lambda_100C)
    Sleep(1000)
    ...
    def Function_4_1169(): pass

    label("Function_4_1169")
    ...
    def Function_7_1295(): pass

    label("Function_7_1295")
    ...
    QueueWorkItem(0x1, 1, lambda_1318)
    ...
    def Function_9_134B(): pass

    label("Function_9_134B")
    ...
    def Function_11_140F(): pass

    label("Function_11_140F")
    ...
    QueueWorkItem(0x10, 2, lambda_15FB)

    def lambda_1613():
        OP_6E(405, 6500)
        ExitThread()

    QueueWorkItem(0xD, 3, lambda_1613)
    Sleep(2500)
    ...
    QueueWorkItem(0x10, 3, lambda_1628)

    def lambda_1640():
        OP_6C(314000, 5000)
        ExitThread()

    QueueWorkItem(0xD, 2, lambda_1640)
    Sleep(5100)
    ...
    QueueWorkItem(0x10, 2, lambda_1655)

    def lambda_166D():
        OP_67(0, 4320, -10000, 4000)
        ExitThread()

    QueueWorkItem(0x10, 3, lambda_166D)
    Sleep(4000)
    ...
    # Function_11_140F end

    def Function_12_16E4(): pass

    label("Function_12_16E4")
    ...
    # Function_12_16E4 end

    def Function_13_172C(): pass

    label("Function_13_172C")
    ...
    # Function_13_172C end

    def Function_14_175C(): pass

    label("Function_14_175C")
    ...
    def Function_16_17BC(): pass

    label("Function_16_17BC")
    ...
    # Function_16_17BC end

    def Function_17_17EC(): pass

    label("Function_17_17EC")
    ...
    # Function_17_17EC end

    def Function_18_181C(): pass

    label("Function_18_181C")
    ...
    # Function_18_181C end

    def Function_19_184C(): pass

    label("Function_19_184C")
    ...
    # Function_19_184C end

    def Function_20_187C(): pass

    label("Function_20_187C")
    ...
    # Function_20_187C end

    def Function_21_18AC(): pass

    label("Function_21_18AC")
    ...
    # Function_21_18AC end

    def Function_22_18DC(): pass

    label("Function_22_18DC")
    ...
    # Function_22_18DC end

    def Function_23_190C(): pass

    label("Function_23_190C")
    ...
    # Function_23_190C end

    def Function_24_193C(): pass

    label("Function_24_193C")
    ...
    # Function_24_193C end

    def Function_25_196C(): pass

    label("Function_25_196C")
    ...
    # Function_25_196C end

    def Function_26_19AF(): pass

    label("Function_26_19AF")
    ...
    # Function_26_19AF end

    def Function_27_1A00(): pass

    label("Function_27_1A00")
