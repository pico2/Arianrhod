...
def main():
    ...
    ScpFunction(
        ...
        "Function_7_17E2",         # 07, 7
        "Function_8_184C",         # 08, 8
        "Function_9_2048",         # 09, 9
        "Function_10_2109",        # 0A, 10
        "Function_11_21AD",        # 0B, 11
        "Function_12_21E4",        # 0C, 12
        "Function_13_30A3",        # 0D, 13
        "Function_14_314A",        # 0E, 14
        "Function_15_535F",        # 0F, 15
        "Function_16_55FC",        # 10, 16
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 3)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_901")
    OP_A2(0x3)
    ...
    def Function_4_948(): pass

    label("Function_4_948")
    ...
    QueueWorkItem(0xA, 1, lambda_A39)
    Sleep(200)
    OP_6F(0x0, 5)
    OP_70(0x0, 0x14)
    Sleep(1500)
    ...
    QueueWorkItem(0xA, 1, lambda_A61)
    ...
    QueueWorkItem(0xA, 1, lambda_AB0)
    Sleep(1000)
    ...
    def Function_5_BEA(): pass

    label("Function_5_BEA")
    ...
    QueueWorkItem(0x101, 2, lambda_152C)
    ...
    QueueWorkItem(0x101, 2, lambda_162D)
    ...
    def Function_7_17E2(): pass

    label("Function_7_17E2")
    ...
    def Function_8_184C(): pass

    label("Function_8_184C")
    ...
    QueueWorkItem(0xFE, 3, lambda_20CE)
    ...
    def Function_10_2109(): pass

    label("Function_10_2109")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_2144")
    ...
    QueueWorkItem(0xFE, 3, lambda_2175)
    OP_8E(0xFE, 0xBA4, 0x0, 0xFADC, 0x7D0, 0x1)
    SetChrFlags(0xFE, 0x80)
    OP_A3(0x2)
    OP_A3(0x1)
    ...
    # Function_10_2109 end

    def Function_11_21AD(): pass

    label("Function_11_21AD")

    OP_A6(0x2)

    label("loc_21B0")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_21C2")
    TurnDirection(0xFE, 0x101, 0)
    OP_48()
    Jump("loc_21B0")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 1)), scpexpr(EXPR_END)), "loc_21D7")
    ...
    def Function_13_30A3(): pass

    label("Function_13_30A3")
    ...
    # Function_13_30A3 end

    def Function_14_314A(): pass

    label("Function_14_314A")
    ...
    QueueWorkItem(0x0, 1, lambda_31BB)
    Sleep(2000)
    Fade(5000)
    ...
    QueueWorkItem(0x0, 1, lambda_324B)
    OP_8C(0xB, 90, 0)
    ...
    QueueWorkItem(0x0, 1, lambda_3377)
    ...
    QueueWorkItem(0x0, 1, lambda_369E)
    Sleep(2000)
    ...
    QueueWorkItem(0x102, 1, lambda_45DC)
    ...
    QueueWorkItem(0x101, 1, lambda_4726)
    ...
    QueueWorkItem(0x102, 1, lambda_4A04)
    SetChrSubChip(0x103, 1)
    Sleep(500)
    ...
    QueueWorkItem(0x102, 1, lambda_4AC2)
    ...
    # Function_14_314A end

    def Function_15_535F(): pass

    label("Function_15_535F")
    ...
    # Function_15_535F end

    def Function_16_55FC(): pass

    label("Function_16_55FC")
    ...
    OP_4F(0x28, (scpexpr(EXPR_PUSH_LONG, 0xFFFF), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_5F(0x0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_5698")
    OP_20(0xBB8)
    FadeToDark(1000, 0, -1)
    Sleep(700)
    OP_22(0xD, 0x0, 0x64)
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_56B2")
    FadeToBright(300, 0)
    TalkEnd(0xFF)
    Return()
