...
def main():
    ...
    ScpFunction(
        ...
        "Function_9_26DF",         # 09, 9
        "Function_10_274B",        # 0A, 10
        "Function_11_275D",        # 0B, 11
        "Function_12_2D14",        # 0C, 12
        "Function_13_35E1",        # 0D, 13
        "Function_14_3C2B",        # 0E, 14
        "Function_15_3DBB",        # 0F, 15
    )
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_END)), "loc_4BD")
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_424")
    ...
    def Function_4_52E(): pass

    label("Function_4_52E")
    ...
    QueueWorkItem(0x107, 2, lambda_662)
    OP_8C(0x107, 90, 400)
    Sleep(300)
    OP_8C(0x102, 90, 400)
    OP_8C(0x101, 90, 400)
    ...
    def Function_5_6E1(): pass

    label("Function_5_6E1")
    ...
    QueueWorkItem2(0x8, 1, lambda_75C)
    ...
    QueueWorkItem2(0x8, 1, lambda_7FE)
    Sleep(200)
    ...
    QueueWorkItem2(0x8, 1, lambda_84B)
    Sleep(200)
    ...
    QueueWorkItem(0x8, 2, lambda_8CB)

    def lambda_8E3():
        OP_8E(0xFE, 0x7468, 0x0, 0x846C, 0x7D0, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_8E3)
    Sleep(800)
    ...
    QueueWorkItem(0x107, 1, lambda_903)
    Sleep(200)
    ...
    QueueWorkItem(0x107, 1, lambda_95B)
    ...
    QueueWorkItem(0x102, 1, lambda_96E)
    ...
    QueueWorkItem2(0x8, 1, lambda_9E5)
    ...
    QueueWorkItem2(0x102, 1, lambda_B7F)
    ...
    QueueWorkItem2(0x107, 1, lambda_B90)
    ...
    QueueWorkItem(0x8, 2, lambda_BCE)

    def lambda_BE6():
        OP_8E(0xFE, 0x7486, 0x0, 0x90BA, 0x1F40, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_BE6)
    Sleep(200)
    ...
    QueueWorkItem(0x8, 3, lambda_C4D)
    ...
    QueueWorkItem(0x8, 2, lambda_C8C)
    Sleep(1500)
    OP_63(0x101)
    ...
    def Function_6_DFF(): pass

    label("Function_6_DFF")
    ...
    def Function_7_EC9(): pass

    label("Function_7_EC9")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 1)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0xA2, 0)), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_1961")
    EventBegin(0x0)
    SetMapFlags(0x10000000)
    Fade(1000)
    OP_4A(0x8, 255)
    ...
    QueueWorkItem2(0x101, 1, lambda_F30)
    ...
    QueueWorkItem2(0x102, 1, lambda_F41)
    ...
    QueueWorkItem2(0x107, 1, lambda_F52)

    def lambda_F63():
        OP_8E(0xFE, 0x7A44, 0xFFFFFC18, 0x1DB0, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x107, 2, lambda_F63)
    Sleep(100)
    ...
    QueueWorkItem(0x101, 2, lambda_F83)
    Sleep(100)
    ...
    QueueWorkItem(0x102, 2, lambda_FA3)
    ...
    QueueWorkItem(0x8, 2, lambda_1186)

    def lambda_119E():
        OP_8E(0xFE, 0x7EFD, 0xFFFFFC18, 0x2936, 0xBB8, 0x0)
        ExitThread()

    QueueWorkItem(0x8, 1, lambda_119E)
    Sleep(300)
    ...
    QueueWorkItem(0x107, 1, lambda_11BE)
    WaitChrThread(0x8, 0x1)
    OP_8C(0x8, 0, 400)
    WaitChrThread(0x107, 0x1)
    OP_8C(0x107, 90, 400)
    ...
    QueueWorkItem2(0x101, 1, lambda_145E)
    OP_8C(0x102, 180, 600)
    ...
    QueueWorkItem(0x101, 1, lambda_160F)
    ...
    def Function_9_26DF(): pass

    label("Function_9_26DF")
    ...
    QueueWorkItem(0xFE, 2, lambda_2725)
    ...
    def Function_12_2D14(): pass

    label("Function_12_2D14")
    ...
    QueueWorkItem(0x107, 1, lambda_2EA9)
    OP_8C(0x8, 0, 400)
    ...
    QueueWorkItem(0x101, 2, lambda_2F6C)
    ...
    QueueWorkItem(0x101, 1, lambda_2FD2)

    def lambda_2FE0():
        TurnDirection(0xFE, 0x102, 400)
        ExitThread()

    QueueWorkItem(0x107, 1, lambda_2FE0)
    ...
    QueueWorkItem2(0x101, 1, lambda_2FEE)
    ...
    QueueWorkItem2(0x101, 1, lambda_324A)
    ...
    QueueWorkItem2(0x107, 1, lambda_325B)
    ...
    QueueWorkItem2(0x102, 1, lambda_326C)
    ...
    QueueWorkItem2(0x8, 1, lambda_327D)
    ...
    QueueWorkItem(0x107, 1, lambda_3376)
    ...
    QueueWorkItem2(0x102, 1, lambda_3384)
    ...
    QueueWorkItem(0x107, 1, lambda_33FA)
    ...
    QueueWorkItem2(0x102, 1, lambda_3408)
    ...
    QueueWorkItem(0x101, 1, lambda_34A7)

    def lambda_34B5():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x107, 1, lambda_34B5)
    ...
    QueueWorkItem2(0x102, 1, lambda_34C3)
    ...
    # Function_12_2D14 end

    def Function_13_35E1(): pass

    label("Function_13_35E1")
    ...
    QueueWorkItem2(0x101, 1, lambda_3773)
    ...
    QueueWorkItem2(0x102, 1, lambda_3784)

    def lambda_3795():
        OP_6D(-2280, 0, 36270, 1500)
        ExitThread()

    QueueWorkItem(0x101, 2, lambda_3795)
    ...
    # Function_13_35E1 end

    def Function_14_3C2B(): pass

    label("Function_14_3C2B")
    ...
    QueueWorkItem(0x106, 1, lambda_3CD0)
    ...
    QueueWorkItem(0x102, 1, lambda_3CEC)
    ...
    # Function_14_3C2B end

    def Function_15_3DBB(): pass

    label("Function_15_3DBB")
