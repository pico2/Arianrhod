...
def main():
    ...
    ScpFunction(
        ...
        "Function_5_4E0",          # 05, 5
        "Function_6_506",          # 06, 6
        "Function_7_1C17",         # 07, 7
        "Function_8_1C64",         # 08, 8
        "Function_9_1D18",         # 09, 9
        "Function_10_1DC4",        # 0A, 10
        "Function_11_2639",        # 0B, 11
        "Function_12_2664",        # 0C, 12
        "Function_13_26A8",        # 0D, 13
        "Function_14_271F",        # 0E, 14
        "Function_15_2794",        # 0F, 15
    )
    ...
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_4DF")
    OP_43(0xFE, 0x2, 0x0, 0x5)
    OP_22(0x191, 0x0, 0x64)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x0, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_RAND), scpexpr(EXPR_PUSH_LONG, 0xA), scpexpr(EXPR_IMOD), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_4DF")
    Jc((scpexpr(EXPR_EXEC_OP, "OP_3E(0x38B, 1)"), scpexpr(EXPR_END)), "loc_4DF")
    TalkBegin(0xFE)
    OP_A2(0x0)
    ...
    def Function_5_4E0(): pass

    label("Function_5_4E0")

    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x7), scpexpr(EXPR_LSS), scpexpr(EXPR_END)), "loc_4FB")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, MakeScenarioFlags(0x82, 0)), scpexpr(EXPR_EQUZ), scpexpr(EXPR_END)), "loc_1C16")
    OP_A2(0x410)
    EventBegin(0x0)
    ...
    Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0xA), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "loc_562")
    ...
    QueueWorkItem(0x101, 1, lambda_57F)
    ...
    QueueWorkItem2(0x101, 2, lambda_723)
    ...
    QueueWorkItem2(0x102, 2, lambda_734)
    ...
    QueueWorkItem2(0xB, 1, lambda_745)
    ...
    QueueWorkItem2(0x9, 1, lambda_756)
    ...
    QueueWorkItem2(0xA, 1, lambda_767)
    ...
    QueueWorkItem(0x102, 1, lambda_793)
    ...
    QueueWorkItem(0xC, 1, lambda_93F)

    def lambda_957():
        OP_8E(0xFE, 0x166C, 0x0, 0x50B4, 0x1B58, 0x0)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_957)

    def lambda_972():
        OP_96(0xFE, 0x18EC, 0xFFFFFF38, 0x42A4, 0x5DC, 0x1B58)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_972)
    WaitChrThread(0x101, 0x1)
    ...
    QueueWorkItem(0xB, 1, lambda_A99)
    ...
    QueueWorkItem2(0xB, 1, lambda_B62)
    ...
    QueueWorkItem(0x9, 1, lambda_BAE)
    ...
    QueueWorkItem(0xA, 1, lambda_BCA)
    ...
    QueueWorkItem(0xB, 2, lambda_EBF)
    ...
    QueueWorkItem(0xB, 1, lambda_F21)

    def lambda_F2F():
        TurnDirection(0xFE, 0x136, 400)
        ExitThread()

    QueueWorkItem(0x9, 1, lambda_F2F)

    def lambda_F3D():
        TurnDirection(0xFE, 0x136, 400)
        ExitThread()

    QueueWorkItem(0xA, 1, lambda_F3D)

    def lambda_F4B():
        TurnDirection(0xFE, 0x136, 400)
        ExitThread()

    QueueWorkItem(0x101, 1, lambda_F4B)

    def lambda_F59():
        TurnDirection(0xFE, 0x136, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_F59)

    def lambda_F67():
        OP_6D(3420, 0, 32210, 3000)
        ExitThread()

    QueueWorkItem(0x0, 2, lambda_F67)

    def lambda_F7F():
        OP_6C(315000, 3000)
        ExitThread()

    QueueWorkItem(0x0, 3, lambda_F7F)

    def lambda_F8F():
        OP_6B(2800, 3000)
        ExitThread()

    QueueWorkItem(0x1, 3, lambda_F8F)
    ...
    QueueWorkItem(0xC, 3, lambda_FF0)
    ...
    QueueWorkItem(0x101, 1, lambda_1206)
    Sleep(200)
    ...
    QueueWorkItem(0x102, 1, lambda_129C)
    Sleep(300)
    ...
    QueueWorkItem(0xA, 1, lambda_12BC)
    Sleep(400)
    ...
    QueueWorkItem(0x9, 1, lambda_12DC)
    Sleep(300)
    WaitChrThread(0x102, 0x1)
    ...
    QueueWorkItem2(0xB, 1, lambda_15C5)
    ...
    QueueWorkItem2(0x9, 1, lambda_15D6)
    ...
    QueueWorkItem2(0xA, 1, lambda_15E7)
    ...
    QueueWorkItem2(0x101, 1, lambda_15F8)
    ...
    QueueWorkItem2(0x102, 1, lambda_1609)
    ...
    QueueWorkItem2(0x136, 1, lambda_161A)
    ...
    QueueWorkItem2(0x101, 1, lambda_19B4)
    ...
    QueueWorkItem2(0x8, 1, lambda_19C5)
    ...
    QueueWorkItem2(0x102, 1, lambda_19D6)
    ...
    QueueWorkItem2(0xA, 1, lambda_19E7)
    ...
    QueueWorkItem2(0x9, 1, lambda_19F8)
    ...
    QueueWorkItem2(0x136, 1, lambda_1A09)
    ...
    QueueWorkItem(0x101, 1, lambda_1BA1)

    def lambda_1BAF():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_1BAF)

    def lambda_1BBD():
        TurnDirection(0xFE, 0x8, 400)
        ExitThread()

    QueueWorkItem(0x136, 1, lambda_1BBD)
    Sleep(400)
    ...
    def Function_7_1C17(): pass

    label("Function_7_1C17")

    Jc((scpexpr(EXPR_PUSH_LONG, 0x1), scpexpr(EXPR_END)), "loc_1C63")
    OP_51(0xD, 0x1, (scpexpr(EXPR_GET_CHR_WORK, 0x101, 0x1), scpexpr(EXPR_GET_CHR_WORK, 0xB, 0x1), scpexpr(EXPR_ADD), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_IDIV), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_51(0xD, 0x2, (scpexpr(EXPR_GET_CHR_WORK, 0x101, 0x2), scpexpr(EXPR_GET_CHR_WORK, 0xB, 0x2), scpexpr(EXPR_ADD), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_IDIV), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_51(0xD, 0x3, (scpexpr(EXPR_GET_CHR_WORK, 0x101, 0x3), scpexpr(EXPR_GET_CHR_WORK, 0xB, 0x3), scpexpr(EXPR_ADD), scpexpr(EXPR_PUSH_LONG, 0x2), scpexpr(EXPR_IDIV), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    OP_48()
    Jump("Function_7_1C17")
    ...
    def Function_8_1C64(): pass

    label("Function_8_1C64")
    ...
    QueueWorkItem2(0xFE, 2, lambda_1CBD)
    Sleep(1600)
    ...
    QueueWorkItem2(0x101, 1, lambda_1F7F)
    ...
    QueueWorkItem2(0x102, 1, lambda_1F90)
    OP_8C(0x136, 180, 0)
    OP_92(0xC, 0x136, 0x1388, 0x2710, 0x0)
    OP_22(0x8C, 0x0, 0x64)
    OP_92(0xC, 0x136, 0xFA0, 0x1F40, 0x0)
    ...
    QueueWorkItem(0xC, 3, lambda_1FF9)
    SetChrChipByIndex(0x136, 5)
    ...
    QueueWorkItem2(0x101, 1, lambda_2277)
    ...
    QueueWorkItem2(0x102, 1, lambda_2288)
    ...
    QueueWorkItem2(0x136, 1, lambda_2299)
    OP_22(0x8C, 0x0, 0x64)
    Fade(250)
    ClearChrFlags(0xC, 0x80)
    ...
    QueueWorkItem(0xC, 1, lambda_22C4)
    Sleep(400)
    ...
    QueueWorkItem(0xC, 1, lambda_22E4)
    Sleep(400)
    ...
    QueueWorkItem(0xC, 1, lambda_2304)
    Sleep(400)
    ...
    QueueWorkItem(0xC, 1, lambda_2324)
    ...
    def Function_11_2639(): pass

    label("Function_11_2639")
    ...
    QueueWorkItem2(0xFE, 2, lambda_2658)
    Return()

    # Function_11_2639 end

    def Function_12_2664(): pass

    label("Function_12_2664")
    ...
    QueueWorkItem2(0xFE, 2, lambda_269C)
    Return()

    # Function_12_2664 end

    def Function_13_26A8(): pass

    label("Function_13_26A8")
    ...
    # Function_13_26A8 end

    def Function_14_271F(): pass

    label("Function_14_271F")
    ...
    # Function_14_271F end

    def Function_15_2794(): pass

    label("Function_15_2794")
