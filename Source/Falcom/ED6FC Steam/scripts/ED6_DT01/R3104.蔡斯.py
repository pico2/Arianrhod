...
def main():
    ...
    QueueWorkItem(0x8, 3, lambda_59C)
    ...
    QueueWorkItem(0x8, 2, lambda_62B)
    ...
    QueueWorkItem(0x8, 1, lambda_652)
    Sleep(200)
    ...
    QueueWorkItem(0xC, 1, lambda_677)
    Sleep(500)
    ...
    QueueWorkItem(0xA, 1, lambda_69C)
    Sleep(500)
    ...
    QueueWorkItem(0x9, 1, lambda_6C1)
    Sleep(200)
    ...
    QueueWorkItem(0xB, 1, lambda_6E6)
    ...
    QueueWorkItem(0x8, 1, lambda_712)
    ...
    QueueWorkItem(0xA, 1, lambda_7C1)

    def lambda_7DC():
        OP_8E(0xFE, 0xA0, 0xFFFFFFCE, 0xFFFF7DF6, 0x1388, 0x0)
        ExitThread()

    QueueWorkItem(0xB, 1, lambda_7DC)
    Sleep(150)
    OP_44(0x8, 0xFF)
    ...
    QueueWorkItem(0x8, 1, lambda_817)
    Sleep(100)
    OP_44(0xC, 0xFF)
    ...
    QueueWorkItem(0xC, 1, lambda_855)
    Sleep(250)
    Battle(0x3A6, 0x0, 0x0, 0x0, 0xFF)
    Switch(
        (scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_END)),
        (1, "loc_88B"),
        (SWITCH_DEFAULT, "loc_88E"),
    )
    ...
    QueueWorkItem(0x106, 1, lambda_964)

    def lambda_972():
        TurnDirection(0xFE, 0x101, 400)
        ExitThread()

    QueueWorkItem(0x102, 1, lambda_972)
    ...
    QueueWorkItem(0x102, 1, lambda_C9E)
    ...
    def Function_4_FF3(): pass

    label("Function_4_FF3")
    ...
    QueueWorkItem(0x101, 2, lambda_1083)
    ...
    QueueWorkItem(0x102, 1, lambda_10BB)
    Sleep(200)
    ...
    QueueWorkItem(0x107, 1, lambda_10DB)
    Sleep(200)
    ...
    QueueWorkItem(0x106, 1, lambda_10FB)
    ...
    QueueWorkItem(0x102, 1, lambda_1150)

    def lambda_115E():
        TurnDirection(0xFE, 0x106, 400)
        ExitThread()

    QueueWorkItem(0x107, 1, lambda_115E)
    CloseMessageWindow()
