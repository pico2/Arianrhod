...
def main():
    ...
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0xE, 0x0, 0x10)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_EXEC_OP, "OP_29(0xE, 0x0, 0x40)"), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_51C")
    EventBegin(0x0)
    OP_22(0x85, 0x1, 0x55)
    ...
    QueueWorkItem(0x102, 1, lambda_3A3)
    ...
    def Function_1_51D(): pass

    label("Function_1_51D")
    ...
    QueueWorkItem(0x8, 3, lambda_531)

    def lambda_54F():
        OP_6B(3500, 3000)
        ExitThread()

    QueueWorkItem(0x2, 2, lambda_54F)
    ...
    QueueWorkItem(0x8, 3, lambda_5A9)
    OP_99(0x8, 0x0, 0x0, 0x0)
    Sleep(20)
    OP_99(0x8, 0x1, 0x1, 0x0)
    Sleep(20)
    ...
    QueueWorkItem(0x8, 3, lambda_611)
    OP_99(0x8, 0x0, 0x0, 0x0)
    Sleep(20)
    OP_99(0x8, 0x1, 0x1, 0x0)
    Sleep(20)
