...
def main():
    ...
    ScpFunction(
        "Function_0_66",           # 00, 0
        "Function_1_1584",         # 01, 1
        "Function_2_15C0",         # 02, 2
        "Function_3_1601",         # 03, 3
        "Function_4_1647",         # 04, 4
    )
    ...
    OP_6D(200, 0, 300, 0)
    OP_0D()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x1, 0x2000)"), scpexpr(EXPR_END)), "loc_1F7")
    Sleep(400)
    OP_8C(0x10, 180, 400)
    ...
    OP_5F(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_1F4")
    OP_0D()
    ...
    CloseMessageWindow()
    Jc((scpexpr(EXPR_EXEC_OP, "OP_29(0x20, 0x0, 0x2)"), scpexpr(EXPR_END)), "loc_3BA")
    ...
    QueueWorkItem(0x102, 1, lambda_376)
    OP_8C(0x10, 0, 400)
    ...
    QueueWorkItem(0x101, 1, lambda_406)
    OP_8C(0x10, 0, 400)
    ...
    OP_5F(0x0)
    FadeToBright(300, 0)
    Jc((scpexpr(EXPR_GET_RESULT, 0x0), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_NEQ), scpexpr(EXPR_END)), "loc_654")
    OP_0D()
    ...
    QueueWorkItem(0x101, 1, lambda_987)
    TurnDirection(0x102, 0x10, 400)
    ...
    QueueWorkItem(0x105, 1, lambda_CA6)
    TurnDirection(0x10, 0x102, 400)
    ...
    QueueWorkItem(0x105, 1, lambda_D86)
    TurnDirection(0x102, 0x10, 400)
    ...
    QueueWorkItem(0x101, 1, lambda_10C7)

    def lambda_10D5():
        TurnDirection(0x105, 0x10, 400)
        ExitThread()

    QueueWorkItem(0x105, 1, lambda_10D5)
    TurnDirection(0x102, 0x10, 400)
    ...
    QueueWorkItem2(0x101, 1, lambda_13C3)
    ...
    QueueWorkItem2(0x102, 1, lambda_13D4)
    ...
    QueueWorkItem2(0x105, 1, lambda_13E5)
    ...
    QueueWorkItem(0x105, 1, lambda_1448)
    ...
    def Function_1_1584(): pass

    label("Function_1_1584")
    ...
    QueueWorkItem(0xFE, 2, lambda_159F)
    OP_8E(0xFE, 0x1F4, 0xFFFFFE0C, 0xC8, 0x7D0, 0x0)
    Return()

    # Function_1_1584 end

    def Function_2_15C0(): pass

    label("Function_2_15C0")
    ...
    QueueWorkItem(0xFE, 2, lambda_15E0)
    OP_8E(0xFE, 0xFFFFFE0C, 0xFFFFFE0C, 0xFFFFFED4, 0x7D0, 0x0)
    Return()

    # Function_2_15C0 end

    def Function_3_1601(): pass

    label("Function_3_1601")
    ...
    QueueWorkItem(0xFE, 2, lambda_1626)
    OP_8E(0xFE, 0x12C, 0xFFFFFE0C, 0xFFFFFAEC, 0x7D0, 0x0)
    Return()

    # Function_3_1601 end

    def Function_4_1647(): pass

    label("Function_4_1647")
