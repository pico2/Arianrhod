...
def main():
    CreateScenaFile(
        ...
        # Information
        b'\x00\x00\x00\x00\x00\x00\x00\x00\x18\xfc\xff\xff\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\xc0]\x00\x00\xf4\x01\x00\x00\x1e\x00-\x00\x00\x00h\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x01\x00r\x00\x00\x00\x00\x01',
    )
    ...
    BattleInfo(
        ...
        (
            ("ms03500.dat", 0, 0, 0, 0, 0, "ms04200.dat", 0, "MonsterBattlePostion_28C", "MonsterBattlePostion_26C", "ed7458.ogg", "ed7453.ogg", "ATBonus_1CC"),
            (),
            (),
            (),
        )
    ...
    BattleInfo(
        "BattleInfo_Last", 0x0052, 255, 6, 45, 3, 3, 30, 0, "bm1070", 0, 100, 0, 0, 0,
        (
            ("ms90011.dat", 0, 0, 0, 0, 0, 0, 0, "MonsterBattlePostion_28C", "MonsterBattlePostion_26C", "ed7544.ogg", "ed7544.ogg", "ATBonus_1CC"),
            (),
            (),
            (),
        )
    ...
    DeclEvent(b'\x00\x00h\xc1\x00\x00\xb0@\x00\x00\x80\xbf\x00 \x99C\x11\xe1\xce=\xc5\xd0\x10>\x00\x00\x00\x80\x00\x00\x00\x00\x1a\xe1\xce\xbd\xbf\xd0\x10>\x00\x00\x00\x80\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x80\xcc\xccL>\x00\x00\x00\x00\xacL\x01@\xe2\xea\xa2?\xcc\xccL>\x00\x00\x80?\x00\x00\x00\x00\x05\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00')
    ...
    ScpFunction((
        ...
        "Function_LastBattle",  # 0F, 15
    ))


    label("Function_0_32C")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, 0x110), scpexpr(EXPR_END)), "loc_343")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, 0x111), scpexpr(EXPR_END)), "loc_355")
    ...
    OP_76(0xFF, "bell", 0x0, 0x1)
    OP_73(0x0, 0x4)
    OP_74(0x0, 0x1E)
    OP_70(0x0, 0x1E)
    OP_76(0x0, "bell_add", 0x0, 0x1)
    OP_76(0xFF, "pano00", 0x0, 0x1)
    OP_76(0xFF, "pano01", 0x0, 0x1)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, 0xD39), scpexpr(EXPR_END)), "loc_3C3")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, 0xD2A), scpexpr(EXPR_END)), "loc_404")
    OP_76(0xFF, "allback", 0x2, "red")
    OP_76(0xFF, "sky", 0x2, "red")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, 0xC1B), scpexpr(EXPR_TEST_SCENA_FLAGS, 0xD2A), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_4C7")
    ...
    OP_76(0x0, "bell_add", 0x1, 0x1)
    OP_76(0xFF, "allback", 0x0, 0x1)
    OP_76(0xFF, "sky", 0x0, 0x1)
    OP_76(0xFF, "cloud", 0x0, 0x1)
    OP_76(0xFF, "back", 0x0, 0x1)
    OP_76(0xFF, "pano00", 0x1, 0x1)
    OP_76(0xFF, "pano01", 0x1, 0x1)

    label("loc_4C7")

    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, 0xD2A), scpexpr(EXPR_END)), "loc_4DE")
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, 0x0), scpexpr(EXPR_END)), "loc_50A")
    OP_50(0x1, (scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_STUB), scpexpr(EXPR_END)))
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, 0x1), scpexpr(EXPR_END)), "loc_53F")
    OP_24(0x84)
    ...
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, 0xD29), scpexpr(EXPR_TEST_SCENA_FLAGS, 0xD2A), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_55B")
    OP_24(0x84)
    Sound(828, 1, 70, 0)
    Jump("loc_561")
    ...
    OP_B7(0x0, 0x0, 0x80)
    Jc((scpexpr(EXPR_TEST_SCENA_FLAGS, 0xD29), scpexpr(EXPR_TEST_SCENA_FLAGS, 0xD2A), scpexpr(EXPR_EQUZ), scpexpr(EXPR_NEQUZ_I64), scpexpr(EXPR_END)), "loc_579")
    OP_B7(0x1, 0x0, 0x80)
    ...
    OP_A2(0x8, 0x8000)
    OP_A3(0x8, 0x4)
    OP_90(0x8, 0xFFFFE994, 0x4A6, 0x28, 0x5A)
    OP_A2(0x8, 0x4)
    ...
    OP_A2(0x9, 0x8000)
    OP_A3(0x9, 0x4)
    OP_90(0x9, 0xFFFFE728, 0x442, 0xFFFFFB28, 0x2D)
    OP_A2(0x9, 0x4)
    OP_70(0x0, 0x1E)
    OP_76(0x0, "bell_add", 0x0, 0x1)
    Sound(828, 2, 100, 0)
    ...
    OP_6D(0x5A, 0x19, 0x0, 0x0)
    OP_6E(0x28A, 0x0)
    OP_6C(0x80E8, 0x0)
    FadeToBright(1000, 0)
    OP_68(0, 3450, 0, 7000)
    OP_6D(0x3C, 0xF, 0x0, 0x1B58)
    OP_6C(0x5208, 0x1B58)
    OP_6F(0x79)
    OP_0D()
    Fade(1000)
    OP_6C(0x6D60, 0x2710)
    OP_14(0x0, 0xBBFFFFFF, 0x0, 0x1, 0x19)
    Sleep(1)
    OP_15(0xFA0)
    Sound(929, 0, 100, 0)
    ...
    OP_6D(0x5A, 0x9, 0x0, 0x1388)
    OP_6E(0x226, 0x1388)
    OP_6C(0x46E6, 0x1388)
    OP_46(0x104, 0x1, 0x14)
    OP_95(0xFE, 0xFFFFC6A8, 0x0, 0xFFFFF808, 0x7D0, 0x0)
    OP_00()
    Sleep(50)
    OP_46(0xF5, 0x1, 0x14)
    OP_95(0xFE, 0xFFFFC25C, 0x0, 0xFFFFFA88, 0x7D0, 0x0)
    OP_00()
    Sleep(50)
    OP_46(0x102, 0x1, 0x14)
    OP_95(0xFE, 0xFFFFC77A, 0x0, 0xFFFFFD76, 0x7D0, 0x0)
    OP_00()
    Sleep(50)
    OP_46(0x101, 0x1, 0x14)
    OP_95(0xFE, 0xFFFFC8E2, 0x0, 0x244, 0x7D0, 0x0)
    OP_00()
    Sleep(50)
    OP_46(0xF4, 0x1, 0x14)
    OP_95(0xFE, 0xFFFFC131, 0x0, 0x474, 0x7D0, 0x0)
    OP_00()
    Sleep(50)
    OP_46(0x103, 0x1, 0x14)
    OP_95(0xFE, 0xFFFFC5E0, 0x0, 0x65E, 0x7D0, 0x0)
    OP_00()
    OP_48(0x104, 0x1)
    OP_46(0x104, 0x2, 0x7)
    ...
    ChrTalk(
        ...
        (
            scpstr(0x7, 0x0),
            "#04924F#3901V#11P#3C#25A#40W我接受你的请求。\x02\x03",
            "#04922F#3902V#40A『盟主』吩咐过我，\x01",
            "要极力满足圣子的愿望。\x02",
        )
    )
    ...
    OP_22()
    Sleep(10)
    PlayBgm("ed7458.ogg", 0)
    OP_68(-5900, 2420, 0, 3000)
    OP_6D(0x5A, 0x9, 0x0, 0xBB8)
    OP_6E(0x226, 0xBB8)
    OP_6C(0x3C8C, 0xBB8)
    OP_6F(0x79)
    ...
    AnonymousTalk(
        0x8,
        (
            "#3903V#3C#30W#40A蛇之使徒第七柱，\x01",
            "『钢』之阿瑞安赫德……\x02\x03",
            "#3904V#48A遵从『零』之圣子所愿，\x01",
            "于此阻拦诸位的道路。\x02\x03",
    ...
    OP_5B(0xFFFF, 0x96, 0xFFFF, 0xFFFF)
    SetChrName("罗伊德等人")
    ...
    #OP_14(0x0, 0xBBFFFFFF, 0x0, 0x0, 0x0)
    ...
    FadeToDark(0, 0, -1)
    OP_CC(0x1, 0xFF, 0x0)
    Call(0, GetFuntionId('Function_LastBattle'))
    Return()
    ...
    OP_14(0x0, 0xBBFFFFFF, 0x0, 0x1, 0xF)
    Sleep(1)
    OP_15(0x9C4)
    OP_A3(0xA, 0x80)
    OP_A2(0xA, 0x20)
    ...
    Fade(500)
    OP_14(0x64, 0xBBFFFFFF, 0x0, 0x1, 0xA)
    ...
    #Jc((scpexpr(EXPR_PUSH_VALUE_INDEX, 0x3), scpexpr(EXPR_PUSH_LONG, 0x0), scpexpr(EXPR_EQU), scpexpr(EXPR_END)), "first_battle_lose")
    ...
    ChrTalk(
        0x105,
        "#10410F#6P#N#40W她居然还一脸轻松的样子……！？\x02",
    )
    ...
    ChrTalk(
        0x106,
        "#10707F#6P#N#40W她居然还一脸轻松的样子……！？\x02",
    )
    ...
    CloseMessageWindow()
    OP_46(0x103, 0x0, 0x7)
    OP_91(0x103, 0x102, 0x1F4)
    OP_00()
    Sleep(30)
    OP_46(0x104, 0x0, 0x7)
    OP_91(0x104, 0x102, 0x1F4)
    OP_00()
    Sleep(30)
    OP_46(0xF4, 0x0, 0x7)
    OP_91(0xF4, 0x102, 0x1F4)
    OP_00()
    Sleep(30)
    OP_46(0xF5, 0x0, 0x7)
    OP_91(0xF5, 0x102, 0x1F4)
    OP_00()
    Sleep(30)
    OP_48(0x103, 0x0)
    OP_48(0x104, 0x0)
    ...
    OP_0D()
    OP_21(0xFA0)
    Jump("final_battle_win")

    label("first_battle_lose")

    OP_29(0xB0, 0x1, 0x6)
    FadeToBright(1000, 0)
    OP_0D()
    OP_6F(0x79)
    OP_46(0x101, 0x2, 0x13)
    ...
    Fade(500)
    Sound(812, 0, 100, 0)
    OP_46(0x102, 0x2, 0x13)
    OP_A6(0xFE, 0x0, 0x32, 0x1F4, 0xBB8)
    OP_00()
    Sleep(50)
    OP_46(0x103, 0x2, 0x13)
    OP_A6(0xFE, 0x0, 0x32, 0x1F4, 0xBB8)
    OP_00()
    Sleep(50)
    OP_46(0xF4, 0x2, 0x13)
    ...
    OP_68(0, 1850, 0, 0)
    OP_68(0, 2850, 0, 6000)
    OP_6D(0x69, 0x15, 0x0, 0x0)
    OP_6D(0x46, 0xF, 0x0, 0x1770)
    OP_6E(0x2BC, 0x0)
    OP_6C(0x2EE0, 0x0)
    OP_6C(0x3A98, 0x1770)
    OP_6F(0x79)
    ...
    Fade(1000)
    OP_68(0, 2850, 0, 0)
    OP_6D(0x5A, 0x1B, 0x0, 0x0)
    OP_6D(0x5A, 0x9, 0x0, 0x1388)
    OP_6E(0x2BC, 0x0)
    OP_6C(0x2EE0, 0x0)
    OP_6F(0x79)
    Sleep(50)
    OP_14(0x1F4, 0xBBFFFFFF, 0x0, 0x1, 0xF)
    OP_6C(0x8CA0, 0x3E8)
    Sound(829, 0, 100, 0)
    ...
    OP_76(0xFF, "pano00", 0x0, 0x1)
    OP_76(0xFF, "pano01", 0x0, 0x1)
    OP_76(0xFF, "allback", 0x1, 0x1)
    OP_76(0xFF, "sky", 0x1, 0x1)
    OP_76(0xFF, "cloud", 0x1, 0x1)
    OP_76(0xFF, "back", 0x1, 0x1)
    OP_76(0xFF, "allback", 0x2, "red")
    OP_76(0xFF, "sky", 0x2, "red")
    OP_7D(0xFF, 0xBE, 0xB4, 0x0, 0x0)
    OP_11(0xFF, 0xCF, 0xB5, 0x23, 0x96, 0x0)
    ...
    label('Function_LastBattle')

    import Arianrhod_2nd_battle as Arianrhod
    Arianrhod.Arianrhod_LastBattle(locals())
    Return()
