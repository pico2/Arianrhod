...
public:
    ...
    BOOLEAN FASTCALL OpenFileInPak(PVOID PakFile, PCSTR FileName);

    static TYPE_OF(&PakFileObject::OpenFileInPak) StubOpenFileInPak;
...
DECL_SELECTANY TYPE_OF(PakFileObject::StubOpenFileInPak) PakFileObject::StubOpenFileInPak = NULL;
