...
extc void    DECL_CDECL Addtolist(long addr,int highlight,char *format,...);
extc void    DECL_CDECL Updatelist(void);
extc HWND    DECL_CDECL Createlistwindow(void);
extc void    DECL_CDECL Error(char *format,...);
extc void    DECL_CDECL Message(ulong addr,char *format,...);
extc void    DECL_CDECL Infoline(char *format,...);
extc void    DECL_CDECL Progress(int promille,char *format,...);
extc void    DECL_CDECL Flash(char *format,...);
...
extc int     DECL_CDECL Decodeaddress(ulong addr,ulong base,int addrmode,
               char *symb,int nsymb,char *comment);
extc int     DECL_CDECL Decoderelativeoffset(ulong addr,int addrmode,
               char *symb,int nsymb);
extc int     DECL_CDECL Decodecharacter(char *s,uint c);
extc int     DECL_CDECL Printfloat4(char *s,float f);
extc int     DECL_CDECL Printfloat8(char *s,double d);
extc int     DECL_CDECL Printfloat10(char *s,long double ext);
extc int     DECL_CDECL Print3dnow(char *s,uchar *f);
extc int     DECL_CDECL Printsse(char *s,char *f);
extc ulong   DECL_CDECL Followcall(ulong addr);
extc int     DECL_CDECL IstextA(char c);
extc int     DECL_CDECL IstextW(wchar_t w);
extc int     DECL_CDECL Stringtotext(char *data,int ndata,char *text,int ntext);
...
extc int     DECL_CDECL Getlong(char *title,ulong *data,int datasize,
               char letter,int mode);
extc int     DECL_CDECL Getlongxy(char *title,ulong *data,int datasize,
               char letter,int mode,int x,int y);
extc int     DECL_CDECL Getregxy(char *title,ulong *data,char letter,int x,int y);
extc int     DECL_CDECL Getline(char *title,ulong *data);
extc int     DECL_CDECL Getlinexy(char *title,ulong *data,int x,int y);
extc int     DECL_CDECL Getfloat10(char *title,long double *fdata,
               uchar *tag,char letter,int mode);
extc int     DECL_CDECL Getfloat10xy(char *title,long double *fdata,
               char *tag,char letter,int mode,int x,int y);
extc int     DECL_CDECL Getfloat(char *title,void *fdata,int size,
               char letter,int mode);
extc int     DECL_CDECL Getfloatxy(char *title,void *fdata,int size,
               char letter,int mode,int x,int y);
extc void    DECL_CDECL Getasmfindmodel(t_asmmodel model[NMODELS],
               char letter,int searchall);
extc void    DECL_CDECL Getasmfindmodelxy(t_asmmodel model[NMODELS],
               char letter,int searchall,int x,int y);
extc int     DECL_CDECL Gettext(char *title,char *text,
               char letter,int type,int fontindex);
extc int     DECL_CDECL Gettextxy(char *title,char *text,char letter,
               int type,int fontindex,int x,int y);
extc int     DECL_CDECL Gethexstring(char *title,t_hexstr *hs,
               int mode,int fontindex,char letter);
extc int     DECL_CDECL Gethexstringxy(char *title,t_hexstr *hs,int mode,
               int fontindex,char letter,int x,int y);
extc int     DECL_CDECL Getmmx(char *title,uchar *data,int mode);
extc int     DECL_CDECL Getmmxxy(char *title,char *data,int mode,int x,int y);
extc int     DECL_CDECL Get3dnow(char *title,uchar *data,int mode);
extc int     DECL_CDECL Get3dnowxy(char *title,char *data,int mode,int x,int y);
extc int     DECL_CDECL Browsefilename(char *title,char *name,char *defext,
               int getarguments);
extc int     DECL_CDECL OpenEXEfile(char *path,int dropped);
extc int     DECL_CDECL Attachtoactiveprocess(int newprocessid);
extc void    DECL_CDECL Animate(int animation);
...
extc int     DECL_CDECL Createsorteddata(t_sorted *sd,char *name,int itemsize,
               int nmax,SORTFUNC *sortfunc,DESTFUNC *destfunc);
extc void    DECL_CDECL Destroysorteddata(t_sorted *sd);
extc void*    DECL_CDECL Addsorteddata(t_sorted *sd,void *item);
extc void    DECL_CDECL Deletesorteddata(t_sorted *sd,ulong addr);
extc void    DECL_CDECL Deletesorteddatarange(t_sorted *sd,ulong addr0,ulong addr1);
extc int     DECL_CDECL Deletenonconfirmedsorteddata(t_sorted *sd);
extc void*   DECL_CDECL Findsorteddata(t_sorted *sd,ulong addr);
extc void*   DECL_CDECL Findsorteddatarange(t_sorted *sd,ulong addr0,ulong addr1);
extc int     DECL_CDECL Findsorteddataindex(t_sorted *sd,ulong addr0,ulong addr1);
extc int     DECL_CDECL Sortsorteddata(t_sorted *sd,int sort);
extc void*   DECL_CDECL Getsortedbyselection(t_sorted *sd,int index);
extc void    DECL_CDECL Defaultbar(t_bar *pb);
extc int     DECL_CDECL Tablefunction(t_table *pt,
               HWND hw,UINT msg,WPARAM wp,LPARAM lp);
extc void    DECL_CDECL Painttable(HWND hw,t_table *pt,DRAWFUNC getline);
extc int     DECL_CDECL Gettableselectionxy(t_table *pt,int column,int *px,int *py);
extc void    DECL_CDECL Selectandscroll(t_table *pt,int index,int mode);
...
extc int     DECL_CDECL Insertname(ulong addr,int type,char *name);
extc int     DECL_CDECL Quickinsertname(ulong addr,int type,char *name);
extc void    DECL_CDECL Mergequicknames(void);
extc void    DECL_CDECL Discardquicknames(void);
extc int     DECL_CDECL Findname(ulong addr,int type,char *name);
extc int     DECL_CDECL Decodename(ulong addr,int type,char *name);
extc ulong   DECL_CDECL Findnextname(char *name);
extc int     DECL_CDECL Findlabel(ulong addr,char *name);
extc void    DECL_CDECL Deletenamerange(ulong addr0,ulong addr1,int type);
extc int     DECL_CDECL Findlabelbyname(char *name,ulong *addr,
               ulong addr0,ulong addr1);
extc ulong   DECL_CDECL Findimportbyname(char *name,ulong addr0,ulong addr1);
extc int     DECL_CDECL Demanglename(char *name,int type,char *undecorated);
extc int     DECL_CDECL Findsymbolicname(ulong addr,char *fname);
...
extc ulong   DECL_CDECL Disasm(uchar *src,ulong srcsize,ulong srcip,uchar *srcdec,
               t_disasm *disasm,int disasmmode,ulong threadid);
extc ulong   DECL_CDECL Disassembleback(uchar *block,ulong base,ulong size,
               ulong ip,int n,int usedec);
extc ulong   DECL_CDECL Disassembleforward(uchar *block,ulong base,ulong size,
               ulong ip,int n,int usedec);
extc int     DECL_CDECL Issuspicious(char *cmd,ulong size,ulong ip,
               ulong threadid,t_reg *preg,char *s);
extc int     DECL_CDECL Isfilling(ulong offset,char *data,ulong size,ulong align);

////////////////////////////////////////////////////////////////////////////////
////////////////////////////// ASSEMBLY FUNCTIONS //////////////////////////////

extc int     DECL_CDECL Assemble(char *cmd,ulong ip,t_asmmodel *model,int attempt,
               int constsize,char *errtext);
extc int     DECL_CDECL Checkcondition(int code,ulong flags);
...
extc int     DECL_CDECL Expression(t_result *result,char *expression,int a,int b,
...
extc HWND    DECL_CDECL Createthreadwindow(void);
extc t_thread* DECL_CDECL Findthread(ulong threadid);
extc int     DECL_CDECL Decodethreadname(char *s,ulong threadid,int mode);
extc ulong   DECL_CDECL Getcputhreadid(void);
extc ulong   DECL_CDECL Runsinglethread(ulong threadid);
extc void    DECL_CDECL Restoreallthreads(void);
...
extc int     DECL_CDECL Listmemory(void);
extc t_memory* DECL_CDECL Findmemory(ulong addr);
extc int     DECL_CDECL Guardmemory(ulong base,ulong size,int guard);
extc void    DECL_CDECL Havecopyofmemory(uchar *copy,ulong base,ulong size);
extc ulong   DECL_CDECL Readmemory(void *buf,ulong addr,ulong size,int mode);
extc ulong   DECL_CDECL Writememory(void *buf,ulong addr,ulong size,int mode);
extc ulong   DECL_CDECL Readcommand(ulong ip,char *cmd);
...
extc t_module* DECL_CDECL Findmodule(ulong addr);
extc t_fixup* DECL_CDECL Findfixup(t_module *pmod,ulong addr);
extc uchar*  DECL_CDECL Finddecode(ulong addr,ulong *psize);
extc ulong   DECL_CDECL Findfileoffset(t_module *pmod,ulong addr);
extc int     DECL_CDECL Decoderange(ulong addr,ulong size,char *s);
extc int     DECL_CDECL Analysecode(t_module *pm);
...
extc int     DECL_CDECL Registerotclass(char *classname,
               char *iconname,WNDPROC classproc);
extc HWND    DECL_CDECL Newtablewindow(t_table *pt,int nlines,int maxcolumns,
               char *winclass,char *wintitle);
extc HWND    DECL_CDECL Quicktablewindow(t_table *pt,int nlines,int maxcolumns,
               char *winclass,char *wintitle);
extc HWND    DECL_CDECL Createdumpwindow(char *name,ulong base,ulong size,
               ulong addr,int type,SPECFUNC *specdump);
extc void    DECL_CDECL Setdumptype(t_dump *pd,int dumptype);
extc void    DECL_CDECL Dumpbackup(t_dump *pd,int action);
extc int     DECL_CDECL Broadcast(UINT msg,WPARAM wp,LPARAM lp);

////////////////////////////////////////////////////////////////////////////////
////////////////////////// DATA CONVERSION FUNCTIONS ///////////////////////////

extc ulong   DECL_CDECL Compress(uchar *bufin,ulong nbufin,
               uchar *bufout,ulong nbufout);
extc ulong   DECL_CDECL Getoriginaldatasize(char *bufin,ulong nbufin);
extc ulong   DECL_CDECL Decompress(uchar *bufin,ulong nbufin,
               uchar *bufout,ulong nbufout);
extc ulong   DECL_CDECL Calculatecrc(uchar *copy,ulong base,ulong size,
...
extc int     DECL_CDECL Findreferences(ulong base,ulong size,ulong addr0,ulong addr1,
               ulong origin,int recurseonjump,char *title);
extc int     DECL_CDECL Findstrings(ulong base,ulong size,ulong origin,char *title);
extc int     DECL_CDECL Findalldllcalls(t_dump *pd,ulong origin,char *title);
extc int     DECL_CDECL Findallcommands(t_dump *pd,t_asmmodel *model,
               ulong origin,char *title);
extc int     DECL_CDECL Findallsequences(t_dump *pd,t_extmodel model[NSEQ][NMODELS],
               ulong origin,char *title);
extc ulong   DECL_CDECL Walkreference(int dir);
extc ulong   DECL_CDECL Walkreferenceex(int dir,ulong *size);
...
extc int     DECL_CDECL Setbreakpoint(ulong addr,ulong type,uchar cmd);
extc int     DECL_CDECL Setbreakpointext(ulong addr,ulong type,char cmd,
               ulong passcount);
extc int     DECL_CDECL Manualbreakpoint(ulong addr,
               int key,int shiftkey,ulong nametype,int font);
extc void    DECL_CDECL Deletebreakpoints(ulong addr0,ulong addr1,int silent);
extc ulong   DECL_CDECL Getbreakpointtype(ulong addr);
extc ulong   DECL_CDECL Getbreakpointtypecount(ulong addr,ulong *passcount);
extc ulong   DECL_CDECL Getnextbreakpoint(ulong addr,ulong *type,int *cmd);
extc void    DECL_CDECL Tempbreakpoint(ulong addr,int mode);
extc int     DECL_CDECL Hardbreakpoints(int closeondelete);
extc int     DECL_CDECL Sethardwarebreakpoint(ulong addr,int size,int type);
extc int     DECL_CDECL Deletehardwarebreakpoint(int index);
extc int     DECL_CDECL Deletehardwarebreakbyaddr(ulong addr);
extc int     DECL_CDECL Setmembreakpoint(int type,ulong addr,ulong size);
extc uchar*  DECL_CDECL Findhittrace(ulong addr,uchar **ptracecopy,ulong *psize);
extc int     DECL_CDECL Modifyhittrace(ulong addr0,ulong addr1,int mode);
extc ulong   DECL_CDECL Isretaddr(ulong retaddr,ulong *procaddr);
extc HWND    DECL_CDECL Creatertracewindow(void);
extc void    DECL_CDECL Settracecondition(char *cond,int onsuspicious,
               ulong in0,ulong in1,ulong out0,ulong out1);
extc void    DECL_CDECL Settracecount(ulong count);
extc void    DECL_CDECL Settracepauseoncommands(char *cmdset);
extc int     DECL_CDECL Startruntrace(t_reg *preg);
extc void    DECL_CDECL Deleteruntrace(void);
extc int     DECL_CDECL Runtracesize(void);
extc int     DECL_CDECL Findprevruntraceip(ulong ip,int startback);
extc int     DECL_CDECL Findnextruntraceip(ulong ip,int startback);
extc int     DECL_CDECL Getruntraceregisters(int nback,t_reg *preg,
               t_reg *pold,char *cmd,char *comment);
extc int     DECL_CDECL Getruntraceprofile(ulong addr,ulong size,ulong *profile);
extc void    DECL_CDECL Scrollruntracewindow(int back);
extc HWND    DECL_CDECL Createprofilewindow(ulong base,ulong size);
...
extc int     DECL_CDECL Injectcode(ulong threadid,t_inject *inject,char *data,
...
extc void    DECL_CDECL Setcpu(ulong threadid,ulong asmaddr,
               ulong dumpaddr,ulong stackaddr,int mode);
extc void    DECL_CDECL Setdisasm(ulong asmaddr,ulong selsize,int mode);
extc void    DECL_CDECL Redrawdisassembler(void);
extc void    DECL_CDECL Getdisassemblerrange(ulong *pbase,ulong *psize);
extc ulong   DECL_CDECL Findprocbegin(ulong addr);
extc ulong   DECL_CDECL Findprocend(ulong addr);
extc ulong   DECL_CDECL Findprevproc(ulong addr);
extc ulong   DECL_CDECL Findnextproc(ulong addr);
extc int     DECL_CDECL Getproclimits(ulong addr,ulong *start,ulong *end);
extc void    DECL_CDECL Sendshortcut(int where,ulong addr,
...
extc t_status DECL_CDECL Getstatus(void);
extc int     DECL_CDECL Go(ulong threadid,ulong tilladdr,int stepmode,
               int givechance,int backupregs);
extc int     DECL_CDECL Suspendprocess(int processevents);
...
extc uchar*  DECL_CDECL Findknownfunction(ulong addr,int direct,
               int level,char *fname);
extc int     DECL_CDECL Decodeknownargument(ulong addr,uchar *arg,ulong value,
               int valid,char *s,char *mask,uchar *pset[]);
extc char*    DECL_CDECL Findunknownfunction(ulong ip,char *code,char *dec,
               ulong size,char *fname);
extc int     DECL_CDECL Decodeascii(ulong value,char *s,int len,int mode);
extc int     DECL_CDECL Decodeunicode(ulong value,char *s,int len);
...
extc HWND    DECL_CDECL Showsourcefromaddress(ulong addr,int show);
extc int     DECL_CDECL Getresourcestring(t_module *pm,ulong id,char *s);
extc t_sourceline* DECL_CDECL Getlinefromaddress(ulong addr);
extc ulong   DECL_CDECL Getaddressfromline(ulong addr0,ulong addr1,
               char *path,ulong line);
extc int     DECL_CDECL Getsourcefilelimits(ulong nameaddr,
               ulong *addr0,ulong *addr1);
extc int     DECL_CDECL Decodefullvarname(t_module *pmod,t_symvar *psym,
               int offset,char *name);
extc int     DECL_CDECL Getbprelname(t_module *pmod,ulong addr,long offset,
               char *s,int nsymb);

////////////////////////////////////////////////////////////////////////////////
//////////////////////////////// WATCH SUPPORT /////////////////////////////////

extc HWND    DECL_CDECL Createwatchwindow(void);
extc int     DECL_CDECL Deletewatch(int indexone);
extc int     DECL_CDECL Insertwatch(int indexone,char *text);
extc int     DECL_CDECL Getwatch(int indexone,char *text);
...
extc HWND    DECL_CDECL Createwinwindow(void);
...
extc HWND    DECL_CDECL Createpatchwindow(void);
...
extc int     DECL_CDECL Registerpluginclass(char *classname,char *iconname,
               HINSTANCE dllinst,WNDPROC classproc);
extc void    DECL_CDECL Unregisterpluginclass(char *classname);
extc int     DECL_CDECL Pluginwriteinttoini(HINSTANCE dllinst,char *key,int value);
extc int     DECL_CDECL Pluginwritestringtoini(HINSTANCE dllinst,char *key,char *s);
extc int     DECL_CDECL Pluginreadintfromini(HINSTANCE dllinst,char *key,int def);
extc int     DECL_CDECL Pluginreadstringfromini(HINSTANCE dllinst,char *key,
               char *s,char *def);
extc int     DECL_CDECL Pluginsaverecord(ulong tag,ulong size,void *data);
extc int     DECL_CDECL Plugingetvalue(int type);
...
extc int  _export DECL_CDECL ODBG_Plugindata(char shortname[32]);
extc int  _export DECL_CDECL ODBG_Plugininit(int ollydbgversion,HWND hw,
                        ulong *features);
extc void _export DECL_CDECL ODBG_Pluginmainloop(DEBUG_EVENT *debugevent);
extc void _export DECL_CDECL ODBG_Pluginsaveudd(t_module *pmod,int ismainmodule);
extc int  _export DECL_CDECL ODBG_Pluginuddrecord(t_module *pmod,int ismainmodule,
                        ulong tag,ulong size,void *data);
extc int  _export DECL_CDECL ODBG_Pluginmenu(int origin,char data[4096],void *item);
extc void _export DECL_CDECL ODBG_Pluginaction(int origin,int action,void *item);
extc int  _export DECL_CDECL ODBG_Pluginshortcut(
                        int origin,int ctrl,int alt,int shift,int key,
                        void *item);
extc void _export DECL_CDECL ODBG_Pluginreset(void);
extc int  _export DECL_CDECL ODBG_Pluginclose(void);
extc void _export DECL_CDECL ODBG_Plugindestroy(void);
extc int  _export DECL_CDECL ODBG_Paused(int reason,t_reg *reg);
extc int  _export DECL_CDECL ODBG_Pausedex(int reasonex,int dummy,t_reg *reg,
                        DEBUG_EVENT *debugevent);
extc int  _export DECL_CDECL ODBG_Plugincmd(int reason,t_reg *reg,char *cmd);
