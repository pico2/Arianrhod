...
__forceinline PVOID AllocateMemory(ULONG_PTR Size, ULONG Flags)
{
    return malloc(Size);
}

__forceinline PVOID ReAllocateMemory(PVOID Memory, ULONG_PTR Size, ULONG Flags)
{
    return realloc(Memory, Size);
}

__forceinline VOID FreeMemory(PVOID Memory, ULONG Flags)
{
    free(Memory);
}
